...
#define    MOUSE_SENSOR_Raw_Data_Output_Status       0x1A
#define    MOUSE_SENSOR_Raw_Data_Output              0x1B
...
#define    MOUSE_SENSOR_Glass_Rest1_Period           0x74
#define    MOUSE_SENSOR_Glass_Rest1_DownShift        0x75
...
const uint8_t download_data_1[] = {0x07,0x41,0x0F,0x28,0x00,0x08,0x16,0x04,0x00};
const uint8_t download_reg_1[]  = {0x7F,0x40,0x41,0x42,0x43,0x4A,0x51,0x53,0x7F};

const uint8_t download_data_2[] = {};
const uint8_t download_reg_2[]  = {};

const uint8_t corded_low_data[] = {0x05,0x64,0x05,0x20,0x40,0x40,0xFB,0xFB,0x90,0x31,0xB8,0xCF,0x50,0x06,0x03,0x02,0x03,0x20,0x8F,0x70,0x07,0x07,0x14,0x00,0x09,0x01,0x23,0x88,0x00,
                                   0x0C,0x04,0x3F,0x3F,0x0F,0x0F,0x0C,0x0A,0x14,0x19,0x32,0x24,0x02,0x02,0x0C,0x20,0x1F,0x5C,0x90,0x14,0x15,0x1E,0x02,0x02,0x14,0x14,0x18,0x55,0x18,
                                   0x40,0x20,0x38,0x68,0x0A,0x1A,0x48,0x40,0x22,0x88,0x88,0x22,0xCB,0x20,0x30,0x28,0x30,0x24,0x02,0x01,0x85,0x0C,0x0A,0x00,0x4F,0x00,0x4F,0x00,0x01,
                                   0x55,0x80};

const uint8_t office_data[]      = {0x05,0xE4,0x05,0x10,0x28,0x30,0xFB,0xFB,0x90,0x3B,0xB8,0xDF,0x10,0x06,0x03,0x01,0x02,0x20,0x8F,0x70,0x04,0x07,0x28,0x00,0x09,0x01,0x13,0x88,0x00,
                                    0x0C,0x04,0x3F,0x3F,0x0F,0x0F,0x0C,0x0A,0x14,0x19,0x53,0x64,0x02,0x02,0x0C,0x1C,0x14,0x4F,0x02,0x00,0x01,0x16,0x10,0x18,0x14,0x14,0x18,0x65,0x34,
                                    0x54,0x38,0x5F,0x7F,0x1C,0x60,0xFF,0x00,0x22,0xF2,0xF6,0x32,0xCC,0x2C,0x38,0x32,0x30,0x1E,0x06,0x02,0xF5,0x06,0x06,0x00,0x4F,0x00,0x4F,0x00,0x01,
                                    0x52,0x80,0x0A,0x10};
const uint8_t lp_data[]          = {0x05,0xE4,0x05,0x10,0x40,0x40,0xFC,0xFC,0x90,0x3B,0xB8,0xDF,0x10,0x06,0x03,0x01,0x02,0x20,0x8F,0x70,0x04,0x07,0x28,0x00,0x09,0x01,0x13,0x88,0x00,
                                    0x0C,0x04,0x3F,0x3F,0x0F,0x0F,0x0C,0x0A,0x11,0x19,0x32,0x12,0x01,0x01,0x0C,0x1C,0x14,0x4F,0x02,0x00,0x01,0x16,0x10,0x18,0x14,0x14,0x18,0x65,0x34,
                                    0x54,0x38,0x5F,0x7F,0x1C,0x60,0xFF,0x00,0x22,0xF2,0xF6,0x32,0xCC,0x2C,0x38,0x32,0x30,0x1E,0x06,0x02,0xF5,0x06,0x06,0x00,0x4F,0x00,0x4F,0x00,0x01,
                                    0x53,0x80,0x01,0x9C};
const uint8_t hp_data[]          = {0x05,0xE4,0x05,0x10,0x40,0x40,0xFB,0xFB,0x90,0x31,0xB8,0xCF,0x10,0x06,0x03,0x01,0x02,0x20,0x8F,0x70,0x04,0x07,0x28,0x00,0x09,0x01,0x13,0x88,0x00,
                                    0x0C,0x04,0x3F,0x3F,0x0F,0x0F,0x0C,0x0A,0x14,0x19,0x32,0x12,0x01,0x01,0x0C,0x1C,0x14,0x4F,0x02,0x00,0x01,0x16,0x10,0x18,0x14,0x14,0x18,0x65,0x34,
                                    0x54,0x38,0x5F,0x7F,0x1C,0x60,0xFF,0x00,0x22,0xF2,0xF6,0x32,0xCC,0x2C,0x38,0x32,0x30,0x1E,0x06,0x02,0xF5,0x06,0x06,0x00,0x4F,0x00,0x4F,0x00,0x01,
                                    0x53,0x80,0x01,0x9C};

const  uint8_t   corded_high_data[] =    {0x05, 0x64, 0x05, 0x20, 0x10, 0x40, 0xFB, 0xFB, 0x80, 0x31,0xA7, 0xCD, 0x50, 0x06, 0x02, 0x02, 0x03, 0x20, 0x98, 0x80,0x07, 0x07, 0x14, 0x00, 0x09, 0x03,
                                0x23, 0x98, 0x18, 0x00,0x11, 0x54, 0x54, 0x20, 0x20, 0x0E, 0x0A, 0x14, 0x19, 0x32,0x24, 0x02, 0x02, 0x0C, 0x20, 0x1F, 0x5C, 0x90, 0x14, 0x15,0x1E, 0x02,
                                0x02, 0x14, 0x14, 0x18, 0x55, 0x18, 0x40, 0x20,0x38, 0x68, 0x0A, 0x1A, 0x48, 0x40, 0x22, 0x88, 0x88, 0x22,0xCB, 0x20, 0x30, 0x28, 0x30, 0x24, 0x02, 0x01,
                                0x85, 0x0C,0x0A, 0x00, 0x95, 0x00, 0x95, 0x00, 0x01, 0x55, 0x80};


const uint8_t corded_low_reg[]  = {0x7F,0x43,0x44,0x49,0x51,0x53,0x55,0x5B,0x5F,0x61,0x6D,0x6E,0x7B,0x7F,0x53,0x62,0x7A,0x6B,0x6D,0x6E,0x6F,0x7F,0x42,0x43,0x7F,0x40,0x43,0x44,0x47,
                                   0x4F,0x51,0x55,0x56,0x59,0x5A,0x73,0x7F,0x4A,0x7F,0x41,0x47,0x4B,0x4C,0x7F,0x4A,0x4B,0x4C,0x4D,0x50,0x51,0x53,0x55,0x62,0x7F,0x62,0x7F,0x48,0x50,
                                   0x51,0x52,0x53,0x55,0x61,0x62,0x63,0x64,0x70,0x71,0x72,0x77,0x79,0x4C,0x4D,0x4E,0x5A,0x5B,0x5D,0x5E,0x6D,0x6E,0x6F,0x7F,0x4F,0x4E,0x52,0x51,0x47,
                                   0x54,0x5A};
const uint8_t corded_high_reg[] = {0x7F, 0x43, 0x44, 0x49, 0x51, 0x53, 0x55, 0x5B, 0x5F, 0x61,0x6D, 0x6E, 0x7B, 0x7F, 0x53, 0x62, 0x7A, 0x6B, 0x6D, 0x6E,0x6F, 0x7F, 0x42, 0x43, 0x7F,
                                    0x40, 0x43, 0x44, 0x47, 0x4F,0x51, 0x55, 0x56, 0x59, 0x5A, 0x73, 0x7F, 0x4A, 0x7F, 0x41,0x47, 0x4B, 0x4C, 0x7F, 0x4A, 0x4B, 0x4C, 0x4D, 0x50, 0x51,
                                    0x53, 0x55, 0x62, 0x7F, 0x62, 0x7F, 0x48, 0x50, 0x51, 0x52,0x53, 0x55, 0x61, 0x62, 0x63, 0x64, 0x70, 0x71, 0x72, 0x77,0x79, 0x4C, 0x4D, 0x4E, 0x5A,
                                    0x5B, 0x5D, 0x5E, 0x6D, 0x6E,0x6F, 0x7F, 0x4F, 0x4E, 0x52, 0x51, 0x47, 0x54, 0x5A};

const uint8_t other_mode_reg[]  = {0x7F,0x43,0x44,0x49,0x51,0x53,0x55,0x5B,0x5F,0x61,0x6D,0x6E,0x7B,0x7F,0x53,0x62,0x7A,0x6B,0x6D,0x6E,0x6F,0x7F,0x42,0x43,0x7F,0x40,0x43,0x44,0x47,
                                   0x4F,0x51,0x55,0x56,0x59,0x5A,0x73,0x7F,0x4A,0x7F,0x41,0x47,0x4B,0x4C,0x7F,0x4A,0x4B,0x4C,0x4D,0x50,0x51,0x53,0x55,0x62,0x7F,0x62,0x7F,0x48,0x50,
                                   0x51,0x52,0x53,0x55,0x61,0x62,0x63,0x64,0x70,0x71,0x72,0x77,0x79,0x4C,0x4D,0x4E,0x5A,0x5B,0x5D,0x5E,0x6D,0x6E,0x6F,0x7F,0x4F,0x4E,0x52,0x51,0x47,
                                   0x54,0x5A,0x78,0x79};
...
static int  mouse_sensor_write(const struct device *dev,uint8_t address,uint8_t data)
{
    ...
    {
        log_mouse_sensor_error("[MOUSE][3950] spi master send error:%d address:%x", 2,ret,address);
        return -EIO;
    }
    hal_nvic_save_and_set_interrupt_mask(&mask);
...
static int  mouse_sensor_read(const struct device *dev,uint8_t address,uint8_t *data)
{
    ...
    if(ret != HAL_SPI_MASTER_STATUS_OK)
    {
        log_mouse_sensor_error("[MOUSE][3950] spi master read error:%d address:%x", 2,ret,address);
        return -EIO;
    }
    *data = receive_buf[1];
    hal_nvic_save_and_set_interrupt_mask(&mask);
...
ATTR_TEXT_IN_TCM static int mouse_sensor_burst_read(const struct device *dev,uint8_t burst_size,bool is_start){
    ...
    if((is_start == false) || ((is_start == true) && (mouse_burst_data->burst_flag == false))){  //is_start false is bt trigger.other manual trigger, first need set spi
        ...
        if(ret != HAL_SPI_MASTER_STATUS_OK)
        {
            log_mouse_sensor_error("[MOUSE][3950] spi master burst read error:%d", 1,ret);
            return -EIO;
        }
        hal_nvic_save_and_set_interrupt_mask(&mask);
...
static int  mouse_sensor_clear_data(const struct device *dev,uint8_t count)
{
    ...
    for(int i = 0;i < count;i++){
        ...
        if(ret != HAL_SPI_MASTER_STATUS_OK)
        {
            log_mouse_sensor_error("[MOUSE][3950] spi master clear data error:%d", 1,ret);
            return -EIO;
        }
    }
    hal_nvic_save_and_set_interrupt_mask(&mask);
...
static int mouse_sensor_set_bt_trig(const struct device *dev,bool bt_trig){
    ...
    if(bt_trig == false){
        ...
        if(ret != HAL_SPI_MASTER_STATUS_OK){
            log_mouse_sensor_error("[MOUSE][3950] spi bt trigger set error :%d", 1, bt_trig);
            return -EIO;
        }
    ...
    hal_nvic_restore_interrupt_mask(mask);
    log_mouse_sensor_info("[MOUSE][3950] spi bt trigger set success :%d", 1, bt_trig);
    return 0;
}
...
static int mouse_sensor_srom_download(const struct device *dev){
    int ret=0,i;
    uint8_t data;
    for(i=0;i<sizeof(download_data_1);i++){
        ret|=mouse_sensor_write(dev,download_reg_1[i],download_data_1[i]);
    }
    hal_gpt_delay_ms(1);
    for(i=0;i<sizeof(download_data_2);i++){
        ret|=mouse_sensor_write(dev,download_reg_2[i],download_data_2[i]);
    }
    if(ret != 0){
        printf("\r\nPAW 3950 srom load fail1 \r\n");
        return -EIO;
    }
    for (i = 0; i < 45; i++)
    {
        mouse_sensor_read(dev,0x6C,&data);
        hal_gpt_delay_ms(1);
        if(data == 0x80){
            break;
        }
    ...
    hal_gpt_delay_ms(5);
    mouse_sensor_write(dev,0x22,0x00);
    mouse_sensor_write(dev,0x55,0x00);
    mouse_sensor_write(dev,0x40,0x00);
    mouse_sensor_write(dev,0x68,0x01);
    return ret;
}
...
static int mouse_sensor_poweron(const struct device *dev){
    ...
    int32_t init_left_time = global_init_left_time;
    ...
    for (i = 0; i < 5; i++){
        ...
        if((i > 1) && (dev_config->nreset_pin != 0xff)){
            hal_pinmux_set_function(dev_config->nreset_pin,0);
            hal_gpio_set_direction(dev_config->nreset_pin,1);
            hal_gpio_set_output(dev_config->nreset_pin, 0);
            hal_gpt_delay_ms(1);
            hal_gpio_set_output(dev_config->nreset_pin, 1);
            hal_gpt_delay_ms(5);
        }
    }
    if(i == 5){
        log_mouse_sensor_error("[MOUSE][3950] sensor not connected ", 0);
        return -EIO;
    }
    while(1){
        if(count == 10){
            log_mouse_sensor_error("[MOUSE][3950] download failed", 0);
            return -EIO;
        }
    ...
    uint8_t xy_data;
    uint8_t x_cpi_low,x_cpi_high;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    ret |= mouse_sensor_read(dev,MOUSE_SENSOR_Resolution_X_Low, &x_cpi_low);
    ret |= mouse_sensor_read(dev,MOUSE_SENSOR_Resolution_X_High, &x_cpi_high);
    log_mouse_sensor_info("[MOUSE][3950] sensor power on success xy:%x x_low_cpi:%x,x_high_cpi:%x", 3 ,xy_data,x_cpi_low,x_cpi_high);
    // log_mouse_sensor_info("[MOUSE][3950] sensor power on success ", 0);
    return ret;
}

static int mouse_sensor_keep_high_fps(const struct device *dev, bool enable, bool force)
{
    uint32_t mask;
    struct mouse_sensor_data *dev_data = dev->data;
    if(enable == dev_data->keep_high_fps && (force == false))
    {
        log_mouse_sensor_warning("[MOUSE][3950] keep_high_fps is already %d, no need to change",1, dev_data->keep_high_fps);
        return 0;
    }
    hal_nvic_save_and_set_interrupt_mask(&mask);
    if(enable){
        dev_data->keep_high_fps = true;
    }else{
        dev_data->keep_high_fps = false;
    }
    hal_nvic_restore_interrupt_mask(mask);
    log_mouse_sensor_info("[MOUSE][3950] sensor keep high_fps: %d, setting done", 1, dev_data->keep_high_fps);
    return 0;
}

static int mouse_sensor_read_keep_high_fps(const struct device *dev, bool *enable)
{
    struct mouse_sensor_data *dev_data = dev->data;
    *enable = dev_data->keep_high_fps;
    log_mouse_sensor_info("[MOUSE][3950] read sensor keep high_fps: %d", 1, *enable);
    return 0;
}
...
static int mouse_sensor_Corded_GamingMode(const struct device *dev){
    ...
    uint32_t mask;
    struct mouse_sensor_data *dev_data = dev->data;
    bool is_low_cpi = (dev_data->cpi_x < 7000 && dev_data->cpi_y < 7000);
    bool is_keep_high_fps = dev_data->keep_high_fps;
    log_mouse_sensor_info("[MOUSE][3950] sensor is_low_cpi:%d, is_keep_high_fps:%d",2, is_low_cpi, is_keep_high_fps);
    if(is_low_cpi && (!is_keep_high_fps)){
        for(i =0;i<sizeof(corded_low_data);i++){
            ret |= mouse_sensor_write(dev,corded_low_reg[i],corded_low_data[i]);
        }
        log_mouse_sensor_info("[MOUSE][3950] sensor set to low_fps in the low dpi state",0);
    }else{
        for(i =0;i<sizeof(corded_high_data);i++){
            ret |= mouse_sensor_write(dev,corded_high_reg[i],corded_high_data[i]);
        }
        if(is_keep_high_fps && is_low_cpi){
            log_mouse_sensor_info("[MOUSE][3950] sensor keep high_fps in the low dpi state",0);
        }
    }
    ret |= mouse_sensor_write(dev,0x40,0x83);
    hal_nvic_save_and_set_interrupt_mask(&mask);
    dev_data->corded_high = (!is_low_cpi) | (is_keep_high_fps);
    hal_nvic_restore_interrupt_mask(mask);
    return ret;
}
...
static int mouse_sensor_LiftCutOff_setting1mm(const struct device *dev){
    int ret=0;
    ret = mouse_sensor_write(dev,0x7F,0x18);
    ret |= mouse_sensor_write(dev,0x7A,0x85);
...
static int mouse_sensor_LiftCutOff_setting2mm(const struct device *dev){
    int ret = 0;
    ret = mouse_sensor_write(dev,0x7F,0x18);
    ret |= mouse_sensor_write(dev,0x7A,0x8F);
    ret |= mouse_sensor_write(dev,0x7F,0x00);
    return ret;
}

static int mouse_sensor_LiftCutOff_setting0_7mm(const struct device *dev){
    int ret = 0;
    ret = mouse_sensor_write(dev,0x7F,0x18);
    ret |= mouse_sensor_write(dev,0x7A,0x00);
    ret |= mouse_sensor_write(dev,0x7F,0x00);
    return ret;
}
...
static int mouse_sensor_liftCutOff_setting(const struct device *dev,uint8_t lift,bool force){
    ...
    }else if(lift == lift_cut_off_0_7mm){
        ret |= mouse_sensor_LiftCutOff_setting0_7mm(dev);
    }
    else{
        log_mouse_sensor_error("[MOUSE][3950] sensor set LOD failed,setting:%d", 1, lift);
        return -EINVAL;
    }
    if(ret == 0) {
        hal_nvic_save_and_set_interrupt_mask(&mask);
    ...
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor set LOD success,setting:%d xy:%x", 4, lift,xy_data);
    return ret;
}
...
static int mouse_sensor_read_liftCutOff_setting(const struct device *dev,uint8_t *lift){
    ...
    uint8_t data;
    ret |= mouse_sensor_write(dev,0x7F,0x18);
    ret |= mouse_sensor_read(dev,0x18,&data);
    ret |= mouse_sensor_write(dev,0x7F,0x00);
    if(ret == 0) {
        if(data== 0x85) *lift = lift_cut_off_1mm;
        else if(data== 0x8F) *lift = lift_cut_off_2mm;
        else if(data== 0x00) *lift = lift_cut_off_0_7mm;
    }
    return ret;
}
...
static int mouse_sensor_rest_mode(const struct device *dev,bool status,bool force){
    ...
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor set rest mode success,setting:%d xy:%x", 4, status,xy_data);
    return ret;
}
...
static int mouse_sensor_cpi(const struct device *dev,uint32_t cpi,cpi_setting setting,bool force)
{
    ...
    if(dev_data->mode == corded_gaming_mode) {
        bool is_low_cpi = (dev_data->cpi_x < 7000 && dev_data->cpi_y < 7000);
        if (is_low_cpi == dev_data->corded_high) mouse_sensor_mode_setting(dev,corded_gaming_mode,true);  //force download corded mode
    }
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor set cpi success,cpi:%d,setting:%d xy:%x low_cpi:%x,high_cpi:%x", 5, cpi,setting,xy_data,Low,High);
    return ret;
}
...
static int mouse_sensor_xy_direction(const struct device *dev,mouse_degree degree,bool force)
{
    ...
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor set xy direction success,setting:%d,xy:%x", 4, degree,xy_data);
    return ret;
}
...
static int mouse_sensor_config_period_time(const struct device *dev,mouse_period_time rate,uint16_t value_ms,bool force){
    ...
    switch (rate){
        ...
        case Rest3_Period_time:
            ...
            break;
        default:
            log_mouse_sensor_error("[MOUSE][3950] sensor config period time failed,setting:%d,time:%d", 2, rate,value_ms);
            return -EIO;
    }
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor config period time success xy:%x", 3 ,xy_data);
    return 0;
}
...
static int mouse_sensor_read_period_time(const struct device *dev,mouse_period_time rate,uint16_t *value_ms){
    ...
    switch (rate){
        ...
        case Rest3_Period_time:
            ...
            break;
        default:
            log_mouse_sensor_error("[MOUSE][3950] sensor read period time failed,setting:%d,time:%d", 2, rate,value_ms);
            return -EIO;
    }
    return 0;
}
static int mouse_sensor_config_time(const struct device *dev,mouse_rest_time rate,const struct sensor_value *val,bool force)
{
    ...
    switch (rate){
        ...
        case Rest1_DownShift_time:
            ...
            if(period == 0){
                log_mouse_sensor_error("[MOUSE][3950] sensor read rest1 period error,period:%d", 1, period);
                mouse_sensor_reinit(dev);
                return -EIO;
            }
        ...
        case Rest2_DownShift_time:
            ...
            if(period == 0){
                log_mouse_sensor_error("[MOUSE][3950] sensor read rest2 period error,period:%d", 1, period);
                mouse_sensor_reinit(dev);
                return -EIO;
            }
            ...
            break;
        default:
            log_mouse_sensor_error("[MOUSE][3950] sensor config time failed,setting:%d", 1, rate);
            return -EIO;
    }
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor sensor config time succes xy:%x", 3 ,xy_data);
    return 0;
}
...
static int mouse_sensor_read_config_time(const struct device *dev,mouse_rest_time rate,struct sensor_value *val){
    ...
    switch (rate){
        ...
        break;
        default:
            log_mouse_sensor_error("[MOUSE][3950] sensor read time failed,setting:%d", 1, rate);
            return -EIO;
    }
    return -EIO;
}
    ...
    switch (function){
        case Motion_sync:
        {
            ...
            if(state){
                ...
                ret |= mouse_sensor_write(dev,0x48, 0xFD);
                ret |= mouse_sensor_write(dev,0x7F, 0x00);
            }else{
                ret |= mouse_sensor_write(dev,0x7F, 0x0D);
                ret |= mouse_sensor_write(dev,0x48, 0xFC);
                ret |= mouse_sensor_write(dev,0x7F, 0x00);
            }
            if(ret == 0){
                hal_nvic_save_and_set_interrupt_mask(&mask);
        ...
        case Ripple_control:
        {
            return -EINVAL; //3950 not support
        ...
        {   if((dev_data->angle_snap == state) && (force == false)){
            ...
            if(state){
                ret |= mouse_sensor_write(dev,MOUSE_SENSOR_Angle_Snap, 0x0D);
            }else{
                ret |= mouse_sensor_write(dev,MOUSE_SENSOR_Angle_Snap, 0x0);
            }
            if(ret == 0){
                hal_nvic_save_and_set_interrupt_mask(&mask);
        ...
        default:
            log_mouse_sensor_error("[MOUSE][3950] sensor set function failed,setting:%d,status:%d", 2, function,state);
            return -EINVAL;
    }
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor set function success,setting:%d,status:%d xy:%x", 5 , function,state,xy_data);
    return ret;
}
...
static int mouse_sensor_mode_setting(const struct device *dev,mouse_mode mode,bool force){
    ...
    if(mode == corded_gaming_mode){
        ...
        log_mouse_sensor_error("[MOUSE][3950] sensor set mode failed,setting:%d", 1, mode);
        return -EIO;
    }
    uint8_t xy_data;
    ret = mouse_sensor_read(dev,MOUSE_SENSOR_Axis_Control, &xy_data);
    log_mouse_sensor_info("[MOUSE][3950] sensor set mode success,setting:%d,corded_high:%d xy:%x", 5 , mode,dev_data->corded_high,xy_data);
    ...
    if(ret == 0){
        ...
        mouse_sensor_config_period_time(dev,Rest1_Period_time,dev_data->rest1_period_time,true);  //test
        ...
        log_mouse_sensor_info("[MOUSE][3950] sensor set rest1 downshift time after set mode success",0);
    }

    return ret;
}

static int mouse_sensor_read_mode_setting(const struct device *dev,mouse_mode *mode){  //test
    int ret=0;
    uint8_t data;
    ret |= mouse_sensor_read(dev,0x40,&data);
    data = data & 0x3;
...
static int mouse_sensor_init_spi(const struct device *dev){
    ...
    if (HAL_SPI_MASTER_STATUS_OK != ret) {
        log_mouse_sensor_error("[MOUSE][3950] sensor init spi failed,ret:%d", 1, ret);
        return -EIO;
    }
...
static int mouse_sensor_sensor_init(const struct device *dev)
{
    ...
    if((dev_config->frequency) >  8000000){
        log_mouse_sensor_error("[MOUSE][3950] sensor spi master frequency is %d over 8M\n",1,dev_config->frequency);
        return -EIO;
    }
    ...
    if(0 != mouse_sensor_keep_high_fps(dev,dev_data->keep_high_fps,dev_data->force)){
        return -EIO;
    }
    ...
    hal_nvic_restore_interrupt_mask(mask);
    log_mouse_sensor_info("[MOUSE][3950] sensor init success\n",0);
    return 0;
}
...
static int mouse_sensor_sensor_init_workround(const struct device *dev)
{
    log_mouse_sensor_info("[MOUSE][3950] sensor init workround\n",0);
    struct mouse_sensor_data *dev_data = dev->data;
    if(0 != mouse_sensor_poweron(dev)){
        return -EIO;
    }
    if(0 != mouse_sensor_keep_high_fps(dev,dev_data->keep_high_fps,true)){
        return -EIO;
    }
    ...
    log_mouse_sensor_info("[MOUSE][3950] sensor workround init success\n",0);
    return 0;
}
...
static int mouse_sensor_sensor_deinit(const struct device *dev)
{
    ...
    int ret =0;
    if(mouse_burst_data->init_flag != true){
        log_mouse_sensor_error("[MOUSE][3950] sensor deinit failed,not init\n",0);
        return -EBUSY;
    }
    ...
    log_mouse_sensor_error("[MOUSE][3950] sensor deinit success\n",0);
	return 0;
}
...
static int mouse_sensor_attr_set(const struct device *dev,enum sensor_channel chan,
    ...
    if(mouse_burst_data->init_flag != true){
        if((uint32_t)attr == MOUSE_SENSOR_ATTR_INIT){
            ...
            log_mouse_sensor_error("[MOUSE][3950] sensor attr set failed, not init, attr:%d\n",1,attr);
            return -EBUSY;
        }
    }
    switch((uint32_t)attr){
        ...
        break;
        case MOUSE_SENSOR_ATTR_KEEP_HIGH_FPS:
            ret = mouse_sensor_keep_high_fps(dev,val->val1,false);
        break;
...
static int mouse_sensor_attr_get(const struct device *dev,enum sensor_channel chan,
    ...
    int ret = 0;
    if(mouse_burst_data->init_flag != true){
            log_mouse_sensor_error("[MOUSE][3950] sensor attr get failed, not init,attr:%d\n",attr);
            return -EBUSY;
    }
    switch((uint32_t)attr){
        case MOUSE_SENSOR_ATTR_XY_DIRECTION:
        ...
        case MOUSE_SENSOR_ATTR_KEEP_HIGH_FPS:
            if((uint32_t)chan ==MOUSE_SENSOR_CHAN_RAM_DATA){
                val->val1 = (int32_t)(dev_data->keep_high_fps);
            }else{
                bool enable = 0;
                ret = mouse_sensor_read_keep_high_fps(dev,&enable);
                if(ret == 0)val->val1 = (int32_t)enable;
            }
        break;
        case MOUSE_SENSOR_ATTR_REST_MODE:
            if((uint32_t)chan ==MOUSE_SENSOR_CHAN_RAM_DATA){
...
ATTR_TEXT_IN_TCM static int mouse_sensor_sample_fetch(const struct device *dev, enum sensor_channel chan){
    if(mouse_burst_data->init_flag != true){
        log_mouse_sensor_error("[MOUSE][3950] sensor sample fetch failed, not init\n",0);
        return -EBUSY;
    }
...
{
    if(mouse_burst_data->init_flag != true){
        log_mouse_sensor_error("[MOUSE][3950] sensor channel get failed, not init\n",0);
        return -EBUSY;
    }
    switch (chan) {
...
#define	PAW3950_PIXART_DEVICE(id)						\
                   \
static struct mouse_sensor_data paw3950_p##id##_data;		\
									\
static const struct mouse_sensor_config paw3950_p##id##_config = {		\
    ...
    .nreset_pin = DT_PROP(DT_DRV_INST(id), nreset_pin),     \
...
DT_INST_FOREACH_STATUS_OKAY(PAW3950_PIXART_DEVICE)
