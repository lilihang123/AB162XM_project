...
/**
 * @file usb_dc_airoha.h
 * @brief AIROHA USB_DC extended APIs header file
 */
...
typedef enum {
	USB_DC_SPPED_LOW_SPEED,
	USB_DC_SPPED_FULL_SPEED,
	USB_DC_SPPED_HIGH_SPEED,
	USB_DC_SPPED_SUPER_SPEED,
} usb_dc_speed_t;
