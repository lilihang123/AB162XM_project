...
static void app_pin_config_parser_output_pin_handle(uint8_t gpio_id, T_GPIO_CONFIG_S * gpio_cfg, T_GPIO_PIN_USAGE_LIST_S* usage_list)
{
    ...
    switch(gpio_cfg->usage)
    {
        ...
        {
            usage_list->data.mouse_dbg.spi_cb = gpio_id;
            usage_list->ctrl.mouse_dbg_ptr = &usage_list->data.mouse_dbg;
        }
        break;

        case APP_PINMUX_USAGE_OUTPUT_DEBUG_LATCH_REPORT_SIGNAL:
        {
            usage_list->data.mouse_dbg.latch_report = gpio_id;
            usage_list->ctrl.mouse_dbg_ptr = &usage_list->data.mouse_dbg;
        }
        break;
        ...
        {
            usage_list->data.mouse_dbg.tx_nack = gpio_id;
            usage_list->ctrl.mouse_dbg_ptr = &usage_list->data.mouse_dbg;
        }
        break;
        ...
        {
            usage_list->data.mouse_dbg.dbg_1 = gpio_id;
            usage_list->ctrl.mouse_dbg_ptr = &usage_list->data.mouse_dbg;
        }
        break;
        ...
        {
            usage_list->data.mouse_dbg.dbg_2 = gpio_id;
            usage_list->ctrl.mouse_dbg_ptr = &usage_list->data.mouse_dbg;
        }
        break;
        ...
        {
            usage_list->data.mouse_dbg.dbg_3 = gpio_id;
            usage_list->ctrl.mouse_dbg_ptr = &usage_list->data.mouse_dbg;
        }
        break;
...
void app_pin_config_parser_print(T_GPIO_PIN_USAGE_LIST_S* usage_list)
{
    ...
    if (usage_list->ctrl.mouse_dbg_ptr){
        APP_LOGI(thisMOD, "mouse_dbg, spi_cb=%02d, latch_report=%d, tx_nack=%02d, dbg_1=%02d, dbg_2=%02d, dbg_3=%02d"
            ,usage_list->ctrl.mouse_dbg_ptr->spi_cb
            ,usage_list->ctrl.mouse_dbg_ptr->latch_report
            ,usage_list->ctrl.mouse_dbg_ptr->tx_nack
            ,usage_list->ctrl.mouse_dbg_ptr->dbg_1
            ,usage_list->ctrl.mouse_dbg_ptr->dbg_2
            ,usage_list->ctrl.mouse_dbg_ptr->dbg_3
            );
    }

    if (usage_list->ctrl.usb_dbg_ptr){
        APP_LOGI(thisMOD, "mouse_dbg, usb_tx=%02d, usb_tx_done=%02d, usb_sof=%02d"
