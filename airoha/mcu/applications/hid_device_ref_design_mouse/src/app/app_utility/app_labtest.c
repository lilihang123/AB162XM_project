...
/* variables                                                                  */
/******************************************************************************/
bool app_lab_type = APP_LABTEST_TYPE_NONE;
uint8_t rf_mode = LABTEST_MODE_DC_TONE;
uint8_t rf_channel = LABTEST_RF_FREQ_L;
bool modem_phy = LABTEST_MODEM_PHY_1M;
...
void app_labtest__relay_status_notify_cb(bt_relay_status_t status)
{
    if (status == bt_relay_status_enable)
    {
        ...
        APP_LOGI(thisMOD,"app_labtest__relay_status_notify_cb, enter relay mode");
    ...
    else if (status == bt_relay_status_disable)
    {
        ...
        APP_LOGI(thisMOD,"app_labtest__relay_status_notify_cb, exit relay mode");
...
/* public functions                                                           */
/******************************************************************************/
void app_labtest_init(bool enter_labtest)
{
    if(enter_labtest){
    ...
    APP_LOGI(thisMOD,"app_labtest_init finish");
    return;
}
