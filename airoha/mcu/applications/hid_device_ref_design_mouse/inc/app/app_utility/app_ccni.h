...
#ifndef __APP_TEMPLETE_H__
#define __APP_TEMPLETE_H__
...
#define APP_CCNI_EVENT_TO_RISCV  IRQGEN_MCU2RISCV_EVENT3

#define CCNI_MSG_INACTIVITY_TIMEOUT     0x81        //
#define CCNI_MSG_FORCE_ALL_KEY_RELEASED 0x82
