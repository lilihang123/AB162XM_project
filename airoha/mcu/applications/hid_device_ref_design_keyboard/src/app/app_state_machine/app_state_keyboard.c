...
#define thisMODULE state_mgr_kb
#define thisMOD    "state_mgr_kb"
LOG_MODULE_REGISTER(thisMODULE);
/******************************************************************************/
/*  function prototype                                                        */
/******************************************************************************/
static void app_state_keyboard_init_modules();
...
/******************************************************************************/
static bool app_state_keyboard__evt_module_init(const struct af_evt_header *evt_header)
{
    APP_LOGI(thisMOD,"app_state_keyboard__evt_module_init");
    #if 0
    ...
    #endif
    app_state_init();
    app_state_keyboard_init_modules();
...
static void app_state_keyboard_init_modules()
{
    APP_LOGI(thisMOD,"app_state_keyboard_init_modules");
    ...
    APP_LOGI(thisMOD,"app_state_keyboard_init_modules end");
}
...
bool app_state_device_active()
{
    ...
    return key_pressed;
#else
    /* always active if wake up condition is unknown and not implement */
    return true;
#endif /* CONFIG_AIR_GESTURE_SERVICE  */
}

/*============================Application Framework============================*/
AF_EVT_SUBSCRIBE_FUN(thisMODULE, evt_module_init, app_state_keyboard__evt_module_init);
