...
AF_EVT_DECLARE(evt_hid_kb_std);
AF_EVT_DECLARE(evt_hid_kb_consumer);
AF_EVT_DECLARE(evt_hid_kb_nKey);
AF_EVT_DECLARE(evt_hid_ms_key);
AF_EVT_DECLARE(evt_hid_ms_motion);
AF_EVT_DECLARE(evt_hid_ms_wheel);

AF_EVT_DECLARE(evt_module_init);
AF_EVT_DECLARE(evt_pairing_request);

AF_EVT_DECLARE(evt_link_switch_req);
...
AF_EVT_DECLARE(evt_mode_switch_status);
AF_EVT_DECLARE(evt_race_mode_switch);
