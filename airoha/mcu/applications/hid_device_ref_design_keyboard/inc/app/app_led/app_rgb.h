...
/* Public macro --------------------------------------------------------------*/
    ...
    #define APP_RGB_COLOR (1 + (3 * CONFIG_AIR_RGB_NUM))
    #define APP_RGB_DATA  (1 + (CONFIG_AIR_RGB_NUM))
#else
    #define APP_RGB_COLOR  4
    #define APP_RGB_DATA   2
#endif
...
typedef struct {
    ...
    uint8_t num;
    uint8_t count;
    uint8_t color[APP_RGB_COLOR];  //1+3*n
