...
#ifndef __APP_BT_SERVICE_LE_CONNECTION_H__
#define __APP_BT_SERVICE_LE_CONNECTION_H__
...
typedef struct {
    ...
    void       *conn;
} PACKED app_bt_service_le_connection_ind_t;
...
} PACKED app_bt_service_le_disconnect_ind_t;

typedef struct {
    uint16_t    conn_handle;
    uint8_t     addr_type;
    uint8_t     addr[BT_ADDR_SIZE];
} PACKED app_bt_service_le_bonded_ind_t;
...
#endif /* __APP_DONGLE_PLATFORM_LE_CONNECTION_H__ */
