...
#define thisMODULE state_mgr_gc
#define thisMOD    "state_mgr_gc"
LOG_MODULE_REGISTER(thisMODULE);
/******************************************************************************/
/*  function prototype                                                        */
/******************************************************************************/
static void app_state_game_controller_init_modules();
...
/******************************************************************************/
static bool app_state_game_controller__evt_module_init(const struct af_evt_header *evt_header)
{
    APP_LOGI(thisMOD,"app_state_game_controller__evt_module_init");
    #if 0
    ...
    #endif
    app_state_init();
    app_state_game_controller_init_modules();
...
static void app_state_game_controller_init_modules()
{
    APP_LOGI(thisMOD,"app_state_game_controller_init_modules");

    T_GPIO_PIN_USAGE_LIST_S pin_usage_list = {0};
    ...
    bool enter_labtest = app_button_labtest_combo_key_pressed();
...
#ifdef CONFIG_AIR_EXTERNAL_BUCK_GPIO_MODE
    external_buck_gpio_init(CONFIG_AIR_EXTERNAL_BUCK_GPIO_MODE_PIN);
    sleep_management_register_all_secure_suspend_callback(SLEEP_BACKUP_RESTORE_VRF_BUCK_SWITCH, (sleep_management_suspend_callback_t)external_buck_suspend_set_gpio, NULL);
    sleep_management_register_all_secure_resume_callback(SLEEP_BACKUP_RESTORE_VRF_BUCK_SWITCH, (sleep_management_resume_callback_t)external_buck_resume_set_gpio, NULL);
#endif

    app_la_debug_init(&pin_usage_list);
    APP_LOGI(thisMOD,"app_state_game_controller_init_modules end");
}
...
AF_EVT_SUBSCRIBE_FUN(thisMODULE, evt_module_init, app_state_game_controller__evt_module_init);
