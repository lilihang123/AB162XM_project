...
/******************************************************************************/
    ...
    {
        {46, PINMUX_FUN_GPIO },     // B
        {45, PINMUX_FUN_GPIO },     // R
        {44, PINMUX_FUN_GPIO },     // G

        {36, PINMUX_FUN_GPIO },
        {35, PINMUX_FUN_GPIO },
        {34, PINMUX_FUN_GPIO },

        {29, PINMUX_FUN_GPIO },//scroll up
        {28, PINMUX_FUN_GPIO },//scroll down

        {25, PINMUX_FUN_GPIO }, // M-Key

        {5, PINMUX_FUN_HW_CTRL_DEBUG }, // BW Key for BT Tx
        {4, PINMUX_FUN_HW_CTRL_DEBUG }, // FW key for BT Rx

        {1, PINMUX_FUN_GPIO }, // R key
    }; 
#else 
    const T_LA_DEBUG_CFG_S la_dbg_pin[] = 
    {
    ...
    //   {29, PINMUX_FUN_GPIO },//Mouse DPI key  
        // {28, PINMUX_FUN_GPIO },//latch

        {24, PINMUX_FUN_HW_CTRL_DEBUG }, // BT dbg

        #if defined(CONFIG_AIR_M21_3395)    
        {23, PINMUX_FUN_GPIO }, // BT dbg
        #else 
        ...
        //{22, HAL_GPIO_22_SPI_MST0_CS0 }, // Mouse Sensor CS
        //{21, HAL_GPIO_21_SPI_MST0_MOSI }, // Mouse Sensor MO
        //{20, HAL_GPIO_20_SPI_MST0_MISO }, // Mouse Sensor MI
        //{19, HAL_GPIO_19_SPI_MST0_SCK }, // Mouse Sensor SCK
        //{18, HAL_GPIO_18_EINT18 }, // Mouse Motion Pin

        {17, PINMUX_FUN_HW_CTRL_DEBUG }, // BT dbg

        {6, PINMUX_FUN_HW_CTRL_DEBUG }, // BT dbg
        {5, PINMUX_FUN_HW_CTRL_DEBUG }, // Mouse L Key
...
static bool app_la_debug__evt_app_state(const struct af_evt_header *evt_header)
{
    ...
    switch(event->app_state)
    {
        ...
        case APP_STATE_USB_CONNECTED:
        {
            #if 0
            #if defined(CONFIG_AIR_M21_SAMPLE)
            const T_LA_DEBUG_CFG_S la_dbg_pin_usb [] =
            { 
                {4, PINMUX_FUN_GPIO }, // BT dbg
                {5, PINMUX_FUN_GPIO }, // BT dbg
            };
            #else
            const T_LA_DEBUG_CFG_S la_dbg_pin_usb [] =
            { 
                {23, PINMUX_FUN_GPIO }, // BT dbg
                {24, PINMUX_FUN_GPIO }, // BT dbg
            };
            #endif
            
            la_debug_gpio_config(la_dbg_pin_usb, sizeof(la_dbg_pin_usb)/sizeof(T_LA_DEBUG_CFG_S) );
            #endif
        }
        break;
