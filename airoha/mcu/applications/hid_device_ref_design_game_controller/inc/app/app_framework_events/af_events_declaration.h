...
typedef enum{
    ...
    RACE_CMD_SET_REMAP_FN_KEY = 0x30EB,
    RACE_CMD_GET_REMAP_FN_KEY,
    #endif
    RACE_SET_JOYSTICK_PARAMETER = 0x30EC,
    RACE_SET_TRIGGER_PARAMETER = 0x30ED,
    RACE_CMD_SET_USB_MODE = 0x30EE,
    RACE_CMD_GET_USB_MODE = 0x30EF,
    RACE_GET_JOYSTICK_PARAMETER = 0x30F1,
    RACE_GET_TRIGGER_PARAMETER = 0x30F2,
    #if defined(CONFIG_AIR_HID_DEVICE_SCENARIO_SERVICE_KEY_REMAP)
    RACE_CMD_SET_LT_RT_THRESHOLD = 0x30F3,
    RACE_CMD_GET_LT_RT_THRESHOLD = 0x30F4,
    #endif
}T_RACE_CMD_E;
...
struct evt_hid_output_report{
    struct af_evt_header header;
    uint8_t length;                     /** length of payload */
    uint8_t output_report[0];           /** output_report */
};
#endif
...
#if defined(CONFIG_AIR_HID_DEVICE_SCENARIO_SERVICE_KEY_REMAP)
struct evt_key_remap_processing{
    struct af_evt_header header;
    uint32_t param;
    T_HID_KEY_REMAP_STATUS_E status;
};

struct evt_remap_backend_process{
    struct af_evt_header header;
};
...
#if defined(CONFIG_AIR_HID_OUTPUT_REPORT_NOTIFY)
AF_EVT_EXTERN(evt_hid_output_report);
#endif
...
#if defined(CONFIG_AIR_HID_DEVICE_SCENARIO_SERVICE_KEY_REMAP)
AF_EVT_EXTERN(evt_key_remap_processing);
AF_EVT_EXTERN(evt_remap_backend_process);
#endif /* CONFIG_AIR_HID_DEVICE_SCENARIO_SERVICE_KEY_REMAP */
/*=============================================================================*/
#endif
