...
/* Public macro --------------------------------------------------------------*/
    ...
    #define LED_RED       LED_NUM_5
    #define LED_GREEN     LED_NUM_4
    #define LED_BLUE      LED_NUM_6
#else
    #define LED_RED       LED_NUM_4
    #define LED_GREEN     LED_NUM_5
    #define LED_BLUE      LED_NUM_6  
#endif 
