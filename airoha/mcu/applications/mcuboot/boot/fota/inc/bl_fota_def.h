...
#define DFU_ERR_LP1_INIT_FAIL     0xD0
#define DFU_ERR_LP2_INIT_FAIL     0xD1
...
typedef enum
{
    FOTA_PART_STATE_INITIAL = 0xFFFF,
    FOTA_PART_STATE_UPDATING_PARTABLE2 = 0xFFFE,
    FOTA_PART_STATE_COMPLETE_PARTABLE2 = 0xFFFC,
} FotaPartitionTableState;
#endif
