...
@click.option('--vector-to-sign', type=click.Choice(['payload', 'digest']),
              ...
              'signing')
@click.option('--sign-by-aes', type=click.Choice(['True', 'False']),
              default='False', help='Sign using HW AES key')
...
def sign(key, public_key_format, align, version, pad_sig, header_size,
         ...
         fix_sig_pubkey, sig_out, vector_to_sign, sign_by_aes):
    ...
    img.create(key, public_key_format, enckey, sign_by_aes, dependencies, boot_record,
