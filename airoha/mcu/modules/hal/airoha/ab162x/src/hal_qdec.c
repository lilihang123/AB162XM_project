...
static bool qdec_rtc_mtcmos_on = false;
...
static void hw_qdec_Isr_zephyr(void)
{
  ...
  {
    printk("irq_type & QDEC_IRQ_Z_CNT\r\n");
  ...
  {
    printk("irq_type & QDEC_IRQ_Z_SUM\r\n");
    if (qdec_callback != NULL)
    {
...
hal_qdec_status_t hal_qdec_init(hal_qdec_config_t *qdec_cfg)
{
  ...
  nvic_status = hal_nvic_register_isr_handler(QDEC_IRQn, (void *)hw_qdec_Isr_zephyr);
  if (nvic_status != HAL_NVIC_STATUS_OK)
  {
    return HAL_QDEC_STATUS_ERROR;
  }
  hal_nvic_enable_irq(QDEC_IRQn);
...
hal_qdec_status_t hal_qdec_backup(void)
{
    return HAL_QDEC_STATUS_OK;
}

hal_qdec_status_t hal_qdec_restore(void)
{
    if (qdec_status > QDEC_STATUS_UNINITIALIZED)
    {
        /*reset qdec register*/
...
hal_qdec_status_t hal_qdec_enter_eint_mode(void *qdec_wakeup_callback)
{
  printk("hal_qdec_enter_eint_mode");
  hal_eint_config_t qdec_eint_config;
  qdec_eint_config.trigger_mode = HAL_EINT_EDGE_FALLING_AND_RISING;
  qdec_eint_config.debounce_time = 0;
  /*input pull up*/
  hal_pinmux_set_function(g_qdec_cfg.pina_pin,12);
  hal_pinmux_set_function(g_qdec_cfg.pinb_pin,12);
  hal_gpio_set_direction(g_qdec_cfg.pina_pin,0);
  hal_gpio_set_direction(g_qdec_cfg.pinb_pin,0);
  hal_gpio_pull_up(g_qdec_cfg.pina_pin);
  hal_gpio_pull_up(g_qdec_cfg.pinb_pin);

  /*set to eint mode*/
  hal_eint_init(g_qdec_cfg.pina_pin,&qdec_eint_config);
  hal_eint_init(g_qdec_cfg.pinb_pin,&qdec_eint_config);
  hal_eint_register_callback(g_qdec_cfg.pina_pin,qdec_wakeup_callback,NULL);
  hal_eint_register_callback(g_qdec_cfg.pinb_pin,qdec_wakeup_callback,NULL);
  hal_eint_enable(g_qdec_cfg.pina_pin);
  hal_eint_enable(g_qdec_cfg.pinb_pin);
  hal_eint_unmask(g_qdec_cfg.pina_pin);
  hal_eint_unmask(g_qdec_cfg.pinb_pin);
  return HAL_QDEC_STATUS_OK;
}

hal_qdec_status_t hal_qdec_exit_eint_mode(void)
{
  printk("hal_qdec_exit_eint_mode");
  hal_eint_deinit(g_qdec_cfg.pina_pin);
  hal_eint_deinit(g_qdec_cfg.pinb_pin);
  hal_pinmux_set_function(g_qdec_cfg.pina_pin,14);//qdec mode
  hal_pinmux_set_function(g_qdec_cfg.pinb_pin,14);
  hal_gpio_pull_up(g_qdec_cfg.pina_pin);
  hal_gpio_pull_up(g_qdec_cfg.pinb_pin);
  return HAL_QDEC_STATUS_OK;
}
