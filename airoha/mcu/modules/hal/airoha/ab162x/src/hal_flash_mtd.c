...
ATTR_TEXT_IN_TCM_RETENTION void *BlockAddress(void *DriverData, uint32_t BlockIndex)
{
...
ATTR_TEXT_IN_TCM_RETENTION static uint32_t LookupAddress(void *DriveData, uint32_t BlockIndex)
{
...
ATTR_TEXT_IN_TCM_RETENTION void *MapWindow(void *DriveData, uint32_t BlockIndex, uint32_t WindowIndex)
{
    NOR_Flash_MTD_Data *D = DriveData;
...
ATTR_TEXT_IN_TCM_RETENTION uint32_t BlockSize(void *DriveData, uint32_t BlockIndex)
{
    NOR_Flash_MTD_Data *D = DriveData;
    uint32_t region = 0, BlockUpperBound = 0;
...
ATTR_TEXT_IN_TCM_RETENTION uint32_t BlockIndex(void *DriveData, uint32_t blk_addr)
{
    NOR_Flash_MTD_Data *D = DriveData;
...
ATTR_TEXT_IN_TCM_RETENTION void DelayAWhile_UST(uint32_t delay)
{
