...
static volatile  I3C_MASTER_REGISTER_T *const     s_i2c_master_reg_airo[HAL_I2C_MASTER_MAX] = { (I3C_MASTER_REGISTER_T *) I2C_REG_FMT(I2C_0_BASE), (I3C_MASTER_REGISTER_T *) I2C_REG_FMT(I2C_1_BASE)};
...
static const  hal_clock_cg_id                   s_i2c_clk_pdn_table[HAL_I2C_MASTER_MAX]   = {HAL_CLOCK_CG_I3C0, HAL_CLOCK_CG_I3C1};
static const  hal_nvic_irq_t                    s_i2c_nvic_irq_num[HAL_I2C_MASTER_MAX]    = {I3C0_IRQn, I3C1_IRQn};
#ifdef HAL_SLEEP_MANAGER_ENABLED
static volatile const sleep_management_lock_request_t    s_i2c_sleep_handle[HAL_I2C_MASTER_MAX] = {SLEEP_LOCK_I3C1, SLEEP_LOCK_I3C1};
#endif
static volatile const pdma_channel_t                     s_i2c_pdma_chnl[HAL_I2C_MASTER_MAX][2] = { {PDMA_I3C0_TX, PDMA_I3C0_RX},
    {PDMA_I3C1_TX, PDMA_I3C1_RX},
};
...
#define     I3C_SOURCE_CLOCK_PERIOD    19.2//9.17 for 109Mhz, 19.2 for 52M
    ...
    volatile I3C_MASTER_REGISTER_T *i2c_reg = NULL;
    uint32_t tm_max = 0;
...
hal_i2c_status_t    i2c_config_io(hal_i2c_port_t  i2c_port, bool is_opendrain)
{
    ...
    /* Disable IBI */
    i2c_reg->DEBUG_CTRL &= ~I3C_DEBUGCTRL_ERR_DET_MASK;
    if (is_opendrain) {
        i2c_reg->IO_CONFIG |= (I3C_IO_CONFIG_SCL_MASK | I3C_IO_CONFIG_SDA_MASK|I3C_IO_CONFIG_CLK_EXT_EN_MASK);
    } else {
        i2c_reg->IO_CONFIG &= ~(I3C_IO_CONFIG_SCL_MASK | I3C_IO_CONFIG_SDA_MASK|I3C_IO_CONFIG_CLK_EXT_EN_MASK);
    }
    return status;
...
ATTR_TEXT_IN_TCM int i2c_op_ioctl(uint8_t i2c_port, uint8_t op_code, uint8_t args)
{
    ...
    switch (op_code) {
        ...
        case I2C_IOCTRL_CLR_IRQ_STAT: {
                s_i2c_master_reg_airo[i2c_port]->SOFT_RESET = I3C_SOFTRESET_ERROR_RESET_MASK;
...
ATTR_TEXT_IN_TCM int i2c_pdma_init(uint32_t i2c_port, i2c_transfer_config_t *config)
{
    ...
    if (tx_enable) {
        ...
        if (dma_statue != PDMA_OK) {
            printk("[hal][i2c%d] pdma_init fail (%d)\r\n", i2c_port, dma_statue);
            return -1;
        }
