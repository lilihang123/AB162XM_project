...
hal_irrx_status_t hal_irrx_receive_rcmm_start(hal_irrx_callback_t callback, void *parameter)
{
    ...
    irrx_register_base->PDREG_IRRCM_THD |= (8 << PDREG_IRRCM_THD_IRRCM_THD_01_OFFSET); //04 << PDREG_IRRCM_THD_IRRCM_THD_01_OFFSET;
    irrx_register_base->PDREG_IRRCM_THD &= ~(PDREG_IRRCM_THD_IRRCM_THD_10_MASK);
    irrx_register_base->PDREG_IRRCM_THD |= (8 << PDREG_IRRCM_THD_IRRCM_THD_10_OFFSET); //04 << PDREG_IRRCM_THD_IRRCM_THD_10_OFFSET;
    irrx_register_base->PDREG_IRRCM_THD &= ~(PDREG_IRRCM_THD_IRRCM_THD_11_MASK);
    irrx_register_base->PDREG_IRRCM_THD |= (14 << PDREG_IRRCM_THD_IRRCM_THD_11_OFFSET); //6 << PDREG_IRRCM_THD_IRRCM_THD_11_OFFSET;
    /*enable rcmm */
    ...
    irrx_register_base->PDREG_IRRCM_THD_0 |= (14 << PDREG_IRRCM_THD_0_IRRCM_THD_20_OFFSET); //0x06 << PDREG_IRRCM_THD_0_IRRCM_THD_20_OFFSET;
    irrx_register_base->PDREG_IRRCM_THD_0 &= ~(PDREG_IRRCM_THD_0_IRRCM_THD_21_MASK);
    irrx_register_base->PDREG_IRRCM_THD_0 |= (20 << PDREG_IRRCM_THD_0_IRRCM_THD_21_OFFSET);; //0x08 << PDREG_IRRCM_THD_0_IRRCM_THD_21_OFFSET;
    ...
    uint32_t                        *precision_us)
{
    ...
    check_period = 1600; // for 32m 50us sample
...
{
    volatile IRRX_REGISTER_T   *irrx_register_base = (IRRX_REGISTER_T *)IRRX_BASE;
