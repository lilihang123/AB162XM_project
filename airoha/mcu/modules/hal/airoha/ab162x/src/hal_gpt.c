...
const char *const gpt_lock_sleep_name[HAL_GPT_MAX_PORT] = {"GPT0", "GPT1", "GPT2", "GPT3", "GPT4", "GPT5", "GPT6"};
...
ATTR_TEXT_IN_TCM_RETENTION hal_gpt_status_t hal_gpt_delay_us(uint32_t us)
{
