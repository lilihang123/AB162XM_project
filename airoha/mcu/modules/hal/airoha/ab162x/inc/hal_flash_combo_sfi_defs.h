...
#define SFI_COMBO_COUNT   3

typedef struct {
#if defined(__SFI_CLK_78MHZ__)
    uint32_t      HWConf_78M[7];     // to be defined by SFI/EMI owner
    uint8_t       DevInit_78M[24];    // to be defined by SFI/EMI owner  (reserved for serial flash)
