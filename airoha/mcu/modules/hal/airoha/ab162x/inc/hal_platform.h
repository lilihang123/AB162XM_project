...
//#define HAL_PWM_DMA_LED_SUPPORTED              /* Supports PWM DMA LED. */
#endif
...
#define HAL_SPI_SLAVE_FEATURE_SW_CONTROL
#endif
...
typedef enum {
    ...
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_SPI_SLA              = 6,           /**< SPI_SLAVE. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_RGU                  = 7,           /**< RGU. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_BT_TIMER     = 8,           /**< CONNSYS_BT_TIMER. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_ZB_TIMER     = 9,           /**< CONNSYS_ZB_TIMER. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_AURX         = 10,          /**< CONNSYS_AURX. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_AUTX         = 11,          /**< CONNSYS_AUTX. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_BT_INT       = 12,          /**< CONNSYS_BT_INT. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_ZB_INT       = 13,          /**< CONNSYS_ZB_INT. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_CONNSYS_BT_PLAYEN    = 14,          /**< CONNSYS_BT_PLAYEN. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_I3C0                 = 15,          /**< I3C0. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_I3C1                 = 16,          /**< I3C1. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_INFRA_SEC_VIO        = 17,          /**< INFRA_SEC_VIO. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_INFRA_BUS_ERR        = 18,          /**< INFRA_BUS_ERR. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_INFRA_BUS_MON_ERR    = 19,          /**< INFRA_BUS_MON_ERR. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_USB_32K_RES          = 20,          /**< USB_32K_RES. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_KEY_SCAN             = 21,          /**< KEY_SCAN. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_RAMBOZ               = 22,          /**< RAMBOZ. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_QDEC                 = 23,          /**< QDEC. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_RTC_TIMER            = 24,          /**< RTC_TIMER. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_LED_CON              = 25,          /**< LED_CON. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_PMU                  = 26,          /**< AD_PMIC. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_BT_TIMER             = 27,          /**< SLP_WAKEUP_BT. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_PWM_0                = 28,          /**< PWM_DMA_0. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_PWM_1                = 29,          /**< PWM_DMA_1. */
    HAL_SLEEP_MANAGER_WAKEUP_SOURCE_ARGB                 = 30,          /**< ARGB_WAKE. */
...
/** @brief spm infra wake up source */
typedef enum {
    HAL_SPM_INFRA_WAKEUP_SOURCE_USB_32K_RES              = 20,          /**< USB_32K_RES. */
    HAL_SPM_INFRA_WAKEUP_SOURCE_SPM_SW_WAKEUP            = 31,          /**< SPM_SW_WAKEUP. */
    HAL_SPM_INFRA_WAKEUP_SOURCE_ALL                      = 32,          /**< All INFRA wakeup source. */
} hal_spm_infra_wakeup_source_t;
/** @brief spm conn wake up source */
typedef enum {
    HAL_SPM_CONN_WAKEUP_SOURCE_BT_TIMER                  = 0,           /**< SLP_WAKEUP_BT. */
    HAL_SPM_CONN_WAKEUP_SOURCE_SPM_SW_WAKEUP             = 31,          /**< SPM_SW_WAKEUP. */
    HAL_SPM_CONN_WAKEUP_SOURCE_ALL                       = 32,          /**< All CONN wakeup source. */
} hal_spm_conn_wakeup_source_t;
/**
 * @}
 * @}
 * @}
 ...
 *  The platform supports 2 I2C masters. Three of them support polling mode and DMA mode,
...
typedef enum {
    ...
    HAL_GPIO_CAPACITANCE_2, /**< HW no define, unable to configure */
...
typedef enum {
    ...
    HAL_EINT_PDN_USB20 = 51,    /**< EINT number 51:  USB0. */
    HAL_EINT_USB0      = 52,    /**< EINT number 52:  USB1. */
    HAL_EINT_USB1      = 53,    /**< EINT number 53:  USB2. */
...
typedef enum {
    HAL_PWM_DMA_0 = 0,                            /**< PWM DMA channel 0. */
    HAL_PWM_DMA_1 = 1,                            /**< PWM DMA channel 1. */
    HAL_PWM_DMA_MAX_CHANNEL                     /**< The total number of PWM channels (invalid PWM channel).*/
} hal_pwm_dma_port_t;

#if defined(HAL_PWM_LED_SUPPORTED) || defined(HAL_PWM_RGB_SUPPORTED) 
/** @brief The PWM DMA port */
typedef enum {
    HAL_PWM_LED_0 = 0,                            /**< PWM LED channel 0. */
    HAL_PWM_LED_1 = 1,                            /**< PWM LED channel 1. */
    HAL_PWM_LED_2 = 2,                            /**< PWM LED channel 2. */
    HAL_PWM_LED_3 = 3,                            /**< PWM LED channel 3. */
    HAL_PWM_LED_4 = 4,                            /**< PWM LED channel 4. */
    HAL_PWM_LED_5 = 5,                            /**< PWM LED channel 5. */
    HAL_PWM_LED_6 = 6,                            /**< PWM LED channel 6. */
    HAL_PWM_LED_7 = 7,                            /**< PWM LED channel 7. */
    HAL_PWM_LED_8 = 8,                            /**< PWM LED channel 8. */
    HAL_PWM_LED_9 = 9,                            /**< PWM LED channel 9. */
    HAL_PWM_LED_10 = 10,                          /**< PWM LED channel 10. */
    HAL_PWM_LED_MAX_CHANNEL                       /**< The total number of PWM LED channels (invalid PWM channel).*/
} hal_pwm_led_channel_t;

typedef enum {
    HAL_PWM_PORT_0 = 0,                            /**< PWM DMA channel 0. */
    HAL_PWM_PORT_1 = 1,                            /**< PWM DMA channel 1. */
    HAL_PWM_PORT_2 = 2,                            /**< PWM  channel 0. */
    HAL_PWM_PORT_MAX_CHANNEL                       /**< The total number of PWM channels (invalid PWM channel).*/
} hal_pwm_port_t;
#endif
/** @brief The PWM internal port */
typedef enum {
    HAL_PWM_INTERNAL_0 = 0,                            /**< PWM DMA channel 0. */
    HAL_PWM_INTERNAL_1 = 1,                            /**< PWM DMA channel 1. */
    HAL_PWM_INTERNAL_2 = 2,                            /**< PWM DMA channel 2. */
    HAL_PWM_INTERNAL_MAX                     /**< The total number of PWM channels (invalid PWM channel).*/
} hal_pwm_internal_channel_t;
/** @brief PWM clock source options */
typedef enum {
    HAL_PWM_CLOCK_32MHZ = 0,                /**< PWM clock source 32MHz(FXO). */
    HAL_PWM_CLOCK_32KHZ = 1,                /**< PWM clock srouce 32kHz. */
    HAL_PWM_CLOCK_26MHZ = 2,                /**< PWM clock source 26MHz. */
    HAL_PWM_CLOCK_52MHZ = 3,                /**< PWM clock srouce 52MHz. */
    HAL_PWM_CLOCK_MAX,
 ...
 *  | ----------------- | ------- | --------------- | ------------------------------------ |
 *  | HAL_DVFS_OPP_LOW  |  0.8v   |   CM33  32MHz   |           CM33  32     MHz           |
...
typedef enum {
    ...
    HAL_DVFS_OPP_LV = HAL_DVFS_OPP_LOW,
    HAL_DVFS_OPP_NV = HAL_DVFS_OPP_MID,  /* N of NV means 'Normal' */
    HAL_DVFS_OPP_MV = HAL_DVFS_OPP_MID,
...
typedef enum {
    HAL_SW_IRQ_0 = CM33_reserved0_IRQn,
    HAL_SW_IRQ_MAX
} hal_sw_irq_t;
...
#define HAL_USB_MAX_NUMBER_ENDPOINT_TX		7
/** @brief  The maximum number of USB RX endpoints.*/
#define HAL_USB_MAX_NUMBER_ENDPOINT_RX		7
