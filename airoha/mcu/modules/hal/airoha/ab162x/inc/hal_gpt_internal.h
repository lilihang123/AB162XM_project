...
#define HAL_CLOCK_CG_GPTIMER        HAL_CLOCK_CG_GPTIMER
#else
#define GPT_IRQ_NUM                 GPT_IRQn
...
#define HAL_GPT_SUPPORT_GPT_MAPPING     HAL_GPT_0,HAL_GPT_3,HAL_GPT_4   /* indicate the supported interrupt timer channle*/
