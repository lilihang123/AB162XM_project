...
typedef struct {
    uint32_t AESOTF_CTL;
    uint32_t AESOTF_NONCE0;
    uint32_t AESOTF_NONCE1;
    uint32_t AESOTF_NONCE2;
    uint32_t AESOTF_NONCE3;
    uint32_t AESOTF_SWKEY0;
    uint32_t AESOTF_SWKEY1;
    uint32_t AESOTF_SWKEY2;
    uint32_t AESOTF_SWKEY3;
    uint32_t AESOTF_REGION0_BEGIN;
    uint32_t AESOTF_REGION0_END;
    uint32_t AESOTF_REGION1_BEGIN;
    uint32_t AESOTF_REGION1_END;
    uint32_t AESOTF_REGION2_BEGIN;
    uint32_t AESOTF_REGION2_END;
    uint32_t AESOTF_REGION3_BEGIN;
    uint32_t AESOTF_REGION3_END;
    uint32_t AESOTF_REGION4_BEGIN;
    uint32_t AESOTF_REGION4_END;
    uint32_t AESOTF_REGION5_BEGIN;
    uint32_t AESOTF_REGION5_END;
    uint32_t AESOTF_REGION6_BEGIN;
    uint32_t AESOTF_REGION6_END;
    uint32_t AESOTF_REGION7_BEGIN;
    uint32_t AESOTF_REGION7_END;
} aesotf_register_backup_t;
