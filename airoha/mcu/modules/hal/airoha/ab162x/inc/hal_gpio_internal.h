...
#define GPIO_AUX_MODE0 0
#define GPIO_AUX_MODE1 1
#define GPIO_AUX_MODE2 2
#define GPIO_AUX_MODE3 3
#define GPIO_AUX_MODE4 4
#define GPIO_AUX_MODE5 5
#define GPIO_AUX_MODE6 6
#define GPIO_AUX_MODE7 7
#define GPIO_AUX_MODE8 8
#define GPIO_AUX_MODE9 9
#define GPIO_AUX_MODE10 10
#define GPIO_AUX_MODE11 11
#define GPIO_AUX_MODE12 12
#define GPIO_AUX_MODE13 13
#define GPIO_AUX_MODE_MAX_NUMBER            13      /*  maximum aux function index of GPIO  */
#define GPIO_PMU_MODE0 0XFF
#define GPIO_PMU_MODE1 14
#define GPIO_PMU_MODE2 15
#define GPIO_PMU_MODE3 16
...
typedef struct {
    uint32_t register0;//for gpio 0-31
    uint32_t register1;//for gpio32-47
} gpio_data_in_mask_t;
...
#define PKA_GPIO_PULL_HIGH(io_group,io_idx) (gpio_base->GPIO_DOUT_SET[io_group] = (GPIO_REG_ONE_BIT_SET_CLR << io_idx))
#define PKA_GPIO_PULL_LOW(io_group,io_idx) (gpio_base->GPIO_DOUT_CLR[io_group] = (GPIO_REG_ONE_BIT_SET_CLR << io_idx))
#define PKA_GPIO_SET(io_group, io_mask) (gpio_base->GPIO_DOUT_SET[io_group] |= io_mask)
#define PKA_GPIO_CLR(io_group, io_mask) (gpio_base->GPIO_DOUT_CLR[io_group] |= io_mask)
