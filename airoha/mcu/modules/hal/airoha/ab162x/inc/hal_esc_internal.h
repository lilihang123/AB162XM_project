...
#define APS_CHIP_1604M_SQ_PSRAM
#endif
...
/*  ESC frequency  */
typedef enum {
    ESC_CLOCK_32MHz = 0,        /* XO 32Mhz */
    ESC_CLOCK_O_26MHz = 1,       /* 26Mhz */
    ESC_CLOCK_78MHz = 2,        /* O_HS_D2 78Mhz */
    ESC_CLOCK_52MHz = 3,        /* O_HS_D4 39Mhz */
    ESC_CLOCK_INVALID = 0xFF
} esc_clock_t;
...
void ESC_Dev_Command(const uint32_t cmd);
void ESC_Dev_Command_Ext(const uint8_t *cmd, uint8_t *data, const uint16_t outl, const uint16_t inl);
