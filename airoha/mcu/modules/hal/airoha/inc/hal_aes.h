...
// Same as hal_aes_cbc_encrypt, but requires calling hal_aes_mtcmos_perisys_enable before and after use.
...
// Same as hal_aes_cbc_decrypt, but requires calling hal_aes_mtcmos_perisys_enable before and after use.
