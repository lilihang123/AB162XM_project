 ...
 *  - step1: call #hal_wdt_init() to configure the WDT as interrupt mode.
...
typedef enum {
    ...
    HAL_WDT_MODE_INTERRUPT_AND_RESET = 2, /**<  WDT interrupt and reset mode. An interrupt will trigger and then a hardware reset will be triggered after the same expiration time. */
#endif
} hal_wdt_mode_t;
 ...
 *  @param [in] wdt_reset_status: The value is defined in #hal_wdt_reset_status_t. This parameter is given by the driver
