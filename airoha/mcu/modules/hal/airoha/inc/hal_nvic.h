 ...
 *       void isr_handler(IRQn_Type irq_number)
 *       {
 *           // Do something.
 *       }
 *    @endcode
 ...
 */
typedef void (*hal_nvic_isr_t)(IRQn_Type irq_number);
/**
  * @}
  */
 ...
 */
hal_nvic_status_t hal_nvic_register_isr_handler(IRQn_Type irq_number, hal_nvic_isr_t isr_handler);
 ...
 * @param[in] irq_number is the NVIC IRQ number.
 */
hal_nvic_status_t hal_nvic_enable_irq(IRQn_Type irq_number);

/**
 * @brief This function disables a device-specific interrupt in the NVIC interrupt controller.
 * @param[in] irq_number is the NVIC IRQ number.
 */
hal_nvic_status_t hal_nvic_disable_irq(IRQn_Type irq_number);
 ...
 * @param[in] irq_number is the NVIC IRQ number.
 */
hal_nvic_status_t hal_nvic_set_pending_irq(IRQn_Type irq_number);

/**
 * @brief This function clears the pending bit of an external interrupt.
 * @param[in] irq_number is the NVIC IRQ number.
 */
hal_nvic_status_t hal_nvic_clear_pending_irq(IRQn_Type irq_number);
 ...
 */
hal_nvic_status_t hal_nvic_set_priority(IRQn_Type irq_number, uint32_t priority);
 ...
 */
uint32_t hal_nvic_get_priority(IRQn_Type irq_number);
...
hal_nvic_status_t hal_nvic_sw_irq_trigger(hal_nvic_irq_t irq_number);
hal_nvic_status_t hal_nvic_sw_irq_clear(hal_nvic_irq_t irq_number);
#ifdef __cplusplus
}
#endif
