 ...
 *
 *    hal_cache_set_size(HAL_CACHE_SIZE_16KB); // Set the total CACHE size.
 *
...
typedef enum {
    ...
    HAL_CACHE_SIZE_8KB = 1,                     /**< CACHE size is 8KB( 2-ways ). */
#elif defined(AIR_BTD_IC_PREMIUM_G1)
    HAL_CACHE_SIZE_0KB = 0,                     /**< No CACHE. */
 ...
 */
#define HAL_CACHE_LINE_SIZE        (CONFIG_CACHEABLE_REGION_ALIGNMENT)
#elif defined(AIR_BTD_IC_MANDATORY_G1)
#define HAL_CACHE_LINE_SIZE        (CONFIG_ICACHE_LINE_SIZE)
#else
#endif
