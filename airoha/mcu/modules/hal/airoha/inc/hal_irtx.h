...
typedef enum {
    HAL_IRTX_STATUS_BUSY = -4,                   /**< IRTX busy error */
    HAL_IRTX_STATUS_CONFIG = -3,                 /**< IRTX config error */   
    HAL_IRTX_STATUS_NOT_INIT = -2,               /**< IRTX NOT INIT  error */
...
typedef void (*hal_irtx_callback_t)(hal_irtx_event_t event, void  *user_data);
 ...
 * @param[in] address nec address data.
 * @param[in] command nec command data.
 * @param[in] repeat nec data repeat 4 times.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
 ...
 * @param[in] address rc5 address data.
 * @param[in] command rc5 command data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
 ...
 * @param[in] mode rc6 mode data.
 * @param[in] control  rc6 control data.
 * @param[in] information  rc6 information data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
...
/**
 * @brief    This function sends the data in the sirc 12 bit encoding format.
 * @param[in] command sirc command data.
 * @param[in] address sirc address data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
...
/**
 * @brief    This function sends the data in the sirc 15 bit encoding format.
 * @param[in] command sirc command data.
 * @param[in] address sirc address data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
...
/**
 * @brief    This function sends the data in the sirc 20 bit encoding format.
 * @param[in] command sirc command data.
 * @param[in] address sirc address data.
 * @param[in] extend sirc extend data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
...
/**
 * @brief    This function sends the data in the rcmm 12 bit encoding format.
 * @param[in] mode rcmm mode data.
 * @param[in] address rcmm address data.
 * @param[in] data rcmm data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
...
/**
 * @brief    This function sends the data in the rcmm 24 bit encoding format.
 * @param[in] mode rcmm mode data.
 * @param[in] data rcmm data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
...
/**
 * @brief    This function sends the data in the rcmm oem encoding format.
 * @param[in] mode rcmm mode data.
 * @param[in] custom_id rcmm custom_id data.
 * @param[in] data rcmm data.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 ...
 * @param[in] duty_radio pulse data carrier duty radio.
 * @return   Indicates whether this function call is successful or not.
 *                If the return value is #HAL_IRTX_STATUS_OK, the operation completed successfully.
 *                If the return value is #HAL_IRTX_STATUS_ERROR, the operation failed.
 * @par       Example
...
hal_irtx_status_t hal_irtx_register_callback(hal_irtx_callback_t callback,
                                                        void *user_data);
