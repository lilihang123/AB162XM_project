 ...
 *       2. The pull-up resistors must be used on the SCL and SDA of the I2C interface. Please refer to the related HDK user guide for more details. \n
 *       3. We recommend against mixing \b Polling \b mode and \b DMA \b mode. If you need to multitask, please use the #hal_i2c_master_send_to_receive_dma_ex_none_blocking.
 *
...
typedef enum {
    HAL_I2C_NON_BLOCKING_FUNCTION_ERROR = -4,    /**<  The I2C is using by non-block transaction. */
    HAL_I2C_EVENT_AHB_BUS_ERROR = -5,            /**<  an ahb bus error happened during transaction. */
    HAL_I2C_EVENT_DATA_ERROR = -4,                /**<  an data error happened during transaction. */
    HAL_I2C_EVENT_REG_ADDRESS_ERROR = -3,           /**<  an reg address error happened during transaction.*/
    HAL_I2C_EVENT_SLAVE_ADDRESS_ERROR = -2,          /**<  an slave address error happened during transaction.*/
    HAL_I2C_EVENT_TIMEOUT_ERROR = -1,       /**<  A timeout error occurred during transaction.*/
    HAL_I2C_EVENT_SUCCESS = 0               /**<  The transaction completed wihtout any error. */
} hal_i2c_callback_event_t;
#endif
...
typedef enum {
    ...
    HAL_I2C_FREQUENCY_400K = 1,          /**<  400kbps. */
    HAL_I2C_FREQUENCY_800K = 2,          /**<  800kbps. */
    HAL_I2C_FREQUENCY_1M   = 3,          /**<  1mbps. */
  #endif
  #if defined(AIR_BTD_IC_PREMIUM_G1)
