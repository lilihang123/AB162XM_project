...
typedef enum {
    ...
    HAL_UART_BAUDRATE_1000000   = 13,   /**< Defines UART baudrate as 1M bps. */
#if defined(AIR_BTD_IC_MANDATORY_G1)
    HAL_UART_BAUDRATE_1500000   = 14,   /**< Defines UART baudrate as 1520000 bps. */
    HAL_UART_BAUDRATE_2000000   = 15,   /**< Defines UART baudrate as 2000000 bps. */
    HAL_UART_BAUDRATE_3000000   = 16,   /**< Defines UART baudrate as 3000000 bps. */
    HAL_UART_BAUDRATE_62500   = 17,   /**< Defines UART baudrate as 62500 bps. */ 
    ...
    HAL_UART_BAUDRATE_2000000   = 14,   /**< Defines UART baudrate as 2000000 bps. */
    HAL_UART_BAUDRATE_3000000   = 15,   /**< Defines UART baudrate as 3000000 bps. */
    HAL_UART_BAUDRATE_3200000   = 16,   /**< Defines UART baudrate as 3200000 bps. */
    HAL_UART_BAUDRATE_6000000   = 17,   /**< Defines UART baudrate as 6000000 bps. */
    HAL_UART_BAUDRATE_8666000   = 18,   /**< Defines UART baudrate as 8666000 bps. */
    HAL_UART_BAUDRATE_MAX               /**< Defines maximum enum value of UART baudrate. */
#endif/*AIR_BTD_IC_PREMIUM_G1*/
...
typedef enum {
    ...
    HAL_UART_EVENT_RECEIVE_DEAD = 7,                /**< Indicates if there is receive special characters. ex. DEAD*/
    HAL_UART_EVENT_RECEIVE_BREAK_SIGNAL = 8,        /**< Indicates if there is receive break signal. */
...
/**
 * @brief     This function config UART RX Pin to eint before enter sleep.
 * @par       Example
 * @code
