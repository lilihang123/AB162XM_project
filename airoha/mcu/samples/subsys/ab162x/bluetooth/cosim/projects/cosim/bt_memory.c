...
#include "bt_debug.h"
#include "bt_memory.h"
#include "bt_l2cap_fix_channel_internal.h"
#ifdef __BT_HB_DUO__
#include "bt_rfcomm_internal.h"
#include "bt_avrcp_internal.h"
#include "bt_spp_internal.h"
#include "bt_a2dp_internal.h"
#include "bt_avdtp.h"
#include "bt_pbapc_internal.h"
#include "bt_hfp_internal.h"
#include "bt_hsp_internal.h"
#include "bt_ctp_internal.h"
#include "bt_aws_internal.h"
#include "bt_hid_internal.h"
#include "bt_aws_mce_int.h"
#include "bt_airupdate_internal.h"
#include "bt_mapc_internal.h"
#include "bt_gatt_over_bredr_internal.h"
#endif
#include "bt_l2cap_le_coc_cbfcm.h"
#include "bt_ull_le_internal.h"
#ifdef BT_EATT_ENABLE
#include "bt_gatt_le_eatt.h"
#endif
...
void bt_memory_init_packet(bt_memory_packet_t type, char *buf, uint32_t size)
{
    ...
    printk("bt_memory_init_packet type = %d, size = %d \n", type, size);
    ...
    if (NULL == bt_mm_cb_p || NULL == bt_mm_cmd_queue_p) {
        ...
        printk("init ok, BT_MM_FOOTER = 0x%x \n", BT_MM_FOOTER);
    }
                                    ...
                                    )
{
...
#endif
    printk("    bt_mm_allocate_packet_internal, size = %d, type = %d, BT_MM_FOOTER_SIZE = %d  \n", size, type, BT_MM_FOOTER_SIZE ); 
    ...
    printk("    bt_mm_allocate_packet_internal  new_mm = %p, sizeof(bt_mm_header_t) = %d,   bt_mm_reserve_size[type] = %d  \n", (new_mm) ,  sizeof(bt_mm_header_t) ,  bt_mm_reserve_size[type] ) ; 
