...
#ifndef __BT_SM_MATH_H__
#define __BT_SM_MATH_H__

#include "bt_type_def.h"

BT_EXTERN_C_BEGIN

void bt_sm_reverse_and_encrypt(bt_smp_key_t output, const bt_smp_key_t key, const bt_smp_key_t data);
