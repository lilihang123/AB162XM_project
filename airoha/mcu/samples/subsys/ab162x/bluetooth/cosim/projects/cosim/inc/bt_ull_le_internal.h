...
typedef struct {
    bt_linknode_t air_cis_connection;
} bt_ull_le_control_t;
...
bt_status_t bt_ull_le_event_callback(uint32_t is_timeout,
        uint32_t timer_id, uint32_t data, const void *hci_data);

bt_status_t bt_ull_le_air_cis_conn_proc(uint32_t is_timeout,
        uint32_t timer_id, uint32_t data, const void *param);
