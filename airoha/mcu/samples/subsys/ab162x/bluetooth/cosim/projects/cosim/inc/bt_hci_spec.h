...
/* for mHDT service*/
#define BT_HCI_CMD_VENDOR_TCI                                               0xFC5B
#define BT_HCI_CMD_VENDOR_TCI_SUB_Read_Local_mHDT_Feature                   0x01
#define BT_HCI_CMD_VENDOR_TCI_SUB_Read_Remote_mHDT_Feature                  0x02
#define BT_HCI_CMD_VENDOR_TCI_SUB_mHDT_Mode                                 0x03
#define BT_HCI_CMD_VENDOR_TCI_SUB_Exit_mHDT_Mode                            0x04
#define BT_HCI_CMD_VENDOR_TCI_SUB_Write_mHDT_Timeout                        0x05
#define BT_HCI_CMD_VENDOR_TCI_SUB_Read_mHDT_Timeout                         0x06
#define BT_HCI_CMD_VENDOR_TCI_SUB_LE_Read_Local_MTK_Proprietary_Feature     0x07
#define BT_HCI_CMD_VENDOR_TCI_SUB_LE_Read_Remote_MTK_Proprietary_Feature    0x08

#define BT_HCI_CMD_VENDOR_SET_ACCESS_ADDRESS                 0xFE20 /*0xFE0B ~ 0xFE1F reserved for ull2.0*/
...
/*for mHDT service*/
#define BT_HCI_EVENT_VENDOR_TCI                                                              0xE9
#define BT_HCI_EVENT_VENDOR_TCI_SUB_Read_Remote_MTK_Proprietary_Feature                      0x01
#define BT_HCI_EVENT_VENDOR_TCI_SUB_Data_Rate_Change                                         0x02
#define BT_HCI_EVENT_VENDOR_TCI_SUB_mHDT_Timeout_Change                                      0x03
#define BT_HCI_EVENT_VENDOR_TCI_SUB_LE_Read_Remote_MTK_Proprietary_Feature_Complete          0x04
...
/* HCI Packet Structure. */
/**
 *  @brief      airoha controller assert event format.
 */
BT_PACKED(
typedef struct {
