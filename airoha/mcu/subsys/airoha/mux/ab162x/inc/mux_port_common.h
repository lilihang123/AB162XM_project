...
#elif defined(CORE_DSP2)
#define GET_CURRENT_CPU_ID()  3
#else
#error "Current CPU number exceed!!"
#endif /* CORE_MCU */

#define AIR_MAX_CPU_NUMBER_2
#if defined(AIR_MAX_CPU_NUMBER_1)
#define AIR_MAX_CPU_NUMBER    1
#define MTK_SINGLE_CPU_ENV
#elif defined(AIR_MAX_CPU_NUMBER_2)
#define AIR_MAX_CPU_NUMBER    2
#elif defined(AIR_MAX_CPU_NUMBER_3)
#define AIR_MAX_CPU_NUMBER    3
#elif defined(AIR_MAX_CPU_NUMBER_4)
#define AIR_MAX_CPU_NUMBER    4
#else
#error "Max CPU number exceed!!"
#endif /* AIR_MAX_CPU_NUMBER_1 */
...
#if defined(__GNUC__)
    #define MUX_GET_RETURN_ADDR() (uint32_t)__builtin_return_address(0)
#elif defined(__CC_ARM)
    #define MUX_GET_RETURN_ADDR() (uint32_t)__return_address()
#elif defined(__ICCARM__)
    #define MUX_GET_RETURN_ADDR() (uint32_t)__get_LR()
#else
    #define MUX_GET_RETURN_ADDR() 0xDEADBEEF
#endif /* __GNUC__ */
