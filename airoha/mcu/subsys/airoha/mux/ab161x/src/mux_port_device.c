...
ATTR_TEXT_IN_TCM uint32_t mux_common_device_get_hw_wptr(virtual_read_write_point_t *p, bool is_rx)
{
    if (is_rx) {
...
*/
ATTR_TEXT_IN_TCM void mux_common_device_set_tx_hw_wptr(virtual_read_write_point_t *p, uint32_t move_bytes)
{
