...
#define MAX_MUX_USER_COUNT  3 // CONFIG_MAX_MUX_USER_COUNT
...
typedef enum {
    ...
    MUX_BT_END = MUX_BT_BLE_2,              /**<  port of  MUX_BT_END*/
#endif
...
#define TX_PROTOCOL_CB_HEAD_BUFFER_MAX_LEN 4
...
#define TX_PROTOCOL_CB_TAIL_BUFFER_MAX_LEN 4
