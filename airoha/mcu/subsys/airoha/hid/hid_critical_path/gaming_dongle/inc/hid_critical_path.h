...
#ifndef __BT_HID_CRITICAL_PATH_H__
#define __BT_HID_CRITICAL_PATH_H__

/**
 * @brief   This function is used for application to initialize HID Critical Path.
 * @param[in]             #none.
...
/**
 * @brief   This function is used for application to send dummy data to USB when CIS Connecte when USB Resume.
...
/**
 * @brief   This function is used for application to set the device parameter when something changed.
 * @param[in]             #type, HID Critical Path Device Type.
 * @param[in]             #info, HID Critical Path Device Info.
 * @return                #none
 */
...
/**
 * @brief   This function is used for application to start HID Critical Path when CIS Connected.
 * @param[in]             #type, HID Critical Path Device Type.
 * @return                #none
 */
...
/**
 * @brief   This function is used for application to stop HID Critical Path when CIS Disconnected.
 * @param[in]             #type, HID Critical Path Device Type.
 * @return                #none
 */
...
/**
 * @brief   This function is used for application to register debug callback.
 * @param[in]             #cb, debug callback function.
 * @return                #none
 */
