...
#define FOTA_MULTI_INFO_ROLLBACK_FLAG_RECORD_LEN       (2) /* The length of the FOTA rollback flag. */
...
#define FOTA_MULTI_INFO_BL_DFU_FLAG_RECORD_LEN         (2) /* The length of the BL DFU flag. */
...
typedef enum {
    ...
    FOTA_MULTI_INFO_TYPE_BL_DFU_FLAG = 0x20, /**< The type for the BL DFU upgrade flag. */
    FOTA_MULTI_INFO_TYPE_ROLLBACK_FLAG = 0x40, /**< The type for the FOTA rollback flag. */

    /* Add a new type before this line and update the value of the NULL type if needed. */
    FOTA_MULTI_INFO_TYPE_NULL = 0x80, /**< The NULL type. It is an invalid type and a new type must be added before it. */
