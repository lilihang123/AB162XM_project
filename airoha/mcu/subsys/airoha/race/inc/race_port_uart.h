...
#ifndef RACE_PORT_UART_H
#define RACE_PORT_UART_H
...
#define RACE_UART_PORT_MAX      (MUX_UART_END - MUX_UART_BEGIN + 1)
#define RACE_PORT_IS_UART(port) ((port) >= MUX_UART_BEGIN && (port) <= MUX_UART_END)
