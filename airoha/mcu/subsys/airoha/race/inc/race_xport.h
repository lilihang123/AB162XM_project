...
#define RACE_DEBUG_PRINT_ENABLE             (FALSE)
...
* set relay flag
*/
#if (defined RACE_RELAY_CMD_ENABLE) || (defined AIR_RACE_CO_SYS_ENABLE) || CONFIG_AIR_RACE_RELAY_CMD_ENABLE
 ...
 * @endcode
 */
extern race_status_t race_init_port_service(race_port_t port);
...
race_status_t race_serial_port_open(race_port_t port_num);
