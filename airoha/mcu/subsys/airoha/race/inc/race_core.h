...
* LOG API
**************************************************************************************************/
//#define RACE_LOG_MSGID_D(fmt,cnt,arg...)        LOG_DBG(fmt, ##arg)
//#define RACE_LOG_MSGID_I(fmt,cnt,arg...)        LOG_INF(fmt, ##arg)
//#define RACE_LOG_MSGID_W(fmt,cnt,arg...)        LOG_WRN(fmt, ##arg)
//#define RACE_LOG_MSGID_E(fmt,cnt,arg...)        LOG_ERR(fmt, ##arg)
...
#define RACE_DEBUG_INFO_ENABLE                  (0)
...
typedef enum {
...
#if 1//RACE_STORAGE_CMD_ENABLE
        MSG_ID_RACE_LOCAL_ERASE_PARTITION_CONTINUE_IND,
        MSG_ID_RACE_LOCAL_HASH_NB_GENERATE_CONTINUE_IND,
#endif
    ...
    MSG_ID_RACE_LOCAL_RELAY_BT_RACE_CMD,
#endif
    MSG_ID_RACE_END
} race_msg_id_t;
...
/*
* unregister relay check handler
*/
