...
#define RACE_CONTAINER_OF(ptr,type,member) ((type *)((uint8_t *)(ptr) - OFFSET_OF(type,member)))

#ifdef AIR_BTD_IC_MANDATORY_G1
#define RACE_ID_AIR_INTERNAL_GROUP1_BEGIN   (0x1680)
#define RACE_ID_AIR_INTERNAL_GROUP1_END     (0x16FF)
#endif
 ...
 * @return    void.
 */
extern void race_dump(const uint8_t *data, race_debug_type_enum type);
extern void race_dump_data(const uint8_t *data, int len, const char *log_msg);
...
#ifdef AIR_BTD_IC_MANDATORY_G1
void *RACE_CmdHandler_air_internal_group1(ptr_race_pkt_t pCmdMsg, uint16_t length, uint8_t channel_id);
#endif
/**
  * @}
  */
