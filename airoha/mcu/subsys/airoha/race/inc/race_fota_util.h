...
typedef enum {
    ...
    RACE_FOTA_SP_TRANS_METHOD_BLE_3,
    ...
    RACE_FOTA_SP_TRANS_METHOD_SP_DONGLE,
#endif
#if defined(AIR_FOTA_DONGLE_HEADSET_BY_SP_ENABLE)
    RACE_FOTA_SP_TRANS_METHOD_SP_DONGLE_THROUGHOUT,
#endif
...
typedef struct {
    ...
    bt_addr_t remote_address;          /**< The Bluetooth address of the sp device. */
...
typedef struct {
    ...
    uint8_t channel_id;
    void *noti;
} race_fota_hash_nb_generate_user_data_struct;
