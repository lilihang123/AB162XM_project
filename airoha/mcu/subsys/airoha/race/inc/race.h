...
typedef struct {
    ...
    race_port_t dev_t;    /**< The race port device. */
    uint8_t *msg_data;    /**< The message data. */
#if (defined AIR_PURE_GAMING_DONGLE_ENABLE) || (defined AIR_DUAL_CHIP_MIXING_MODE_ROLE_MASTER_ENABLE) || (defined AIR_DCHS_MODE_MASTER_ENABLE)
