...
#ifndef __RACE_CMD_KEY_EVENT_H__
#define __RACE_CMD_KEY_EVENT_H__

#include "race_cmd_feature.h"
#include "race_cmd.h"

#ifdef RACE_KEY_EVENT_CMD_ENABLE
#define RACE_ATPORT_EVENT_CMD_ID 0x1100
#define RACE_KEY_EVENT_CMD_ID 0x1101

void *RACE_CmdHandler_key_event(ptr_race_pkt_t pCmdMsg, uint16_t length, uint8_t channel_id);
#endif /* RACE_KEY_EVENT_CMD_ENABLE */
#endif /* __RACE_CMD_KEY_EVENT_H__ */
#endif
