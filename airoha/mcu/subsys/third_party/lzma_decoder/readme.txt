...
Usage:          Include the module with "/airoha/mcu/subsys/third_party/lzma_decoder/CMakeLists.txt" in your GCC project Makefile, or include library file directly under lib folder.
Dependency:     None.
...
Example project:Please find fota related sources under /airoha/mcu/applications/mcuboot/boot/fota/src/bl_fota_upgrade.c for detail.