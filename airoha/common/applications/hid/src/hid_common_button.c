...
T_TRIGGER_MODE_S *trigger_mode = (T_TRIGGER_MODE_S*) CROSS_CORE_MEM_VARIABLE(trigger_mode_status);
...
{
    trigger_mode->lt_digital = LT_RT_MODE_IS_DIGITAL(key_status, LT_MODE_BIT);
    trigger_mode->rt_digital = LT_RT_MODE_IS_DIGITAL(key_status, RT_MODE_BIT);
}
#endif /* AIR_PRODUCT_TYPE_GAME_CONTROLLER */
