...
typedef enum {
    HAL_HW_SEMAPHORE_CHANNEL_MCU  = 0,          /**< HW semaphore channel used by CM4 */
#if defined(AIR_BTD_IC_PREMIUM_G1)
    HAL_HW_SEMAPHORE_CHANNEL_RISCV = 1,          /**< HW semaphore channel used by Ibex */
    HAL_HW_SEMAPHORE_CHANNEL_HWMAC = 2,         /**< HW semaphore channel used by HWMAC */
#endif
 ...
 * @return
 * #HAL_HW_SEMAPHORE_STATUS_INVALID_PARAMETER, invalid parameter.
 * #HAL_HW_SEMAPHORE_CHANNEL_MCU, semaphore is taken by MCU.
 * #HAL_HW_SEMAPHORE_CHANNEL_RISCV, semaphore is taken by RISCV.
 * #HAL_HW_SEMAPHORE_CHANNEL_HWMAC, semaphore is taken by HWMAC.
