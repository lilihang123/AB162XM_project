...
#define LL_FEAT_BIT_PAWR_PROPRIETARY BIT64(BT_LE_FEAT_BIT_PAWR_PROPRIETARY)
#else /* !LL_FEAT_BIT_PAWR_PROPRIETARY */
#define LL_FEAT_BIT_PAWR_PROPRIETARY 0
#endif /* !LL_FEAT_BIT_PAWR_PROPRIETARY */
