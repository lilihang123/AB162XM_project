...
/* Modifications:
2025-11-21 by Airoha - Support secp160r1.
*/
...
#if defined(MBEDTLS_ANSI_X963_KDF_C) && !defined(MBEDTLS_MD_C)
#error "MBEDTLS_ANSI_X963_KDF_C defined, but not all prerequisites"
#endif
