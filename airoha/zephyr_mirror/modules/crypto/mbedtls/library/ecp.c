 ...
 */
/* Modifications:
2025-11-21 by Airoha - Support secp160r1, Airoha performance optimization.
*/
...
static const mbedtls_ecp_curve_info ecp_supported_curves[] =
{
    ...
    { MBEDTLS_ECP_DP_SECP160R1,    10,     160,    "secp160r1"         },
#endif
...
#ifdef AIR_MBEDTLS_CODE_OPTIMIZE
    if ((c = mbedtls_air_malloc(T_size * sizeof(mbedtls_mpi))) == NULL) {
#else
 ...
 */
#ifdef AIR_MBEDTLS_CODE_OPTIMIZE
ATTR_TEXT_IN_TCM static void ecp_comb_recode_core(unsigned char x[], size_t d,
                        ...
                        mbedtls_ecp_restart_ctx *rs_ctx)
{
    ...
    {
#ifdef AIR_MBEDTLS_CODE_OPTIMIZE
        T = mbedtls_air_malloc(T_size * sizeof(mbedtls_ecp_point));
#else
