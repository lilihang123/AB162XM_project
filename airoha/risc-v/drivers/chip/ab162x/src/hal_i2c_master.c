...
static i2c_transfer_config_t       * const s_i2c_q_buf[HAL_I2C_MASTER_MAX] = {s_i2c0_q_buf, (i2c_transfer_config_t *) NULL};
static const uint8_t                s_i2c_q_szb[HAL_I2C_MASTER_MAX] = {HAL_I2C_MASTER_0_FIFO_DEPTH, 0};
