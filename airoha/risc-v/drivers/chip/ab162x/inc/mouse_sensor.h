...
typedef enum {
    MOUSE_SENSOR_STATUS_NOT_SET_BURST          = -10,            /**< mouse sensor not set burst read. */  
    MOUSE_SENSOR_STATUS_READ_DATA_FAILED       = -9,            /**< mouse sensor read data failed. */  
    MOUSE_SENSOR_STATUS_NOT_INIT               = -8,            /**< mouse sensor not initialized. */                     
