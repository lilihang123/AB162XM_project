...
#define HAL_GPT_SW_MS_PORT              HAL_GPT_5   /* configure HAL_GPT_5 as DSP0 software timer */
#define HAL_GPT_SW_US_PORT              HAL_GPT_6   /* configure HAL_GPT_6 as DSP0 software timer */
...
//#define HAL_GPT_SUPPORT_GPT_MAPPING     HAL_GPT_0,HAL_GPT_5,HAL_GPT_6   /* indicate the supported interrupt timer channle*/
#define HAL_GPT_SUPPORT_INT_CHANNEL     2           /* indicate the supported interrupt timer channle number*/  
#define HAL_GPT_SUPPORT_GPT_MAPPING     HAL_GPT_5,HAL_GPT_6   /* indicate the supported interrupt timer channle*/  
...
#define GPT_GET_FREE_RUN_COUNT_US(VAR) (VAR = GPT2->GPT_COUNT)
