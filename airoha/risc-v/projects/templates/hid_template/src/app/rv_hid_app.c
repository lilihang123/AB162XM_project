...
/* Private typedef -----------------------------------------------------------*/
/* Private macro -------------------------------------------------------------*/
log_create_module(rv_hid_app, PRINT_LEVEL_INFO);


/* Public variables ----------------------------------------------------------*/
T_RV_HID_APP_S rv_hid_app;


/* Private functions ---------------------------------------------------------*/
void rv_hid_app__preprocess()
{
    
}

void rv_hid_app__process()
{
    
}

void rv_hid_app__post_process()
{
    
}

/* Public functions ----------------------------------------------------------*/
void rv_hid_app__cm33_state_update(uint32_t new_state)
{
    HID_DBG_LOG(rv_hid_app, "rv_hid_app__cm33_state_update, new_state = %d ", 1, new_state);
...
void rv_hid_app__init()
{

}

void rv_hid_app__deinit()
{
