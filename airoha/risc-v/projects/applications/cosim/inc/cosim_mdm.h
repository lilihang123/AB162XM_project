...
#define MDM_SWCOSIM_HSDATA          (MDM_base + 0x00CC)
#define MDM_WAIT_US                 (MDM_base + 0x00D0)
...
#define MDM_TM_ENDSIM               (*((P_U32)MDM_ENDSIM) = 0)              // End of simulation
#define MDM_TM_SET_PEER_WAIT(a)     (*((P_U32)MDM_SWCOSIM_HSDATA) = (U32)(a))
#define MDM_TM_GET_PEER_WAIT        (*((P_U32)MDM_SWCOSIM_HSDATA))

#define MDM_TM_SET_WAIT_US(a)       (*((P_U32)MDM_WAIT_US) = (U32)(a))
#define MDM_TM_GET_WAIT_US          (*((P_U32)MDM_WAIT_US))
...
#define LOG_MSGID_E(module, message, arg_cnt, ...) \
    MDM_TM_PRINTF(message, ##__VA_ARGS__)
