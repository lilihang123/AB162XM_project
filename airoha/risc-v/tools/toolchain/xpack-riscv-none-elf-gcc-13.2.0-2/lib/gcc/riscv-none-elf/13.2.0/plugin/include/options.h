...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1889,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1890,                       /* -mcmodel= */
  OPT_mcpu_ = 1891,                          /* -mcpu= */
  OPT_mcsr_check = 1892,                     /* -mcsr-check */
  OPT_mdiv = 1893,                           /* -mdiv */
  OPT_mexplicit_relocs = 1894,               /* -mexplicit-relocs */
  OPT_mfdiv = 1895,                          /* -mfdiv */
  OPT_minline_atomics = 1896,                /* -minline-atomics */
  OPT_misa_spec_ = 1897,                     /* -misa-spec= */
  OPT_mlittle_endian = 1898,                 /* -mlittle-endian */
  OPT_mplt = 1899,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1900,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1901,                         /* -mrelax */
  OPT_mriscv_attribute = 1902,               /* -mriscv-attribute */
  OPT_msave_restore = 1903,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1904,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1905,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 1906, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1907,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1908,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1909,                  /* -mstrict-align */
  OPT_mtune_ = 1910,                         /* -mtune= */
  OPT_n = 1911,                              /* -n */
  OPT_name_sort = 1912,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1913,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1914,              /* -no-integrated-cpp */
  OPT_no_pie = 1915,                         /* -no-pie */
  OPT_nocpp = 1916,                          /* -nocpp */
  OPT_nodefaultlibs = 1917,                  /* -nodefaultlibs */
  OPT_nolibc = 1918,                         /* -nolibc */
  OPT_nophoboslib = 1919,                    /* -nophoboslib */
  OPT_nostartfiles = 1920,                   /* -nostartfiles */
  OPT_nostdinc = 1921,                       /* -nostdinc */
  OPT_nostdinc__ = 1922,                     /* -nostdinc++ */
  OPT_nostdlib = 1923,                       /* -nostdlib */
  OPT_nostdlib__ = 1924,                     /* -nostdlib++ */
  OPT_o = 1925,                              /* -o */
  OPT_objects = 1926,                        /* -objects */
  OPT_p = 1927,                              /* -p */
  OPT_pass_exit_codes = 1928,                /* -pass-exit-codes */
  /* OPT_pedantic = 1929, */                 /* -pedantic */
  OPT_pedantic_errors = 1930,                /* -pedantic-errors */
  OPT_pg = 1931,                             /* -pg */
  OPT_pie = 1932,                            /* -pie */
  OPT_pipe = 1933,                           /* -pipe */
  OPT_print_file_name_ = 1934,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1935,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1936,          /* -print-multi-directory */
  OPT_print_multi_lib = 1937,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1938,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1939,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1940,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1941,               /* -print-prog-name= */
  OPT_print_search_dirs = 1942,              /* -print-search-dirs */
  OPT_print_sysroot = 1943,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1944,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1945,                    /* -print-value */
  OPT_quiet = 1946,                          /* -quiet */
  OPT_r = 1947,                              /* -r */
  OPT_remap = 1948,                          /* -remap */
  OPT_reverse_sort = 1949,                   /* -reverse-sort */
  OPT_s = 1950,                              /* -s */
  OPT_save_temps = 1951,                     /* -save-temps */
  OPT_save_temps_ = 1952,                    /* -save-temps= */
  OPT_shared = 1953,                         /* -shared */
  OPT_shared_libgcc = 1954,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1955,               /* -shared-libphobos */
  OPT_size_sort = 1956,                      /* -size-sort */
  /* OPT_specs = 1957, */                    /* -specs */
  OPT_specs_ = 1958,                         /* -specs= */
  OPT_static = 1959,                         /* -static */
  OPT_static_libasan = 1960,                 /* -static-libasan */
  OPT_static_libgcc = 1961,                  /* -static-libgcc */
  OPT_static_libgfortran = 1962,             /* -static-libgfortran */
  OPT_static_libgm2 = 1963,                  /* -static-libgm2 */
  OPT_static_libgo = 1964,                   /* -static-libgo */
  OPT_static_libhwasan = 1965,               /* -static-libhwasan */
  OPT_static_liblsan = 1966,                 /* -static-liblsan */
  OPT_static_libmpx = 1967,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1968,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1969,               /* -static-libphobos */
  OPT_static_libquadmath = 1970,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1971,               /* -static-libstdc++ */
  OPT_static_libtsan = 1972,                 /* -static-libtsan */
  OPT_static_libubsan = 1973,                /* -static-libubsan */
  OPT_static_pie = 1974,                     /* -static-pie */
  /* OPT_std_c__03 = 1975, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1976, */                /* -std=c++0x */
  OPT_std_c__11 = 1977,                      /* -std=c++11 */
  OPT_std_c__14 = 1978,                      /* -std=c++14 */
  OPT_std_c__17 = 1979,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1980, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1981, */                /* -std=c++1z */
  OPT_std_c__20 = 1982,                      /* -std=c++20 */
  OPT_std_c__23 = 1983,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1984, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1985, */                /* -std=c++2b */
  OPT_std_c__98 = 1986,                      /* -std=c++98 */
  OPT_std_c11 = 1987,                        /* -std=c11 */
  OPT_std_c17 = 1988,                        /* -std=c17 */
  /* OPT_std_c18 = 1989, */                  /* -std=c18 */
  /* OPT_std_c1x = 1990, */                  /* -std=c1x */
  OPT_std_c2x = 1991,                        /* -std=c2x */
  /* OPT_std_c89 = 1992, */                  /* -std=c89 */
  OPT_std_c90 = 1993,                        /* -std=c90 */
  OPT_std_c99 = 1994,                        /* -std=c99 */
  /* OPT_std_c9x = 1995, */                  /* -std=c9x */
  OPT_std_f2003 = 1996,                      /* -std=f2003 */
  OPT_std_f2008 = 1997,                      /* -std=f2008 */
  OPT_std_f2008ts = 1998,                    /* -std=f2008ts */
  OPT_std_f2018 = 1999,                      /* -std=f2018 */
  OPT_std_f95 = 2000,                        /* -std=f95 */
  OPT_std_gnu = 2001,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2002, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2003, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2004,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2005,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2006,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2007, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2008, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2009,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2010,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2011, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2012, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2013,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2014,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2015,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2016, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2017, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2018,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2019, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2020,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2021,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2022, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2023, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2024,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2025, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2026, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2027, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2028, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2029, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2030,                     /* -std=legacy */
  OPT_stdlib_ = 2031,                        /* -stdlib= */
  OPT_symbol_ = 2032,                        /* -symbol= */
  OPT_symbolic = 2033,                       /* -symbolic */
  OPT_t = 2034,                              /* -t */
  OPT_time = 2035,                           /* -time */
  OPT_time_ = 2036,                          /* -time= */
  OPT_traditional = 2037,                    /* -traditional */
  OPT_traditional_cpp = 2038,                /* -traditional-cpp */
  OPT_tree_stats = 2039,                     /* -tree-stats */
  OPT_trigraphs = 2040,                      /* -trigraphs */
  OPT_type_stats = 2041,                     /* -type-stats */
  OPT_u = 2042,                              /* -u */
  OPT_undef = 2043,                          /* -undef */
  OPT_v = 2044,                              /* -v */
  OPT_version = 2045,                        /* -version */
  OPT_w = 2046,                              /* -w */
  OPT_wrapper = 2047,                        /* -wrapper */
  OPT_x = 2048,                              /* -x */
  OPT_z = 2049,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
