...
/* Public define ------------------------------------------------------------*/
#define PKA_EXP_ANCHOR_DIFF_8K_4M           (-138)
#define PKA_EXP_ANCHOR_DIFF_LOWER_8K_4M     (-240)
#define PKA_EXP_ANCHOR_DIFF_LOWER_8K_4M_OLD (-268)
#define PKA_EXP_ANCHOR_DIFF_LOWER_4K_2M     (-348)
#define PKA_EXP_ANCHOR_DIFF_4K_2M           (-260)
