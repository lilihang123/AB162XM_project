...
static void object_transfer_work_handler(struct k_work *work)
{
	struct k_work_delayable *dwork = k_work_delayable_from_work(work);
	struct bt_ots *ots = CONTAINER_OF(dwork, struct bt_ots, object_transfer_work);
		     ...
		     struct bt_ots_init_param *ots_init)
{
	...
	k_work_init_delayable(&ots->object_transfer_work, object_transfer_work_handler);
