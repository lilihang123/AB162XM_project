 ...
 */
ATTR_TEXT_IN_TCM memq_link_t *memq_enqueue(memq_link_t *link, void *mem, memq_link_t **tail)
{
 ...
 */
ATTR_TEXT_IN_TCM memq_link_t *memq_peek(memq_link_t *head, memq_link_t *tail, void **mem)
{
 ...
 * @return         head or NULL if queue is empty
 */
ATTR_TEXT_IN_TCM memq_link_t *memq_peek_n(memq_link_t *head, memq_link_t *tail, uint8_t n,
			 void **mem)
{
 ...
 * @return             head or NULL if queue is empty
 */
ATTR_TEXT_IN_TCM memq_link_t *memq_dequeue(memq_link_t *tail, memq_link_t **head, void **mem)
{
	memq_link_t *old_head;
