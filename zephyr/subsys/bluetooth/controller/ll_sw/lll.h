...
enum {
    ...
    TICKER_ID_SCAN_SYNC_WR_RESPONSE_BASE,
    TICKER_ID_SCAN_SYNC_WR_BASE,
    TICKER_ID_SCAN_SYNC_WR_LAST = ((TICKER_ID_SCAN_SYNC_WR_BASE) + 1),  
#if defined(CONFIG_BT_CTLR_SYNC_PERIODIC_RSP_PRO)
	TICKER_ID_SCAN_SYNC_WR_PRO,
#endif

    //TICKER_ID_SCAN_SYNC_WR_BASE,
    //TICKER_ID_SCAN_SYNC_WR_LAST = ((TICKER_ID_SCAN_SYNC_WR_BASE) + 127),
    //TICKER_ID_SCAN_SYNC_WR_RESPONSE_BASE,
    ...
    //TICKER_ID_SCAN_SYNC_WR_RESPONSE_BASE,
    //TICKER_ID_SCAN_SYNC_WR_BASE,
    //TICKER_ID_SCAN_SYNC_WR_LAST = ((TICKER_ID_SCAN_SYNC_WR_BASE) + 64),    
#endif
	TICKER_ID_MAX,
};
...
#define TICKER_ID_ULL_BASE ((TICKER_ID_LLL_PREEMPT)+ (TICKER_ID_DEBUG_INFO) + 1)

#define LE_PERIPHERAL_CONNECTION_FROM_ADVERTISING 0
#define LE_PERIPHERAL_CONNECTION_FROM_PAWR        1
...
enum node_rx_type {
	...
	NODE_RX_TYPE_SYNC_TRANSFER_RECEIVED, //45
    NODE_RX_TYPE_SYNC_TRANSFER_RECEIVED_V2,//46
	NODE_RX_TYPE_AIR_PA_TAILORED_DATA_RECEIVED,//47
...
#if defined(CONFIG_BT_CTLR_SYNC_PERIODIC_RSP_PRO)
struct node_rx_pa_tailored_data_received {
	uint8_t subevent;
	uint8_t id;
	uint8_t status;
	uint8_t packet_num;
