...
#define BT_LE_FEAT_BIT_PAWR_PROPRIETARY         51
...
#define BT_FEAT_LE_ISO(feat)            (BT_FEAT_LE_CIS(feat) | \
					BT_FEAT_LE_BIS(feat))
#define BT_FEAT_LE_PAWR_PROPRIETARY(feat)         BT_LE_FEAT_TEST(feat, \
						  BT_LE_FEAT_BIT_PAWR_PROPRIETARY)        
...
#define BT_HCI_EVT_LE_AIR_PA_TAILORED_DATA_RECEIVED_COMPLETE 0xD0
struct bt_hci_evt_le_air_pa_tailored_data_received {
	uint8_t subevent;
	uint8_t id;
	uint8_t status;
	uint8_t packet_num;
