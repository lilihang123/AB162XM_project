...
/* Modifications:
2025-09-15 by Airoha - Add a `mode` parameter to the `obj_write` callback function to indicate whether to truncate the object content.
*/
...
struct bt_ots_cb {
	 ...
	 *  @param mode     The mode of the write operation.
	 *
	...
	ssize_t (*obj_write)(struct bt_ots *ots, struct bt_conn *conn, uint64_t id,
			     ...
			     size_t rem, enum bt_ots_oacp_write_op_mode mode);
