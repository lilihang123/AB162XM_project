...
#define DEVICERESETN_DDRCTRL BIT(0)
#define DEVICERESETN_DDRAXI  BIT(1)
#define DEVICERESETN_DDRAHB  BIT(2)
#define DEVICERESETN_DDRPHY  BIT(3)
#define DEVICERESETN_PCIEAUX BIT(4)
#define DEVICERESETN_GEMGXL  BIT(5)
