...
/**
 * @brief NRFX_PWM_NRF52_ANOMALY_109_WORKAROUND_ENABLED - Enables nRF52 Anomaly 109 workaround
 * for PWM.
 *
 * Boolean. Accepted values 0 and 1.
 */
...
/**
 * @brief NRFX_SPIM_NRF52_ANOMALY_109_WORKAROUND_ENABLED - Enables nRF52 Anomaly 109 workaround for
 * SPIM.
 *
 * Boolean. Accepted values 0 and 1.
 */
...
/**
 * @brief NRFX_SPIS_NRF52_ANOMALY_109_WORKAROUND_ENABLED - Enables nRF52 Anomaly 109 workaround
 * for SPIS.
 *
 * Boolean. Accepted values 0 and 1.
 */
...
/**
 * @brief NRFX_TWIM_NRF52_ANOMALY_109_WORKAROUND_ENABLED - Enables nRF52 Anomaly 109 workaround for
 * TWIM.
 *
 * Boolean. Accepted values 0 and 1.
 */
