...
#define I2SIPCMC		8
#define SSMIDyCS(y)		0x60 + 0x10*y
#define SSMIDyD(y)		0x64 + 0x10*y
#define SSMIDyTSA(y)	0x68 + 0x10*y
#define SSMODyCS(y)		0x60 + 0x10*I2SIPCMC + 0x10*y
...
#define SSCR1_RSVD1		DAI_INTEL_SSP_MASK(15, 3)
#define SSCR1_IFS		BIT(16)
#define SSCR1_PINTE		BIT(18)
#define SSCR1_TINTE		BIT(19)
#define SSCR1_RSVD21		DAI_INTEL_SSP_MASK(21, 20)
...
#define SSPSP2_RFAC		DAI_INTEL_SSP_MASK(9, 8)
#define SSPSP2_TFAC		DAI_INTEL_SSP_MASK(11, 10)
#define SSPSP2_EFEP		DAI_INTEL_SSP_MASK(13, 12)
#define SSPSP2_ESFRMDW	DAI_INTEL_SSP_MASK(15, 14)
