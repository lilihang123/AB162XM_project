...
DEFINE_TEST_VARIANT2(support_q15, arm_copy_q15, 7, in_q15, 7);
DEFINE_TEST_VARIANT2(support_q15, arm_copy_q15, 16, in_q15, 16);
DEFINE_TEST_VARIANT2(support_q15, arm_copy_q15, 23, in_q15, 23);
...
DEFINE_TEST_VARIANT1(support_q15, arm_fill_q15, 7, 7);
DEFINE_TEST_VARIANT1(support_q15, arm_fill_q15, 16, 16);
DEFINE_TEST_VARIANT1(support_q15, arm_fill_q15, 23, 23);
...
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_float, 7, in_q15, ref_f32, 7);
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_float, 16, in_q15, ref_f32, 16);
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_float, 23, in_q15, ref_f32, 23);
...
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_q31, 7, in_q15, ref_q31, 7);
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_q31, 16, in_q15, ref_q31, 16);
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_q31, 23, in_q15, ref_q31, 23);
...
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_q7, 7, in_q15, ref_q7, 7);
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_q7, 16, in_q15, ref_q7, 16);
DEFINE_TEST_VARIANT3(support_q15, arm_q15_to_q7, 23, in_q15, ref_q7, 23);

ZTEST_SUITE(support_q15, NULL, NULL, NULL, NULL, NULL);
