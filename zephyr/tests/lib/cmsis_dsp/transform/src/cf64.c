	...
	bool inverse, const uint64_t *input, const uint64_t *ref, size_t length)
{
	...
	/* Initialise instance */
	status = arm_cfft_init_f64(&inst, length / 2);
