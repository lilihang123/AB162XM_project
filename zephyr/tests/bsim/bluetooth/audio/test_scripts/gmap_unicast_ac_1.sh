...
function Execute_AC_1() {
    ...
    Execute ./bs_${BOARD_TS}_tests_bsim_bluetooth_audio_prj_conf \
        -v=${VERBOSITY_LEVEL} -s=${SIMULATION_ID} -d=0 -testid=gmap_ugg_ac_1 -RealEncryption=1 \
...
Execute_AC_1 32_1_gr
Execute_AC_1 32_2_gr
Execute_AC_1 48_1_gr
Execute_AC_1 48_2_gr
Execute_AC_1 48_3_gr
Execute_AC_1 48_4_gr
