...
function Execute_AC_11_II() {
    ...
    Execute ./bs_${BOARD_TS}_tests_bsim_bluetooth_audio_prj_conf \
        -v=${VERBOSITY_LEVEL} -s=${SIMULATION_ID} -d=0 -testid=cap_initiator_ac_11_ii \
...
Execute_AC_11_II 8_1_1 8_1_1
Execute_AC_11_II 8_2_1 8_2_1
Execute_AC_11_II 16_1_1 16_1_1
Execute_AC_11_II 16_2_1 16_2_1
Execute_AC_11_II 24_1_1 24_1_1
