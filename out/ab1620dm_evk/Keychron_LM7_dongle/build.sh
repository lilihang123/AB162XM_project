...
OUTPUT_FOLDER=out/ab1620dm_evk/Keychron_LM7_dongle
OUTPUT_LOG_FOLDER=${OUTPUT_FOLDER}/log
BUILD_LOG=build_ab1620dm_evk_Keychron_LM7_dongle.log

START_TIME_IN_SEC=$(TZ=UTC date +%s)

 west build -p auto -d out/ab1620dm_evk/Keychron_LM7_dongle -b ab1620dm_evk --sysbuild airoha/mcu/applications/Keychron_LM7_dongle_design -- -DSB_CONF_FILE=config/ab1620dm_evk/sysbuild_with_mcuboot.conf -Dmcuboot_DTC_OVERLAY_FILE=config/ab162x_evb/mcuboot.overlay -Dmcuboot_CONF_FILE=config/ab162x_evb/air_mcuboot.conf -DKeychron_LM7_dongle_design_DTC_OVERLAY_FILE=config/ab1620dm_evk/app.overlay -DKeychron_LM7_dongle_design_CONF_FILE=config/ab1620dm_evk/hid_dongle_ref_design_flash_boot_m20.conf 2>&1 | tee build_ab1620dm_evk_Keychron_LM7_dongle.log
BUILD_RESULT=$?
