...
OUTPUT_FOLDER=out/ab1620dm_evk/hid_dongle_ref_design_m20
OUTPUT_LOG_FOLDER=${OUTPUT_FOLDER}/log
BUILD_LOG=build_ab1620dm_evk_hid_dongle_ref_design_m20.log

START_TIME_IN_SEC=$(TZ=UTC date +%s)

 west build -p auto -d out/ab1620dm_evk/hid_dongle_ref_design_m20 -b ab1620dm_evk --sysbuild airoha/mcu/applications/hid_dongle_ref_design -- -DSB_CONF_FILE=config/ab1620dm_evk/sysbuild_with_mcuboot.conf -Dmcuboot_DTC_OVERLAY_FILE=config/ab162x_evb/mcuboot.overlay -Dmcuboot_CONF_FILE=config/ab162x_evb/air_mcuboot.conf -Dhid_dongle_ref_design_DTC_OVERLAY_FILE=config/ab1620dm_evk/app.overlay -Dhid_dongle_ref_design_CONF_FILE=config/ab1620dm_evk/hid_dongle_ref_design_flash_boot_m20.conf 2>&1 | tee build_ab1620dm_evk_hid_dongle_ref_design_m20.log
BUILD_RESULT=$?
