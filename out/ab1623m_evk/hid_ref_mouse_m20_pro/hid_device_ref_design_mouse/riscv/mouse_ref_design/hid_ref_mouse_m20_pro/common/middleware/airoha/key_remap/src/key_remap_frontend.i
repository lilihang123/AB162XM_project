# 0 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
# 38 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
# 1 "/workdir/airoha/common/middleware/airoha/key_remap/inc/key_remap_frontend.h" 1
# 40 "/workdir/airoha/common/middleware/airoha/key_remap/inc/key_remap_frontend.h"
...
# 41 "/workdir/airoha/common/middleware/airoha/key_remap/inc/key_remap_frontend.h" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c" 2
...
# 41 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c" 2
# 53 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
__attribute__ ((__section__(".log_filter." "kr_frontend"))) log_control_block_t log_control_block_kr_frontend = { "kr_frontend", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 53 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c" 3 4
((void *)0)
# 53 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
, 
# 53 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c" 3 4
...
((void *)0)
# 53 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "kr_frontend"))) __attribute__((used)) const char log_control_block_mirror_kr_frontend[] = "kr_frontend";
...
T_HID_KEY_REMAP_FRONTEND_S key_setting[10];
# 96 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
void key_remap_frontend_process_xy(T_OUTGOING_VALUES_S *outgoing)
{
...
void key_remap_frontend_process(T_OUTGOING_VALUES_S *outgoing)
{
    ...
    uint32_t erase_bit = (kr_ctrl.key_remap_enable | 0x20 | 0x40 | 0x80) & new_key;
...
# 125 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
...
# 171 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
void key_remap_frontend_setting_update()
{
...
# 200 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_frontend.c"
