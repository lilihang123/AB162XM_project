# 0 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
# 35 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h" 1
# 38 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h"
...
# 39 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h" 2
...
# 40 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h" 2
# 1 "/workdir/airoha/risc-v/tools/toolchain/xpack-riscv-none-elf-gcc-13.2.0-2/lib/gcc/riscv-none-elf/13.2.0/include/stdarg.h" 1 3 4
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h"
...
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h" 2
...
# 36 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c" 2

# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 38 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c" 2

# 1 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 1
# 49 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
typedef enum {
...
# 100 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 3 4
   _Bool 
# 100 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
        is_full;
    union {
...
extern share_buffer_status_t share_buffer_get_write_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t *write_ptr, 
# 110 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 3 4
                                                                                                                                           _Bool 
# 110 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
                                                                                                                                                *is_full);
extern share_buffer_status_t share_buffer_set_write_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t write_ptr, 
# 111 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 3 4
                                                                                                                                          _Bool 
# 111 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
                                                                                                                                               *is_full);
extern share_buffer_status_t share_buffer_get_read_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t *read_ptr, 
# 112 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 3 4
                                                                                                                                         _Bool 
# 112 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
                                                                                                                                              *is_empty);
extern share_buffer_status_t share_buffer_set_read_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t read_ptr, 
# 113 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 3 4
                                                                                                                                        _Bool 
# 113 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
                                                                                                                                             *is_empty);
...
# 40 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c" 2


# 1 "/workdir/airoha/risc-v/kernel/service/exception_handler/inc/exception_handler.h" 1
# 43 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c" 2
# 51 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "51"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_ccni[(2*16*sizeof(hal_ccni_message_t))];

__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "53"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_core_status[(2*sizeof(uint32_t))];

__attribute__ ((__aligned__(16))) __attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "55"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_spi_sensor[16];




__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "60"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_syslog_uart_para[(sizeof(uart_backup_para_for_log_t))];

__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "62"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_eint_count[(EINT_COUNTER_NUMBER_MUX*sizeof(uint32_t))];
...
__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "70"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_syslog[(0x168)];
__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "71"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_sw_verno_str[(0x90)];
__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "72"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_build_date_time_str[(0x90)];



__attribute__ ((__section__(".log_filter." "common"))) log_control_block_t log_control_block_common = { "common", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 76 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c" 3 4
((void *)0)
# 76 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
, 
# 76 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c" 3 4
((void *)0)
# 76 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
...
((void *)0)
# 76 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "common"))) __attribute__((used)) const char log_control_block_mirror_common[] = "common";




__attribute__ ((__aligned__(4))) __attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "81"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_exception_risc_v_0[396];




__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "86"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_pka_share[sizeof(pka_share_info)];



__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "90"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_hid_common_para[sizeof(hid_common_info)];
...
__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "98"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_mux[0x200];



__attribute__((section(".share_zidata" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_cross_core_config.c\"" "." "102"))) __attribute__ ((__aligned__(4))) volatile uint8_t ccm_disable_all_log[1];
