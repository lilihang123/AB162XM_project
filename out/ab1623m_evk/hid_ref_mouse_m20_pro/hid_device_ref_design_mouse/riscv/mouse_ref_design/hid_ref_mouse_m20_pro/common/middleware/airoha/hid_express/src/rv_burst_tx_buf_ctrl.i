# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c"
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c"
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c" 2
...
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c" 2
...
# 41 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c" 2
# 50 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c"
...
uint32_t LC_burst_tx_number = 2;
uint32_t outgoing_buffer_avail = 2;
extern T_BT_DEBUG_S bt_debug;
extern T_ATT_ATTRIBUTE_HANDLE_S attr_handle;
# 69 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c"
uint32_t rv_bt_burst_tx_num_ctrl(T_BT_HID_REPORT_S *report, uint32_t buf_avail_num)
{
    uint32_t LC_queued_tx_pkt_num = 10 - buf_avail_num;
    outgoing_buffer_avail = LC_burst_tx_number;

    if(LC_queued_tx_pkt_num && LC_queued_tx_pkt_num != 10)
    {
        LC_queued_tx_pkt_num--;
    }
    else if(LC_queued_tx_pkt_num == 10)
    {

        return 0;
    }
# 95 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_burst_tx_buf_ctrl.c"
    if(LC_queued_tx_pkt_num >= 2)
    {
        LC_ReTx_times++;
    }
    ...
    if(LC_traffic_statistic_counter >= 133)
    {
        if (LC_ReTx_times >= 10)
        {

            LC_burst_tx_number = 10;
            bt_debug.LC_burst_tx_number_10++;
        }
        else
        {
            LC_burst_tx_number = 2;
        }
    ...
    {
        if((LC_burst_tx_number == 10) && (LC_queued_tx_pkt_num == (10 - 2)))
        {
