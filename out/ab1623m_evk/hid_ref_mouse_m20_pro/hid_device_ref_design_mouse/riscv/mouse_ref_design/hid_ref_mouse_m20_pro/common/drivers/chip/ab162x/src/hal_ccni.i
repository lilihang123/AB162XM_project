# 0 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
# 35 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
...
# 36 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 2
# 47 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
...
# 48 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 2
...
# 50 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 51 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h" 1
# 52 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 2
...
# 53 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 2
# 94 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
static void ccni_irq_handler(hal_nvic_irq_t irq);

static hal_ccni_status_t s_ccni_init_status = HAL_CCNI_STATUS_NO_INIT;
# 121 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
hal_ccni_status_t hal_ccni_init(void)
{
    if (s_ccni_init_status == HAL_CCNI_STATUS_NO_INIT) {
# 135 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
...
static void ccni_irq_handler(hal_nvic_irq_t irq)
{
    ...
    (void)irq;
    irq_event = ((CCNI_REGISTER_T *) (0x422b0000))->STATUS;
    for (i = 0; i < HAL_CCNI_EVENT_MAX; i++) {
        if (irq_event & (1 << i)) {
            if ((((CCNI_REGISTER_T *) (0x422b0000))->MASK) & (1 << i)) {
                continue;
            }
# 171 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
            event = i | (HAL_CCNI_CORE_MCU<<24) | (HAL_CCNI_CORE_RISCV<<16);

            hal_ccni_mask_event(event);
            { if(!(ccni_callback[i] != 
# 174 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
           ((void *)0)
# 174 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
           )){ __asm__("j ."); } };
            if (ccni_callback[i]) {
                if (i < 16) {
                    ...
                    p_share_memory = (uint8_t *)(ccm_ccni) + (HAL_CCNI_CORE_RISCV - 1) * ((2*16*sizeof(hal_ccni_message_t))/2) + i * sizeof(hal_ccni_message_t);

                    ccni_callback[i](event, (hal_ccni_message_t *)p_share_memory);
                } else {
                    ccni_callback[i](event, 
# 185 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                           ((void *)0)
# 185 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
                                               );
                }
            }
...
hal_ccni_status_t hal_ccni_query_event_status(hal_ccni_event_t event, uint32_t *data)
{
    ...
    src_core = ((event & (0xFF000000)) >> 24);
    dst_core = ((event & (0x00FF0000)) >> 16);
    event_index = event & (HAL_CCNI_EVENT_MAX - 1);

    if ((data == 
# 208 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                ((void *)0)
# 208 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
                    ) ||
        ((event & (0xFF000000)) == ((event & (0x00FF0000)) << 8)) ||
        (((event & (HAL_CCNI_EVENT_MAX - 1)) >= HAL_CCNI_EVENT_MAX)) ||
    ...
    switch (dst_core) {
        case HAL_CCNI_CORE_MCU:
            *data = ((((CCNI_REGISTER_T *) (0x422c0000))->STATUS) & (1 << event_index)) ? HAL_CCNI_EVENT_STATUS_BUSY : HAL_CCNI_EVENT_STATUS_IDLE;
            break;
        case HAL_CCNI_CORE_RISCV:
            *data = ((((CCNI_REGISTER_T *) (0x422b0000))->STATUS) & (1 << event_index)) ? HAL_CCNI_EVENT_STATUS_BUSY : HAL_CCNI_EVENT_STATUS_IDLE;
            break;
    }
    hal_nvic_restore_interrupt_mask(mask);
    return status;
}
# 243 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
hal_ccni_status_t hal_ccni_set_event_with_retry(hal_ccni_event_t event, hal_ccni_message_t *message, uint32_t retry_time)
{
    ...
    if (
        ...
        ((HAL_CCNI_CORE_RISCV<<24) != (event & (0xFF000000))) ||
        ((HAL_CCNI_CORE_MCU<<16) != (event & (0x00FF0000))) ||

        ((event & (0xFF000000)) == ((event & (0x00FF0000)) << 8)) ||
        ((16 <= event_index) && (message != 
# 263 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                                                 ((void *)0)
# 263 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
                                                                     ))
    ) {
        return HAL_CCNI_STATUS_INVALID_PARAMETER;
    }
    ...
    while (1) {
        if (((((CCNI_REGISTER_T *) (0x422c0000))->STATUS) & (1 << event_index)) == HAL_CCNI_EVENT_STATUS_IDLE) {
            break;
        } else {
            if (0 == retry_time) {
                timeout = 1;
    ...
    if (event_index < 16) {
        ...
        p_share_memory = (uint32_t *)((uint8_t *)(ccm_ccni) + (HAL_CCNI_CORE_MCU - 1) * ((2*16*sizeof(hal_ccni_message_t))/2));

        p_share_memory[event_index * 2] = message->data[0];
        p_share_memory[event_index * 2 + 1] = message->data[1];
    }

    (((CCNI_REGISTER_T *) (0x422c0000))->SET) |= (1 << event_index);
    hal_nvic_restore_interrupt_mask(mask);
    return status;
}
...
hal_ccni_status_t hal_ccni_set_event(hal_ccni_event_t event, hal_ccni_message_t *message)
{
    return hal_ccni_set_event_with_retry(event, message, (0xFFFFFFFF));
}
...
static hal_ccni_status_t ccni_write_register(hal_ccni_event_t event, uint32_t register_offset, uint32_t value)
{
    ...
    src_core = ((event & (0xFF000000)) >> 24);
    dst_core = ((event & (0x00FF0000)) >> 16);
    event_idx = event & (HAL_CCNI_EVENT_MAX - 1);
    ...
    reg_addr = (uint32_t)((CCNI_REGISTER_T *) (0x422b0000)) + register_offset;
    hal_nvic_save_and_set_interrupt_mask(&mask);
    if (value == 0x1) {
...
hal_ccni_status_t hal_ccni_clear_event(hal_ccni_event_t event)
{
    return ccni_write_register(event, (
# 348 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                     __builtin_offsetof (
# 348 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
                                     CCNI_REGISTER_T
# 348 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                     , 
# 348 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
...
{
    return ccni_write_register(event, (
# 353 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                     __builtin_offsetof (
# 353 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
                                     CCNI_REGISTER_T
# 353 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                     , 
# 353 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
...
{
    return ccni_write_register(event, (
# 358 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                     __builtin_offsetof (
# 358 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
                                     CCNI_REGISTER_T
# 358 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c" 3 4
                                     , 
# 358 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_ccni.c"
