# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
...
void hid_express_bt_debug_print();
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/rv_burst_tx_buf_ctrl.h" 1
# 41 "/workdir/airoha/common/middleware/airoha/hid_express/inc/rv_burst_tx_buf_ctrl.h"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_bt_mode.h" 1
# 42 "/workdir/airoha/common/middleware/airoha/hid_express/inc/rv_burst_tx_buf_ctrl.h" 2
...
uint32_t rv_bt_burst_last_outgoing_avail_num();
# 41 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
...
# 42 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
...
# 43 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
...
# 44 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
...
# 48 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 2
...
void init_bt_queue() {
    ...
    bt_ctrl.rear = 0;
    bt_buffer_size = 2;
    bt_buffer_size_mask = (2 - 1);
}


# 71 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 3 4
_Bool 
# 71 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
    is_bt_queue_empty() {
    return bt_ctrl.front == bt_ctrl.rear;
}


# 75 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 3 4
_Bool 
# 75 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
    is_bt_queue_full() {
...
# 137 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
...
# 157 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
}
...
static void hid_express_bt_assemble_kb_std_report(T_BT_HID_REPORT_S* assemble_report, T_OUTGOING_VALUES_S* outgoing)
{
    ...
    assemble_report->kb_std5.combo = outgoing->kb_std[0] & 0x000000FF;
    assemble_report->kb_std5.keycode[0] =(outgoing->kb_std[0] >> 8) & 0x000000FF;
    assemble_report->kb_std5.keycode[1] = (outgoing->kb_std[0] >> 16) & 0x000000FF;
    assemble_report->kb_std5.keycode[2] = (outgoing->kb_std[0] >> 24) & 0x000000FF;
    assemble_report->kb_std5.keycode[3] = outgoing->kb_std[1] & 0x000000FF;
    assemble_report->kb_std5.keycode[4] = (outgoing->kb_std[1] >> 8) & 0x000000FF;
# 183 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
}
...
# 200 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
}
# 367 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
static void hid_express_bt_submit_report_to_pka_16bits(T_BT_HID_REPORT_S* assemble_report)
{
    ...
    if (bt_tx_buffer == 
# 370 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c" 3 4
                       ((void *)0)
# 370 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
                           ) {
...
# 410 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
...
# 530 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
        bt_debug.drop_data++;
        bt_debug.controller_full++;
        tx_result = 1;
    }
...
int hid_express_bt_data_send(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result, uint32_t tx_idx, uint32_t assemble)
{
    ...
    if(assemble)
    {
        ...
        if(outgoing->type == 2 || outgoing->x != 0 || outgoing->y != 0)
...
# 616 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
    }
    else
    {
        hid_express_bt_send_report(&assemble_report, assemble);
...
{
    init_bt_queue();
# 636 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
    default_BT_report.l2cap.LEN = sizeof(T_ATT_HEADER_S) + sizeof(T_MOUSE_REPORT_PAYLOAD_S);

    default_BT_report.l2cap.CH_ID = (4);
    default_BT_report.att.OPCODE = (0x1b);
}
# 658 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_bt_mode.c"
void hid_experss_bt_set_attr_handle(uint32_t ms, uint32_t kb_std, uint32_t kb_consumer)
{
    attr_handle.ms = ms;
...
void hid_express_bt_debug_print()
{
    ...
    do { extern log_control_block_t log_control_block_rv_exp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "rv_exp" " C:info F: L: ]: " "BT mode status merge data = %d, controller full = %d, tx buffer full = %d, LC_burst_tx_number is 10 = %d"; print_module_msgid_log(&log_control_block_rv_exp, (PRINT_LEVEL_INFO), (msg_id_string), (4), bt_debug.drop_data_print, bt_debug.controller_full_print, bt_debug.tx_buffer_full_print, bt_debug.LC_burst_tx_number_10_print); } while (0);
