# 0 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
# 38 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
...
# 39 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 40 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 41 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 42 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 43 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h" 1
# 48 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h"
typedef enum
{
  HAL_QDEC_LED_ACTIVE_MDOE = 0x00,
  HAL_QDEC_LED_IDLE_MDOE = 0x01
} hal_qdec_mode_status_t;

typedef enum
{
  HAL_QDEC_LED_LOW_ACTIVE = 0x00,
  HAL_QDEC_LED_HIGH_ACTIVE = 0x01
} hal_qdec_led_active_value_setting_t;

typedef enum
{
  HAL_QDEC_DIV_OF_Z_COUNT_1_2 = 0x00,
  HAL_QDEC_DIV_OF_Z_COUNT_1_4 = 0x01
} hal_qdec_z_div_setting_t;

typedef enum
{
  HAL_QDEC_SELECT_GROUP_A = 0x00,
  HAL_QDEC_SELECT_GROUP_B = 0x01
} hal_qdec_sel_group_setting_t;

typedef enum
{
  HAL_QDEC_LED_NO_EFFECT = 0x00,
  HAL_QDEC_LED_FORCE_OFF = 0x01
} hal_qdec_led_setting_t;

typedef enum
{
  HAL_QDEC_READ_DATA_BY_IRQ= 0x00,
  HAL_QDEC_READ_DATA_BY_NEXT_CYCLE = 0x01
} hal_qdec_data_getting_type_t;

typedef enum
{
  HAL_QDEC_ZSUM_MODE= 0x00,
  HAL_QDEC_ZCNT_MODE = 0x01
} hal_qdec_mode_t;


typedef enum
{
  HAL_QDEC_STATUS_ERROR = -2,
  HAL_QDEC_INVALID_PARAMETER = -1,
  HAL_QDEC_STATUS_OK = 0
} hal_qdec_status_t;
...
hal_qdec_status_t hal_qdec_latch_status_is_busy(
# 163 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h" 3 4
                                               _Bool 
# 163 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h"
                                                    *hw_latch_status);
...
# 44 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 45 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_wheel_ir_comparator.h" 1
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 47 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 48 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_ccni.h" 1
# 49 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
...
# 50 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2

# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_wheel_queue.h" 1
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_wheel_queue.h"
...
void riscv_wheel_queue_update(int16_t update_num);
# 52 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 2
# 60 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
uint8_t scroll_ctrl_pin_id;
uint8_t scroll_active_level;


uint32_t qdec_reverse_enable = 
# 64 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 3 4
                              0
# 64 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
                                   ;
...
# 127 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 3 4
       _Bool 
# 127 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
            hw_latch_busy;
...
int riscv_wheel_init()
{
    if((hid_common->app.features & (0x01 << 1)))
    {
        qdec_reverse_enable = 
# 166 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c" 3 4
                             1
# 166 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
                                 ;
    }

    scroll_ctrl_pin_id = hid_common->app.scroll_ctrl.id;
    scroll_active_level = hid_common->app.scroll_ctrl.para & 0x01;
    do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "riscv_wheel_init, qdec_reverse_enable = %d, scroll_ctrl_pin_id = %d, scroll_active_level = %d"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (3), qdec_reverse_enable, scroll_ctrl_pin_id, scroll_active_level); } while (0);
...
{
    do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "riscv_wheel_deinit"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (0)); } while (0);
...
# 235 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel.c"
void riscv_wheel_debug_print()
{
