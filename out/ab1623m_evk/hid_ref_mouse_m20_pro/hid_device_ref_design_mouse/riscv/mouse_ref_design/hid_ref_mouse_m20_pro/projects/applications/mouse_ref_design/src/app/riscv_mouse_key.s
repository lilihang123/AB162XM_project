...
.L6:
	...
	lw	a0,0(sp)
.LVL6:
	lw	a2,new_keys_status_record
	call	riscv_mkey_ir_ctrl__ir_key_check
.LVL7:
	.loc 1 145 1
	lw	ra,20(sp)
	.cfi_remember_state
...
.LVL40:
	...
	.cfi_offset 1, -4
	.loc 1 256 36
	call	riscv_mkey_ir_ctrl_delay
.LVL41:
	.loc 1 256 34 discriminator 1
	sw	a0,riscv_app+4,a5
...
.LVL45:
	...
	.cfi_offset 1, -4
	.loc 1 300 5
	call	riscv_mkey_ir_ctrl_post_process
.LVL46:
...
.LVL61:
	.loc 1 355 5
	.loc 1 362 5
	tail	riscv_mkey_ir_ctrl__app_state_update
.LVL62:
	.cfi_endproc
.LFE27:
...
.LFB29:
	...
	.loc 1 412 5
	call	riscv_mkey_ir_ctrl_debug_print
.LVL63:
...
.LFE30:
	...
	.section	.text.riscv_mouse_key__notify_cm33_key_status,"ax",@progbits
	.align	1
	.globl	riscv_mouse_key__notify_cm33_key_status
	.hidden	riscv_mouse_key__notify_cm33_key_status
	.type	riscv_mouse_key__notify_cm33_key_status, @function
riscv_mouse_key__notify_cm33_key_status:
.LFB31:
...
.LVL69:
	...
	.cfi_offset 1, -4
	.loc 1 447 9
	call	peripheral_sampling__check_condiction
.LVL70:
	lla	s1,new_keys_status_record
...
.LVL71:
	...
	mv	a1,s0
	li	a0,0
	call	hid_express__push_to_key_queue
.LVL72:
.L74:
	.loc 1 456 5
...
.LVL73:
	...
	.cfi_endproc
.LFE31:
	.size	riscv_mouse_key__notify_cm33_key_status, .-riscv_mouse_key__notify_cm33_key_status
...
.Letext0:
	...
	.file 17 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_mouse_key_ir_ctrl.h"
	.file 18 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_key_queue_mouse.h"
	.file 19 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express.h"
	.file 20 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint_internal.h"
	.file 21 "/workdir/airoha/common/drivers/chip/ab162x/inc/air_chip.h"
