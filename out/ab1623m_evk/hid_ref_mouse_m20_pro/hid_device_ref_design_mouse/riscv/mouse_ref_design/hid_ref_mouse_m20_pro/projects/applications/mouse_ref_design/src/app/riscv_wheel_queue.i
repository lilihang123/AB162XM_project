# 0 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c"
# 38 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c"
...
# 39 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c" 2
...
# 40 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c" 2
...
# 66 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c" 3 4
_Bool 
# 66 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c"
    riscv_wheel_queue_is_full()
{
    return ((wheel_q_Ctrl.buf_head + 1) & ((1<<3) - 1)) == wheel_q_Ctrl.buf_tail;
}


# 71 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c" 3 4
_Bool 
# 71 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_wheel_queue.c"
...
void riscv_wheel_queue_push(int16_t wheel_data)
{
    if (riscv_wheel_queue_is_full()) {
        do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "riscv_wheel_queue_push - Queue is full"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (0)); } while (0);
        return;
    }
    ...
    if(wheel_data != 0)
    {
        ...
        wheel_q_Ctrl.buf_head = (wheel_q_Ctrl.buf_head + 1) & ((1<<3) - 1);
    }
}
...
void riscv_wheel_queue_pop(int16_t* num)
{
    if(!riscv_wheel_queue_is_empty())
    {
        *num = wheel_q_Ctrl.buffer[wheel_q_Ctrl.buf_tail];
        wheel_q_Ctrl.buf_tail = (wheel_q_Ctrl.buf_tail + 1) & ((1<<3) - 1);
    }
    else {
        *num = 0;
    }
