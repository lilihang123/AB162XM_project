# 0 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
# 38 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
...
# 39 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 40 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 41 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_ccni.h" 1
# 38 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_ccni.h"
...
# 39 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_ccni.h" 2
...
# 42 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/rv_application.h"
...
# 45 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 48 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 50 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 51 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 53 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 55 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 56 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
# 58 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
...
void hid_express_bt_debug_print();
# 61 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 2
# 76 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
uint32_t last_app_state = APP_STATE_NONE;

extern 
# 78 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
      _Bool 
# 78 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
...
uint8_t risv_app_sleep_lock_status = 
# 84 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                    0
# 84 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                         ;

void rv_sleep_lock_request(uint32_t lock)
{
    hal_sleep_manager_status_t ret=0;

    if (lock && (risv_app_sleep_lock_status == 
# 90 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                               0
# 90 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                                    )) {
        risv_app_sleep_lock_status = lock;
        ret = hal_sleep_manager_lock_sleep(SLEEP_LOCK_APP);
    }
    else if ((lock == 
# 94 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                     0
# 94 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                          ) && risv_app_sleep_lock_status){
        risv_app_sleep_lock_status = lock;
        ret = hal_sleep_manager_unlock_sleep(SLEEP_LOCK_APP);
    }

    do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "rv_sleep_lock_request, lock req = %d, risv_app_sleep_lock_status = %d, ret = %d"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (3), lock , risv_app_sleep_lock_status , ret); } while (0)
...
void hal_ccni_event_callback3(hal_ccni_event_t event, hal_ccni_message_t *msg)
{
    g_riscv_ccni_irq_occur = 
# 110 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                            1
# 110 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                ;
    uint8_t * raw_msg = (uint8_t *)msg;

    switch(raw_msg[0])
    {
        case HID_CCNI_MSG_APP_STATE:
        {
            uint32_t app_state = (msg->data[0] >> 8) & 0x000000FF;
            do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "======== app_state = 0x%x"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (1), app_state); } while (0);
            riscv_mouse_key_change_state(app_state);
            switch(app_state)
            {
                case APP_STATE_STANDBY:
                {
                    rv_sleep_lock_request(
# 124 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         0
# 124 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                              );
                }
                break;
                ...
                {
                    hid_common_clear_hid_exp_flag(9);

                    hid_experss_bt_clear_queue();

                    rv_sleep_lock_request(
# 134 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 134 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 151 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 151 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 157 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 157 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                ...
                {
                    rv_sleep_lock_request(
# 174 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 174 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                ...
                {
                    rv_sleep_lock_request(
# 182 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 182 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 189 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 189 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 195 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 195 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                    peripheral_sampling_state_change_active();
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 202 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 202 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 218 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 218 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 223 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 223 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                    peripheral_sampling_state_change_active();
                }
                break;
                ...
                {
                    rv_sleep_lock_request(
# 234 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                         1
# 234 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                             );
                }
                break;
        ...
        case HID_CCNI_MSG_FAKE_REPORT_ENABLE:
        {
            rv_fake_report_config(raw_msg[1], raw_msg[2], *(uint32_t*)&raw_msg[3]);
        }
        break;



        case HID_CCNI_MSG_KEY_REMAP_CONFIG:
        {
        ...
        case HID_CCNI_MSG_FAKE_REPORT_CONFIG:
        {
            uint32_t ptr_val;
        ...
        {
            hid_experss_bt_set_attr_handle(raw_msg[1], raw_msg[2], raw_msg[3]);
        }
        break;
        ...
        case HID_CCNI_MSG_WAKEUP_KEY:
        {
            ...
            else
            {
                ...
                hid_express__push_to_key_queue(K_TYPE_K, riscv_mouse_key_id_to_key_status(raw_msg[1]));
            }
        }
        break;

        case HID_CCNI_MSG_KEY:
        {

            hid_express__push_to_key_queue((raw_msg[1]), (*(uint32_t*)&raw_msg[2]));
        }
        break;

        case HID_CCNI_MSG_USB_PLUG_OUT:
        {
            peripheral_sampling_state_change_active();
        }
        break;
...
void riscv_app_ccin_init()
{
    hal_ccni_unmask_event(((HAL_CCNI_CORE_MCU<<24)|(HAL_CCNI_CORE_RISCV<<16)|HAL_CCNI_EVENT3));
}
...
hal_ccni_status_t riscv_app_ccin_send(uint8_t* payload, uint8_t len)
{
    ...
    if ((len > 8) || (payload == 
# 351 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c" 3 4
                                ((void *)0)
# 351 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
                                    )) {
    ...
    status = hal_ccni_set_event(((HAL_CCNI_CORE_RISCV<<24)|(HAL_CCNI_CORE_MCU<<16)|HAL_CCNI_EVENT3), &msg);

    if(status == HAL_CCNI_STATUS_BUSY)
    {
        uint16_t retry_cnt = 0;
        uint32_t data = HAL_CCNI_EVENT_STATUS_BUSY;
        while((data == HAL_CCNI_EVENT_STATUS_BUSY) && (retry_cnt < 1000)){
            retry_cnt++;
            hal_ccni_query_event_status(((HAL_CCNI_CORE_RISCV<<24)|(HAL_CCNI_CORE_MCU<<16)|HAL_CCNI_EVENT3), &data);
        }
        if( ((retry_cnt < 1000) && "Error : RISC-V busy for too long") == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "(retry_cnt < MAX_CCNI_STATUS_RETRY_CNT) && \"Error : RISC-V busy for too long\""; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"; light_assert(exp, file, 367); };
...
# 400 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_ccni.c"
void riscv_app_ccni_key_remap_send(uint32_t status, uint32_t attribute)
{
    uint8_t msg[5];
    msg[0] = HID_CCNI_MSG_KEY_REMAP_TRIGGER;
    msg[1] = status;
    msg[2] = attribute & 0xFF;
    msg[3] = attribute >> 8 & 0XFF;
    msg[4] = attribute >> 16;
