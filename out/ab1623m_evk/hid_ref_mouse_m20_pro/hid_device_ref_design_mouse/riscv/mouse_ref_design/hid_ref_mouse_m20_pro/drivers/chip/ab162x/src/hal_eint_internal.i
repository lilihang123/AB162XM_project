# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c"
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c"
...
# 414 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h"
                                                                        toggle);
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c" 2



# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 47 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c" 2
# 56 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c"
typedef struct {
    uint8_t max_ms;
    uint8_t prescaler;
    uint16_t clock;
...
__attribute__((section(".tcm_rwdata" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c\"" "." "73"))) EINT_REGISTER_T *EINT_REGISTER = (EINT_REGISTER_T *)0x42140000;
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c\"" "." "83"))) __attribute__ ((noinline)) uint32_t eint_get_status(uint32_t index)
{
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c\"" "." "91"))) __attribute__ ((noinline)) uint32_t eint_get_event(uint32_t index)
{
    if (index > (HAL_EINT_NUMBER_MAX >> 5)) {
        return 0xFFFFFFFF;
    }
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c\"" "." "99"))) __attribute__ ((noinline)) void eint_ack_interrupt(uint32_t eint_number)
{
    uint32_t reg_index;
    uint32_t reg_shift;
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c\"" "." "110"))) __attribute__ ((noinline)) void eint_ack_wakeup_event(uint32_t eint_number)
{
    uint32_t reg_index;
    uint32_t reg_shift;
...
uint32_t eint_caculate_debounce_time(uint32_t ms)
{
    ...
    for (i = 0; i < 6; i++) {
        if (ms <= eint_deb_table[i].max_ms) {
            ...
            count = (((ms*eint_deb_table[i].clock)+500)/1000);
            break;
        }
    }

    count = (count | (0x1UL << (16)) |
             ((0x7UL << (12)) & (prescaler << (12))));
    return count;
}

__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint_internal.c\"" "." "140"))) __attribute__ ((noinline)) void hal_eint_isr(uint8_t index)
{
    uint32_t i;
    uint32_t reg_index;
    uint32_t eint_index;
