# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 2
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 2
...
UART_REGISTER_T *const g_uart_regbase[] = {((UART_REGISTER_T *)(0x42240000)), ((UART_REGISTER_T *)(0x42250000)), ((UART_REGISTER_T *)(0x42260000))};




const uint8_t g_uart_port_to_irq_num[] = {17, 17, 17};

# 53 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
_Bool 
# 53 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
    volatile g_uart_receive_break_single_status[HAL_UART_MAX] = {
# 53 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                                                 0
# 53 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                                                      , 
...
void uart_dma_channel_to_callback_data(vdma_channel_t dma_channel, uart_dma_callback_data_t *user_data)
{
    switch (dma_channel) {
        case VDMA_UART0RX:
            user_data->is_rx = 
# 59 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                              1
# 59 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                  ;
            user_data->uart_port = HAL_UART_0;
            break;
        case VDMA_UART1RX:
            user_data->is_rx = 
# 63 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                              1
# 63 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                  ;
            user_data->uart_port = HAL_UART_1;
            break;
        case VDMA_UART2RX:
            user_data->is_rx = 
# 67 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                              1
# 67 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                  ;
            user_data->uart_port = HAL_UART_2;
            break;
        case VDMA_UART0TX:
            user_data->is_rx = 
# 71 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                              0
# 71 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                   ;
            user_data->uart_port = HAL_UART_0;
            break;
        case VDMA_UART1TX:
            user_data->is_rx = 
# 75 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                              0
# 75 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                   ;
            user_data->uart_port = HAL_UART_1;
            break;
        case VDMA_UART2TX:
            user_data->is_rx = 
# 79 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                              0
# 79 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                   ;
            user_data->uart_port = HAL_UART_2;
            break;
        default:
...
void uart_enable_dma(UART_REGISTER_T *uartx)
{
    uartx->DMA_CON_UNION.DMA_CON_CELLS.TX_DMA_EN = (0x1<<(0));
    uartx->DMA_CON_UNION.DMA_CON_CELLS.RX_DMA_EN = (0x1<<(0));
}
...
void uart_interrupt_handler(uint8_t irq_number)
{
    ...
    UART_REGISTER_T *uartx = ((UART_REGISTER_T *)(0x42240000));
# 112 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
    if(irq_number==17)
    {
    ...
    switch (type) {
        ...
        case UART_INTERRUPT_RECEIVE_TIMEOUT:
            uart_receive_handler(uart_port, 
# 127 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                           1
# 127 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                               );
            break;
        ...
        case UART_INTERRUPT_RECEIVE_BREAK:
            g_uart_receive_break_single_status[uart_port] = 
# 145 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                                           1
# 145 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                                               ;
            uart_break_signal_handler(uart_port);
            break;

        case UART_INTERRUPT_SEND_EMPTY:
            uart_send_handler(uart_port, 
# 150 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                        1
# 150 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                            );
...
void uart_set_baudrate(UART_REGISTER_T *uartx, uint32_t actual_baudrate)
{
    ...
    uartx->SAMPLE_REG_UNION.SAMPLE_REG_CELLS.SPEED= (0x3<<(0));

    uartx->FRACDIV = fraction_mapping[fraction];

    if ((actual_baudrate >= 3000000) && (actual_baudrate != 8666000)) {
        uartx->LCR_UNION.LCR_CELLS.GUARD = 0x12;
    }

    if (actual_baudrate == 8666000) {
        uartx->LCR_UNION.LCR_CELLS.GUARD = 0x11;
    }
}
...
{
# 270 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
}
...
void uart_set_hardware_flowcontrol(UART_REGISTER_T *uartx)
{
    ...
    uartx->MCR_UNION.MCR_CELLS.RTS = (0x1<<(0));
    uartx->EFR_UNION.EFR_CELLS.HW_FLOW_CONT = ((0x1<<(1)) |
                                               (0x1<<(0)));
...
void uart_set_software_flowcontrol(UART_REGISTER_T *uartx,
                                   ...
                                   uint8_t escape_character)
{
    uartx->XON_XOFF_UNION.XON_XOFF = (xon << (8)) |
                                     (xoff << (0));
    uartx->ESCAPE_REG_UNION.ESCAPE_REG = (0x1 << (8)) |
                                         (escape_character << (0));
    uartx->EFR_UNION.EFR_CELLS.SW_FLOW_CONT = ((0x1<<(1)) |
                                               (0x1<<(0)));
...
void uart_unmask_send_interrupt(UART_REGISTER_T *uartx)
{
    uartx->IER_UNION.IER_CELLS.ETSEI_ETBEI = (0x1<<(1));
}

void uart_mask_send_interrupt(UART_REGISTER_T *uartx)
{
    uartx->IER_UNION.IER_CELLS.ETSEI_ETBEI = ~((0x1<<(0)) | (0x1<<(1)));
}

void uart_unmask_receive_interrupt(UART_REGISTER_T *uartx)
{
    uartx->IER_UNION.IER_CELLS.ELSI_ERBFI = ((0x1<<(1)) | (0x1<<(0)));
}
...
void uart_unmask_dead_interrupt(UART_REGISTER_T *uartx)
{
    uartx->IER_UNION.IER_CELLS.DETCI_XOFFI |= (0x1<<(1));
}
...
void uart_set_auto_baudrate(UART_REGISTER_T *uartx, 
# 583 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                                   _Bool 
# 583 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                                        is_enable, uint32_t current_baudrate)
{
    if (is_enable) {
        ...
        uartx->DLM_DLL = 32000000 / current_baudrate / 16;
...
# 629 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
_Bool 
# 629 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
    uart_query_rx_empty(hal_uart_port_t uart_port)
{
    ...
    if ((uartx->LSR) & (0x1<<(0))) {
        return 
# 634 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
              0
# 634 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                   ;
    } else {
        return 
# 636 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
              1
# 636 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                  ;
    }
}


# 640 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
_Bool 
# 640 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
    uart_query_tx_empty(hal_uart_port_t uart_port)
{
    UART_REGISTER_T *uartx;
    uartx = g_uart_regbase[uart_port];
    if ((uartx->LSR) & (0x1<<(6))) {
        return 
# 645 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
              1
# 645 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                  ;
    } else {
        return 
# 647 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
              0
# 647 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                   ;
    }
}

void uart_send_xon_xoff(hal_uart_port_t uart_port, 
# 651 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                                  _Bool 
# 651 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                                       snd_xon, 
# 651 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c" 3 4
                                                                _Bool 
# 651 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_uart_internal.c"
                                                                     snd_xoff)
{
    ...
    if (snd_xon) {
        uartx->EFR_UNION.EFR_CELLS.SW_FLOW_CONT = 0x01;
        uartx->EFR_UNION.EFR_CELLS.SEND_XON = (0x1<<(0));
        uartx->EFR_UNION.EFR_CELLS.SW_FLOW_CONT = ((0x1<<(1)) | (0x1<<(0)));
    } else if (snd_xoff) {
        uartx->EFR_UNION.EFR_CELLS.SW_FLOW_CONT = 0x01;
        uartx->EFR_UNION.EFR_CELLS.SEND_XOFF = (0x1<<(0));
        uartx->EFR_UNION.EFR_CELLS.SW_FLOW_CONT = ((0x1<<(1)) | (0x1<<(0)));
    }
}
