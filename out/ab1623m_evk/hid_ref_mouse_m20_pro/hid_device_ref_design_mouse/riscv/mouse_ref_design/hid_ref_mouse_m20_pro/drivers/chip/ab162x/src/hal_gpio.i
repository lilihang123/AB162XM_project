# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_gpio.h" 2
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 2
...
GPIO_BASE_REGISTER_T *gpio_base = (GPIO_BASE_REGISTER_T *)(0x420b0000);
GPIO_CFG0_REGISTER_T *gpio_cfg0 = (GPIO_CFG0_REGISTER_T *)(0x420c0000);
GPIO_CFG1_REGISTER_T *gpio_cfg1 = (GPIO_CFG1_REGISTER_T *)(0x420d0000);
...
hal_gpio_status_t hal_gpio_set_direction(hal_gpio_pin_t gpio_pin, hal_gpio_direction_t gpio_direction)
{
    ...
    reg_num = gpio_pin / 32;
    index_num = gpio_pin % 32;

    if (gpio_direction == HAL_GPIO_DIRECTION_INPUT) {
        gpio_base->GPIO_DIR_CLR[reg_num] = (0x1 << index_num);
    } else {
        gpio_base->GPIO_DIR_SET[reg_num] = (0x1 << index_num);
    }
...
hal_gpio_status_t hal_gpio_get_direction(hal_gpio_pin_t gpio_pin, hal_gpio_direction_t *gpio_direction)
{
    ...
    if (
# 116 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
       ((void *)0) 
# 116 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
            == gpio_direction) {
    ...
    if (gpio_base->GPIO_DIR[reg_num] & (0x1 << index_num)) {
...
# 132 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
_Bool 
# 132 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
    pmu_in_signal_function_check(hal_gpio_pin_t gpio_pin, uint8_t function_index)
{
    ...
    switch (function_index) {
        ...
        default:
            return 
# 147 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
                  0
# 147 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
                       ;
    }
...
# 153 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
_Bool 
# 153 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
    g_cfg_function_check(hal_gpio_pin_t gpio_pin, uint8_t function_index)
{
    switch (function_index)
    {
        case 11:
        ...
        default:
            return 
# 164 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
                  0
# 164 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
                       ;
    }
}
...
hal_gpio_status_t hal_gpio_set_analog_mode(hal_gpio_pin_t gpio_pin)
{
    ...
    io_cfg_base = (gpio_pin <= 22) ? 0x420c0000 : 0x420d0000;
    shift = (gpio_pin <= 22) ? gpio_pin : (gpio_pin - 23);

    (*((volatile uint32_t*)(io_cfg_base + 0x30 + 0x8))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_clear_analog_mode(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x30 + 0x4))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_set_rtc_in_en(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + reg_shift + 0x4))) = 1 << bit_shift;
...
hal_gpio_status_t hal_gpio_clear_rtc_in_en(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + reg_shift + 0x8))) = 1 << bit_shift;
...
hal_pinmux_status_t hal_pinmux_set_function(hal_gpio_pin_t gpio_pin, uint8_t function_index)
{
 ...
 io_cfg_base = (gpio_pin <= 22) ? 0x420c0000 : 0x420d0000;
    ...
    if(function_index <= 13) {
        ...
        remainder = gpio_pin % 8;

        gpio_base->GPIO_MODE_CLR[reg_num] = (0xF << (remainder * 4));
        gpio_base->GPIO_MODE_SET[reg_num] = (function_index << (remainder * 4));


        shift = gpio_cfg_table[gpio_pin].rtc_gpio_mode_reg_shift;
        if (shift != 0xFF) {
            (*((volatile uint32_t*)((io_cfg_base + gpio_cfg_table[gpio_pin].rtc_gpio_mode_reg) + 0x8))) = (0x3) << shift;
        }
        ...
        if (shift != 0xFF) {
            ...
            {
                (*((volatile uint32_t*)((0x420d0000 + gpio_cfg_table[gpio_pin].rtc_gpio_mode_reg) + 0x8))) = (0x3) << shift;
                (*((volatile uint32_t*)((0x420d0000 + gpio_cfg_table[gpio_pin].rtc_gpio_mode_reg) + 0x4))) = (0x1) << shift;
            } else {
                (*((volatile uint32_t*)((io_cfg_base + gpio_cfg_table[gpio_pin].rtc_gpio_mode_reg) + 0x8))) = (0x3) << shift;
                (*((volatile uint32_t*)((io_cfg_base + gpio_cfg_table[gpio_pin].rtc_gpio_mode_reg) + 0x4))) = (function_index - 13) << shift;
            }
        }
    }
...
hal_gpio_status_t hal_gpio_get_input(hal_gpio_pin_t gpio_pin, hal_gpio_data_t *gpio_data)
{
    ...
    if (
# 318 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
       ((void *)0) 
# 318 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
            == gpio_data) {
        return HAL_GPIO_STATUS_INVALID_PARAMETER;
    }
    ...
    if (gpio_base->GPIO_DIN[reg_num] & (0x1 << index_num)) {
...
hal_gpio_status_t hal_gpio_get_output(hal_gpio_pin_t gpio_pin, hal_gpio_data_t *gpio_data)
{
    ...
    if (
# 367 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
       ((void *)0) 
# 367 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
            == gpio_data) {
        return HAL_GPIO_STATUS_INVALID_PARAMETER;
    }
    ...
    if (gpio_base->GPIO_DOUT[reg_num] & (0x1 << index_num)) {
        *gpio_data = HAL_GPIO_DATA_HIGH;
    } else {
        *gpio_data = HAL_GPIO_DATA_LOW;
    }
...
hal_gpio_status_t hal_gpio_set_rsel_register(hal_gpio_pin_t gpio_pin, uint8_t gpio_rsel0, uint8_t gpio_rsel1)
{
    ...
    io_cfg_base = (gpio_pin <= 22) ? 0x420c0000 : 0x420d0000;
    rsel_shift = ((gpio_pin == 4) || (gpio_pin == 38)) ? 0 : 2;

    (*((volatile uint32_t*)(io_cfg_base + 0x80 + shift_addr[gpio_rsel0 ? 1 : 0]))) = rsel_shift;
    (*((volatile uint32_t*)(io_cfg_base + 0x80 + shift_addr[gpio_rsel1 ? 1 : 0]))) = rsel_shift << 1;
...
hal_gpio_status_t hal_gpio_pull_up(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x50 + 0x8))) = 1 << shift;
    (*((volatile uint32_t*)(io_cfg_base + 0x70 + 0x4))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_pull_down(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x70 + 0x8))) = 1 << shift;
    (*((volatile uint32_t*)(io_cfg_base + 0x50 + 0x4))) = 1 << shift;
...
# 536 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
hal_gpio_status_t hal_gpio_set_schmitt(hal_gpio_pin_t gpio_pin)
{
    uint8_t shift;
    uint32_t io_cfg_base;
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x90 + 0x4))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_clear_schmitt(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x90 + 0x8))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_set_slew_rate(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0xA0 + 0x4))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_clear_slew_rate(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0xA0 + 0x8))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_set_high_impedance(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x40 + 0x8))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_clear_high_impedance(hal_gpio_pin_t gpio_pin)
{
    ...
    (*((volatile uint32_t*)(io_cfg_base + 0x40 + 0x4))) = 1 << shift;
...
hal_gpio_status_t hal_gpio_set_capacitance(hal_gpio_pin_t gpio_pin, hal_gpio_capacitance_t cap)
{
    ...
    io_cfg_base = (gpio_pin <= 22) ? 0x420c0000 : 0x420d0000;
    shift = ((gpio_pin == 4) || (gpio_pin == 38)) ? 0 : 4;

    (*((volatile uint32_t*)(io_cfg_base + 0x20 + 0x8))) = 0x7 << shift;
    (*((volatile uint32_t*)(io_cfg_base + 0x20 + 0x4))) = ((cap << 1) | 0x1) << shift;
...
hal_gpio_status_t hal_gpio_set_driving_current(hal_gpio_pin_t gpio_pin, hal_gpio_driving_current_t driving)
{
    ...
    temp = (*((volatile uint32_t*)(io_cfg_base + gpio_cfg_table[gpio_pin].drv_reg)));
    temp &= ~(0x7 << shift);
    temp |= (driving << shift);
    (*((volatile uint32_t*)(io_cfg_base + gpio_cfg_table[gpio_pin].drv_reg))) = temp;
...
hal_gpio_status_t hal_gpio_get_input_by_mask(gpio_data_in_mask_t *inout_data_mask)
{
    uint32_t mask;
    if (
# 788 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c" 3 4
       ((void *)0) 
# 788 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio.c"
            == inout_data_mask) {
        return HAL_GPIO_STATUS_INVALID_PARAMETER;
    }
