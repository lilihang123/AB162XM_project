# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c"
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c"
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2

# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h" 1
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint_internal.h" 1
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2
...
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2
...
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_comparator.c" 2
...
void hal_comparator_analog_power_on(void)
{
    ...
    *((volatile uint32_t *)(0x42108008)) = 0x01120953;
}

void hal_comparator_analog_power_off(void)
{

    *((volatile uint32_t *)(0x42108008)) = 0x01120000;
}

void hal_comparator_analog_reset(void)
{

    *((volatile uint32_t *)(0x42108008)) = 0x01130000;

    *((volatile uint32_t *)(0x42108008)) = 0x01150000;

    *((volatile uint32_t *)(0x42108008)) = 0x01160000;

    *((volatile uint32_t *)(0x42108008)) = 0x01170000;

    *((volatile uint32_t *)(0x42108008)) = 0x01180000;


    *((volatile uint32_t *)(0x42080060)) = 0x00000000;

    *((volatile uint32_t *)((0x42080060 +0x4))) = 0x00000000;

    *((volatile uint32_t *)((0x42080060 +0x8))) = 0x00000000;

    *((volatile uint32_t *)((0x42080060 +0xc))) = 0x00000000;
}
...
void hal_comparator_analog_int_ref_on(hal_comparator_inter_ref_cfg_t internal_ref_cfg)
{
    ...
    *((volatile uint32_t *)(0x42108008)) = (ref_val);
}
...
void hal_comparator_analog_comp1_init(hal_comparator_cfg_t *comp_cfg)
{
    ...
    *((volatile uint32_t *)(0x42108008)) = (comp1_mode_value);
    g_comp1_mode_reg_value = comp1_mode_value;

    uint32_t input_gpio_mask = ((comp_cfg->input_gpio) <<((8)));
    uint32_t ref_in_gpio_mask = ((comp_cfg->ref_in_gpio) <<((0)));
    uint32_t ref_sel_mask = ((comp_cfg->ref_sel) <<((12)));
    uint32_t ladder_ref_sel_mask =((comp_cfg->ladder_ref_sel) <<((14)));
    ...
    if((comp_cfg->mode)>HAL_COMP_SE_MODE_MAX)
    {
        ...
        *((volatile uint32_t *)(0x42108008)) = (ref_in_mask);

        uint8_t rladder_value = comp_cfg->vup_rladder_value;
        *((volatile uint32_t *)(0x42108008)) = (0x01170000);
        *((volatile uint32_t *)(0x42108008)) = (0x01180000 | ((rladder_value) << (0)));
    }else
    {
        ...
        *((volatile uint32_t *)(0x42108008)) = ( (0x01170000) | ((rladder_value_vdn) << (8)));
        *((volatile uint32_t *)(0x42108008)) = (0x01180000 | ((rladder_value_vup) << (0)));
    }
}
...
void hal_comparator_analog_comp2_init(hal_comparator_cfg_t *comp_cfg)
{
    ...
    uint32_t ref_in_gpio_mask=((0x00003100) | ((comp_cfg->ref_in_gpio) <<((4))));
    uint32_t input_gpio_mask = ((comp_cfg->input_gpio) <<((0)));
    uint32_t ref_sel_mask = ((comp_cfg->ref_sel) <<((4)));
    uint32_t ladder_ref_sel_mask =((comp_cfg->ladder_ref_sel) <<((8)));
    uint32_t ref_in_mask = (input_gpio_mask | ref_sel_mask | ladder_ref_sel_mask);

    *((volatile uint32_t *)(0x42080060)) = comp2_mode_value;
    g_comp2_mode_reg_value = comp2_mode_value;

    if((comp_cfg->mode)>HAL_COMP_SE_MODE_MAX)
    {
        *((volatile uint32_t *)((0x42080060 + 0x4))) = (ref_in_gpio_mask);

        *((volatile uint32_t *)((0x42080060 + 0x8))) = (ref_in_mask);

        uint32_t vup_mask = ((comp_cfg -> vup_rladder_value) << (8));
        *((volatile uint32_t *)((0x42080060 + 0xc))) = (vup_mask);
    }else
    {
        ref_in_gpio_mask = (0x00000001 | ((comp_cfg->ref_in_gpio) <<((4))));
        *((volatile uint32_t *)((0x42080060 + 0x4))) = (ref_in_gpio_mask);

        uint32_t ref_sel_mask = ((HAL_REF_V_SEL_RLADDER) <<((4)));
        uint32_t ref_in_mask = (input_gpio_mask | ref_sel_mask | ladder_ref_sel_mask);
        *((volatile uint32_t *)((0x42080060 + 0x8))) = (ref_in_mask);


        uint32_t vup_mask = ((comp_cfg -> vup_rladder_value) << (8));
        uint32_t vdn_mask = ((comp_cfg -> vdn_rladder_value) << (0));
