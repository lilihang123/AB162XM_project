# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_ramboz.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_ramboz.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_ramboz.h" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_ramboz.h" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_ramboz.h" 2
...
typedef enum
{
  HAL_RAMBOZ_DIRECTION_0 = 0x0,
  HAL_RAMBOZ_DIRECTION_1 = 0x1
} hal_ramboz_direction_t;

typedef enum
{
  HAL_RAMBOZ_MODE_8CNT = 0x0,
  HAL_RAMBOZ_MODE_5CNT = 0x1
} hal_ramboz_mode_t;

typedef enum
{
  HAL_RAMBOZ_FAST_SAMPLE = 0x0,
  HAL_RAMBOZ_SLOW_SAMPLE = 0x1
} hal_ramboz_sample_mode_t;

typedef enum
{
  HAL_RAMBOZ_READ_DATA_BY_IRQ= 0x0,
  HAL_RAMBOZ_READ_DATA_BY_NEXT_CYCLE = 0x1
...
typedef enum
{
  HAL_RAMBOZ_STATUS_ERROR = -2,
  HAL_RAMBOZ_INVALID_PARAMETER = -1,
  HAL_RAMBOZ_STATUS_OK = 0
} hal_ramboz_status_t;
...
typedef enum
{
  HAL_RAMBOZ_WAKEUP_EVENT_Z_CNT = 0,
  HAL_RAMBOZ_WAKEUP_EVENT_RAMBO_CNT = 1,
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 2




static volatile HW_RAMBZ_REGISTER_T *const ramboz_register = (HW_RAMBZ_REGISTER_T *)(0x42102000);

void (*ramboz_callback)(uint8_t irq_type) = 
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                                           ((void *)0)
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                               ;
...
static void hw_ramboz_Isr_zephyr(void)
{
    ...
    {
        if (ramboz_callback!=
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                            ((void *)0)
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                )
        {
    ...
    else if(irq_status & (0x1 << (0)))
    {
        if (ramboz_callback!=
# 66 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                            ((void *)0)
# 66 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                )
        {
    ...
    }else if(irq_status & (0x1 << (2)))
    {
        if (ramboz_callback!=
# 77 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                            ((void *)0)
# 77 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                )
        {
...
static hal_ramboz_status_t hal_ramboz_init_para_check(hal_ramboz_config_t *ramboz_cfg)
{
    ...
    if ((filter_period > 0xF) || (fast_sample_period > 0xFFF) || (low_sample_period > 0xFFF) ||
        (fast_roll_period > 0xFFF))
    {
        return HAL_RAMBOZ_INVALID_PARAMETER;
    }
...
{
# 139 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
}
...
hal_ramboz_status_t hal_ramboz_init(hal_ramboz_config_t *ramboz_cfg)
{
    ...
    hal_nvic_register_isr_handler(11, (void *)hw_ramboz_Isr_zephyr);
...
{
    if (callback == 
# 262 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                   ((void *)0)
# 262 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                       )
    {
...
static 
# 274 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
      _Bool 
# 274 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
           ramboz_available_data = 
# 274 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                                   0
# 274 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                        ;
hal_ramboz_status_t hal_ramboz_set_latch_clear()
{
        ...
        ramboz_register->RAMBOZ_Z_CNT_UNION.RAMBOZ_Z_CNT_CELLS.Z_CNT_LATCH_N_CLR = 0x01;
        ramboz_available_data = 
# 280 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                               1
# 280 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                   ;
        return HAL_RAMBOZ_STATUS_OK;
...
hal_ramboz_status_t hal_ramboz_get_data(int16_t *data)
{
    ...
    ramboz_available_data = 
# 294 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c" 3 4
                           0
# 294 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_ramboz.c"
                                ;
