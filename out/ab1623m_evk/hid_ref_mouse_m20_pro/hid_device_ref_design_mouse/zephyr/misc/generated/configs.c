...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_AIROHA_AIR_RGB_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AIR_RGB_REAL_TIME_FIFO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AIR_RGB_EFFECT_OVERWRITE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AIR_SLIDE_SWITCH_BT_MODE_PIN, 46);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AIR_SLIDE_SWITCH_GAMING_MODE_PIN, 47);
