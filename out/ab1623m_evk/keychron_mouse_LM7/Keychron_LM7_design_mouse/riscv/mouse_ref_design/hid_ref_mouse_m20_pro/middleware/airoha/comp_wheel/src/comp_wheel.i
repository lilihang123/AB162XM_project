# 0 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
# 36 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_comparator.h"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_platform.h" 1
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_comparator.h" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h" 1
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h"
...
# 43 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/inc/comp_wheel.h" 2
...
# 37 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c" 2
...
# 38 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c" 2


__attribute__ ((__section__(".log_filter." "comp_wheel"))) log_control_block_t log_control_block_comp_wheel = { "comp_wheel", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 40 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c" 3 4
((void *)0)
# 40 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
, 
# 40 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c" 3 4
((void *)0)
# 40 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
...
((void *)0)
# 40 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "comp_wheel"))) __attribute__((used)) const char log_control_block_mirror_comp_wheel[] = "comp_wheel";
...
static void comp_wheel_encoder_process_event(void)
{
    ...
    if(comp_wheel_encoder.callback != 
# 135 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c" 3 4
                                     ((void *)0)
# 135 "/workdir/airoha/risc-v/middleware/airoha/comp_wheel/src/comp_wheel.c"
                                         )
    {
...
static void comp_wheel_get_pin_value()
{
    ...
    if(pina_state != g_last_pina_state)
    {
        if(pina_state == 0)
        {
            *((volatile uint32_t *)(0x42108008)) = ( (0x01170000) | ((g_comp1_vup_rladder_value) << (8)));
        }else
        {
            *((volatile uint32_t *)(0x42108008)) = ( (0x01170000) | ((g_comp1_vdn_rladder_value) << (8)));
        }
    }
    ...
    if(pinb_state != g_last_pinb_state)
    {
        uint32_t vup_mask ;
        uint32_t vdn_mask;
        vup_mask = ((g_comp2_vup_rladder_value) << (8));
        if(pinb_state == 0)
        {
            vdn_mask = ((g_comp2_vdn_rladder_value) << (0));
        }else
        {
            vdn_mask = ((g_comp2_vup_rladder_value) << (0));
        }

        *((volatile uint32_t *)(0x42080060 + 0xc)) = ( (vup_mask | vdn_mask));
    }
