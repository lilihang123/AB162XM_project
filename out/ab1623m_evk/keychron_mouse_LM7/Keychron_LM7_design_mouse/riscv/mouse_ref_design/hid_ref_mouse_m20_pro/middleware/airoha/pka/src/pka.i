# 0 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
# 38 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
...
# 39 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2
...
# 40 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2
# 1 "/workdir/airoha/risc-v/kernel/service/syslog/inc/syslog.h" 1
# 43 "/workdir/airoha/risc-v/kernel/service/syslog/inc/syslog.h"
...
# 44 "/workdir/airoha/risc-v/kernel/service/syslog/inc/syslog.h" 2
# 1 "/workdir/airoha/risc-v/tools/toolchain/xpack-riscv-none-elf-gcc-13.2.0-2/lib/gcc/riscv-none-elf/13.2.0/include/stdarg.h" 1 3 4
# 45 "/workdir/airoha/risc-v/kernel/service/syslog/inc/syslog.h" 2
...
# 41 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2



# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 2




# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager.h" 1
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager.h"
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager.h" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 2
...
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_platform.h" 1
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 2
# 623 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
typedef enum {
...
# 677 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
typedef enum {
    HAL_SPI_MASTER_EVENT_SEND_FINISHED = 0,
    HAL_SPI_MASTER_EVENT_RECEIVE_FINISHED = 1,
    HAL_SPI_MASTER_NO_BUSY_FUNCTION_ERROR = 2,
} hal_spi_master_callback_event_t;



typedef enum {
    HAL_SPI_STATUS_FULL_BY_NON_BLOCKING_FUNCTION = -7,
    HAL_SPI_STATUS_ERROR_USED_BY_NORMAL_USER = -6,
    HAL_SPI_STATUS_BUSY_BY_NON_BLOCKING_FUNCTION = -5,
...
typedef enum {
    ...
    HAL_SPI_MASTER_IDLE = 0,
    HAL_SPI_MASTER_BUSY = 1
} hal_spi_master_running_status_t;
# 722 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
typedef void (*hal_spi_master_callback_t)(hal_spi_master_callback_event_t event, void *user_data);
# 734 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
typedef struct {
...
# 858 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_init(hal_spi_master_port_t master_port,
        hal_spi_master_config_t *spi_config);
# 870 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_deinit(hal_spi_master_port_t master_port);
# 894 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
...
# 915 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_send_polling(hal_spi_master_port_t master_port,
        uint8_t *data,
        uint32_t size);
# 935 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_send_dma(hal_spi_master_port_t master_port,
        uint8_t *data,
        uint32_t size);
# 953 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_send_dma_blocking(hal_spi_master_port_t master_port,
        uint8_t *data,
        uint32_t size);
# 983 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
...
# 1006 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_send_and_receive_dma(hal_spi_master_port_t master_port,
        hal_spi_master_send_and_receive_config_t *spi_send_and_receive_config);
# 1029 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_send_and_receive_dma_advanced(hal_spi_master_port_t master_port,
                                                            hal_spi_master_send_and_receive_config_t *spi_send_and_receive_config,
# 1030 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                                                                 _Bool 
# 1030 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                                                                      start);
...
# 1051 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_send_and_receive_dma_blocking(hal_spi_master_port_t master_port,
        hal_spi_master_send_and_receive_config_t *spi_send_and_receive_config);
# 1068 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
...
# 1084 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_delay_cnt(hal_spi_master_port_t master_port, uint16_t delay_cnt,uint8_t one_location_cnt,
# 1084 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                                                                   _Bool 
# 1084 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                                                                        is_multy);
# 1100 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_clear_data(hal_spi_master_port_t master_port, uint8_t cmd_cnt, 
# 1100 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                                         _Bool 
# 1100 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                                              is_high, 
# 1100 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
...
# 1100 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                                                            enable);
# 1113 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_bt_enable(hal_spi_master_port_t master_port, 
# 1113 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                       _Bool 
# 1113 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                            bt_enable);
# 1126 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_trigger_start(hal_spi_master_port_t master_port, 
# 1126 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                       _Bool 
# 1126 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                            start);
# 1138 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
 hal_spi_master_status_t hal_spi_enable_nvic_irq(hal_spi_master_port_t master_port,
# 1138 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                  _Bool 
# 1138 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                       enable);
# 1155 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_chip_select_timing(hal_spi_master_port_t master_port,
        hal_spi_master_chip_select_timing_t chip_select_timing);
# 1175 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_deassert(hal_spi_master_port_t master_port,
        hal_spi_master_deassert_t deassert);
# 1212 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_register_callback(hal_spi_master_port_t master_port,
        ...
        void *user_data);
# 1229 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_mode(hal_spi_master_port_t master_port,
        hal_spi_master_mode_t mode);
# 1243 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_dummy_bits(hal_spi_master_port_t master_port,
        uint8_t dummy_bits);
# 1257 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
hal_spi_master_status_t hal_spi_master_set_command_bytes(hal_spi_master_port_t master_port,
        uint8_t command_bytes);
# 1280 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
...
hal_spi_master_status_t hal_spi_master_send_and_receive_fifo_advanced(hal_spi_master_port_t master_port, hal_spi_master_send_and_receive_config_t *transfer_config, 
# 1283 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                                                                                                   _Bool 
# 1283 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                                                                                                        start);
hal_spi_master_status_t hal_spi_master_fifo_access(hal_spi_master_port_t master_port, 
# 1284 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 3 4
                                                                                     _Bool 
# 1284 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h"
                                                                                          is_write, uint32_t *data, uint32_t size);
# 45 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h" 1
# 41 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h"
# 1 "/workdir/airoha/risc-v/kernel/service/exception_handler/inc/assert.h" 1
# 43 "/workdir/airoha/risc-v/kernel/service/exception_handler/inc/assert.h"
...
# 38 "/workdir/airoha/common/drivers/chip/ab162x/../inc/hal_ccni.h"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_platform.h" 1
# 39 "/workdir/airoha/common/drivers/chip/ab162x/../inc/hal_ccni.h" 2
...
# 115 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h" 2
...
# 45 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h"
...
# 46 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h" 2
...
# 46 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2

# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h" 1
# 48 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2
# 1 "/workdir/airoha/risc-v/middleware/airoha/pka/inc/pka.h" 1
# 49 "/workdir/airoha/risc-v/middleware/airoha/pka/inc/pka.h"
...
# 80 "/workdir/airoha/risc-v/middleware/airoha/pka/inc/pka.h"
...
# 49 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 2
# 83 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
__attribute__ ((__section__(".log_filter." "riscv_pka"))) log_control_block_t log_control_block_riscv_pka = { "riscv_pka", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 83 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
((void *)0)
# 83 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
, 
# 83 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
...
((void *)0)
# 83 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "riscv_pka"))) __attribute__((used)) const char log_control_block_mirror_riscv_pka[] = "riscv_pka";
...
RiscVHid RiscVHID[(10)];
static uint8_t RiscVHidIdx = 0;
static uint8_t correction_idx = 0xFF;
# 123 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
...
static inline 
# 128 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
             _Bool 
# 128 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                  pka_share_OS_dlist_is_empty(
    pka_share_DLIST_STRU_PTR plist)
{
    ...
    pka_share_DLIST_HEAD_PTR head)
{
    if (!pka_share_OS_dlist_is_empty(head)) {
        ...
        return 
# 172 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
              ((void *)0)
# 172 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                  ;
    }
}
    ...
    pka_share_OSMQ_PTR mq_ptr)
{
    ...
    if( (mq_ptr != 
# 182 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
   ((void *)0)
# 182 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
   ) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "mq_ptr != NULL"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"; light_assert(exp, file, 182); };
    ...
    if (mq_ptr->noB > 0) {
        ...
        list_ptr = 
# 192 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                  ((void *)0)
# 192 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                      ;
    }

    if (list_ptr != 
# 195 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                   ((void *)0)
# 195 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                       ) {
        return list_ptr;
    } else {
        return 
# 198 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
              ((void *)0)
# 198 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                  ;
    }
}
...
{
    void* pGet =
# 209 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
               ((void *)0)
# 209 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                   ;
...
void pka_share_OSMQ_Put(pka_share_OSMQ_PTR mq_ptr, void *ptr)
{
    ...
    if( (mq_ptr != 
# 219 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
   ((void *)0)
# 219 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
   ) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "mq_ptr != NULL"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"; light_assert(exp, file, 219); };
    if( (ptr != 
# 220 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
   ((void *)0)
# 220 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
   ) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "ptr != NULL"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"; light_assert(exp, file, 220); };
...
void pka_share_OSMQ_PutFront(pka_share_OSMQ_PTR mq_ptr, void *ptr)
{
    ...
    if( (mq_ptr != 
# 234 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
   ((void *)0)
# 234 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
   ) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "mq_ptr != NULL"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"; light_assert(exp, file, 234); };
    if( (ptr != 
# 235 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
   ((void *)0)
# 235 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
   ) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "ptr != NULL"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"; light_assert(exp, file, 235); };
...
void pka_share_OSMQ_PrintList(pka_share_OSMQ_PTR mq_ptr) {
    ...
    while (head->next != &mq_ptr->head) {
        ...
        do { extern log_control_block_t log_control_block_riscv_pka; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_pka" " C:info F: L: ]: " "pka_share_OSMQ_PrintList, seqn = %02x"; print_module_msgid_log(&log_control_block_riscv_pka, (PRINT_LEVEL_INFO), (msg_id_string), (1), payload[14]); } while (0);
        head = list;
    }
}
...
void pka_share_OSMQ_PrintQueue(pka_share_OSMQ_PTR mq_ptr) {
    ...
    while (head->next != &mq_ptr->head) {
        ...
        uint8_t *ptr = (void*) list;
        uint8_t *payload = pka_share_tx_buf_get_payload(ptr);
        do { extern log_control_block_t log_control_block_riscv_pka; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_pka" " C:info F: L: ]: " "pka_share_OSMQ_PrintQueue, ptr = %02x, valid = %d, payload[9~14] = %02x %02x %02x %02x %02x %02x"; print_module_msgid_log(&log_control_block_riscv_pka, (PRINT_LEVEL_INFO), (msg_id_string), (8), ptr, ptr[0x8+0x9] & 0x80, payload[9], payload[10], payload[11], payload[12], payload[13], payload[14]); } while (0)
                                                                                                                  ;
        head = list;
    }
}
...
void pka_share_tx_buf_apply_to_HWMT()
{
    ...
    if (ptr == 
# 279 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
              ((void *)0)
# 279 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                  ) {
    ...
    uint32_t mask;
    do { hal_nvic_save_and_set_interrupt_mask(&mask); share_buffer_hw_semaphore_take(4); } while (0);


    uint8_t *pNextTxPtr0 = *pka_share_ptr->bt_info.le.NextTxPtr0;
    if (*pka_share_ptr->bt_info.le.POFlow_ptr == 1 && pNextTxPtr0 == 
# 289 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                                                                    ((void *)0)
# 289 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                                                                        ) {
        ...
        *pka_share_ptr->bt_info.le.NextTxPtr0 = ptr + pka_share_ptr->hid_tx_buf_queue_header_size;
        ...
        if (ptr == 
# 299 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                  ((void *)0)
# 299 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                      ) {



            do { share_buffer_hw_semaphore_give(4); hal_nvic_restore_interrupt_mask(mask); } while (0);
            return;
        }
    }

    uint8_t *pNextTxPtr1 = *pka_share_ptr->bt_info.le.NextTxPtr1;
    if (*pka_share_ptr->bt_info.le.POFlow_ptr == 1 && pNextTxPtr1 == 
# 309 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                                                                    ((void *)0)
# 309 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                                                                        ) {
...
void pka_share_tx_buf_ack_pending_check()
{
    ...
    for (i= pka_share_ptr->hid_tx_buf_ack_pending_queue.noB; i > 0; i--) {
        ...
        if (ptr != 
# 337 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                  ((void *)0)
# 337 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                      ) {
...
# 368 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
_Bool 
# 368 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
    pka_share_hid_need_accmulate(void)
{
    return ((*pka_share_ptr->hid_tx_status_ptr == 0) || (pka_tx_buf_is_hid(*pka_share_ptr->bt_info.rt.CurTxPtr) == 
# 370 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                                                                                                                  0
# 370 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                                                                                                                       ));
}
...
uint8_t pka_share_get_tx_status(void)
{
    ...
    return ((*pka_share_ptr->hid_tx_status_ptr == 1) || (pka_tx_buf_is_hid(*pka_share_ptr->bt_info.rt.CurTxPtr) == 
# 376 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
                                                                                                                  0
# 376 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
                                                                                                                       ));
}
...
void riscv_pka_le_tx_post_prepare_callback(uint8_t tx_cnt)
{
# 394 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
...
void riscv_pka_rtt_tx_post_prepare_callback(uint8_t tx_cnt)
{
# 436 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
    if (tx_cnt == 0) {
...
# 464 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
uint8_t pka_share_hwmt_get_rxhdr()
{
    return *(pka_share_ptr->bt_info.rt.hwmt_tpollgo_ptr - 4);
}
...
void pka_share_get_sync_clk(bttime_stru *sync_time)
{
    sync_time->period = (*(volatile uint32_t*)0xA0010410) >> 2;
    sync_time->phase = *(volatile uint32_t*)0xA0010414;
}
...
void pka_share_get_cur_pico_clk(bttime_stru_ptr time_ptr)
{
    ...
    do {
        native_clk.period = *(volatile uint32_t*)0xA0010008;
        native_clk.phase = *(volatile uint16_t*)0xA001000C;
    } while (native_clk.period != *(volatile uint32_t*)0xA0010008);
...
void riscv_pka_rt_tx_post_prepare_callback(uint8_t tx_cnt)
{
# 544 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
    if (pka_share_hwmt_get_curidx() == 0) {
        bttime_stru last_anchor, native_anchor, pico_offset;
        bttime_stru sync_time;
        
# 547 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c" 3 4
       _Bool 
# 547 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
            connsys_clk_domain = *((volatile uint32_t *)(0x42106010));
        uint32_t xo_pdn_top_cond0 = *((volatile uint32_t *)(0x4204000C));


        if (((connsys_clk_domain & 0x01) == (1)) || (xo_pdn_top_cond0 & (0x40))) {
            return;
        }
  ...
  pka_share_get_sync_clk(&sync_time);
        ...
        if (sync_time.period == 0) {
            do { extern log_control_block_t log_control_block_riscv_pka; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_pka" " C:info F: L: ]: " "[RISCV][HWM_SYNC] sync time null"; print_module_msgid_log(&log_control_block_riscv_pka, (PRINT_LEVEL_INFO), (msg_id_string), (0)); } while (0);
            return;
        }
...
# 650 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
        int32_t ref_offset = 0;
        uint8_t report_rate = pka_share_ptr->bt_info.rt.CurrentReportRate - 1;

        if (pka_share_ptr->bt_info.rt.TxRxDataRate == 2) {
            ref_offset = (report_rate == 5) ? (-260) : (-348);
        } else {
            if (report_rate == 6) {
                ref_offset = (-138);
            } else {
        ...
        if (report_rate == 6 ||
                (report_rate == 5 && pka_share_ptr->bt_info.rt.TxRxDataRate == 2) ||
            ...
            while (offset > (-138) + (10) && i < 8) {
                offset -= expslot_1[i];
                i++;
            }
        } else {
# 687 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
            while (offset > (-240) + (10) && i < 8) {
                offset -= expslot_2[i];
                i++;
            }
        }
# 700 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
        if (offset != ref_offset)
        {
            if((offset >= (ref_offset - (10))) &&
            (offset <= (ref_offset + (10)))) {
                if(((offset <= (ref_offset - (4))) || (offset >= (ref_offset + (4))))) {
        ...
        connsys_clk_domain = *((volatile uint32_t *)(0x42106010));
        xo_pdn_top_cond0 = *((volatile uint32_t *)(0x4204000C));
        if (((connsys_clk_domain & 0x01) == (1)) || (xo_pdn_top_cond0 & (0x40))) {
            return;
        }


        if (riscv_pka_info.pico_offset.phase != 0xFFFF)
        {
            if (riscv_pka_info.pico_offset.phase == *pka_share_ptr->bt_info.common.hwmt_pico_offset_phase_ptr){
                riscv_pka_info.pico_offset.phase = 0xFFFF;
            } else {
                uint32_t retru = 3;
                while (retru-- > 0) {
                ...
                correction_idx = 0xFF;
                record_riscV_info(sync_time.period, sync_time.phase, offset);
# 785 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
            }
        }
    ...
    ;
# 869 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
}
...
# 917 "/workdir/airoha/risc-v/middleware/airoha/pka/src/pka.c"
void riscv_pka_init()
{
