# 0 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c"
# 35 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c"
...
# 36 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c" 2
...
# 38 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 39 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c" 2
# 52 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c"
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spm.h" 2
...
# 53 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c" 2
...
# 54 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c" 2
...
# 55 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c" 2
...
hal_hw_semaphore_status_t hw_semaphore_give(hal_hw_semaphore_id_t id);
 ...
 hal_hw_semaphore_status_t hal_hw_semaphore_take(hal_hw_semaphore_id_t id)
{
# 77 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_hw_semaphore.c"
 ...
 hal_hw_semaphore_channel_t hal_hw_semaphore_query_channel(hal_hw_semaphore_id_t id)
{
    ...
    if ((((volatile SMPH_REGISTER_T *) (0x422A0000))->global_status & (1 << id)) == 0) {
        ...
        for (ch = HAL_HW_SEMAPHORE_CHANNEL_MCU; ch < HAL_HW_SEMAPHORE_CHANNEL_MAX; ch++) {
            if (((volatile SMPH_REGISTER_T *) (0x422A0000))->ch_status[ch] & (1 << id)) {
                return ch;
            }
        }
        return HAL_HW_SEMAPHORE_CHANNEL_NOT_EXIST;
 ...
 hal_hw_semaphore_status_t hw_semaphore_take(hal_hw_semaphore_id_t id)
{
    ...
    if ((((volatile SMPH_REGISTER_T *) (0x422A0000))->ch_status[1] & (1 << id)) != 0) {
        hal_nvic_restore_interrupt_mask(int_mask);
        return HAL_HW_SEMAPHORE_STATUS_TAKE_ERROR;
    }
    ((volatile SMPH_REGISTER_T *) (0x422A0000))->channels[1].ch_lock = (1 << id);
    hal_nvic_restore_interrupt_mask(int_mask);
    return ((((volatile SMPH_REGISTER_T *) (0x422A0000))->ch_status[1] & (1 << id)) == 0) ? HAL_HW_SEMAPHORE_STATUS_TAKE_ERROR : HAL_HW_SEMAPHORE_STATUS_OK;
}

 hal_hw_semaphore_status_t hw_semaphore_take_special(hal_hw_semaphore_id_t id)
{
    if ((((volatile SMPH_REGISTER_T *) (0x422A0000))->ch_status[1] & (1 << id)) != 0) {
        return HAL_HW_SEMAPHORE_STATUS_TAKE_ERROR;
    }
 ...
 hal_hw_semaphore_status_t hw_semaphore_give(hal_hw_semaphore_id_t id)
{
    ...
    ((volatile SMPH_REGISTER_T *) (0x422A0000))->channels[1].ch_release = (1 << id);
    hal_nvic_restore_interrupt_mask(int_mask);
    return ((((volatile SMPH_REGISTER_T *) (0x422A0000))->ch_status[1] & (1 << id)) == 0) ? HAL_HW_SEMAPHORE_STATUS_OK : HAL_HW_SEMAPHORE_STATUS_GIVE_ERROR;
}

 hal_hw_semaphore_status_t hw_semaphore_give_special(hal_hw_semaphore_id_t id)
{
    if ((((volatile SMPH_REGISTER_T *) (0x422A0000))->ch_status[1] & (1 << id)) == 0) {
        return HAL_HW_SEMAPHORE_STATUS_GIVE_ERROR;
    }
