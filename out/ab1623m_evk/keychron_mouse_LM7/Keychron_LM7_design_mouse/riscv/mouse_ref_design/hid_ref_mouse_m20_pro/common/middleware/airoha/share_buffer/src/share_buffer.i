# 0 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
# 38 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
# 1 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 1
# 41 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h"
...
# 42 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 2
...
# 43 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 2
...
# 44 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 2
...
# 45 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 2
...
# 46 "/workdir/airoha/common/middleware/airoha/share_buffer/inc/share_buffer.h" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 2
...
# 40 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 2
...
# 41 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 2
# 62 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
...
void share_buffer_hw_semaphore_take(hal_hw_semaphore_id_t hw_sem_id)
{
    ...
    while (1) {
        ...
        take_times++;
        if (take_times > 50000) {
            if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"; light_assert(exp, file, 76); };
        }
    }
}
...
void share_buffer_hw_semaphore_give(hal_hw_semaphore_id_t hw_sem_id)
{
    if (HAL_HW_SEMAPHORE_STATUS_OK != hw_semaphore_give_special(hw_sem_id)) {
        if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"; light_assert(exp, file, 84); };
    }
}
...
share_buffer_status_t share_buffer_init(share_buffer_type_t type, share_buffer_info_t *share_buffer_info, share_buffer_parameter_t *share_buffer_parameter)
{
    ...
    switch (type)
    {
        ...
        case SHARE_BUFFER_RING:
            do { hal_nvic_save_and_set_interrupt_mask(&mask); share_buffer_hw_semaphore_take(share_buffer_parameter->hw_sem_id); } while (0);
            ...
            share_buffer_info->is_full = 
# 105 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                        0
# 105 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                             ;

            do { share_buffer_hw_semaphore_give(share_buffer_parameter->hw_sem_id); hal_nvic_restore_interrupt_mask(mask); } while (0);
...
share_buffer_status_t share_buffer_get_write_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t *write_ptr, 
# 119 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                                                                                                    _Bool 
# 119 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                                                                                                         *is_full)
{
    share_buffer_status_t ret = SHARE_BUFFER_STATUS_ERROR;
    uint32_t mask;
    ...
    switch (share_buffer_info->type)
    {
        case SHARE_BUFFER_RING_4B_ALIGNED:
        case SHARE_BUFFER_RING:
            do { hal_nvic_save_and_set_interrupt_mask(&mask); share_buffer_hw_semaphore_take(hw_sem_id); } while (0);

            *write_ptr = (uint32_t)(share_buffer_info->info.ring.write_ptr);
            *is_full = share_buffer_info->is_full;

            do { share_buffer_hw_semaphore_give(hw_sem_id); hal_nvic_restore_interrupt_mask(mask); } while (0);
...
share_buffer_status_t share_buffer_set_write_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t write_ptr, 
# 145 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                                                                                                   _Bool 
# 145 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                                                                                                        *is_full)
{
    share_buffer_status_t ret = SHARE_BUFFER_STATUS_ERROR;
    uint32_t mask;
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            {
                share_buffer_info->is_full = 
# 159 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                            1
# 159 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                ;
                *is_full = 
# 160 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                          1
# 160 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                              ;
            }
            else
            {
                *is_full = 
# 164 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                          0
# 164 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                               ;
            }
...
share_buffer_status_t share_buffer_get_read_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t *read_ptr, 
# 179 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                                                                                                  _Bool 
# 179 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                                                                                                       *is_empty)
{
    share_buffer_status_t ret = SHARE_BUFFER_STATUS_ERROR;
    uint32_t mask;
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            *read_ptr = share_buffer_info->info.ring.read_ptr;
            if ((*read_ptr == share_buffer_info->info.ring.write_ptr) && (share_buffer_info->is_full != 
# 191 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                                                                       1
# 191 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                                                                           ))
            {
                *is_empty = 
# 193 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                           1
# 193 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                               ;
            }
            else
            {
                *is_empty = 
# 197 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                           0
# 197 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                ;
            }
...
share_buffer_status_t share_buffer_set_read_pointer(share_buffer_info_t *share_buffer_info, uint8_t hw_sem_id, uint32_t read_ptr, 
# 212 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                                                                                                 _Bool 
# 212 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                                                                                                      *is_empty)
{
    share_buffer_status_t ret = SHARE_BUFFER_STATUS_ERROR;
    uint32_t mask;
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            share_buffer_info->is_full = 
# 224 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                        0
# 224 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                             ;
            if (read_ptr == share_buffer_info->info.ring.write_ptr)
            {
                *is_empty = 
# 227 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                           1
# 227 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                               ;
            }
            else
            {
                *is_empty = 
# 231 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                           0
# 231 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                ;
            }
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            if ((share_buffer_parameter->param.ring.mem_info.total_free_size >= share_buffer_parameter->param.ring.block.block_size) && (share_buffer_parameter->param.ring.block.block_size != 0))
            {
                ...
                {
                    share_buffer_info->is_full = 
# 340 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                1
# 340 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                    ;
                }
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            if ((share_buffer_parameter->param.ring.mem_info.total_used_size >= share_buffer_parameter->param.ring.block.block_size) && (share_buffer_parameter->param.ring.block.block_size != 0))
            {
                ...
                {
                    share_buffer_info->is_full = 
# 425 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c" 3 4
                                                0
# 425 "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"
                                                     ;
                }
...
share_buffer_status_t share_buffer_write(share_buffer_info_t *share_buffer_info, void *des, void *src, uint32_t size)
{
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            {
                if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"; light_assert(exp, file, 578); };
            }
...
share_buffer_status_t share_buffer_read(share_buffer_info_t *share_buffer_info, void *des, void *src, uint32_t size)
{
    ...
    switch (share_buffer_info->type)
    {
        ...
        case SHARE_BUFFER_RING:
            ...
            {
                if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/share_buffer/src/share_buffer.c"; light_assert(exp, file, 613); };
            }
