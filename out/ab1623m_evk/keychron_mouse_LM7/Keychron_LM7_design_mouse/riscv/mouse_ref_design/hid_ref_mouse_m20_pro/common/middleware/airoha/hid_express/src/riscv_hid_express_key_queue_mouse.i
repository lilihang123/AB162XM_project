# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 2
...
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 2
...
# 41 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 2
...
# 42 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 2
...
# 43 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 2
# 52 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
typedef enum {
...
# 79 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"

# 79 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 3 4
_Bool 
# 79 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
    is_queue_full(T_KEY_QUEUE_CTRL_S *kCtrl)
{
    return (((kCtrl->buf_head + 1) & ((1<<3) - 1)) == kCtrl->buf_tail);
}


# 84 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 3 4
_Bool 
# 84 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
    is_key_expired(uint32_t key_time, uint32_t cur_time)
{
    uint32_t duration = 0;
    hal_gpt_get_duration_count(key_time, cur_time, &duration);

    return (duration > 2000000);
}



# 93 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 3 4
_Bool 
# 93 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
    is_queue_empty(T_KEY_QUEUE_CTRL_S *kCtrl)
{
...
int get_queue_count(T_KEY_QUEUE_CTRL_S *kCtrl)
{
    if (kCtrl->buf_tail >= kCtrl->buf_head)
        ...
        return (1<<3) - (kCtrl->buf_head - kCtrl->buf_tail);
}



# 108 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c" 3 4
_Bool 
# 108 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
    is_queue_num_2(T_KEY_QUEUE_CTRL_S *kCtrl)
{
...
void riscv_key_push_key_info(T_KEY_QUEUE_CTRL_S *kCtrl, uint32_t type, uint32_t item1, uint32_t item2, uint32_t timestamp) {
    ...
    kCtrl->buf_head = (kCtrl->buf_head + 1) & ((1<<3) - 1);
...
KEY_QUEUE_STATUS riscv_key_push(T_KEY_QUEUE_CTRL_S *kCtrl, void * outgoing_data , uint32_t timestamp)
{
    ...
    if (( ((kCtrl->last_pushed_ms & 0x000000FF) != outgoing->k))
        || ( (outgoing->z1 != 0))
        || ( (outgoing->z2 != 0))
    )
    {
        combined_value = (outgoing->k & 0x000000FF) | ((outgoing->z1 & 0x000000FF) << 16) | ((outgoing->z2 & 0x000000FF) << 24);
...
# 204 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
    return status;
}
...
KEY_QUEUE_STATUS riscv_key_pop_temperory(T_KEY_QUEUE_CTRL_S *kCtrl, void *outgoing_data, uint32_t timestamp)
{
    ...
    {
        kCtrl->outgoing_item_idx = (kCtrl->buf_tail + 1) & ((1<<3) - 1);
...
# 233 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
            kCtrl->buf_tail = (kCtrl->buf_tail + 1) & ((1<<3) - 1);
        } else {
            ...
            switch(outgoing_key_info->type)
            {
                ...
                {
                    outgoing->type = 2;
                    outgoing->k = outgoing_key_info->items[0] & 0x000000FF;
                    outgoing->z1 = (outgoing_key_info->items[0] >> 16) & 0x000000FF;
                    outgoing->z2 = (outgoing_key_info->items[0] >> 24) & 0x000000FF;
                ...
                break;
# 278 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_key_queue_mouse.c"
                default:
                    break;
...
void riscv_hid_express_key_queue_debug_print(T_KEY_QUEUE_CTRL_S *kCtrl, uint32_t riscv_trigger_time)
{
    ...
    if ((kCtrl->buf_tail_printed != kCtrl->buf_tail) && (kCtrl->buffer[kCtrl->buf_tail_printed].key_delivery_status == KEY_DELIVERY_STATE_IDLE || kCtrl->buffer[kCtrl->buf_tail_printed].key_delivery_status == KEY_DELIVERY_STATE_ABANDONED))
    {
        ...
        T_KEY_INFO_S *outgoing_key_info = &kCtrl->buffer[(kCtrl->buf_tail_printed + 1) & ((1<<3) - 1)];

        do { extern log_control_block_t log_control_block_rv_exp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "rv_exp" " C:info F: L: ]: " "Index[%d], type = %d, key = (%08X-%08X <--), retry cnt = %08X, timestamp = %d"; print_module_msgid_log(&log_control_block_rv_exp, (PRINT_LEVEL_INFO), (msg_id_string), (9), kCtrl->buf_tail_printed , outgoing_key_info->type , outgoing_key_info->items[1] , outgoing_key_info->items[0] , outgoing_key_info->nack_cnt , outgoing_key_info->timestamp); } while (0)
        ...
        kCtrl->buf_tail_printed = (kCtrl->buf_tail_printed + 1) & ((1<<3) - 1);
    }
