# 0 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
# 36 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
...
# 37 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 2
# 47 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
__attribute__ ((__section__(".log_filter." "kr_q"))) log_control_block_t log_control_block_kr_q = { "kr_q", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 47 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 3 4
((void *)0)
# 47 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
, 
# 47 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 3 4
...
((void *)0)
# 47 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "kr_q"))) __attribute__((used)) const char log_control_block_mirror_kr_q[] = "kr_q";
...
static 
# 72 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 3 4
      _Bool 
# 72 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
           key_remap_queue_is_full(T_REMAP_QUEUE_CTRL_S *Kr_q_Ctrl)
{
    return ((Kr_q_Ctrl->buf_head + 1) & ((1<<2) - 1)) == Kr_q_Ctrl->buf_tail;
}



static 
# 79 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 3 4
      _Bool 
# 79 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
           key_remap_queue_is_empty(T_REMAP_QUEUE_CTRL_S *Kr_q_Ctrl)
{
...
void key_remap_xy_pop(T_OUTGOING_VALUES_S *outgoing_data)
{
    if(Kr_xy_buf.val[Kr_xy_buf.active].x || Kr_xy_buf.val[Kr_xy_buf.active].y)
    {
        ...
        outgoing_data->kb_std[1] |= 0x80000000;
    }
}
...
void key_remap_queue_pop(T_REMAP_QUEUE_CTRL_S *Kr_q_Ctrl, void *outgoing_data)
{
    ...
    {
        T_REMAP_KEY_INFO_S *key_remap_info = &Kr_q_Ctrl->buffer[(Kr_q_Ctrl->buf_tail + 1) & ((1<<2) - 1)];
        T_REMAP_VALUES_S *outgoing_key_info = &(key_remap_info->data);

        if(key_remap_info->ready)
        {
# 140 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
            ...
            Kr_q_Ctrl->buf_tail = (Kr_q_Ctrl->buf_tail + 1) & ((1<<2) - 1);
            key_remap_info->ready = 
# 160 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 3 4
                                   0
# 160 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
                                        ;
        }
    }
}
...
void key_remap_queue_push(T_REMAP_QUEUE_CTRL_S *Kr_q_Ctrl, T_REMAP_VALUES_S *outgoing_data, uint32_t key_status)
{
    ...
    Kr_q_Ctrl->buf_head = (Kr_q_Ctrl->buf_head + 1) & ((1<<2) - 1);
    ...
    key_remap_info->ready = 
# 196 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c" 3 4
                           1
# 196 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_queue.c"
                               ;
}
