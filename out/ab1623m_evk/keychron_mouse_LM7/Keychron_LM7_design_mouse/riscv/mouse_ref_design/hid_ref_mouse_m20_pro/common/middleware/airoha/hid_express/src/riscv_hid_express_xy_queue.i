# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_xy_queue.h" 1
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_xy_queue.h"
...
# 41 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_xy_queue.h" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c" 2
...
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c" 2
# 53 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
T_ASSEMBLE_VAL_CTRL_S vCtrl_x;
T_ASSEMBLE_VAL_CTRL_S vCtrl_y;
# 70 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
void hid_express_generate_value_candidate(T_ASSEMBLE_VAL_CTRL_S * vctrl, uint32_t tx_result, int32_t value_new )
{
    vctrl->predict_n[0] = value_new;
    vctrl->predict_n[1] = value_new + vctrl->tx_n[0];
...
void hid_express_generate_value_candidate_1R1T_concurrent(T_ASSEMBLE_VAL_CTRL_S * vctrl, uint32_t tx_result, int32_t value_new )
{
    ...
    if (tx_result){
        vctrl->predict_n[0] = value_new + vctrl->predict_n[0];
    }
    else {
        vctrl->predict_n[0] = value_new;
    }

    vctrl->predict_n[1] = vctrl->tx_n[0];
}
...
uint32_t hid_express_x_y_buf_has_data()
{
    ...
    {
        return 
# 105 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c" 3 4
              1
# 105 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
                  ;
    }
    return 
# 107 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c" 3 4
          0
# 107 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_xy_queue.c"
               ;
}
