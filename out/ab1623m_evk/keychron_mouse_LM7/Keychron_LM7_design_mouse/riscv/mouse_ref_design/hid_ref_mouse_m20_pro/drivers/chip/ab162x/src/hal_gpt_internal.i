# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 2
...
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_gpt_internal.h" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 2


# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 2
...
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 2



gpt_context_t g_gpt_context[2];

hal_gpt_running_status_t gpt_running_state[2];
const hal_gpt_port_t gpt_context_mapping[2] = {HAL_GPT_5,HAL_GPT_6};
...
void gpt_start_free_run_timer(GPT_REGISTER_T *gpt, uint32_t clock_source, uint32_t divide)
{
    ...
    gpt->GPT_CON_UNION.GPT_CON = (uint32_t)GPT_CLOCK_UNGATE | (uint32_t)GPT_MODE_FREE_RUN | 0x1;
...
void gpt_reset_default_timer(uint32_t gpt_port)
{
    ...
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CLK = (0x10);
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_IRQ_ACK = 0x1;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_COMPARE = 0xffffffff;
...
void gpt_interrupt_handler(hal_nvic_irq_t irq_number)
{
    ...
    for (i = 0; i < HAL_GPT_MAX_PORT; i++) {
        ...
        state = ((GPT_REGISTER_T*)((0x42150000) + (0x100*i)))->GPT_IRQ_STA;
        enable = ((GPT_REGISTER_T*)((0x42150000) + (0x100*i)))->GPT_IRQ_EN;



        if ((state & 0x1) && (enable & 0x1)) {

            ((GPT_REGISTER_T*)((0x42150000) + (0x100*i)))->GPT_IRQ_ACK = 0x1;
            ...
            if (g_gpt_context[index].callback_context.callback != 
# 182 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                                                 ((void *)0)
# 182 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                                                     ) {
...
{
    static 
# 196 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
          _Bool 
# 196 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
               is_init = 
# 196 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                         0
# 196 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
    ...
    if (is_init == 
# 198 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                  0
# 198 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                       ) {
        hal_nvic_disable_irq(GPT_IRQn);
        hal_nvic_register_isr_handler(GPT_IRQn, gpt_interrupt_handler);
        hal_nvic_enable_irq(GPT_IRQn);
        is_init = 
# 202 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                 1
# 202 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                     ;
...
# 210 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
_Bool 
# 210 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
...
void sw_gpt_find_the_next_expire_time(uint32_t current_count, uint32_t *p_index, uint32_t *p_expire_count, sw_gpt_type_t sw_type)
{
    ...
    uint32_t the_minimum_count = 0xFFFFFFFF, the_minimum_note = 10;
    for (i = 0; i < 10; i++) {
...
void sw_gpt_callback(sw_gpt_type_t *sw_gpt_type_port)
{
    ...
    g_sw_gpt_running_note[sw_gpt_type] = 10;
...
Reget_current_count:
    ...
    expired_flag = 
# 255 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                  0
# 255 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                       ;
    for (i = 0; i < 10; i++) {
        ...
        if ((g_sw_gpt_notes.sw_gpt_timer[i].status == SW_GPT_NOTE_STATUS_OF_RUNING) &&
            ...
            expired_flag = 
# 267 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                          1
# 267 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                              ;
    ...
    if (expired_flag == 
# 275 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                       1
# 275 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                           ) {
    ...
    if (g_sw_gpt_running_note[sw_gpt_type] == 10) {
        sw_gpt_find_the_next_expire_time(current_count, &next_index, &next_count, sw_gpt_type);
        if (next_index == 10) {
            ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON_CELLS.EN = 0;
            if ((sw_gpt_type == SW_GPT_US_TYPE)&&(sw_gpt_us_locksleep_status == 
# 285 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                                                               1
# 285 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                                                                   )) {
                sw_gpt_us_locksleep_status = 
# 286 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                            0
# 286 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                                 ;
        ...
        g_sw_gpt_running_note[sw_gpt_type] = next_index;
...
void clear_gpt_and_restart_hw_gpt(uint32_t next_expired_count, hal_gpt_port_t port)
{
    ...
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CON_UNION.GPT_CON &= ~(GPT_CLOCK_GATE);
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_IRQ_EN = 0;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CON_UNION.GPT_CON_CELLS.EN &= ~0x1;



    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CLK = (0x00) | (uint32_t) GPT_DIVIDE_1;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_COMPARE = next_expired_count;
    while (((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_WCOMPSTA & (1 << port));
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_IRQ_ACK = 0x1;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CLR = 0x1;
    while (((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_CLRSTA & (1 << port));


    if (port == HAL_GPT_5) {
        ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CLK = (0x10) | (uint32_t)GPT_DIVIDE_1;
    }
    if (port == HAL_GPT_6) {
        ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CLK = (0x00) | (uint32_t)GPT_DIVIDE_16;
    }

    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CON_UNION.GPT_CON &= ~(3 << 8);
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_CON_UNION.GPT_CON_CELLS.EN |= 0x1;
    ((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_IRQMSK1 &= ~(1 << port);
    ((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_WAKEUPMSK1 &= ~(1 << port);
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*port)))->GPT_IRQ_EN = 0x1;
...
hal_gpt_status_t sw_gpt_timer_start(uint32_t handle, uint32_t timeout_time, hal_gpt_callback_t callback, void *user_data, sw_gpt_type_t sw_type)
{
    ...
    hal_gpt_port_t gpt_port = HAL_GPT_MAX_PORT;
    if (callback == 
# 349 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                   ((void *)0)
# 349 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                       ) {
    ...
    if (timeout_time > 65535999 && sw_type == SW_GPT_MS_TYPE) {
        return HAL_GPT_STATUS_ERROR_START_TOO_LONG;
    }
    if (timeout_time > 2147483647 && sw_type == SW_GPT_US_TYPE) {
        return HAL_GPT_STATUS_ERROR_START_TOO_LONG;
    }
    ...
    if (sw_type == SW_GPT_US_TYPE) {
        gpt_port = HAL_GPT_6;
        hal_nvic_save_and_set_interrupt_mask(&mask);
        if (sw_gpt_us_locksleep_status == 
# 376 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                         0
# 376 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                              ) {
            do{ hal_sleep_manager_lock_sleep(gpt_lock_sleep_handle[gpt_port]); }while(0);
            sw_gpt_us_locksleep_status = 
# 378 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                        1
# 378 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                            ;
        }
        hal_nvic_restore_interrupt_mask(mask);
        hal_gpt_get_free_run_count(HAL_GPT_CLOCK_SOURCE_1M, &current_count);
...
hal_gpt_status_t sw_gpt_timer_stop(uint32_t handle, sw_gpt_type_t sw_type)
{
    ...
    if (g_sw_gpt_notes.sw_gpt_timer[index].status == SW_GPT_NOTE_STATUS_OF_RUNING) {
        ...
        if (next_index == 10) {
            ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON_CELLS.EN = 0;
            if ((sw_type == SW_GPT_US_TYPE)&&(sw_gpt_us_locksleep_status == 
# 443 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                                                           1
# 443 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                                                               )) {
                sw_gpt_us_locksleep_status = 
# 444 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c" 3 4
                                            0
# 444 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt_internal.c"
                                                 ;
                do{ hal_sleep_manager_unlock_sleep(gpt_lock_sleep_handle[gpt_port]); }while(0);
            }
            g_sw_gpt_running_note[sw_type] = 10;
            hal_nvic_restore_interrupt_mask(mask);
            return HAL_GPT_STATUS_OK;
        }
