# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_qdec.h" 2
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 2




# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
static volatile HW_QDEC_REGISTER_T *const qdec_register = (HW_QDEC_REGISTER_T *)(0x42101000);
...
static 
# 50 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
      _Bool 
# 50 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
           g_first_data_flag = 
# 50 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                               0
# 50 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                                    ;
static volatile 
# 51 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
               _Bool 
# 51 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                    qdec_available_data = 
# 51 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                                          0
# 51 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
...
void (*qdec_callback)(uint8_t irq_type) = 
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                                         ((void *)0)
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                                             ;
...
static void hw_qdec_Isr_zephyr(void)
{
  ...
  {
    if (qdec_callback != 
# 78 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                        ((void *)0)
# 78 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                            )
    {
  ...
  {
    if (qdec_callback != 
# 90 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                        ((void *)0)
# 90 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                            )
    {
  ...
  {
    if (qdec_callback != 
# 102 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                        ((void *)0)
# 102 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                            )
    {
...
static hal_qdec_status_t qdec_group_config_para_check(hal_qdec_group_config_t qdec_group_cfg)
{
  ...
  if ((smp_period > 0x1ff) || (led_period > 0xf) || (led_period > smp_period) ||
      (dbc_count > 0x1f) || (dbc_count == 1))
  {
...
hal_qdec_status_t hal_qdec_init(hal_qdec_config_t *qdec_cfg)
{
  ...
  hal_nvic_register_isr_handler(11, (void *)hw_qdec_Isr_zephyr);




  hal_nvic_enable_irq(11);
...
hal_qdec_status_t hal_qdec_deinit(void)
{
  ...
  g_first_data_flag = 
# 227 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                     0
# 227 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                          ;
  qdec_register->QDEC_CON_UNION.QDEC_CON_CELLS.SW_RSTB = 0x00;
...
hal_qdec_status_t hal_qdec_enable(void)
{
# 263 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
  g_first_data_flag = 
# 263 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                     1
# 263 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                         ;
...
hal_qdec_status_t hal_qdec_disable(void)
{
  ...
  g_first_data_flag = 
# 278 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                     0
# 278 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                          ;
  qdec_status = QDEC_STATUS_INITIALIZED;
  return HAL_QDEC_STATUS_OK;
}
...
{
  if (callback == 
# 285 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                 ((void *)0)
# 285 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                     )
  {
    return HAL_QDEC_INVALID_PARAMETER;
  }
...
hal_qdec_status_t hal_qdec_set_latch_clear(void)
{
    ...
    if (qdec_available_data == 
# 315 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                              0
# 315 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                                   )
    {
      qdec_register->QDEC_LATCH_N_CLR_UNION.QDEC_LATCH_N_CLR_CELLS.LATCH_N_CLR = 0x01;
      qdec_available_data = 
# 318 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                           1
# 318 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                               ;
      return HAL_QDEC_STATUS_OK;
    }
...
hal_qdec_status_t hal_qdec_get_data(int16_t *data)
{
  int16_t temp_data;
  if (qdec_available_data == 
# 341 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                            0
# 341 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                                 )
  {
    return HAL_QDEC_STATUS_ERROR;
  }
  ...
  if (qdec_mode == HAL_QDEC_ZSUM_MODE)
  {
    ...
    qdec_available_data = 
# 349 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                         0
# 349 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                              ;
    if (g_first_data_flag)
    {
      fifo_data = 0;
      g_first_data_flag = 
# 353 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                         0
# 353 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                              ;
    }
  ...
  else
  {
    ...
    qdec_available_data = 
# 368 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                         0
# 368 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                              ;
    if (g_first_data_flag)
    {
      fifo_data = 0;
      g_first_data_flag = 
# 372 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                         0
# 372 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                              ;
    }
    if (0x100 & fifo_data)
    {
...
hal_qdec_status_t hal_qdec_latch_status_is_busy(
# 556 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                                               _Bool 
# 556 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                                                    *hw_latch_status)
{
  ...
  {
    *hw_latch_status=
# 568 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                    0
# 568 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                         ;
  }
  else
  {
    *hw_latch_status=
# 572 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                    1
# 572 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                        ;
  }
  return HAL_QDEC_STATUS_OK;
}
...
hal_qdec_status_t hal_qdec_get_z_sum_threshold(uint16_t *threshold)
{
  uint32_t z_sum_thr;
  if (threshold == 
# 692 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                  ((void *)0)
# 692 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                      )
  {
    return HAL_QDEC_INVALID_PARAMETER;
  }
...
{
  if((hw_sel_status == 
# 709 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                      ((void *)0)
# 709 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
                          )||(group == 
# 709 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c" 3 4
                                       ((void *)0)
# 709 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_qdec.c"
