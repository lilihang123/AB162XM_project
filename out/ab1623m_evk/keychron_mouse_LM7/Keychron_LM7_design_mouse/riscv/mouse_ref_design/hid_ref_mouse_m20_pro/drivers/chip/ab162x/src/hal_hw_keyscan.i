# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 2

typedef enum
{
  HAL_HW_KEYSCAN_OFFICE_KB = 0x0,
  HAL_HW_KEYSCAN_GAMING_KB_ALIGN_BT = 0x1,
  HAL_HW_KEYSCAN_GAMING_KB = 0x2,
  HAL_HW_KEYSCAN_SW_TRIGGER = 0x3
} hal_hw_keyscan_mode_t;


typedef enum
{
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_2T = 0x0,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_3T = 0x1,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_4T = 0x2,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_5T = 0x3,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_6T = 0x4,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_8T = 0x5,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_10T = 0x6,
  HAL_HW_KEYSCAN_IO_SWITCH_TIME_SELECTION_14T = 0x7
} hal_hw_keyscan_io_switch_time_t;


typedef enum
{
  HAL_HW_KEYSCAN_RATE_100RR = 0x00,
  HAL_HW_KEYSCAN_RATE_125RR = 0x01,
  HAL_HW_KEYSCAN_RATE_133RR = 0x02,
  HAL_HW_KEYSCAN_RATE_250RR = 0x03,
  HAL_HW_KEYSCAN_RATE_500RR = 0x04,
  HAL_HW_KEYSCAN_RATE_1KRR = 0x05,
  HAL_HW_KEYSCAN_RATE_2KRR = 0x06,
  HAL_HW_KEYSCAN_RATE_4KRR = 0x07,
  HAL_HW_KEYSCAN_RATE_8KRR = 0x08,
  HAL_HW_KEYSCAN_RATE_16KRR = 0x09,
  HAL_HW_KEYSCAN_RATE_32KRR = 0x10
} hal_hw_keyscan_rate_t;
...
} hal_keyscan_hwstatus_t;


typedef enum
{
  HAL_HW_KEYSCAN_TYPE_OFFICE_KB = 0x00,
  HAL_HW_KEYSCAN_TYPE_GAMING_KB_MECH = 0x01,
  HAL_HW_KEYSCAN_TYPE_GAMING_KB_OPT = 0x02
} hal_hw_keyscan_kb_type_t;


typedef enum
{
  HAL_HW_KEYSCAN_IO_SETING_LOW_ACTIVE = 0x00,
  HAL_HW_KEYSCAN_IO_SETING_HIGH_ACTIVE = 0x01
} hal_hw_keyscan_io_setting_t;


typedef struct
{
  hal_hw_keyscan_mode_t mode;
  hal_hw_keyscan_io_switch_time_t swich_time;
  hal_hw_keyscan_rate_t rate;
  
# 108 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 3 4
 _Bool 
# 108 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h"
      debounce_en;
  ...
  uint8_t row[8];
  uint8_t col[18];
  hal_hw_keyscan_kb_type_t keyboard_type;
  uint8_t col_in_setting;
} hal_hw_keyscan_config_t;


typedef enum
{
  HAL_HW_KEYSCAN_STATUS_ERROR = -2,
  HAL_HW_KEYSCAN_INVALID_PARAMETER = -1,
  HAL_HW_KEYSCAN_STATUS_OK = 0
} hal_hw_keyscan_status_t;

typedef void (*hal_hw_keyscan_callback_t)(uint32_t *keys, uint8_t one_packet_valid_num, uint8_t total_key_num, 
# 127 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 3 4
                                                                                                              _Bool 
# 127 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h"
                                                                                                                   is_ghost_happen);
...
void hal_hw_keyscan_align_bt_trigger_set_enable(
# 135 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h" 3 4
                                               _Bool 
# 135 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_hw_keyscan.h"
                                                    bt_trigger_enable);
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_platform.h" 1
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 2
# 62 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
static uint8_t total_key_num;
static uint8_t one_packet_valid_num;
static hal_keyscan_hwstatus_t hw_keyscan_status = KEYSCAN_HWSTATUS_UNINITIALIZED;
...
# 69 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
_Bool 
# 69 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
    is_ghost = 
# 69 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
               0
# 69 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
...
static volatile HW_KEYSCAN_REGISTER_T *const keyscan_register = (HW_KEYSCAN_REGISTER_T *)(0x421E0000);
void (*key_transaction)(uint32_t *keys, uint8_t one_packet_valid_num, uint8_t total_key_num, 
# 72 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                                                                            _Bool 
# 72 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                                                                                                 is_ghost_happen) = 
# 72 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                                                                                                    ((void *)0)
# 72 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
...
{
    if ((row_num > 8) || (col_num > 18) || (row_num == 0) || (col_num == 0))
    {
        return HAL_HW_KEYSCAN_INVALID_PARAMETER;
    }
    else
...
{
    if (hal_clock_is_enabled(keycan_cg_blck) != 
# 238 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                               1
# 238 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                                                   ) {
    ...
    if (hal_clock_is_enabled(keycan_cg_2m) != 
# 244 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                             1
# 244 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                                                 ) {
...
{
    if (hal_clock_is_enabled(keycan_cg_blck) == 
# 256 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                               1
# 256 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                                                   ) {
    ...
    if (hal_clock_is_enabled(keycan_cg_2m) == 
# 262 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                             1
# 262 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                                                 ) {
        if (HAL_CLOCK_STATUS_OK != hal_clock_enable(keycan_cg_2m)) {
...
hal_hw_keyscan_status_t hal_hw_keyscan_init(hal_hw_keyscan_config_t *keyscan_config)
{
    if (hw_keyscan_status != KEYSCAN_HWSTATUS_UNINITIALIZED)
    {
        return HAL_HW_KEYSCAN_STATUS_ERROR;
    }
...
# 293 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
   _Bool 
# 293 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
        debounce_en = keyscan_config->debounce_en;
    ...
    for (i = row_num; i < 8; i++)
    {
        keyscan_register->SFR_ROW_MAP[i] = 0X3f;
    }

    for (i = col_num; i < 18; i++)
    {
        keyscan_register->SFR_COL_MAP[i] = 0X3f;
    }
    ...
    hal_nvic_register_isr_handler(16, (void *)hw_keyscan_dummy_Isr);
# 369 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
    keyscan_register->SFR_IRQ_CLEAR = 0x01;
    while(!(keyscan_register->AFIFO_STATUS_UNION.AFIFO_STATUS_CELLS.AFIFO_EMPTY)) {
        key_data = keyscan_register->AFIFO_DOUT;
    }
    keyscan_register->SFR_IRQ_CLEAR = 0x01;
    hal_nvic_enable_irq(16);
    keyscan_register->SFR_KEYSCAN_IO_EN = (0X01);
    hw_keyscan_status = KEYSCAN_HWSTATUS_INITIALIZED;
...
hal_hw_keyscan_status_t hal_hw_keyscan_deinit(void)
{
    if (hw_keyscan_status != KEYSCAN_HWSTATUS_INITIALIZED)
    {
        return HAL_HW_KEYSCAN_STATUS_ERROR;
    }
    ...
    int i;
    keyscan_register->SFR_KEYSCAN_EN = (0X00);
    keyscan_register->SFR_KEYSCAN_IO_EN = (0X00);
    for (i = 0; i < 8; i++)
    {
        keyscan_register->SFR_ROW_MAP[i] = 0X3f;
    }
    ...
    keyscan_register->SFR_RLS_DEB_TIME = 0X03;
    keyscan_register->SFR_PRS_DEB_TIME = 0X01;
    total_key_num = 0;
    one_packet_valid_num = 0;
    hw_keyscan_status = KEYSCAN_HWSTATUS_UNINITIALIZED;
    return HAL_HW_KEYSCAN_STATUS_OK;
}
...
hal_hw_keyscan_status_t hal_hw_keyscan_enable(void)
{
    ...
    keyscan_register->SFR_KEYSCAN_EN = (0X01);
    hw_keyscan_status = KEYSCAN_HWSTATUS_RUNGING;
...
hal_hw_keyscan_status_t hal_hw_keyscan_disable(void)
{
    if (hw_keyscan_status != KEYSCAN_HWSTATUS_RUNGING)
    {
        return HAL_HW_KEYSCAN_STATUS_ERROR;
    }
    keyscan_register->SFR_KEYSCAN_EN = (0X00);
...
{
    if (callback == 
# 446 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                   ((void *)0)
# 446 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                       )
    {
        return HAL_HW_KEYSCAN_INVALID_PARAMETER;
    }
...
void hal_hw_keyscan_sw_trigger(void)
{
    *(volatile uint32_t *)(0x4202003c) = (0x1);
}

void hal_hw_keyscan_align_bt_trigger_set_enable(
# 463 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c" 3 4
                                               _Bool 
# 463 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_hw_keyscan.c"
                                                    bt_trigger_enable)
{
