# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c"
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spm.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spm.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spm.h" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spm.h" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
# 47 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
# 48 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_spm.c" 2
...
int spm_init(void)
{
    ...
    do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "[SLP] *SPM_CFG_IBEX_WAKEUP_SOURCE_MASK(0x%08x)=0x%08x\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_INFO), (msg_id_string), (2),(uint32_t)(volatile uint32_t*)( (0x42130000 ) + 0x0008 ), *(volatile uint32_t*)( (0x42130000 ) + 0x0008 )); } while (0);
...
void spm_mask_wakeup_source(uint32_t wakeup_source)
{
    ...
    if (wakeup_source == HAL_SLEEP_MANAGER_WAKEUP_SOURCE_ALL) {
        *(volatile uint32_t*)( (0x42130000 ) + 0x0008 ) = 0xFFFFFFFF;
    } else {
        *(volatile uint32_t*)( (0x42130000 ) + 0x0008 ) |= (0x1 << wakeup_source);
    }
...
void spm_unmask_wakeup_source(uint32_t wakeup_source)
{
    ...
    if (wakeup_source == HAL_SLEEP_MANAGER_WAKEUP_SOURCE_ALL) {
        *(volatile uint32_t*)( (0x42130000 ) + 0x0008 ) = 0x0;
    } else {
        *(volatile uint32_t*)( (0x42130000 ) + 0x0008 ) &= ~(0x1 << wakeup_source);
    }
