# 0 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
# 39 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
...
# 40 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 41 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 42 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 43 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 44 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 45 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 46 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
...
# 47 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 2
# 68 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
void hal_ccni_event_callback16(hal_ccni_event_t event, hal_ccni_message_t *msg)
{
    static volatile 
# 70 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 3 4
                   _Bool 
# 70 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
                        exception_triggered_flag = 
# 70 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 3 4
                                                   1
# 70 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
                                                       ;
    __attribute__ ((__section__(".log_string"))) static const char exp[] = "Triggered";
    __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c";
    light_assert(exp, file, 73);
    (void) event;
    (void) msg;
    (void) exception_triggered_flag;
}
# 91 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
void exc_port_alert_other_cores(void)
{

    hal_ccni_set_event(((HAL_CCNI_CORE_RISCV<<24)|(HAL_CCNI_CORE_MCU<<16)|HAL_CCNI_EVENT16), 
# 94 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c" 3 4
                                                 ((void *)0)
# 94 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
                                                     );
}
# 105 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
void exc_port_gpt_get_free_run_1M_count(uint32_t *count)
{
    hal_gpt_get_free_run_count(HAL_GPT_CLOCK_SOURCE_1M, count);
}
# 118 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
void exc_port_gpt_get_free_run_32K_count(uint32_t *count)
{
    hal_gpt_get_free_run_count(HAL_GPT_CLOCK_SOURCE_32K, count);
}
# 131 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
void exc_port_core_status_update(void)
{
    return;
}
# 144 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
int exc_port_ccni_clear_event(void)
{
    return hal_ccni_clear_event(((HAL_CCNI_CORE_MCU<<24)|(HAL_CCNI_CORE_RISCV<<16)|HAL_CCNI_EVENT16));
}
# 157 "/workdir/airoha/risc-v/kernel/service/exception_handler/src/exception_portable.c"
int exc_port_ccni_query_event_status(void)
{
    uint32_t master_status = HAL_CCNI_EVENT_STATUS_IDLE;
    while (master_status != HAL_CCNI_EVENT_STATUS_BUSY) {
        hal_ccni_query_event_status(((HAL_CCNI_CORE_MCU<<24)|(HAL_CCNI_CORE_RISCV<<16)|HAL_CCNI_EVENT16), &master_status);
    }
    return 0;
