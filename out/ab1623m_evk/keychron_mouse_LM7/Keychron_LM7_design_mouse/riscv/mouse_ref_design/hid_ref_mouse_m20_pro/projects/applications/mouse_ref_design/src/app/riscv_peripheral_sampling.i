# 0 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
# 38 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
...
# 39 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 41 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2

# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_motion_sensor.h" 1
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_motion_sensor.h"
int riscv_motion_sensor_init();

void riscv_motion_sensor_data_tx_complete();
int riscv_motion_sensor_data_get(int32_t * outgoing_x, int32_t * outgoing_y);
# 43 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 44 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_wheel.h" 1
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_wheel.h"
int riscv_wheel_init();
int riscv_wheel_get_data(int32_t * outgoing_z);
int riscv_wheel_trigger_read_process();
int riscv_wheel_get_data(int32_t * outgoing_z);
void riscv_wheel_set_output_ctrl_pin(uint8_t scroll_id, uint8_t active_level );
...
# 45 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 47 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 48 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 52 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
...
# 55 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2

# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_wheel_ir_comparator.h" 1
# 57 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_mouse_key_sw_debounce.h" 1
# 58 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 2
# 88 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
__attribute__ ((__section__(".log_filter." "riscv_ps"))) log_control_block_t log_control_block_riscv_ps = { "riscv_ps", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 88 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
((void *)0)
# 88 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
, 
# 88 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
...
((void *)0)
# 88 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "riscv_ps"))) __attribute__((used)) const char log_control_block_mirror_riscv_ps[] = "riscv_ps";


static uint32_t inActivity_gpt_hdl = 0;
uint32_t inactivity_counter;
static uint32_t sampling_state = 0;
uint32_t pairing_state = PAIRING_STATE_SEND_REPORT;
uint32_t inActivity_time = 10000;
...
# 111 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                                 0
# 111 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                                      , 0, 0);
        ...
        rv_fake_report_config(
# 116 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                             0
# 116 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                                  , 0, 0);
        riscv_app_ccin_fake_data_disable();
    }
}
...
void peripheral_sampling_pairing_check()
{
    ...
    switch(pairing_state)
    {
        ...
        {
            if (((flag & ((0x01 << 6)|(0x01 << 2)|(0x01 << 3)|(0x01 << 4)) ) == ((0x01 << 6)|(0x01 << 2)|(0x01 << 3)|(0x01 << 4)))) {
                if((pka_share_tx_buf_avail_num() == 10))
                {
                    peripheral_sampling_all_key_release_ccni_send();
                    pairing_state = PAIRING_STATE_CCNI_SEND;
                }
            }
            else if (((flag & ((0x01 << 7)|(0x01 << 4))) == ((0x01 << 7)|(0x01 << 4)))) {
...
void peripheral_sampling_idle_check(uint32_t send_result)
{
    if ( send_result == 0 ){
        ...
        else if (sampling_state == 0 && inActivity_time){

            sampling_state = 1;


            hal_gpt_sw_stop_timer_ms(inActivity_gpt_hdl);
            hal_gpt_sw_start_timer_ms(inActivity_gpt_hdl, inActivity_time, peripheral_sampling_inactivity_timeout, 
# 221 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                                                                                                                  ((void *)0) 
# 221 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                                                                                                                       );
...
# 229 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
_Bool 
# 229 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
    peripheral_sampling__need_early_key_handle_in_wireless_mode()
{
    if ( (riscv_app.state == APP_STATE_CONNECT_PREPARING )
        || (riscv_app.state & APP_STATE_BT_PAIRING )
        || (riscv_app.state == APP_STATE_2_4G_CONNECTED )
        || (riscv_app.state == APP_STATE_2_4G_CONNECTED_ACTIVE )
        || (riscv_app.state == APP_STATE_2_4G_CONNECTED_ENTERING_ACTIVE )
        || (riscv_app.state == APP_STATE_BT_CONNECTED )
        || (riscv_app.state == APP_STATE_BT_CONNECTED_ACTIVE )
        || (riscv_app.state == APP_STATE_BT_CONNECTED_ENTERING_ACTIVE )
        )
    {
        return 
# 241 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
              1
# 241 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                  ;
    }

    return 
# 244 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
          0
# 244 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
               ;
}
...
{
    ;
    do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "peripheral_sampling_app_state_update, riscv_app.state = 0x%x"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (1), riscv_app.state); } while (0);
...
void peripheral_sampling_common_para_update()
{
    ...
    do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "peripheral_sampling_common_para_update, rr_idx = %d, rr_idx_usb = %d, rr_idx_2_4g = %d "; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (3), riscv_app.rr_idx , riscv_app.rr_idx_usb , riscv_app.rr_idx_2_4g); } while (0)
...
# 474 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
_Bool 
# 474 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
    peripheral_sampling__check_condiction(uint32_t check_type)
{
    switch(check_type)
    {
        ...
        {
            if ((riscv_app.rr_idx == HID_REPORT_RATE_8K_HZ) && (riscv_app.state & (APP_STATE_USB_CONNECTED | APP_STATE_BT_CONNECTED | APP_STATE_2_4G_CONNECTED)) && !(riscv_app.state & APP_STATE_BT_CONNECTED)){
                return 
# 481 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                      1
# 481 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                          ;
            }
        }
        break;
        ...
        {
            if ((riscv_app.state & (APP_STATE_USB_CONNECTED | APP_STATE_BT_CONNECTED | APP_STATE_2_4G_CONNECTED))){
                if (((riscv_app.state & 0x0F ) == 0x01) == 
# 489 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                                                              0
# 489 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                                                                   ){
                    return 
# 490 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                          1
# 490 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                              ;
                }
            }
        }
        ...
        case APP_CHECK_CONNECTED_ACTIVE:
        {
            if ((riscv_app.state & (APP_STATE_USB_CONNECTED | APP_STATE_BT_CONNECTED | APP_STATE_2_4G_CONNECTED))){
                if (((riscv_app.state & 0x0F ) == 0x01)){
                    return 
# 500 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                          1
# 500 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                              ;
                }
            }
        }
        ...
        case APP_CHECK_USB_MODE:
        {
            if ((riscv_app.state & APP_STATE_USB_CONNECTED)){
                return 
# 509 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
                      1
# 509 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
                          ;
            }
        }
        break;
    ...
    return 
# 518 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c" 3 4
          0
# 518 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_peripheral_sampling.c"
               ;
}
