# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h" 1
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc.h" 1
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h" 2
...
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h" 2
# 56 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h"
typedef enum {
    RTC_DIVIDE_1 = 0,
    RTC_DIVIDE_2 = 1,
    RTC_DIVIDE_3 = 2,
...
# 95 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h" 3 4
   _Bool 
# 95 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h"
                            has_initilized;
} rtc_context_t;
...
# 117 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h" 3 4
   _Bool 
# 117 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h"
            creat_heap;
    
# 118 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h" 3 4
   _Bool 
# 118 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_rtc_internal.h"
            sw_start_first;
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 2


RTC_TIMER_REGISTER_T *rtc_base = (RTC_TIMER_REGISTER_T *)0x42100000;
...
void rtc_reset_default_timer(hal_rtc_timer_port_t rtc_timer_port)
{
    if(rtc_timer_port != HAL_RTC_TIMER_2){
        ...
        rtc_base->rtc_config[rtc_timer_port].rtc_con.word = 0;
        rtc_base->rtc_config[rtc_timer_port].rtc_clr.word = 1;
        while (!(rtc_base->rtc_t_clrsta.word & (1 << rtc_timer_port)));
        rtc_base->rtc_config[rtc_timer_port].rtc_irq_ack.word = 1;
        rtc_base->rtc_config[rtc_timer_port].rtc_compare.word = 0xffffffff;
        while (!(rtc_base->rtc_t_wcompsta.word & (1 << rtc_timer_port)));
    }else{
        rtc_base->rtc_ao_config.rtc_irq_en.field.IRQEN0 = 0;
        rtc_base->rtc_ao_config.rtc_con.word = 0;
        rtc_base->rtc_ao_config.rtc_clr.word = 1;
        while (!(rtc_base->rtc_ao_t_clrsta.word & 1));
        rtc_base->rtc_ao_config.rtc_irq_ack.word = 1;
        rtc_base->rtc_ao_config.rtc_compare.word = 0xffffffff;
...
{
    if(rtc_timer_port == HAL_RTC_TIMER_1){
        return HAL_RTC_STATUS_ERROR_PORT;
    }

    if ((g_rtc_context[rtc_timer_port].running_status == HAL_RTC_RUNNING) || (g_rtc_context[rtc_timer_port].has_initilized == 
# 80 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                                                                                             1
# 80 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                                                                                                 )) {
    ...
    if(rtc_timer_port != HAL_RTC_TIMER_2){
        ...
        rtc_base->rtc_t_irqmask1.word &= ~(1 << rtc_timer_port);
        rtc_base->rtc_t_wakeupmask1.word &= ~(1 << rtc_timer_port);

        rtc_base->rtc_config[rtc_timer_port].rtc_irq_en.field.IRQEN0 = 0;
    }else{
        rtc_base->rtc_ao_config.rtc_con.field.SW_CG0 = 1;
        rtc_base->rtc_ao_t_irqmask1.word &= ~(1);
        rtc_base->rtc_ao_t_wakeupmask1.word &= ~(1);
    ...
    g_rtc_context[rtc_timer_port].has_initilized = 
# 103 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                  1
# 103 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                      ;
...
hal_rtc_status_t hal_rtc_timer_deinit(hal_rtc_timer_port_t rtc_timer_port)
{
    ...
    g_rtc_context[rtc_timer_port].has_initilized = 
# 119 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                  0
# 119 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                       ;
...
hal_rtc_status_t hal_rtc_enable_time(void){
    ...
    if(g_rtc_context[HAL_RTC_TIMER_1].has_initilized == 
# 132 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                          0
# 132 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                               ) {
        memset(&sw_rtc_context, 0, sizeof(sw_rtc_context_t));
        if(HAL_RTC_TIMER_1 == 2){
            rtc_base->rtc_ao_config.rtc_con.field.SW_CG0 = 0;
            rtc_base->rtc_ao_t_irqmask1.word &= ~(1);
            rtc_base->rtc_ao_t_wakeupmask1.word &= ~(1);
            rtc_base->rtc_ao_config.rtc_clk.field.CLK0 =(0x10);
            rtc_base->rtc_ao_config.rtc_con.field.MODE0 = 2;
            rtc_base->rtc_ao_config.rtc_clr.word = 1;
            while (!(rtc_base->rtc_ao_t_clrsta.word & 1));
            rtc_base->rtc_ao_config.rtc_irq_ack.word = 1;
            rtc_base->rtc_ao_config.rtc_compare.word = 0xFFFFFFFF;
            while (!(rtc_base->rtc_ao_t_wcompsta.word & 1 ));
            rtc_base->rtc_ao_config.rtc_irq_en.field.IRQEN0 = 1;
            rtc_base->rtc_ao_config.rtc_con.field.EN0 = 1;
        }
        else{
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_con.field.SW_CG0 = 0;
            rtc_base->rtc_t_irqmask1.word &= ~(1 << HAL_RTC_TIMER_1);
            rtc_base->rtc_t_wakeupmask1.word &= ~(1 << HAL_RTC_TIMER_1);
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_clk.field.CLK0 = (0x10);
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_con.field.MODE0 = 2;
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_clr.word = 1;
            while (!(rtc_base->rtc_t_clrsta.word & (1 << HAL_RTC_TIMER_1)));
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_irq_ack.word = 1;
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_compare.word = 0xFFFFFFFF;
            while (!(rtc_base->rtc_t_wcompsta.word & (1 << HAL_RTC_TIMER_1)));
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_irq_en.field.IRQEN0 = 1;
            rtc_base->rtc_config[HAL_RTC_TIMER_1].rtc_con.field.EN0 = 1;
        }
        g_rtc_context[HAL_RTC_TIMER_1].callback_context.callback = (hal_rtc_time_callback_t)sw_rtc_callback;
        sw_rtc = SW_RTC_NOT_USER;
        g_rtc_context[HAL_RTC_TIMER_1].callback_context.user_data = &sw_rtc;
        rtc_nvic_register();
        g_rtc_context[HAL_RTC_TIMER_1].has_initilized = 
# 166 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                          1
# 166 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                              ;
    }
...
hal_rtc_status_t hal_rtc_disable_time(void){
    ...
    hal_nvic_save_and_set_interrupt_mask(&mask);
    if(g_rtc_context[HAL_RTC_TIMER_1].has_initilized == 
# 175 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                          1
# 175 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                              ) {
        freeMinHeap(heap);
        memset(&g_rtc_context[HAL_RTC_TIMER_1], 0, sizeof(rtc_context_t));
        memset(&sw_rtc_context, 0, sizeof(sw_rtc_context_t));
        rtc_reset_default_timer(HAL_RTC_TIMER_1);
        g_rtc_context[HAL_RTC_TIMER_1].has_initilized = 
# 180 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                          0
# 180 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                               ;
    }
    hal_nvic_restore_interrupt_mask(mask);
    return HAL_RTC_STATUS_OK;
...
hal_rtc_status_t hal_rtc_alarm_get_handle(uint32_t *handle)
{
    uint32_t i, mask;
    if(g_rtc_context[HAL_RTC_TIMER_1].has_initilized == 
# 189 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                                          0
# 189 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                                               ) {
        return HAL_RTC_STATUS_ERROR;
    }
    if (handle == 
# 192 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                 ((void *)0)
# 192 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                     ) {
        return HAL_RTC_STATUS_INVALID_PARAM;
    }
    if(sw_rtc_context.creat_heap == 
# 195 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                   0
# 195 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                        ){
        heap = createMinHeap(5 +1);
        if(heap == 
# 197 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                  ((void *)0)
# 197 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                      ){
            return HAL_RTC_STATUS_ERROR;
        }
        sw_rtc_context.creat_heap = 
# 200 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                   1
# 200 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                       ;
    }
    if(heap->size == 5){
...
hal_rtc_status_t hal_rtc_alarm_free_handle(uint32_t handle)
{
    ...
    if(sw_rtc_context.creat_heap != 
# 223 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                   1
# 223 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                       ){
        return HAL_RTC_STATUS_ERROR;
    }
...
{
    if(sw_rtc_context.creat_heap != 
# 241 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                   1
# 241 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                       ){
        return HAL_RTC_STATUS_ERROR;
    }
...
{
    if(sw_rtc_context.creat_heap != 
# 249 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                   1
# 249 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                       ){
        return HAL_RTC_STATUS_ERROR;
    }
...
hal_rtc_status_t hal_rtc_get_alarm_ms(uint32_t handle, uint64_t *remain_time){
    if(sw_rtc_context.creat_heap != 
# 270 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c" 3 4
                                   1
# 270 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_rtc.c"
                                       ){
        return HAL_RTC_STATUS_ERROR;
    }
...
hal_rtc_status_t hal_rtc_set_time(const hal_rtc_time_t *time){
    ...
    hal_nvic_save_and_set_interrupt_mask(&mask);
    sw_rtc_context.timer_count = hal_rtc_get_current(HAL_RTC_TIMER_1);
