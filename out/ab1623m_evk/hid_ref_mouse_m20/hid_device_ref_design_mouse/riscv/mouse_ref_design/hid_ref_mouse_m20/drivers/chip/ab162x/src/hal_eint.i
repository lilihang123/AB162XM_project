# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h" 2
...
# 414 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h"
                                                                        toggle);
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h" 1
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 2
...
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 47 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 2
...
# 48 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 2
# 58 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
...
hal_eint_status_t hal_eint_init(hal_eint_number_t eint_number, const hal_eint_config_t *eint_config)
{
    ...
    if (ini_state == 0) {
        ...
        hal_nvic_register_isr_handler(24, (hal_nvic_isr_t)hal_eint_isr);
        hal_nvic_enable_irq(24);
        ini_state = 1;
    }

    if (eint_number >= HAL_EINT_NUMBER_MAX || eint_config == 
# 73 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                            ((void *)0)
# 73 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                                ) {
        return HAL_EINT_STATUS_INVALID_PARAMETER;
    }

    hal_nvic_save_and_set_interrupt_mask(&mask);
    eint_function_table[eint_number].eint_callback = 
# 78 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                    ((void *)0)
# 78 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                        ;
    eint_function_table[eint_number].user_data = 
# 79 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                ((void *)0)
# 79 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                    ;
...
hal_eint_status_t hal_eint_deinit(hal_eint_number_t eint_number)
{
    ...
    hal_nvic_save_and_set_interrupt_mask(&mask);
    eint_function_table[eint_number].eint_callback = 
# 100 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                    ((void *)0)
# 100 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                        ;
    eint_function_table[eint_number].user_data = 
# 101 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                ((void *)0)
# 101 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                    ;
                                             ...
                                             void *user_data)
{
    ...
    if (eint_number >= HAL_EINT_NUMBER_MAX || eint_callback == 
# 115 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                              ((void *)0)
# 115 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                                  ) {
        return HAL_EINT_STATUS_INVALID_PARAMETER;
    }
...
# 135 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
hal_eint_status_t hal_eint_set_trigger_mode(hal_eint_number_t eint_number,
                                            hal_eint_trigger_mode_t trigger_mode)
{
    ...
    reg_index = eint_number / (32);
    reg_shift = 1 << (eint_number % (32));
...
hal_eint_status_t hal_eint_set_debounce_count(hal_eint_number_t eint_number, uint32_t count)
{
    ...
    if (eint_number > HAL_EINT_NUMBER_47) {
        return HAL_EINT_STATUS_INVALID_PARAMETER;
    }
    ...
    eint_con = (count | (0x1UL << (16)) | ((0x7UL << (12)) & ((0x00000000) << (12))));



    if (count == 0) {

        EINT_REGISTER->EINT_CON_REGISTER[eint_number].EINT_CON_CELLS.DBC_EN = (0x00);

    } else {
        EINT_REGISTER->EINT_CON_REGISTER[eint_number].EINT_CON = 0;
        EINT_REGISTER->EINT_CON_REGISTER[eint_number].EINT_CON_CELLS.DBC_EN = (0x01);
        EINT_REGISTER->EINT_CON_REGISTER[eint_number].EINT_CON_CELLS.RSTDBC = (0x01);
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c\"" "." "312"))) __attribute__ ((noinline)) hal_eint_status_t eint_mask_wakeup_source(hal_eint_number_t eint_number)
{
    uint32_t reg_index;
    uint32_t reg_shift;
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c\"" "." "329"))) __attribute__ ((noinline)) hal_eint_status_t eint_unmask_wakeup_source(hal_eint_number_t eint_number)
{
    uint32_t reg_index;
    uint32_t reg_shift;
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c\"" "." "347"))) __attribute__ ((noinline)) hal_eint_status_t hal_eint_mask(hal_eint_number_t eint_number)
{
    ...
    EINT_REGISTER->EINT_D1EN_CLR[reg_index] = reg_shift;
...
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c\"" "." "370"))) __attribute__ ((noinline)) hal_eint_status_t hal_eint_unmask(hal_eint_number_t eint_number)
{
    ...
    EINT_REGISTER->EINT_D1EN_SET[reg_index] = reg_shift;
...
# 419 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
    return HAL_EINT_STATUS_OK;
}
...
hal_eint_status_t hal_eint_set_counter_number(hal_eint_number_t eint_number, eint_counter_number_t counter_number)
{
    ...
    if (counter_number > EINT_COUNTER_NUMBER_9)
    {
        return HAL_EINT_STATUS_INVALID_PARAMETER;
    }
...
uint32_t hal_eint_get_counter_value(eint_counter_number_t counter_number)
{
    ...
    volatile uint32_t *eint_count_value = (volatile uint32_t *)ccm_eint_count;
    ...
    eint_ack_interrupt(eint_count_table[counter_number]);
...
uint32_t hal_eint_get_free_counter_value(void)
{
    ...
    counter_value = EINT_REGISTER->EINT_COUNTER_OUT;

    return counter_value;
}

hal_eint_status_t hal_eint_toggle_set(hal_eint_number_t eint_number,
# 470 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c" 3 4
                                                                   _Bool 
# 470 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_eint.c"
                                                                        toggle)
{
