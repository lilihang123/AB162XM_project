# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_spi_master.h" 2
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h" 1
# 45 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_platform.h" 1
# 46 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h" 2
...
# 55 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h" 3 4
   _Bool 
# 55 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h"
        burst_flag;
    
# 56 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h" 3 4
   _Bool 
# 56 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_spi_sensor.h"
        init_flag;
    uint8_t reserved2[3];
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 2
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h" 1
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 2
...
__attribute__ ((__aligned__(16))) uint8_t burst_reg = 0x16;
static mouse_burst_data_t * mouse_burst_data = (mouse_burst_data_t *)ccm_spi_sensor;
int mouse_sensor_burst_read(uint8_t burst_size){




    if(mouse_burst_data->init_flag == 
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 3 4
                                     0
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
                                          ){
    ...
    hal_spi_master_restore_address_advanced(HAL_SPI_MASTER_0,&burst_reg,(uint8_t *)&(mouse_burst_data->reserved));
    hal_spi_master_trigger_start(HAL_SPI_MASTER_0, 
# 61 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 3 4
                                          1
# 61 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
                                              );
# 82 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
    return MOUSE_SENSOR_STATUS_OK;
}

void hal_ccni_event_callback20(hal_ccni_event_t event, hal_ccni_message_t *msg)
{
    uint32_t mask;
...
{
    hal_ccni_set_event(((HAL_CCNI_CORE_RISCV<<24)|(HAL_CCNI_CORE_MCU<<16)|HAL_CCNI_EVENT15), 
# 94 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 3 4
                                                ((void *)0)
# 94 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
                                                    );
}
...
int mouse_sensor_get_data(int16_t *data_x,int16_t *data_y){
    uint32_t mask;
    if(mouse_burst_data->init_flag == 
# 99 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 3 4
                                     0
# 99 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
                                          ){
        return MOUSE_SENSOR_STATUS_NOT_INIT;
    }
...
# 110 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c" 3 4
                                            ((void *)0)
# 110 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/mouse_sensor.c"
                                                );
        }
...
int mouse_sensor_register_callback(hal_spi_master_callback_t callback,void *user_data){
    return hal_spi_master_register_callback(HAL_SPI_MASTER_0,callback,user_data);
}
