# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_gpt_internal.h" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_gpt_internal.h" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2

# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2


# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager.h" 1
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2
...
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_platform.h" 1
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 2


const char *gpt_lock_sleep_name[HAL_GPT_MAX_PORT] = {"GPT0", "GPT1", "GPT2", "GPT3", "GPT4", "GPT5", "GPT6"};
uint8_t gpt_lock_sleep_handle[HAL_GPT_MAX_PORT];
static 
# 50 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
      _Bool 
# 50 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
           hal_gpt_is_port_valid(hal_gpt_port_t gpt_port)
{

    if ((gpt_port < HAL_GPT_MAX_PORT) && (gpt_port == HAL_GPT_0)) {
        return 
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
              1
# 54 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                  ;
    }
    return 
# 56 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
          0
# 56 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
               ;
}
...
hal_gpt_status_t hal_gpt_init(hal_gpt_port_t gpt_port)
{
    ...
    if ((hal_gpt_is_port_valid(gpt_port) != 
# 65 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                           1
# 65 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                               ) || (index == 0xff)||(index >= 2)) {
        return HAL_GPT_STATUS_ERROR_PORT;
    }

    if ((g_gpt_context[index].running_status == HAL_GPT_RUNNING) || (g_gpt_context[index].has_initilized == 
# 69 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                                                                           1
# 69 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                                                                               )) {
    ...
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON &= ~(GPT_CLOCK_GATE);

    ((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_IRQMSK1 &= ~(1 << gpt_port);
    ((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_WAKEUPMSK1 &= ~(1 << gpt_port);


    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_IRQ_EN &= ~0x1;

    do{ gpt_lock_sleep_handle[gpt_port] = hal_sleep_manager_set_sleep_handle(gpt_lock_sleep_name[gpt_port]); }while(0);





    g_gpt_context[index].has_initilized = 
# 94 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                         1
# 94 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                             ;
...
hal_gpt_status_t hal_gpt_deinit(hal_gpt_port_t gpt_port)
{
    ...
    if ((hal_gpt_is_port_valid(gpt_port) != 
# 105 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                           1
# 105 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                               ) || (index == 0xff)||(index >= 2)) {
        return HAL_GPT_STATUS_ERROR_PORT;
    }
    ...
    g_gpt_context[index].has_initilized = 
# 118 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                         0
# 118 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                              ;

    ((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_IRQMSK0 |= (1 << gpt_port);

    gpt_reset_default_timer((uint32_t)gpt_port);

    do{ hal_sleep_manager_release_sleep_handle(gpt_lock_sleep_handle[gpt_port]); }while(0);
...
hal_gpt_status_t hal_gpt_get_free_run_count(hal_gpt_clock_source_t clock_source, uint32_t *count)
{
    ...
    if (clock_source == HAL_GPT_CLOCK_SOURCE_32K) {
        if (gpt_running_state[0] != HAL_GPT_RUNNING) {
            ...
            gpt_start_free_run_timer(((GPT_REGISTER_T*)((0x42150000) + (0x100*HAL_GPT_1))), (0x10), GPT_DIVIDE_1);
        ...
        *count = gpt_current_count(((GPT_REGISTER_T*)((0x42150000) + (0x100*HAL_GPT_1))));
        ...
        if (gpt_running_state[1] != HAL_GPT_RUNNING) {
            ...
            gpt_start_free_run_timer(((GPT_REGISTER_T*)((0x42150000) + (0x100*HAL_GPT_2))), (0x00), GPT_DIVIDE_16);

            gpt_running_state[1] = HAL_GPT_RUNNING;

        }
        *count = gpt_current_count(((GPT_REGISTER_T*)((0x42150000) + (0x100*HAL_GPT_2))));
    } else {
...
{
    if (duration_count == 
# 175 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                         ((void *)0)
# 175 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                             ) {
        return HAL_GPT_STATUS_INVALID_PARAMETER;
    }
...
hal_gpt_status_t hal_gpt_get_running_status(hal_gpt_port_t gpt_port, hal_gpt_running_status_t *running_status)
{
    ...
    if (gpt_port == HAL_GPT_1) {
        *running_status = gpt_running_state[0];
        return HAL_GPT_STATUS_OK;
    }

    if (gpt_port == HAL_GPT_2) {
                                           ...
                                           void *user_data)
{
    ...
    if ((hal_gpt_is_port_valid(gpt_port) != 
# 221 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                           1
# 221 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                               ) || (index == 0xff)||(index >= 2)) {
        return HAL_GPT_STATUS_ERROR_PORT;
    }
    ...
    if ((g_gpt_context[index].running_status == HAL_GPT_RUNNING) ||
        (g_gpt_context[index].has_initilized != 
# 226 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                               1
# 226 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                   )) {
    ...
    if (callback == 
# 231 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                   ((void *)0)
# 231 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                       ) {
        return HAL_GPT_STATUS_INVALID_PARAMETER;
    }
...
hal_gpt_status_t hal_gpt_start_timer_ms(hal_gpt_port_t gpt_port, uint32_t timeout_time_ms, hal_gpt_timer_type_t timer_type)
{
    ...
    if ((hal_gpt_is_port_valid(gpt_port) != 
# 254 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                           1
# 254 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                               ) || (index == 0xff)||(index >=2)) {
        return HAL_GPT_STATUS_ERROR_PORT;
    }
    ...
    if ((g_gpt_context[index].running_status == HAL_GPT_RUNNING)
        || (g_gpt_context[index].has_initilized != 
# 259 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                  1
# 259 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                      )) {
    ...
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_IRQ_EN = 0;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON_CELLS.EN &= ~0x1;
# 287 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CLK = (0x00) | (uint32_t)GPT_DIVIDE_1;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_COMPARE = gpt_convert_ms_to_32k_count(timeout_time_ms);
    while (((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_WCOMPSTA & (1 << gpt_port));

    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_IRQ_ACK = 0x1;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CLR = 0x1;
    while (((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_CLRSTA & (1 << gpt_port));


    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CLK = (0x10) | (uint32_t)GPT_DIVIDE_1;

    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON = 0;


    if (timer_type) {
        ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON |= (uint32_t)(GPT_MODE_REPEAT | 0x1);
    } else {
        ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CON_UNION.GPT_CON |= (uint32_t)(GPT_MODE_ONE_SHOT | 0x1);
    }
...
hal_gpt_status_t hal_gpt_delay_ms(uint32_t ms)
{
    ...
    gpt_delay_time(((GPT_REGISTER_T*)((0x42150000) + (0x100*HAL_GPT_1))), gpt_convert_ms_to_32k_count(ms));
...
hal_gpt_status_t hal_gpt_start_timer_us(hal_gpt_port_t gpt_port, uint32_t timeout_time_us, hal_gpt_timer_type_t timer_type)
{
    ...
    if ((hal_gpt_is_port_valid(gpt_port) != 
# 343 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                           1
# 343 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                               ) || (index == 0xff)||(index >=2)) {
    ...
    if ((g_gpt_context[index].running_status == HAL_GPT_RUNNING)
        || (g_gpt_context[index].has_initilized != 
# 349 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                  1
# 349 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                      )) {
    ...
    do{ hal_sleep_manager_lock_sleep(gpt_lock_sleep_handle[gpt_port]); }while(0);
    g_gpt_context[index].is_gpt_locked_sleep = 
# 361 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                              1
# 361 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                  ;
    ...
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CLK = (0x00) | (uint32_t)GPT_DIVIDE_16;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_COMPARE = timeout_time_us;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_IRQ_ACK = 0x1;
    ((GPT_REGISTER_T*)((0x42150000) + (0x100*gpt_port)))->GPT_CLR = 0x1;
    while (((GPT_REGISTER_GLOABL_T*)((0x42150000) + 0xC00))->GPT_CLRSTA & (1 << gpt_port));
...
hal_gpt_status_t hal_gpt_delay_us(uint32_t us)
{
    ...
    gpt_delay_time(((GPT_REGISTER_T*)((0x42150000) + (0x100*HAL_GPT_2))), us);
...
hal_gpt_status_t hal_gpt_stop_timer(hal_gpt_port_t gpt_port)
{
    ...
    if ((hal_gpt_is_port_valid(gpt_port) != 
# 417 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                           1
# 417 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                               ) || (index == 0xff)||(index >= 2)) {
        return HAL_GPT_STATUS_ERROR_PORT;
    }
    ...
    if (g_gpt_context[index].is_gpt_locked_sleep == 
# 439 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                   1
# 439 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                       ) {
        do{ hal_sleep_manager_unlock_sleep(gpt_lock_sleep_handle[gpt_port]); }while(0);
        g_gpt_context[index].is_gpt_locked_sleep = 
# 441 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                  0
# 441 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                       ;
    }
    return HAL_GPT_STATUS_OK;
}
...
uint8_t g_sw_gpt_running_note[SW_GPT_MAX_TYPE] = {10, 10};
volatile 
# 449 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
        _Bool 
# 449 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
             sw_gpt_first_start = 
# 449 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                  0
# 449 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
...
hal_gpt_status_t hal_gpt_sw_get_timer(uint32_t *handle)
{
    ...
    static sw_gpt_type_t sw_type_port[0x02];
    sw_type_port[0] = SW_GPT_MS_TYPE;
    sw_type_port[1] = SW_GPT_US_TYPE;
    if (handle == 
# 460 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                 ((void *)0)
# 460 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                     ) {
        return HAL_GPT_STATUS_INVALID_PARAMETER;
    }
    hal_nvic_save_and_set_interrupt_mask(&mask);
    if (g_sw_gpt_notes.used_timer_count >= 10) {
        hal_nvic_restore_interrupt_mask(mask);
        return HAL_GPT_STATUS_ERROR_PORT_USE_FULL;
    }
    for (i = 0; i < 10; i++) {
        if (g_sw_gpt_notes.sw_gpt_timer[i].status == SW_GPT_NOTE_STATUS_OF_FREE) {
            *handle = i | 0xAAAA0000;
            g_sw_gpt_notes.sw_gpt_timer[i].status = SW_GPT_NOTE_STATUS_OF_ALLOC;
            g_sw_gpt_notes.sw_gpt_timer[i].expire_count = 0x0;
            g_sw_gpt_notes.sw_gpt_timer[i].callback = 
# 473 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                     ((void *)0)
# 473 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                         ;
            g_sw_gpt_notes.sw_gpt_timer[i].user_data = 
# 474 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                                                      ((void *)0)
# 474 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                                          ;
            break;
        }
    }
    ...
    hal_nvic_restore_interrupt_mask(mask);
    if (sw_gpt_first_start == 
# 480 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                             0
# 480 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                  ) {
        do{ gpt_lock_sleep_handle[HAL_GPT_6] = hal_sleep_manager_set_sleep_handle(gpt_lock_sleep_name[HAL_GPT_6]); }while(0);
    }
    hal_nvic_save_and_set_interrupt_mask(&mask);


    if (sw_gpt_first_start == 
# 486 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                             0
# 486 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                  ) {
        sw_gpt_first_start = 
# 487 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c" 3 4
                            1
# 487 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpt.c"
                                ;
        gpt_ms_index = gpt_get_context_index(HAL_GPT_5);
        gpt_us_index = gpt_get_context_index(HAL_GPT_6);
        if((gpt_ms_index >= 2 )||(gpt_us_index >= 2))
        {
           hal_nvic_restore_interrupt_mask(mask);
           return HAL_GPT_STATUS_ERROR_PORT;
        }
...
hal_gpt_status_t hal_gpt_sw_free_timer(uint32_t handle)
{
    uint32_t index;
    uint32_t mask;
    if ((handle & 0xAAAA0000) != 0xAAAA0000) {
        return HAL_GPT_STATUS_INVALID_PARAMETER;
    }
    index = (handle & 0xFFFF);
    if (index >= 10){
