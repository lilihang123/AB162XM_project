# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c"
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h" 1
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h"
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h" 2
...
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_saradc.h" 2

typedef enum {
    HAL_ADC_STATUS_INVALID_PARAMETER = -4,
    HAL_ADC_STATUS_ERROR_BUSY = -3,
...
typedef enum {
    ...
    HAL_ADC_AVERAGE_4 = 2,
    HAL_ADC_AVERAGE_8 = 3,
    HAL_ADC_AVERAGE_64 = 4,
    HAL_ADC_AVERAGE_128 = 5,
    HAL_ADC_AVERAGE_256 = 6,
    HAL_ADC_AVERAGE_512 = 7,
    HAL_ADC_AVERAGE_MAX
} hal_adc_average_t;
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_platform.h" 1
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
...
hal_adc_status_t hal_saradc_set_mode(hal_saradc_data_rate_t data_rate, hal_saradc_measure_mode_t measure_mode)
{
    ...
    switch (data_rate) {
        case (HAL_SARADC_DATA_RATE_HS_MODE):
            ...
            ((ADC_REGISTER_T *)0x400D0000)->AUXADC_DIV_CON = 0x0;
        ...
        case (HAL_SARADC_DATA_RATE_MS_MODE):
            ...
            ((ADC_REGISTER_T *)0x400D0000)->AUXADC_DIV_CON = 0x1;
        ...
        case (HAL_SARADC_DATA_RATE_LS_MODE):
            ...
            ((ADC_REGISTER_T *)0x400D0000)->AUXADC_DIV_CON = 0x5;
            *((volatile uint32_t *)(0x42080084)) = 0x10;
...
hal_adc_status_t hal_saradc_enable()
{
    ...
    ((ADC_REGISTER_T *)0x400D0000)->MACRO_CON2_UNION.MACRO_CON2 |= (0x1UL);
    hal_gpt_delay_us(50);
    ((ADC_REGISTER_T *)0x400D0000)->ANA_EN_CON_UNION.ANA_EN_CON = 0x101;
    hal_gpt_delay_us(50);
...
hal_adc_status_t hal_saradc_disable()
{
    ...
    ((ADC_REGISTER_T *)0x400D0000)->ANA_EN_CON_UNION.ANA_EN_CON = 0;

    ((ADC_REGISTER_T *)0x400D0000)->MACRO_CON2_UNION.MACRO_CON2 = 0;
...
hal_adc_status_t hal_saradc_get_data_immediately(hal_saradc_data_t *saradc_data)
{
    ((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON1 = 0x0;
    ((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON1 = saradc_data->channel_mask;
    while (((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON3_UNION.AUXADC_CON3_CELLS.ADC_STAT & (0x1UL));
    for (uint8_t ch = 0; ch < 32; ch++) {
        if (saradc_data->channel_mask & (1 << ch)) {
            saradc_data->channel_data[ch] = ((ADC_REGISTER_T *)0x400D0000)->AUXADC_DATA[ch];
        }
    }
    return HAL_ADC_STATUS_OK;
}
...
{
    ((ADC_REGISTER_T *)0x400D0000)->AUXADC_AVG_NUM = average_num;
    ((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON1 = 0x0;
    for (uint8_t ch = 0; ch < 32; ch++) {
        if (saradc_data->channel_mask & (1 << ch)) {
            ((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON4_UNION.AUXADC_CON4 |= (1 << 8);
            ((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON1 = 0x1 << ch;
            while (((ADC_REGISTER_T *)0x400D0000)->AUXADC_AVG_READY == 0);
        }
    }
    for (uint8_t ch = 0; ch < 32; ch++) {
        if (saradc_data->channel_mask & (1 << ch)) {
            saradc_data->channel_data[ch] = ((ADC_REGISTER_T *)0x400D0000)->AVG_DATA[ch] >> 3;
        }
    }
    return HAL_ADC_STATUS_OK;
}
...
# 183 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
...
# 184 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
...
# 185 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_gpio.h" 1
# 186 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c" 2
# 196 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_saradc.c"
DMA_REGISTER_GLOABL_T *const g_sw_dma_reg_global_table = (DMA_REGISTER_GLOABL_T*)(0x40040000);
GDMA_REGISTER_T *const g_sw_dma_reg = ((GDMA_REGISTER_T *)((0x40040000) + ((1 + (0)) * 0x100)));
...
hal_adc_status_t hal_saradc_dma_init()
{
    ...
    g_sw_dma_reg_global_table->RG_GLB_CLK_SET = ((1 << ((0))));
    g_sw_dma_reg_global_table->RG_GLB_CPU0_INT_SET = ((1 << ((0))));
    ...
    g_sw_dma_reg->GDMA_ACKINT = (0x1 << (15));
    g_sw_dma_reg->GDMA_COUNT = 0x10;
    g_sw_dma_reg->GDMA_SRC = (uint32_t)(&((ADC_REGISTER_T *)0x400D0000)->AUXADC_DATA[0]);
    g_sw_dma_reg->GDMA_CON_UNION.GDMA_CON = (1) | (1 << 1) | (0 << 3);
    g_sw_dma_reg->GDMA_CON_UNION.GDMA_CON |= (2 << 8);
    g_sw_dma_reg->GDMA_CON_UNION.GDMA_CON |= (0x2 << 18);
...
hal_adc_status_t hal_saradc_get_data_immediately_for_special(volatile uint32_t *dest_address, uint32_t channel_mask, hal_saradc_special_gpio_cfg_t gpio_cfg, uint8_t mux_max_index)
{
    if( gpio_cfg.mux_index == 0){
        ...
        ((ADC_REGISTER_T *)0x400D0000)->AUXADC_CON1 = channel_mask & 0xFFFF;
    }
    ...
    for(i = 0;i<3;i++)
    {
        ...
        uint8_t gpio_data = ((gpio_cfg.mux_index) >> i) & 0x1;

        reg_num = gpio_pin >> 5;
        index_num = gpio_pin & 0x1f;

        if (gpio_data) {
            gpio_base->GPIO_DOUT_SET[reg_num] = (0x1 << index_num);
        } else {
            gpio_base->GPIO_DOUT_CLR[reg_num] = (0x1 << index_num);
        }
    }

    while((g_sw_dma_reg_global_table->RG_GLB_STA) & (1 << (2 * ((0)))));
...
hal_adc_status_t hal_saradc_init(hal_saradc_data_rate_t data_rate, hal_saradc_measure_mode_t measure_mode)
{
    ...
    *((volatile uint32_t *)(0x420302A0)) = 0x0;
    ((ADC_REGISTER_T *)0x400D0000)->AUXADC_SPL_CON = 0x2;


    hal_saradc_enable();

    *((volatile uint32_t *)(0x42010108)) = 0x3;
    ((ADC_REGISTER_T *)0x400D0000)->ACD_FUNC_MODE_CTL = 0x1;
    return HAL_ADC_STATUS_OK;
}
