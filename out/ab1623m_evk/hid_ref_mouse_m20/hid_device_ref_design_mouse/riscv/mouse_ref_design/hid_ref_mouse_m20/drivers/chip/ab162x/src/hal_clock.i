# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 2
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 2
# 47 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
typedef enum {
    CG_REQUEST_STATUS,
    CG_REQUEST_CLEAR,
    CG_REQUEST_SET,
...
cg_state_t pseudo_cg_tbl[(HAL_CLOCK_CG_PSEUDO_END - HAL_CLOCK_CG_PSEUDO_BEGIN + 1)];
...
{
    volatile uint32_t *con_addr = 
# 83 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 3 4
                                 ((void *)0)
# 83 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
                                     , *set_addr = 
# 83 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 3 4
                                                   ((void *)0)
# 83 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
...
# 83 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
    ...
    if((clock_id >= HAL_CLOCK_CG_AUXADC) && (clock_id <= HAL_CLOCK_CG_AUXADC)) {
        con_addr = ((volatile uint32_t *)(0x42040000 +0x0000));
        set_addr = ((volatile uint32_t *)(0x42040000 +0x0B10));
        clr_addr = ((volatile uint32_t *)(0x42040000 +0x0B20));
    }
    else if((clock_id >= HAL_CLOCK_CG_PWM_DMA_0) && (clock_id <= HAL_CLOCK_CG_PMU_1M)) {
        con_addr = ((volatile uint32_t *)(0x42040000 +0x0004));
        set_addr = ((volatile uint32_t *)(0x42040000 +0x0B40));
        clr_addr = ((volatile uint32_t *)(0x42040000 +0x0B50));
    }
    else if((clock_id >= HAL_CLOCK_CG_FAST_DMA_1) && (clock_id <= HAL_CLOCK_CG_SEC_MON_AO)) {
        con_addr = ((volatile uint32_t *)(0x42040000 +0x0008));
        set_addr = ((volatile uint32_t *)(0x42040000 +0x0B44));
        clr_addr = ((volatile uint32_t *)(0x42040000 +0x0B54));
    }
    else if((clock_id >= HAL_CLOCK_CG_SPIMST0) && (clock_id <= HAL_CLOCK_CG_BT_MAC)) {
        con_addr = ((volatile uint32_t *)(0x42040000 +0x000C));
        set_addr = ((volatile uint32_t *)(0x42040000 +0x0B70));
        clr_addr = ((volatile uint32_t *)(0x42040000 +0x0B80));
    }
    else if((clock_id >= HAL_CLOCK_CG_CMSYS_BUS) && (clock_id <= HAL_CLOCK_CG_OSC_HS_D4)) {
        con_addr = ((volatile uint32_t *)(0x42040000 +0x0010));
        set_addr = ((volatile uint32_t *)(0x42040000 +0x0BA0));
        clr_addr = ((volatile uint32_t *)(0x42040000 +0x0BB0));
    }
    else if((clock_id >= HAL_CLOCK_CG_AUXADC_SRAM) && (clock_id <= HAL_CLOCK_CG_USB_DMA)) {
        con_addr = ((volatile uint32_t *)(0x422D0000 +0x0020));
        set_addr = ((volatile uint32_t *)(0x422D0000 +0x0310));
        clr_addr = ((volatile uint32_t *)(0x422D0000 +0x0320));
    }
    else if((clock_id >= HAL_CLOCK_CG_CMSYS_ROM) && (clock_id <= HAL_CLOCK_CG_CMSYS_ROM)) {
        con_addr = ((volatile uint32_t *)(0x422D0000 +0x0028));
        set_addr = ((volatile uint32_t *)(0x422D0000 +0x0370));
        clr_addr = ((volatile uint32_t *)(0x422D0000 +0x0380));
    }
    else {
    ...
    if(request == CG_REQUEST_STATUS) {
        ...
        *clr_addr = (1 << bit_idx);
        ...
        do {
            if(clock_id == clk_always_on_cg_tbl[idx]) {
...
hal_clock_status_t hal_clock_enable(hal_clock_cg_id clock_id)
{
    ...
    if((clock_id >= HAL_CLOCK_CG_PSEUDO_BEGIN) && (clock_id <= HAL_CLOCK_CG_PSEUDO_END)) {
        ...
        *((volatile uint32_t *)(0x42040000 +0x0B50)) = clock_id & 0x0000001F;
    }
    else {
...
hal_clock_status_t hal_clock_disable(hal_clock_cg_id clock_id)
{
    ...
    if((clock_id >= HAL_CLOCK_CG_PSEUDO_BEGIN) && (clock_id <= HAL_CLOCK_CG_PSEUDO_END)) {
        ...
        *((volatile uint32_t *)(0x42040000 +0x0B40)) = clock_id & 0x0000001F;
    }
    else {
...
# 192 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 3 4
_Bool 
# 192 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
    hal_clock_is_enabled(hal_clock_cg_id clock_id)
{
    ...
    if((clock_id >= HAL_CLOCK_CG_PSEUDO_BEGIN) && (clock_id <= HAL_CLOCK_CG_PSEUDO_END)) {
        ...
        if(clock_physical_cg_ctrl(clock_id, CG_REQUEST_STATUS) == CG_CLR__CLK_ON) {
            return 
# 202 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 3 4
                  1
# 202 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
                      ;
        }
    }
    return 
# 205 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c" 3 4
          0
# 205 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_clock.c"
               ;
...
uint8_t hal_clock_mux_cur_sel(clock_mux_sel_id mux_id)
{
    ...
    switch(mux_id) {
        case CLK_SYS_SEL:
            mux_sel = *((volatile uint8_t *)(0x42107000 +0x0016));
            break;
        case CLK_IBEX_SEL:
            mux_sel = *((volatile uint8_t *)(0x42030000 +0x0023));
        default:
            break;
    }
...
hal_clock_status_t hal_clock_mux_sel(clock_mux_sel_id mux_id, clk_mux_sel_idx_t mux_sel)
{
    ...
    switch(mux_id) {
        case CLK_IBEX_SEL:
            *((volatile uint8_t *)(0x42030000 +0x0047)) = 1;
            *((volatile uint8_t *)(0x42030000 +0x0023)) = mux_sel;
            *((volatile uint8_t *)(0x42030000 +0x0037)) = 1;
            while(*((volatile uint8_t *)(0x42030000 +0x0037)));
            while(*((volatile uint8_t *)(0x42030000 +0x0263)));
            *((volatile uint8_t *)(0x42030000 +0x0047)) = 0;
            return HAL_CLOCK_STATUS_OK;
        default:
            return HAL_CLOCK_STATUS_INVALID_PARAMETER;
    }
