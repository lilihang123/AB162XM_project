# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
...
# 41 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_internal.h" 1
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_internal.h"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_internal.h" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_internal.h" 2




# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_sleep_manager_internal.h"
typedef enum {
    UNLOCK_SLEEP = 0,
    LOCK_SLEEP = 1
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
...
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
...
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 2
# 123 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
typedef struct {
    uint32_t x1;
    uint32_t x2;
    uint32_t x3;
...
static sleep_management_suspend_callback_func_t suspend_user_callback_func_table [3];
static sleep_management_resume_callback_func_t resume_user_callback_func_table [3];
...
void sleep_management_enter_deep_sleep(void)
{
    ...
    *((volatile uint32_t*)( (0x42120000 ) + 0x0184 )) = (0x1 + 0x90);
    sleep_management_suspend_callback();
    *((volatile uint32_t*)( (0x42120000 ) + 0x0184 )) = (0x2 + 0x90);
    *(volatile uint32_t*)(0x422e0000 + 0x0018) |= 0x100;
    *((volatile uint32_t*)( (0x42120000 ) + 0x0184 )) = (0x3 + 0x90);
    ...
    asm volatile ("csrr %0, mip" : "=r" (mip_value));
    ...
    *((volatile uint32_t*)( (0x42120000 ) + 0x0184 )) = (0x4 + 0x90);
    *(volatile uint32_t*)(0x422e0000 + 0x0018) &= ~0x100;
    sleep_management_resume_callback();
    *((volatile uint32_t*)( (0x42120000 ) + 0x0184 )) = (0x5 + 0x90);
    do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "[SLP] dsp deep sleep exit, wakeup source = 0x%08x"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_INFO), (msg_id_string), (1), *(volatile uint32_t*)( (0x42130000 ) + 0x0174 )); } while (0);
    do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "[SLP][wakeup] dsp mstatus = 0x%08x, mie = 0x%08x, mip=0x%08x"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_INFO), (msg_id_string), (3), mstatus_value, mie_value, mip_value); } while (0);



    hal_nvic_restore_interrupt_mask(sleep_management_mask);
    *((volatile uint32_t*)( (0x42120000 ) + 0x0184 )) = (0x6 + 0x90);
}

void sleep_management_register_suspend_callback(sleep_management_backup_restore_module_t module, sleep_management_suspend_callback_t callback, void *data)
{
    if (module == SLEEP_BACKUP_RESTORE_USER) {
        if (suspend_user_register_count < 3) {
            ...
            do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "register suspend callback function overflow\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_ERROR), (msg_id_string), (0)); } while (0);
        }
    } else {
...
{
    if (module == SLEEP_BACKUP_RESTORE_USER) {
        if (resume_user_register_count < 3) {
            ...
            do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "register resume callback function overflow\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_ERROR), (msg_id_string), (0)); } while (0);
        }
    } else {
...
uint8_t sleep_management_get_lock_handle(const char *handle_name)
{
    ...
    for (index = 0 ; index < (50 -SLEEP_LOCK_USER_START_ID); index++) {
        ...
        if (((sleep_management_handle.user_handle_resoure >> index) & 0x01) == 0) {
            ...
            memset(&sleep_management_handle.user_handle_name[index][0], 0, 11);
            ...
            if (name_len == 0) {
                do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle name error\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_ERROR), (msg_id_string), (0)); } while (0);
    ...
    if (index >= (50 -SLEEP_LOCK_USER_START_ID)) {
        do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "cannot get sleep handle\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_ERROR), (msg_id_string), (0)); } while (0);
...
void sleep_management_release_lock_handle(uint8_t handle_index)
{
    ...
    if ((handle_index >= 50) || (handle_index < SLEEP_LOCK_USER_START_ID)) {
        do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle index error\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_ERROR), (msg_id_string), (0)); } while (0);
        return;
    }
    ...
    if (((sleep_management_handle.user_handle_resoure >> handle_index) & 0x01) == 1) {
        ...
        memset(&sleep_management_handle.user_handle_name[handle_index][0], 0, 11);
    } else {
        do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle already release \r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_WARNING), (msg_id_string), (0)); } while (0);
    }
    hal_nvic_restore_interrupt_mask(mask);
...
void sleep_management_lock_sleep(sleep_management_lock_sleep_t lock, uint8_t handle_index)
{
    ...
    if (lock == LOCK_SLEEP) {
        ...
        if (sleep_management_handle.lock_sleep_request_count[handle_index] == 0xFF) {
            do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle=%d,lock sleep count full \r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_WARNING), (msg_id_string), (1), handle_index); } while (0);
            if (handle_index >= SLEEP_LOCK_USER_START_ID) {
                do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle=%s\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_WARNING), (msg_id_string), (1), sleep_management_handle.user_handle_name[(handle_index - SLEEP_LOCK_USER_START_ID)]); } while (0);
            }
        }
        ...
        if (sleep_management_handle.lock_sleep_request_count[handle_index] > 0) {
            ...
            hal_nvic_restore_interrupt_mask(mask);
            do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle=%d,lock sleep has already released \r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_WARNING), (msg_id_string), (1), handle_index); } while (0);
            if (handle_index >= SLEEP_LOCK_USER_START_ID) {
                do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle=%s"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_WARNING), (msg_id_string), (1), sleep_management_handle.user_handle_name[(handle_index - SLEEP_LOCK_USER_START_ID)]); } while (0);
            }
        }
    }
...
# 468 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
_Bool 
# 468 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    sleep_management_check_sleep_locks(void)
{
    
# 470 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
   _Bool 
# 470 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
        lock = 
# 470 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
               1
# 470 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    ...
    sleep_handle_mask <<= (50 - 1);
    sleep_handle_mask -= 1;

    hal_nvic_save_and_set_interrupt_mask(&mask);
    if ((sleep_management_handle.lock_sleep_request & sleep_handle_mask) == 0) {
        lock = 
# 479 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
              0
# 479 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
                   ;
    } else {
        lock = 
# 481 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
              1
# 481 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
                  ;
    }
    hal_nvic_restore_interrupt_mask(mask);
...
# 488 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
_Bool 
# 488 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    sleep_management_check_handle_status(uint8_t handle_index)
{
    
# 490 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
   _Bool 
# 490 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
        lock = 
# 490 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
               0
# 490 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    ...
    if ((handle_index >= 50)) {
        do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle index error\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_ERROR), (msg_id_string), (0)); } while (0);
        return 
# 495 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
              0
# 495 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
                   ;
    }

    if (((sleep_management_handle.lock_sleep_request >> (handle_index)) & 0x01) == 1) {
        lock = 
# 499 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
              1
# 499 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
                  ;
        return lock;
    } else {
        lock = 
# 502 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
              0
# 502 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
                   ;
        return lock;
    }
...
uint64_t sleep_management_get_lock_sleep_handle_list(void)
{
    ...
    do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "lock sleep handle list : \r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_INFO), (msg_id_string), (0)); } while (0);
    for (i = 0; i < 50; i++) {
        if (lock_sleep_request & (mask << i)) {
            do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "index of sleep handle = %d\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_INFO), (msg_id_string), (1), i); } while (0);
            if (i >= SLEEP_LOCK_USER_START_ID) {
                do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "sleep handle = %s\r\n"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_INFO), (msg_id_string), (1), sleep_management_handle.user_handle_name[i - SLEEP_LOCK_USER_START_ID]); } while (0);
            }
        }
    }
...
{
    uint8_t index = 0;
# 586 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    return (index);
}

void sleep_management_release_lock_extslp_handle(uint8_t handle_index)
{
# 611 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    return;
}

void sleep_management_lock_extslp(sleep_management_lock_extslp_t lock, uint8_t handle_index)
{
# 673 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    return;
}


# 676 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
_Bool 
# 676 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    sleep_management_check_extslp_locks(void)
{
    
# 678 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
   _Bool 
# 678 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
        lock = 
# 678 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
               0
# 678 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
                    ;
# 695 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    return lock;
}


# 698 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
_Bool 
# 698 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
    sleep_management_check_request_extslp_status()
{
    uint32_t mask;
...
# 703 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c" 3 4
   _Bool 
# 703 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager_internal.c"
        lock = (0x1 & *(volatile uint32_t*)( (0x42130000 ) + 0x0070 ));
    hal_nvic_restore_interrupt_mask(mask);
