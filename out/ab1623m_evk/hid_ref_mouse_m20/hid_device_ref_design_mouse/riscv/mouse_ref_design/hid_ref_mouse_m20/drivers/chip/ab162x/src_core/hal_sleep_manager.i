# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
...
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
...
# 40 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
...
# 42 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
...
# 43 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
...
# 44 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
...
# 45 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 2
# 90 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
uint8_t hal_sleep_manager_set_sleep_handle(const char *handle_name)
{
...
# 138 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 3 4
_Bool 
# 138 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
    hal_sleep_manager_is_sleep_locked(void)
{
    ...
    return 
# 143 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 3 4
          0
# 143 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
               ;

}


# 147 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 3 4
_Bool 
# 147 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
    hal_sleep_manager_is_sleep_handle_alive(uint8_t handle_index)
{
    ...
    return 
# 152 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c" 3 4
          0
# 152 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
               ;

}

void hal_sleep_manager_riscv_sleep_routine(void){
# 165 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
...
# 188 "/workdir/airoha/risc-v/drivers/chip/ab162x/src_core/hal_sleep_manager.c"
    return HAL_SLEEP_MANAGER_OK;
}
