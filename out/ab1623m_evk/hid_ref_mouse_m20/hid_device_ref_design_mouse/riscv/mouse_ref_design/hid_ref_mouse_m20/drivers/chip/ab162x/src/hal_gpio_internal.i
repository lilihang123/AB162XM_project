# 0 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio_internal.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio_internal.c"
# 35 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio_internal.c"
...
# 36 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio_internal.c" 2
...
# 39 "/workdir/airoha/risc-v/drivers/chip/ab162x/src/hal_gpio_internal.c" 2
...
void gpio_get_state(hal_gpio_pin_t gpio_pin, gpio_state_t *gpio_state)
{
    ...
    pu = ((*((volatile uint32_t*)(io_cfg_base + 0x70))) >> shift) & 0x01;
    pd = ((*((volatile uint32_t*)(io_cfg_base + 0x50))) >> shift) & 0x01;

    temp = (pu << 4) + pd;
    if((gpio_pin == 4) || (gpio_pin == 5) || (gpio_pin == 38) || (gpio_pin == 39)) {
        shift = ((gpio_pin == 4) || (gpio_pin == 38)) ? 0 : 2;
        rsel = ((*((volatile uint32_t*)(io_cfg_base + 0x80))) >> shift) & 0x3;
