# 0 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
# 38 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
...
# 39 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 40 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 41 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 42 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 43 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 44 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 45 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 46 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 47 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 48 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 49 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2

# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_mouse_key_sw_debounce.h" 1
# 51 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
# 1 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/inc/app/riscv_mouse_key_ir_ctrl.h" 1
# 52 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
...
# 53 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 2
# 63 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
typedef struct {
...
# 121 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
    ...
    {
        if (rv_key_ids[idx] < 32 ){
            if ( all_gpio_status_1 & (1 << (rv_key_ids[idx]))){

                mouse_5key |= (1 << (idx));
            }
        }
        else if (rv_key_ids[idx] < 48 ){
...
void update_key_status(uint32_t *all_gpio_status_1, uint32_t *all_gpio_status_2, uint32_t key_id_index, 
# 147 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c" 3 4
                                                                                                       _Bool 
# 147 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
                                                                                                            is_pressed)
{
    uint32_t shift_value = ((rv_key_ids[key_id_index] < 32) ? (0x01<<rv_key_ids[key_id_index]) : (0x01<<(rv_key_ids[key_id_index]-32)));

    if (rv_key_ids[key_id_index] < 32) {
        if (is_pressed) {
...
uint32_t riscv_mouse_key_combo_key_check()
{
    ...
    uint32_t all_gpio_status_1 = ~gpio_data_in_mask_temp.register0;
    uint32_t all_gpio_status_2 = ~gpio_data_in_mask_temp.register1;
# 190 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
...
int riscv_mouse_key_init()
{
    ...
    do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "riscv_mouse_key_init, key_num = %d, rv_key_ids = %d, %d, %d, %d, %d, %d, %d, %d"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (10), rv_key_num , rv_key_ids[0] , rv_key_ids[1] , rv_key_ids[2] , rv_key_ids[3] , rv_key_ids[4] , rv_key_ids[5] , rv_key_ids[6] , rv_key_ids[7]); } while (0)
# 228 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
         ;
...
# 249 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
}
...
int riscv_mouse_key_get_key_status(uint32_t * outgoing_keys)
{
    ...
    hal_gpt_get_free_run_count( HAL_GPT_CLOCK_SOURCE_1M , &riscv_app.read_key_timestamp );
# 270 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
        new_keys_status = riscv_mouse_key_polling_all_key_status();
        *outgoing_keys = new_keys_status;
# 284 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
    return SUCCESS;
}

void riscv_mouse_key_post_process()
{
# 304 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
...
void riscv_mouse_key_pairing_key_check()
{
    if((combo_cfg.app_state & (APP_STATE_USB_CONNECTED | APP_STATE_BT_CONNECTED | APP_STATE_2_4G_CONNECTED)) && (combo_cfg.app_state & 0x01))
    {
        uint32_t end_gpt_free_count = 0;
        uint32_t duration_count = 0;
        combo_key_result = riscv_mouse_key_combo_key_check();
        if((start_gpt_free_count != 0) && (combo_key_result == 0))
        {
            ...
            {
                hid_common_set_hid_exp_flag(9);
                start_gpt_free_count = 0;
            }
        }
        else if(combo_key_result == 0)
        {
...
{
    ;
# 365 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
    switch(new_state)
    {
...
void riscv_mouse_key_debug_print()
{
# 419 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
    if (mouse_5key_printed != mouse_5key){
        do { extern log_control_block_t log_control_block_riscv_ps; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "riscv_ps" " C:info F: L: ]: " "mouse_5key = 0x%x --> 0x%x,  combo_key_list = 0x%08X-%08X, combo_key_list_size = 0x%x, combo_key_result = 0x%x, flags = 0x%x"; print_module_msgid_log(&log_control_block_riscv_ps, (PRINT_LEVEL_INFO), (msg_id_string), (7), mouse_5key_printed , mouse_5key , combo_cfg.combo_key_list[0].combo_bit_00_31 , combo_cfg.combo_key_list[0].combo_bit_32_63 , combo_cfg.combo_key_list_size , combo_key_result , hid_common->hid.flags); } while (0)
# 429 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
             ;
...
# 460 "/workdir/airoha/risc-v/projects/applications/mouse_ref_design/src/app/riscv_mouse_key.c"
uint32_t riscv_mouse_key_id_to_key_status(uint32_t key_id)
{
    int found_idx = -1;
