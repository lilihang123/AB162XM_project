# 0 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
# 36 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
...
# 37 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 2
...
# 38 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 2
# 1 "/workdir/airoha/risc-v/kernel/service/system_online_dump/inc/system_online_dump.h" 1
# 44 "/workdir/airoha/risc-v/kernel/service/system_online_dump/inc/system_online_dump.h"
typedef enum {
...
# 66 "/workdir/airoha/risc-v/kernel/service/system_online_dump/inc/system_online_dump.h"
typedef enum {
...
# 39 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 2
...
# 40 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 2
...
# 41 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 2
...
# 42 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 2
...
__attribute__ ((__section__(".log_filter." "system_online_dsp"))) log_control_block_t log_control_block_system_online_dsp = { "system_online_dsp", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 51 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 3 4
((void *)0)
# 51 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
, 
# 51 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 3 4
((void *)0)
# 51 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
...
((void *)0)
# 51 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "system_online_dsp"))) __attribute__((used)) const char log_control_block_mirror_system_online_dsp[] = "system_online_dsp";
# 60 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
sys_task_info_t sys_task_info[1] = {
             {0, 0, "main"},
};


extern uint32_t port_syslog_send(uint32_t id, 
# 65 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 3 4
                                             _Bool 
# 65 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
                                                  drop_flag, mux_buffer_t *p_buf_info);
# 192 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
void ccni_dump_sysinfo(uint32_t func_id)
{
    do { extern log_control_block_t log_control_block_system_online_dsp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "system_online_dsp" " C:info F: L: ]: " "Please enable RISC-V AIR_ONLINE_SWLA_ENABLE first. function_id:%d "; print_module_msgid_log(&log_control_block_system_online_dsp, (PRINT_LEVEL_WARNING), (msg_id_string), (1), func_id); } while (0);
}



void hal_ccni_event_callback15(hal_ccni_event_t event, hal_ccni_message_t *msg)
{
    ...
    if (
# 207 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c" 3 4
       ((void *)0) 
# 207 "/workdir/airoha/risc-v/kernel/service/system_online_dump/src/system_online_dump.c"
            != msg) {
        sub_id = (system_ccni_sub_event_id_t)(((hal_ccni_message_t *)msg)->data[0]);
        do { extern log_control_block_t log_control_block_system_online_dsp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "system_online_dsp" " C:info F: L: ]: " "dsp_system_event_handler msg[0]:0x%x msg[1]:0x%x sub_id:%d"; print_module_msgid_log(&log_control_block_system_online_dsp, (PRINT_LEVEL_INFO), (msg_id_string), (3), (uint32_t)(((hal_ccni_message_t *)msg)->data[0]), (uint32_t)(((hal_ccni_message_t *)msg)->data[1]), sub_id); } while (0)
