# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c"
# 37 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_report_id_selector.h" 1
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_report_id_selector.h"
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_report_id_selector.h" 2
uint32_t riscv_hid_report_id_select(T_OUTGOING_VALUES_S* outgoing);
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c" 2
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express.h" 1
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c" 2
# 59 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c"
uint32_t riscv_hid_report_id_select(T_OUTGOING_VALUES_S* outgoing)
{

    if (outgoing->type == 9)
    {
# 73 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_report_id_selector.c"
        if((outgoing->kb_std[0] >> 24) & 0x000000FF)
        {
            return 9;
        }
        else
