# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"
# 37 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"
...
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
...
# 42 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
...
# 43 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
...
# 44 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
...
# 45 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_bt_mode.h" 1
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_bt_mode.h"
typedef enum {
...
void hid_express_bt_debug_print();
# 46 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 2
...
void hid_express_dbg_check()
{
    ...
    uint32_t time_delta;
    (current_gpt_free_count = ((GPT_REGISTER_T*)((0x42150000) + 0x200))->GPT_COUNT);
    hal_gpt_get_duration_count(dbg.timestamp, current_gpt_free_count, &time_delta);

    if( time_delta > (1000000-(125/2)) ){
        dbg.waiting_4print = 
# 79 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 3 4
                            1
# 79 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"
                                ;
        ...
        if(((hid_flags & ((0x01 << 6)|(0x01 << 2)|(0x01 << 3)|(0x01 << 4)) ) == ((0x01 << 6)|(0x01 << 2)|(0x01 << 3)|(0x01 << 4)))){
...
void rv_hid_exp_delay_printf()
{
    ...
    if(dbg.waiting_4print){
        ...
        do { extern log_control_block_t log_control_block_rv_exp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "rv_exp" " C:info F: L: ]: " "Common HID Exp Status Report: Key = %d,  Wheel = %d, Nack = %d, Motion Count = %d, Motion Pin Low = %d, Sampling Count = %d, SPI CB in 1s = %d, RR_idx = %d (0=125, 3=1K, 6=8k)"; print_module_msgid_log(&log_control_block_rv_exp, (PRINT_LEVEL_INFO), (msg_id_string), (8), dbg.valid_key_cnt_4print , dbg.wheel_ok_4print , dbg.nack_count_4print , dbg.sensor_ok_4print , dbg.motion_pin_low_4print , dbg.sampling_cnt_4print , dbg.total_cnt_4print , hid_ctrl.rr_idx); } while (0)
# 127 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"
             ;

       do { extern log_control_block_t log_control_block_rv_exp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "rv_exp" " C:info F: L: ]: " "Common HID PKA Status Report: PkaHidDrop = %d, PkaHid = %d, PkaAcl = %d"; print_module_msgid_log(&log_control_block_rv_exp, (PRINT_LEVEL_INFO), (msg_id_string), (3), dbg.pka_hid_drop_cnt_4print , dbg.pka_hid_cnt_4print , dbg.pka_acl_cnt_4print); } while (0)
        ...
        if(((hid_flags & ((0x01 << 7)|(0x01 << 4))) == ((0x01 << 7)|(0x01 << 4)))){
            if(dbg.nack_count_4print == dbg.total_cnt_4print){
                ...
                {
                    if( (0 && "Always buffer full within 2 seconds") == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0 && \"Always buffer full within 2 seconds\""; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"; light_assert(exp, file, 141); };
                }
            }
            else{
        ...
        dbg.waiting_4print = 
# 155 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c" 3 4
                            0
# 155 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_hid_exp_delay_printf.c"
                                 ;
