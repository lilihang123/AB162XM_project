# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
# 36 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_usb_mode.h" 1
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_usb_mode.h"
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/inc/riscv_hid_express_usb_mode.h" 2
...
# 37 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 40 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 42 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 44 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 48 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
...
# 52 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 2
# 66 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
...
# 84 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
void hid_express_usb_mode_send_report_to_CM33(hal_ccni_message_t* outgoing_rep)
{


    hal_ccni_set_event(((HAL_CCNI_CORE_RISCV<<24)|(HAL_CCNI_CORE_MCU<<16)|HAL_CCNI_EVENT0), 
# 88 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 3 4
                                              ((void *)0)
# 88 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
                                                  );
...
void hid_express_usb_mode_generate_kb_consumer_reports(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result)
{
    ...
    do { u32_may_alias_t temp = ((10) & 0x000000FF) | (((outgoing->kb_consumer & 0x000000FF) & 0x000000FF) << 8) | ((((outgoing->kb_consumer >> 8) & 0x000000FF) & 0x000000FF) << 16) | ((((outgoing->kb_consumer >> 16) & 0x000000FF) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_consumer2.report_id) = temp; } while(0)




                         ;
    do { u32_may_alias_t temp = (((outgoing->kb_consumer >> 24) & 0x000000FF) & 0x000000FF) | (((0x00) & 0x000000FF) << 8) | (((0x00) & 0x000000FF) << 16) | (((0x00) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_consumer2.consumer[3]) = temp; } while(0)




                         ;
# 126 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
}
...
void hid_express_usb_mode_generate_kb_std_reports(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result)
{
    ...
    do { u32_may_alias_t temp = ((9) & 0x000000FF) | (((outgoing->kb_std[0] & 0x000000FF) & 0x000000FF) << 8) | ((((outgoing->kb_std[0] >> 8) & 0x000000FF) & 0x000000FF) << 16) | ((((outgoing->kb_std[0] >> 16) & 0x000000FF) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_std5.report_id) = temp; } while(0)




                         ;
    do { u32_may_alias_t temp = (((outgoing->kb_std[0] >> 24) & 0x000000FF) & 0x000000FF) | (((outgoing->kb_std[1] & 0x000000FF) & 0x000000FF) << 8) | ((((outgoing->kb_std[1] >> 8) & 0x000000FF) & 0x000000FF) << 16) | (((0) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_std5.keycode[2]) = temp; } while(0)




                         ;
# 160 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
}
# 226 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
void hid_express_usb_mode_generate_12bits_reports(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result)
{
    tx_result &= 0x01;


    do { u32_may_alias_t temp = ((2) & 0x000000FF) | (((outgoing->k) & 0x000000FF) << 8) | ((((usb_vCtrl_x->predict_n[tx_result] & 0x000000FF)) & 0x000000FF) << 16) | (((((usb_vCtrl_x->predict_n[tx_result] >> 8) & 0x000000FF)) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].ms_s16_z8.report_id) = temp; } while(0)




                         ;
    do { u32_may_alias_t temp = (((usb_vCtrl_y->predict_n[tx_result] & 0x000000FF)) & 0x000000FF) | (((((usb_vCtrl_y->predict_n[tx_result] >> 8) & 0x000000FF)) & 0x000000FF) << 8) | (((outgoing->z1) & 0x000000FF) << 16) | (((outgoing->z2) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].ms_s16_z8.y) = temp; } while(0)




                         ;
# 257 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
}
...
void hid_express_usb_mode_generate_kb_std_xy_reports(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result)
{
    ...
    do { u32_may_alias_t temp = ((1) & 0x000000FF) | (((outgoing->kb_std[0] & 0x000000FF) & 0x000000FF) << 8) | ((((outgoing->kb_std[0] >> 8) & 0x000000FF) & 0x000000FF) << 16) | ((((outgoing->kb_std[0] >> 16) & 0x000000FF) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_std2.report_id) = temp; } while(0)




                         ;
    do { u32_may_alias_t temp = (((usb_vCtrl_x->predict_n[tx_result] & 0x000000FF)) & 0x000000FF) | (((((usb_vCtrl_x->predict_n[tx_result] >> 8) & 0x000000FF)) & 0x000000FF) << 8) | ((((usb_vCtrl_y->predict_n[tx_result] & 0x000000FF)) & 0x000000FF) << 16) | (((((usb_vCtrl_y->predict_n[tx_result] >> 8) & 0x000000FF)) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_std2.x) = temp; } while(0)




                         ;
# 291 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
}
...
void hid_express_usb_mode_generate_kb_consumer_xy_reports(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result)
{
    ...
    do { u32_may_alias_t temp = ((5) & 0x000000FF) | (((outgoing->kb_consumer & 0x000000FF) & 0x000000FF) << 8) | ((((outgoing->kb_consumer >> 8) & 0x000000FF) & 0x000000FF) << 16) | (((0x00) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_consumer1.report_id) = temp; } while(0)




                         ;
    do { u32_may_alias_t temp = (((usb_vCtrl_x->predict_n[tx_result] & 0x000000FF)) & 0x000000FF) | (((((usb_vCtrl_x->predict_n[tx_result] >> 8) & 0x000000FF)) & 0x000000FF) << 8) | ((((usb_vCtrl_y->predict_n[tx_result] & 0x000000FF)) & 0x000000FF) << 16) | (((((usb_vCtrl_y->predict_n[tx_result] >> 8) & 0x000000FF)) & 0x000000FF) << 24); *((u32_may_alias_t *)&hid_common->outgoing_report[0].kb_consumer1.x) = temp; } while(0)




                         ;
# 324 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
}

uint32_t hid_express_usb_last_report_is_kb()
{

    if((last_report_id == 9) || (last_report_id == 10))
    {
        return 1;
    }
    return 0;
...
void hid_express_usb_delay_for_latency()
{
    ...
    hid_common->hid.outgoing_report_ready = 0x00;
...
void hid_express_usb_data_set_report_ready(){
    ...
    hid_common->hid.outgoing_report_ready = 0x01;

}

int hid_express_usb_data_send(T_OUTGOING_VALUES_S* outgoing, uint32_t tx_result, uint32_t tx_idx, 
# 389 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c" 3 4
                                                                                                 _Bool 
# 389 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
                                                                                                      report_go)
{
    ...
    switch (report_id)
    {
# 412 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
        case 1:
    ...
    hid_common->hid.outgoing_report_ready = 0x02;
# 476 "/workdir/airoha/common/middleware/airoha/hid_express/src/riscv_hid_express_usb_mode.c"
    return 0;
}
