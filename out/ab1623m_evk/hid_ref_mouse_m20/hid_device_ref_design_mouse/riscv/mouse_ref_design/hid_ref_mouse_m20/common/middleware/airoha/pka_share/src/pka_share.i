# 0 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
# 38 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
# 1 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h" 1
# 41 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h"
...
# 42 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h" 2
...
# 43 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h" 2
...
# 44 "/workdir/airoha/common/middleware/airoha/pka_share/inc/pka_share.h" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 2
...
# 37 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h"
# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_platform.h" 1
# 38 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_eint.h" 2
...
# 151 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_cross_core_config.h"
...
# 40 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 2

# 1 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_nvic.h" 1
# 42 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 2
...
# 46 "/workdir/airoha/risc-v/drivers/chip/ab162x/inc/hal_gpt_internal.h" 2
...
# 43 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 2
# 65 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
...
# 116 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
extern 
# 116 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
      _Bool 
# 116 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
...
void *g_pEmptyPktPtr = 
# 120 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                      ((void *)0)
# 120 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                          ;
...
void pka_share_hw_semaphore_take(hal_hw_semaphore_id_t hw_sem_id)
{
    ...
    while (++take_times) {
        ...
        if (take_times > 500) {
            if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"; light_assert(exp, file, 134); };
        }
    }
}
...
void pka_share_hw_semaphore_give(hal_hw_semaphore_id_t hw_sem_id)
{
    if (HAL_HW_SEMAPHORE_STATUS_OK != hal_hw_semaphore_give(hw_sem_id)) {
        if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"; light_assert(exp, file, 142); };
    }
}
# 267 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
void pka_share_init(void)
{
    pka_share_ptr = (pka_share_info*)ccm_pka_share;
    pka_share_tx_hid_ctl.pLeAclTxPtr = 
# 270 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                      ((void *)0)
# 270 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                          ;
}
...
# 333 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
uint8_t * pka_share_tx_buf_get_by_idx(uint8_t idx)
{
...
void pka_share_tx_buf_init(uint16_t *ptr)
{
    ...
    ptr[offset] = 0x14;
    ptr[offset + 1] = pka_share_ptr->hid_tx_buf_payload_size;
    ptr[offset + 7] = pka_share_ptr->hid_tx_buf_payload_size;
    ptr[offset + 6] = (pka_share_ptr->cb_type == PKA_SHARE_TX_PREPARE_CB_TYPE_LE) ?
                    2 : 0;
}
...
# 409 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
_Bool 
# 409 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
    pka_tx_buf_is_hid(uint8_t *ptr)
{
...
# 429 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
_Bool 
# 429 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
    pka_tx_buf_is_empty(uint8_t *ptr)
{
    if (ptr == 
# 431 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
              ((void *)0) 
# 431 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                   || pka_tx_buf_get_data_len((uint16_t *)ptr) == 0) {
        return 
# 432 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
              1
# 432 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                  ;
    }
    return 
# 434 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
          0
# 434 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
               ;
}

void pka_flag_set_loading(uint8_t value)
{
    *pka_share_ptr->bt_info.common.flag_ptr &= ~0x40;
    if (value != 0) {
        *pka_share_ptr->bt_info.common.flag_ptr |= 0x40;
    }
}
...
# 445 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
_Bool 
# 445 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
    pka_active_state_match(uint16_t state)
{
    return (*pka_share_ptr->bt_info.rt.acl_active_state_ptr == state);
}
# 460 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
void pka_active_state_set(uint8_t state)
{
...
# 481 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
void pka_share_tx_ctrl_init(void)
{
    if (pka_share_ptr->req_rscv_ctl_int != 
# 483 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                          0
# 483 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                               ) {
        ...
        if (pka_cb_type == PKA_SHARE_TX_PREPARE_CB_TYPE_RT) {
            ...
            for(uint8_t idx = 0; idx < pka_share_tx_hid_ctl.HidTxBufNum; idx++) {
                ...
                pka_share_tx_hid_ctl.HidTxBuf[idx].valid = 
# 493 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                                          1
# 493 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                                              ;
            ...
            if (pka_share_tx_hid_ctl.HidTxBufNum > (4)) {
                if( (0) == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0"; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"; light_assert(exp, file, 499); };
            }
        ...
        pka_share_ptr->req_rscv_ctl_int = 
# 506 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                         0
# 506 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                              ;
    }
}
# 596 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
t_pka_share_tx_hid_ptr g_pLastGetHidTx = 
# 596 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                        ((void *)0)
# 596 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                            ;
# 608 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
    ...
    if (pka_cb_type == PKA_SHARE_TX_PREPARE_CB_TYPE_RT) {
        ...
        for(uint8_t idx = 0; idx < pka_share_tx_hid_ctl.HidTxBufNum; idx++, pHidTx++) {
            if (pHidTx->state == BUFFER_PUSH_TO_HWMAC) {
                ...
                if (pHidTx->valid != 
# 617 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                    0
# 617 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                         ) {
...
# 636 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
__attribute__((optimize("O3"))) void *pka_share_get_hid_tx_ptr(void)
{
    if (pka_cb_type == PKA_SHARE_TX_PREPARE_CB_TYPE_RT) {
        if (pka_share_tx_hid_ctl.HidTxBufAllcNum < pka_share_tx_hid_ctl.HidTxBufNum) {
            t_pka_share_tx_hid_ptr pHidTx = 
# 640 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                           ((void *)0)
# 640 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                               ;
    ...
    return 
# 657 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
          ((void *)0)
# 657 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
              ;
}
# 670 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
__attribute__((optimize("O3"))) void pka_share_push_hid_tx_ptr(void* pTxPtr)
{
    ...
    return 
# 679 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
          ((void *)0)
# 679 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
              ;
}
# 692 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
__attribute__((optimize("O3"))) uint32_t pka_share_advanced_tx_prepare_rt(void)
{

    uint32_t timestamp_key_submitted = 7;
    ...
    if (g_riscv_ccni_irq_occur == 
# 706 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                 0
# 706 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                      ) {

        pLeAclTxPtrCandidate = pPkaShareTxHidCtl->pLeAclTxPtr;

        pHidTxPtrCandidate = (pHidTx->state == BUFFER_ALLC_BY_APP) ? pHidTx->pPtr : 
# 710 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                                                                   ((void *)0)
# 710 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                                                                       ;




        pPkaCandTxPtr[0] = *g_pPkaRtInfo->CandiTxPtr[0];
        if (pPkaCandTxPtr[0] == g_pEmptyPktPtr) {
            if (pLeAclTxPtrCandidate != 
# 717 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                       ((void *)0)
# 717 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                           ) {
                *g_pPkaRtInfo->CandiTxPtr[0] = pLeAclTxPtrCandidate;
                pPkaCandTxPtr[0] = pLeAclTxPtrCandidate;

                pLeAclTxPtrCandidate = pPkaShareTxHidCtl->pLeAclTxPtr = 
# 721 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                                                       ((void *)0)
# 721 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                                                           ;
                hid_express_dbg_inc_pka_acl_cnt();
            } else {
                if (pHidTxPtrCandidate != 
# 724 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                         ((void *)0)
# 724 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                             ) {
                    do {
                        *g_pPkaRtInfo->CandiTxPtr[0] = pHidTxPtrCandidate;

                    } while(*g_pPkaRtInfo->CandiTxPtr[0] != pHidTxPtrCandidate);
# 743 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                    pPkaCandTxPtr[0] = pHidTxPtrCandidate;
                    pHidTxPtrCandidate = 
# 744 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                        ((void *)0)
# 744 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                            ;
                    ...
                    (timestamp_key_submitted = ((GPT_REGISTER_T*)((0x42150000) + 0x200))->GPT_COUNT);
                    hid_express_dbg_inc_pka_hid_cnt();
                }
            }
            pka_tx_buf_clear_buf_valid(pPkaCandTxPtr[0]);
        }


        pPkaCandTxPtr[1] = *g_pPkaRtInfo->CandiTxPtr[1];
        pPkaCandTxPtr[2] = *g_pPkaRtInfo->CandiTxPtr[2];

        if (pPkaCandTxPtr[2] == g_pEmptyPktPtr) {
            if (pLeAclTxPtrCandidate != 
# 766 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                       ((void *)0)
# 766 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                           ) {
                *g_pPkaRtInfo->CandiTxPtr[2] = pLeAclTxPtrCandidate;
                pPkaCandTxPtr[2] = pLeAclTxPtrCandidate;

                pPkaShareTxHidCtl->pLeAclTxPtr = 
# 770 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                                ((void *)0)
# 770 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                                    ;
                hid_express_dbg_inc_pka_acl_cnt();
            } else {

                if (pHidTxPtrCandidate == 
# 774 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                         ((void *)0)
# 774 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                             ) {
                ...
                if ((pHidTxPtrCandidate != 
# 781 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                          ((void *)0)
# 781 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                              ) &&
                    (pPkaCandTxPtr[0] != pHidTxPtrCandidate) &&
                    (pPkaCandTxPtr[1] != pHidTxPtrCandidate)) {
                    do {
                        *g_pPkaRtInfo->CandiTxPtr[2] = pHidTxPtrCandidate;

                    } while (*g_pPkaRtInfo->CandiTxPtr[2] != pHidTxPtrCandidate);

                    pPkaCandTxPtr[2] = pHidTxPtrCandidate;
                    *pka_share_ptr->bt_info.rt.hwmt_tpollgo_ptr = 2;
# 799 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                    pHidTx->state = BUFFER_PUSH_TO_HWMAC;
            ...
            pka_tx_buf_clear_buf_valid(pPkaCandTxPtr[2]);
        }


        if ((pPkaCandTxPtr[1] == g_pEmptyPktPtr) &&
            (pPkaCandTxPtr[0] == g_pEmptyPktPtr) &&
            (pPkaCandTxPtr[2] == g_pEmptyPktPtr) &&
            (pHidTx->state == BUFFER_PUSH_TO_HWMAC)) {
    ...
    if (pPkaShareTxHidCtl->pLeAclTxPtr == 
# 825 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                         ((void *)0)
# 825 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                             ) {
        share_buffer_hw_semaphore_take(4);
        pPkaShareTxHidCtl->pLeAclTxPtr = *g_pPkaRtInfo->NextTxPtr;
        *g_pPkaRtInfo->NextTxPtr = 
# 828 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                  ((void *)0)
# 828 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                      ;
    ...
    ;
    return timestamp_key_submitted - 7;
}
# 960 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
void pka_share_tx_forward_prepare_rtt0(void)
{
...
# 985 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
}
uint8_t pka_share_get_current_report_rate(void)
{
...
uint8_t pka_share_get_current_max_pdu_len(void)
{
    ...
    if (pka_share_ptr != 
# 1003 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                        ((void *)0)
# 1003 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                            ) {
        if (pka_share_ptr->bt_info.rt.max_pdu_len_ptr != 
# 1004 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c" 3 4
                                                        ((void *)0)
# 1004 "/workdir/airoha/common/middleware/airoha/pka_share/src/pka_share.c"
                                                            ) {
