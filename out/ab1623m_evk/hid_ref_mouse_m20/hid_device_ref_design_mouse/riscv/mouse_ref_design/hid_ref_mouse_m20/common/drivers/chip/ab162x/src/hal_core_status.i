# 0 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c"
# 36 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c"
...
# 37 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_core_status.h" 1
# 45 "/workdir/airoha/common/drivers/chip/ab162x/inc/hal_core_status.h"
typedef enum {
    HAL_CORE_MCU = 0,
    HAL_CORE_RISCV = 1,
    HAL_CORE_MAX,
...
typedef enum {
    ...
    HAL_CORE_STATUS_MAX = 0x7FFFFFFF
} hal_core_status_t;

_Static_assert(sizeof(hal_core_id_t) == 4, "size of hal_core_id_t is not 4 bytes");
_Static_assert(sizeof(hal_core_status_t) == 4, "size of hal_core_status_t is not 4 bytes");
...
# 38 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c" 2
# 1 "/workdir/airoha/common/drivers/chip/ab162x/inc/memory_attribute.h" 1
# 39 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c" 2
...
# 40 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c" 2
# 64 "/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c"
__attribute__((section(".tcm_code" "." "\"/workdir/airoha/common/drivers/chip/ab162x/src/hal_core_status.c\"" "." "64"))) __attribute__ ((noinline)) hal_core_status_t hal_core_status_read(hal_core_id_t id)
{
    if (id >= HAL_CORE_MAX) {
        return HAL_CORE_ERROR;
    } else {
        return *((hal_core_status_t*)(ccm_core_status) + id);
    }
}
...
hal_core_status_t hal_core_status_write(hal_core_id_t id, hal_core_status_t status)
{
    ...
    if (id != HAL_CORE_RISCV) {
        do { extern log_control_block_t log_control_block_common; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "common" " C:info F: L: ]: " "cross core operation: %d => %d"; print_module_msgid_log(&log_control_block_common, (PRINT_LEVEL_WARNING), (msg_id_string), (2), id, status); } while (0);
    }




    *((hal_core_status_t*)(ccm_core_status) + id) = status;
    return status;
