# 0 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
# 38 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
...
# 39 "/workdir/airoha/common/middleware/airoha/key_remap/inc/key_remap_queue.h"
...
# 40 "/workdir/airoha/common/middleware/airoha/key_remap/inc/key_remap_queue.h" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 2
...
# 40 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 2
# 49 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
_Static_assert(sizeof(T_REMAP_VALUES_S) % sizeof(uint32_t) == 0, "Struct size must be multiple of 4 bytes");
# 61 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
typedef struct {
...
# 90 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
    int new_z1;
...
# 104 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
__attribute__ ((__section__(".log_filter." "kr_backend"))) log_control_block_t log_control_block_kr_backend = { "kr_backend", (DEBUG_LOG_ON), (PRINT_LEVEL_INFO), 
# 104 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
((void *)0)
# 104 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
, 
# 104 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
...
((void *)0)
# 104 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
, print_module_msgid_log }; __attribute__ ((__section__(".log_filter_mirror." "kr_backend"))) __attribute__((used)) const char log_control_block_mirror_kr_backend[] = "kr_backend";
...
T_HID_KEY_REMAP_BACKEND_S macro_setting[10];
...
static uint32_t key_remap_combo_judgement(uint8_t key_code)
{
    switch(key_code & 0xFF)
    {
        ...
        default:
            return 
# 160 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
                  0
# 160 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                       ;
    }
}
# 172 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
...
# 253 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
void key_remap_csm_key_press(uint32_t *macro_key, uint16_t value)
{
    for (int i = 0; i < 2; ++i) {
        uint16_t current_value = (*macro_key >> (i * 16)) & 0xFFFF;
        if (current_value == 0) {
            *macro_key |= ((uint32_t)value << (i * 16));
            break;
        }
    }
}
...
static void key_remap_update_record(uint32_t macro_key_idx)
{
    ...
    if(( ((macro_setting[idx].macro) >> 24) & 0xFF ) == KEY_EVENT_MOUSE_XY)
    {
...
static void key_remap_get_ms_x_y(uint32_t setting_idx)
{
    ...
    uint32_t outgoing_x;
    uint32_t outgoing_y;
    uint32_t delta_x = ((int8_t)(((((gpt_free_count) >> (0)) & 0x07) ^ (((gpt_free_count) >> (15)) & 0x07)) << 5)) >> 5;
    uint32_t delta_y = ((int8_t)(((((gpt_free_count) >> (3)) & 0x07) ^ (((gpt_free_count) >> (12)) & 0x07)) << 5)) >> 5;

    if (setting_idx < 10)
    {
        outgoing_x = ( ((int32_t)((macro_setting[setting_idx].x_y) & 0xFFF) << 20) >> 20 );
        if (delta_x != -4) {
            outgoing_x += delta_x;
        }

        outgoing_y = ( ((int32_t)(((macro_setting[setting_idx].x_y) >> 12) & 0xFFF) << 20) >> 20 );
        if (delta_y != -4) {
            outgoing_y += delta_y;
        }
...
void key_remap_macro_timeout(void* user_data)
{
    ...
    while (1)
    {
        uint32_t type = ( ((setting->macro) >> 24) & 0xFF );
        ...
        if (type == KEY_EVENT_NONE)
        {
            ...
            relative_time = ( (macro_setting[idx].macro) & 0xFFFFFF );
            hal_gpt_sw_stop_timer_ms(macro_gpt_hdl);
            hal_gpt_sw_start_timer_ms(macro_gpt_hdl, relative_time, key_remap_macro_timeout, 
# 385 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
                                                                                            ((void *)0)
# 385 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                                                                                                );
...
# 461 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                default:
                    break;
            }
        }
        ...
        if (relative_time)
        {
            ...
            if((hid_ctrl.rr_idx < 2) && (relative_time < 8))
            {
                relative_time = 8 >> hid_ctrl.rr_idx;
            }
            ...
            hal_gpt_sw_stop_timer_ms(macro_gpt_hdl);
            hal_gpt_sw_start_timer_ms(macro_gpt_hdl, relative_time, key_remap_macro_timeout, 
# 490 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
                                                                                            ((void *)0)
# 490 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                                                                                                );
            return;
        }
        else
        {
            ...
            if(while_count > 10)
            {
                if( (0 && "Infinite loop detected") == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0 && \"Infinite loop detected\""; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"; light_assert(exp, file, 498); };
            }
            while_count++;
            continue;
        }
...
# 555 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
...

{
    ...
    T_HID_KEY_REMAP_BACKEND_S *setting = 
# 560 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
                                        ((void *)0)
# 560 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                                            ;
    ...
    {
        if( (0 && "key idx over range") == 0 ) { __attribute__ ((__section__(".log_string"))) static const char exp[] = "0 && \"key idx over range\""; __attribute__ ((__section__(".log_string"))) static const char file[] = "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"; light_assert(exp, file, 589); };
        return;
    }
    ...
    switch (setting->status)
    {
        ...
        case REMAP_KB_STD:
            ...
            remap_values->kb_std[0] |= setting->item & 0x000000FF;
        ...
        case MACRO_REMAP:
                ...
                || (kr_ctrl.macro_process_state == MACRO_RESTART))
            {
                ...
                switch(( ((setting->macro) >> 24) & 0xFF ))
                {
                    ...
                    break;
# 707 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                }
        ...
        case REMAP_TO_PAIRING:
            ...
            break;
# 811 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
        default:
            break;
    }
}
...
void key_remap_backend_process()
{
    ...
    for (int idx = 0; (idx < kr_ctrl.key_num) && (idx <= M_KEY_PAIRING_IDX); ++idx)
    {
        ...
        else
        {
            ...
            if ((during_macro_idx == idx) && (during_macro_idx < 10))
            {
            ...
            else if((macro_setting[idx].status) == REMAP_TO_DPI && (last_all_key & mouse_key_bits[idx]))
            {
                ...
                if((macro_setting[idx].item & 0x000000FF) == DPI_STAGE_LOCK)
                {
...
# 882 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c" 3 4
                                           1
# 882 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
                                               ;
            }
        }
    }
    ...
    if (new_z1)
    {
# 906 "/workdir/airoha/common/middleware/airoha/key_remap/src/key_remap_backend.c"
        if((((kr_ctrl.key_remap_enable & 0x40000000) != 0) && (new_z1 > 0))||
            (((kr_ctrl.key_remap_enable & 0x80000000) != 0) && (new_z1 < 0)))
        {
...
void key_remap_backend_postprocess()
{
    switch (kr_ctrl.macro_process_state)
    {
        case MACRO_START:
        {
            ...
            uint32_t rel_time = ( (macro_setting[kr_ctrl.during_macro_idx].macro) & 0xFFFFFF );

            if((hid_ctrl.rr_idx <= 2) && (rel_time <= 8))
            {
                rel_time = 8 >> hid_ctrl.rr_idx;
            }
