# 0 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c"
# 1 "/workdir/airoha/risc-v//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c"
# 37 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c"
...
# 38 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 2
...
# 39 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 2
...
# 41 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 2
...
# 42 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 2
...
int rv_fake_report_config(uint32_t enable, uint32_t pattern, uint32_t rounds)
{
    do { extern log_control_block_t log_control_block_rv_exp; __attribute__ ((__section__(".log_string"))) static const char msg_id_string[] = "[M:" "rv_exp" " C:info F: L: ]: " "rv_fake_report_config  enable =%d, pattern = %d,   rounds = %d"; print_module_msgid_log(&log_control_block_rv_exp, (PRINT_LEVEL_INFO), (msg_id_string), (3), enable , pattern , rounds); } while (0)
...
# 126 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 3 4
_Bool 
# 126 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c"
    rv_fake_report_get_report_status()
{
    if(fake_report_rounds == 0xFFFFFFFF){
        return 
# 129 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 3 4
              0
# 129 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c"
                   ;
    }
    return 
# 131 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c" 3 4
          1
# 131 "/workdir/airoha/common/middleware/airoha/hid_express/src/rv_fake_report.c"
              ;
}
