...
OUTPUT_FOLDER=out/ab1623m_evk/hid_ref_mouse_m20
OUTPUT_LOG_FOLDER=${OUTPUT_FOLDER}/log
BUILD_LOG=build_ab1623m_evk_hid_ref_mouse_m20.log

START_TIME_IN_SEC=$(TZ=UTC date +%s)

 west build -p auto -d out/ab1623m_evk/hid_ref_mouse_m20 -b ab1623m_evk --sysbuild airoha/mcu/applications/hid_device_ref_design_mouse -- -DSB_CONF_FILE=config/ab1623m_evk/sysbuild_with_mcuboot.conf -Dmcuboot_DTC_OVERLAY_FILE=config/ab162x_evb/mcuboot.overlay -Dmcuboot_CONF_FILE=config/ab162x_evb/air_mcuboot.conf -Dhid_device_ref_design_mouse_DTC_OVERLAY_FILE=config/ab1623m_evk/hid_device_ref_design_mouse_m20.overlay -Dhid_device_ref_design_mouse_CONF_FILE=config/ab1623m_evk/hid_device_ref_design_mouse_m20.conf 2>&1 | tee build_ab1623m_evk_hid_ref_mouse_m20.log
BUILD_RESULT=$?
