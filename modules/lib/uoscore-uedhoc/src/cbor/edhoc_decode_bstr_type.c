...
static bool decode_bstr_type_b_str(zcbor_state_t *state, struct zcbor_string *result);
		...
		size_t *payload_len_out)
{
	...
	return zcbor_entry_function(payload, payload_len, (void *)result, payload_len_out, states,
		(zcbor_decoder_t *)decode_bstr_type_b_str, sizeof(states) / sizeof(zcbor_state_t), 1);
}
