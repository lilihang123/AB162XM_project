...
const uint8_t *T3__MASTER_SALT = NULL;
uint8_t T3__MASTER_SALT_LEN = 0;

const uint8_t *T3__ID_CONTEXT = NULL;
...
const uint8_t *T4__MASTER_SALT = NULL;
uint8_t T4__MASTER_SALT_LEN = 0;

const uint8_t *T4__ID_CONTEXT = NULL;
...
const uint8_t *T5__SENDER_ID = NULL;
...
const uint8_t *T6__RECIPIENT_ID = NULL;
...
const uint8_t *T7__RECIPIENT_ID = NULL;
...
const uint8_t *T7__ID_CONTEXT = NULL;
