 ...
 * manually modified version is kept in order to build. Swt default
...
#define SWT_IP_SW_MAJOR_VERSION_INIT_PBCFG             1
#define SWT_IP_SW_MINOR_VERSION_INIT_PBCFG             0
#define SWT_IP_SW_PATCH_VERSION_INIT_PBCFG             0

#endif /* SWT_IP_INIT_PBCFG_H */
