...
#define FLS_QSPI_TYPES_AR_RELEASE_MINOR_VERSION     7
...
#if ((FLS_QSPI_TYPES_AR_RELEASE_MAJOR_VERSION    != QSPI_IP_HYPERFLASHTYPES_AR_RELEASE_MAJOR_VERSION) || \
     (FLS_QSPI_TYPES_AR_RELEASE_MINOR_VERSION    != QSPI_IP_HYPERFLASHTYPES_AR_RELEASE_MINOR_VERSION) || \
     (FLS_QSPI_TYPES_AR_RELEASE_REVISION_VERSION != QSPI_IP_HYPERFLASHTYPES_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((FLS_QSPI_TYPES_SW_MAJOR_VERSION != QSPI_IP_HYPERFLASHTYPES_SW_MAJOR_VERSION) || \
     (FLS_QSPI_TYPES_SW_MINOR_VERSION != QSPI_IP_HYPERFLASHTYPES_SW_MINOR_VERSION) || \
     (FLS_QSPI_TYPES_SW_PATCH_VERSION != QSPI_IP_HYPERFLASHTYPES_SW_PATCH_VERSION) \
    )
