...
#define QSPI_IP_HYPERFLASH_SW_MAJOR_VERSION_C             3
...
Qspi_Ip_InstrOpType QSPI_IP_HF_LUT_NAME[QSPI_IP_HF_LUT_SIZE] =
{
...
static Qspi_Ip_StatusType Qspi_Ip_HyperflashWaitDeviceReady(uint32 instance)
{
    ...
    if (((readValue & QSPI_IP_HF_SR_DRB_MASK) == 0U) && (status == STATUS_QSPI_IP_SUCCESS))
    {
