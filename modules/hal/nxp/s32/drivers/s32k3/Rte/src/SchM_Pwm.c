...
VAR_SEC_NOCACHE(msr_PWM_EXCLUSIVE_AREA_02) static volatile uint32 msr_PWM_EXCLUSIVE_AREA_02[NUMBER_OF_CORES];
VAR_SEC_NOCACHE(reentry_guard_PWM_EXCLUSIVE_AREA_02) static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_02[NUMBER_OF_CORES];
...
VAR_SEC_NOCACHE(msr_PWM_EXCLUSIVE_AREA_06) static volatile uint32 msr_PWM_EXCLUSIVE_AREA_06[NUMBER_OF_CORES];
VAR_SEC_NOCACHE(reentry_guard_PWM_EXCLUSIVE_AREA_06) static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_06[NUMBER_OF_CORES];
...
VAR_SEC_NOCACHE(msr_PWM_EXCLUSIVE_AREA_29) static volatile uint32 msr_PWM_EXCLUSIVE_AREA_29[NUMBER_OF_CORES];
VAR_SEC_NOCACHE(reentry_guard_PWM_EXCLUSIVE_AREA_29) static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_29[NUMBER_OF_CORES];
VAR_SEC_NOCACHE(msr_PWM_EXCLUSIVE_AREA_30) static volatile uint32 msr_PWM_EXCLUSIVE_AREA_30[NUMBER_OF_CORES];
VAR_SEC_NOCACHE(reentry_guard_PWM_EXCLUSIVE_AREA_30) static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_30[NUMBER_OF_CORES];
