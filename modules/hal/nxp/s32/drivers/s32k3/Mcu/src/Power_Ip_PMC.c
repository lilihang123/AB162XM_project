    ...
    if(PMC_UNINIT != Power_Ip_ePMCAeStatus)
    {
        ...
        if ((uint32)0U != EventReport)
        {
            ...
            if((uint32)0x0U != (EventReport & PMC_AE_MONITOR_HVDINTF_MASK))
            {
                ...
                POWER_IP_DETECT_ISR_NOTIFICATION(POWER_IP_VOLTAGE_HVD_VDDINT,POWER_IP_E_ISR_HIGH_VOLTAGE_ERROR);
#else
                Power_Ip_ReportPowerErrors(POWER_IP_ISR_VOLTAGE_HVD_VDDINT_DETECT, POWER_IP_E_ISR_HIGH_VOLTAGE_ERROR);
#endif
            }
            ...
            {
#ifdef POWER_IP_DETECT_ISR_NOTIFICATION
                POWER_IP_DETECT_ISR_NOTIFICATION(POWER_IP_VOLTAGE_HVD_15,POWER_IP_E_ISR_HIGH_VOLTAGE_ERROR);
#else
                Power_Ip_ReportPowerErrors(POWER_IP_ISR_VOLTAGE_HVD_15_DETECT, POWER_IP_E_ISR_HIGH_VOLTAGE_ERROR);
#endif
            }
        }
    }
...
void Power_Ip_PMC_AE_VoltageDetectHvdOnVddIsr(void)
{
    ...
    /* Read Voltage Detect Flag */
    Aec_Ip_SpiRead((uint32)(&(IP_PMC_AE->MONITOR)),POWER_IP_DATAWIDTH_32,&TmpAe);
    VoltageDetectFlags = (TmpAe & PMC_AE_MONITOR_HVDVDDF_MASK);
    ...
    if(PMC_UNINIT != Power_Ip_ePMCAeStatus)
    {
        ...
        if ((uint32)0U != EventReport)
        {
            ...
            {
#ifdef POWER_IP_DETECT_ISR_NOTIFICATION
                POWER_IP_DETECT_ISR_NOTIFICATION(POWER_IP_VOLTAGE_HVD_VDD,POWER_IP_E_ISR_HIGH_VOLTAGE_ERROR);
#else
                Power_Ip_ReportPowerErrors(POWER_IP_ISR_VOLTAGE_HVD_VDD_DETECT, POWER_IP_E_ISR_HIGH_VOLTAGE_ERROR);
#endif
            }
        }
    }
...
void Power_Ip_PMC_AE_VoltageDetectLvdOnVddcIsr(void)
{
    ...
    /* Read Voltage Detect Flag */
    Aec_Ip_SpiRead((uint32)(&(IP_PMC_AE->MONITOR)),POWER_IP_DATAWIDTH_32,&TmpAe);
    VoltageDetectFlags = (TmpAe & PMC_AE_MONITOR_LVDCF_MASK);
    ...
    if(PMC_UNINIT != Power_Ip_ePMCAeStatus)
    {
        ...
        if ((uint32)0U != EventReport)
        {
            ...
            {
#ifdef POWER_IP_DETECT_ISR_NOTIFICATION
                POWER_IP_DETECT_ISR_NOTIFICATION(POWER_IP_VOLTAGE_HVD_VDD,POWER_IP_E_ISR_LOW_VOLTAGE_ERROR);
#else
                Power_Ip_ReportPowerErrors(POWER_IP_ISR_VOLTAGE_HVD_VDD_DETECT, POWER_IP_E_ISR_LOW_VOLTAGE_ERROR);
#endif
            }
        }
    }
...
void Power_Ip_PMC_AE_VoltageDetectLvdOnVlsIsr(void)
{
    ...
    /* Read Voltage Detect Flag */
    Aec_Ip_SpiRead((uint32)(&(IP_PMC_AE->MONITOR)),POWER_IP_DATAWIDTH_32,&TmpAe);
    VoltageDetectFlags = (TmpAe & PMC_AE_MONITOR_LVDVLSF_MASK);
