 ...
 * @version 1.3
 * @date 2021-07-14
 * @brief Peripheral Access Layer for S32Z2_SCB
 *
...
#if !defined(S32Z2_SCB_H_)  /* Check if memory map has not been already included */
#define S32Z2_SCB_H_
...
typedef struct {
  ...
  __IO uint32_t NSACR;                             /**< Non-secure Coprocessor Access Control Register, offset: 0xD8C */
       uint8_t RESERVED_3[368];
...
#define IP_S32_SCB_BASE                             (0xE000E000u)
/** Peripheral S32_SCB base pointer */
#define S32_SCB                                  ((S32_SCB_Type *)IP_S32_SCB_BASE)
/** Array initializer of S32_SCB peripheral base addresses */
#define IP_S32_SCB_BASE_ADDRS                       { IP_S32_SCB_BASE }
/** Array initializer of S32_SCB peripheral base pointers */
#define IP_S32_SCB_BASE_PTRS                        { IP_S32_SCB }
