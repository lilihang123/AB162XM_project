...
/*!
 * @file S32Z2_SYSTICK.h
 * @version 1.3
 * @date 2021-07-14
 * @brief Peripheral Access Layer for S32Z2_SYSTICK
 *
...
#if !defined(S32Z2_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32Z2_SYSTICK_H_
...
#endif  /* #if !defined(S32Z2_SYSTICK_H_) */
