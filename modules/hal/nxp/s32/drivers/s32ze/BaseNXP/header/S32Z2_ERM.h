...
#if !defined(S32Z2_ERM_H_)  /* Check if memory map has not been already included */
#define S32Z2_ERM_H_
...
#define ERM_INSTANCE_COUNT                       (10u)

/* ERM - Peripheral instance base addresses */
/** Peripheral CE_ERM_0 base address */
#define IP_CE_ERM_0_BASE                         (0x44810000u)
/** Peripheral CE_ERM_0 base pointer */
#define IP_CE_ERM_0                              ((ERM_Type *)IP_CE_ERM_0_BASE)
/** Peripheral CE_ERM_1 base address */
#define IP_CE_ERM_1_BASE                         (0x44818000u)
/** Peripheral CE_ERM_1 base pointer */
#define IP_CE_ERM_1                              ((ERM_Type *)IP_CE_ERM_1_BASE)
/** Peripheral CE_ERM_2 base address */
#define IP_CE_ERM_2_BASE                         (0x44830000u)
/** Peripheral CE_ERM_2 base pointer */
#define IP_CE_ERM_2                              ((ERM_Type *)IP_CE_ERM_2_BASE)
/** Peripheral ERM_0 base address */
#define IP_ERM_0_BASE                            (0x40070000u)
/** Peripheral ERM_0 base pointer */
#define IP_ERM_0                                 ((ERM_Type *)IP_ERM_0_BASE)
/** Peripheral ERM_1 base address */
#define IP_ERM_1_BASE                            (0x40870000u)
/** Peripheral ERM_1 base pointer */
#define IP_ERM_1                                 ((ERM_Type *)IP_ERM_1_BASE)
/** Peripheral ERM_2 base address */
#define IP_ERM_2_BASE                            (0x41070000u)
/** Peripheral ERM_2 base pointer */
#define IP_ERM_2                                 ((ERM_Type *)IP_ERM_2_BASE)
/** Peripheral ERM_3 base address */
#define IP_ERM_3_BASE                            (0x41870000u)
/** Peripheral ERM_3 base pointer */
#define IP_ERM_3                                 ((ERM_Type *)IP_ERM_3_BASE)
/** Peripheral ERM_4 base address */
#define IP_ERM_4_BASE                            (0x42070000u)
/** Peripheral ERM_4 base pointer */
#define IP_ERM_4                                 ((ERM_Type *)IP_ERM_4_BASE)
/** Peripheral ERM_5 base address */
#define IP_ERM_5_BASE                            (0x42870000u)
/** Peripheral ERM_5 base pointer */
#define IP_ERM_5                                 ((ERM_Type *)IP_ERM_5_BASE)
/** Peripheral SMU__ERM base address */
#define IP_SMU__ERM_BASE                         (0x45010000u)
/** Peripheral SMU__ERM base pointer */
#define IP_SMU__ERM                              ((ERM_Type *)IP_SMU__ERM_BASE)
/** Array initializer of ERM peripheral base addresses */
#define IP_ERM_BASE_ADDRS                        { IP_CE_ERM_0_BASE, IP_CE_ERM_1_BASE, IP_CE_ERM_2_BASE, IP_ERM_0_BASE, IP_ERM_1_BASE, IP_ERM_2_BASE, IP_ERM_3_BASE, IP_ERM_4_BASE, IP_ERM_5_BASE, IP_SMU__ERM_BASE }
/** Array initializer of ERM peripheral base pointers */
#define IP_ERM_BASE_PTRS                         { IP_CE_ERM_0, IP_CE_ERM_1, IP_CE_ERM_2, IP_ERM_0, IP_ERM_1, IP_ERM_2, IP_ERM_3, IP_ERM_4, IP_ERM_5, IP_SMU__ERM }
