...
#define MSCM_CPXCFG2_ITCM(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_CPXCFG2_ITCM_SHIFT)) & MSCM_CPXCFG2_ITCM_MASK)

#define MSCM_CPXCFG2_TCM_MASK                    (0xFFFF0000U)
#define MSCM_CPXCFG2_TCM_SHIFT                   (16U)
#define MSCM_CPXCFG2_TCM_WIDTH                   (16U)
#define MSCM_CPXCFG2_TCM(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_CPXCFG2_TCM_SHIFT)) & MSCM_CPXCFG2_TCM_MASK)
/*! @} */
...
#define MSCM_CP0CFG2_TCM(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_CP0CFG2_TCM_SHIFT)) & MSCM_CP0CFG2_TCM_MASK)
/*! @} */
...
#define MSCM_CP1CFG2_TCM(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_CP1CFG2_TCM_SHIFT)) & MSCM_CP1CFG2_TCM_MASK)
/*! @} */
...
#define MSCM_CP2CFG2_ITCM(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_CP2CFG2_ITCM_SHIFT)) & MSCM_CP2CFG2_ITCM_MASK)

#define MSCM_CP2CFG2_TCM_MASK                    (0xFFFF0000U)
#define MSCM_CP2CFG2_TCM_SHIFT                   (16U)
#define MSCM_CP2CFG2_TCM_WIDTH                   (16U)
#define MSCM_CP2CFG2_TCM(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_CP2CFG2_TCM_SHIFT)) & MSCM_CP2CFG2_TCM_MASK)
/*! @} */
...
#define MSCM_CP3CFG2_ITCM(x)                     (((uint32_t)(((uint32_t)(x)) << MSCM_CP3CFG2_ITCM_SHIFT)) & MSCM_CP3CFG2_ITCM_MASK)

#define MSCM_CP3CFG2_TCM_MASK                    (0xFFFF0000U)
#define MSCM_CP3CFG2_TCM_SHIFT                   (16U)
#define MSCM_CP3CFG2_TCM_WIDTH                   (16U)
#define MSCM_CP3CFG2_TCM(x)                      (((uint32_t)(((uint32_t)(x)) << MSCM_CP3CFG2_TCM_SHIFT)) & MSCM_CP3CFG2_TCM_MASK)
/*! @} */
...
#define MSCM_IRSPRC_RTU0_GIC(x)                  (((uint16_t)(((uint16_t)(x)) << MSCM_IRSPRC_RTU0_GIC_SHIFT)) & MSCM_IRSPRC_RTU0_GIC_MASK)

#define MSCM_IRSPRC_RTU1_GIC_MASK                (0x2U)
#define MSCM_IRSPRC_RTU1_GIC_SHIFT               (1U)
#define MSCM_IRSPRC_RTU1_GIC_WIDTH               (1U)
#define MSCM_IRSPRC_RTU1_GIC(x)                  (((uint16_t)(((uint16_t)(x)) << MSCM_IRSPRC_RTU1_GIC_SHIFT)) & MSCM_IRSPRC_RTU1_GIC_MASK)

#define MSCM_IRSPRC_SMU_CORE_MASK                (0x4U)
#define MSCM_IRSPRC_SMU_CORE_SHIFT               (2U)
#define MSCM_IRSPRC_SMU_CORE_WIDTH               (1U)
#define MSCM_IRSPRC_SMU_CORE(x)                  (((uint16_t)(((uint16_t)(x)) << MSCM_IRSPRC_SMU_CORE_SHIFT)) & MSCM_IRSPRC_SMU_CORE_MASK)
