...
#define GPR1_LVFCCUGD1_FHID(x)                   (((uint32_t)(((uint32_t)(x)) << GPR1_LVFCCUGD1_FHID_SHIFT)) & GPR1_LVFCCUGD1_FHID_MASK)
/*! @} */
...
#define GPR1_LVFCCULD3_FHID(x)                   (((uint32_t)(((uint32_t)(x)) << GPR1_LVFCCULD3_FHID_SHIFT)) & GPR1_LVFCCULD3_FHID_MASK)
/*! @} */
...
#define GPR1_LVFCCULD4_FHID(x)                   (((uint32_t)(((uint32_t)(x)) << GPR1_LVFCCULD4_FHID_SHIFT)) & GPR1_LVFCCULD4_FHID_MASK)
/*! @} */
...
#define GPR1_FUNCC2_CTRL(x)                      (((uint32_t)(((uint32_t)(x)) << GPR1_FUNCC2_CTRL_SHIFT)) & GPR1_FUNCC2_CTRL_MASK)
/*! @} */
...
#define GPR1_INITM1_STAT(x)                      (((uint32_t)(((uint32_t)(x)) << GPR1_INITM1_STAT_SHIFT)) & GPR1_INITM1_STAT_MASK)
/*! @} */
...
#define GPR1_TARGTMS1_STAT(x)                    (((uint32_t)(((uint32_t)(x)) << GPR1_TARGTMS1_STAT_SHIFT)) & GPR1_TARGTMS1_STAT_MASK)
/*! @} */
...
#define GPR1_TARGTMC1_EN(x)                      (((uint32_t)(((uint32_t)(x)) << GPR1_TARGTMC1_EN_SHIFT)) & GPR1_TARGTMC1_EN_MASK)
/*! @} */
...
#define GPR1_NETCC0_IERBLOCK(x)                  (((uint32_t)(((uint32_t)(x)) << GPR1_NETCC0_IERBLOCK_SHIFT)) & GPR1_NETCC0_IERBLOCK_MASK)
/*! @} */
...
#define GPR1_NETCC1_LINK0MIIP(x)                 (((uint32_t)(((uint32_t)(x)) << GPR1_NETCC1_LINK0MIIP_SHIFT)) & GPR1_NETCC1_LINK0MIIP_MASK)

#define GPR1_NETCC1_LINK1MIIP_MASK               (0xF0U)
#define GPR1_NETCC1_LINK1MIIP_SHIFT              (4U)
#define GPR1_NETCC1_LINK1MIIP_WIDTH              (4U)
#define GPR1_NETCC1_LINK1MIIP(x)                 (((uint32_t)(((uint32_t)(x)) << GPR1_NETCC1_LINK1MIIP_SHIFT)) & GPR1_NETCC1_LINK1MIIP_MASK)
/*! @} */
...
#define GPR1_XPAR1_DIS(x)                        (((uint32_t)(((uint32_t)(x)) << GPR1_XPAR1_DIS_SHIFT)) & GPR1_XPAR1_DIS_MASK)

#define GPR1_XPAR1_STAT_MASK                     (0x100U)
#define GPR1_XPAR1_STAT_SHIFT                    (8U)
#define GPR1_XPAR1_STAT_WIDTH                    (1U)
#define GPR1_XPAR1_STAT(x)                       (((uint32_t)(((uint32_t)(x)) << GPR1_XPAR1_STAT_SHIFT)) & GPR1_XPAR1_STAT_MASK)
/*! @} */
