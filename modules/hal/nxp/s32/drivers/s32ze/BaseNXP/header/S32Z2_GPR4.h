...
#define GPR4_LVFCCUGD4_FHID(x)                   (((uint32_t)(((uint32_t)(x)) << GPR4_LVFCCUGD4_FHID_SHIFT)) & GPR4_LVFCCUGD4_FHID_MASK)
/*! @} */
...
#define GPR4_LVFCCULD12_FHID(x)                  (((uint32_t)(((uint32_t)(x)) << GPR4_LVFCCULD12_FHID_SHIFT)) & GPR4_LVFCCULD12_FHID_MASK)
/*! @} */
...
#define GPR4_LVFCCULD13_FHID(x)                  (((uint32_t)(((uint32_t)(x)) << GPR4_LVFCCULD13_FHID_SHIFT)) & GPR4_LVFCCULD13_FHID_MASK)
/*! @} */
...
#define GPR4_LVFCCULD14_FHID(x)                  (((uint32_t)(((uint32_t)(x)) << GPR4_LVFCCULD14_FHID_SHIFT)) & GPR4_LVFCCULD14_FHID_MASK)
/*! @} */
...
#define GPR4_INITM4_STAT(x)                      (((uint32_t)(((uint32_t)(x)) << GPR4_INITM4_STAT_SHIFT)) & GPR4_INITM4_STAT_MASK)
/*! @} */
...
#define GPR4_TARGTMS4_STAT(x)                    (((uint32_t)(((uint32_t)(x)) << GPR4_TARGTMS4_STAT_SHIFT)) & GPR4_TARGTMS4_STAT_MASK)
/*! @} */
...
#define GPR4_TARGTMC4_EN(x)                      (((uint32_t)(((uint32_t)(x)) << GPR4_TARGTMC4_EN_SHIFT)) & GPR4_TARGTMC4_EN_MASK)
/*! @} */
...
#define GPR4_CLKOUT2SEL_MUXSEL(x)                (((uint32_t)(((uint32_t)(x)) << GPR4_CLKOUT2SEL_MUXSEL_SHIFT)) & GPR4_CLKOUT2SEL_MUXSEL_MASK)
/*! @} */
...
#define GPR4_MEW0MSTDIS_MSTRDIS(x)               (((uint32_t)(((uint32_t)(x)) << GPR4_MEW0MSTDIS_MSTRDIS_SHIFT)) & GPR4_MEW0MSTDIS_MSTRDIS_MASK)

#define GPR4_MEW0MSTDIS_MID_MASK                 (0x7EU)
#define GPR4_MEW0MSTDIS_MID_SHIFT                (1U)
#define GPR4_MEW0MSTDIS_MID_WIDTH                (6U)
#define GPR4_MEW0MSTDIS_MID(x)                   (((uint32_t)(((uint32_t)(x)) << GPR4_MEW0MSTDIS_MID_SHIFT)) & GPR4_MEW0MSTDIS_MID_MASK)
/*! @} */
...
#define GPR4_MEW1MSTDIS_MSTRDIS(x)               (((uint32_t)(((uint32_t)(x)) << GPR4_MEW1MSTDIS_MSTRDIS_SHIFT)) & GPR4_MEW1MSTDIS_MSTRDIS_MASK)
...
#define GPR4_HSE_SYS_FUSEC_CTRL(x)               (((uint32_t)(((uint32_t)(x)) << GPR4_HSE_SYS_FUSEC_CTRL_SHIFT)) & GPR4_HSE_SYS_FUSEC_CTRL_MASK)
/*! @} */
