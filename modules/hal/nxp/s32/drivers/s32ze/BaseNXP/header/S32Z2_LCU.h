...
#if !defined(S32Z2_LCU_H_)  /* Check if memory map has not been already included */
#define S32Z2_LCU_H_
...
typedef struct {
  ...
  __IO uint32_t STPEN;                             /**< Stop Mode Enable, offset: 0x2A4 */
...
#define LCU_STPEN_STPEN_MASK                     (0xFFFU)
#define LCU_STPEN_STPEN_SHIFT                    (0U)
#define LCU_STPEN_STPEN_WIDTH                    (12U)
