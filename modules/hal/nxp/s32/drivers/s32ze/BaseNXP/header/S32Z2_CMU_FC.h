...
#define IP_CMU_FC_BASE_PTRS                      { IP_CE_CMU_FC_0, IP_CE_CMU_FC_1, IP_CE_CMU_FC_2, IP_CMU_FC_0, IP_CMU_FC_1, IP_CMU_FC_2A, IP_CMU_FC_2B, IP_CMU_FC_2C, IP_CMU_FC_2D, IP_CMU_FC_3, IP_CMU_FC_4, IP_CMU_FC_5, IP_CMU_FC_6, IP_CMU_FC_DEBUG_1, IP_CMU_FC_DEBUG_2, IP_AES__CMU_FC, IP_RTU0__CMU_FC_0, IP_RTU0__CMU_FC_1, IP_RTU0__CMU_FC_2, IP_RTU0__CMU_FC_3, IP_RTU0__CMU_FC_4, IP_RTU1__CMU_FC_0, IP_RTU1__CMU_FC_1, IP_RTU1__CMU_FC_2, IP_RTU1__CMU_FC_3, IP_RTU1__CMU_FC_4, IP_SMU__CMU_FC }
...
#define CMU_FC_GCR_FI_SCE(x)                     (((uint32_t)(((uint32_t)(x)) << CMU_FC_GCR_FI_SCE_SHIFT)) & CMU_FC_GCR_FI_SCE_MASK)

#define CMU_FC_GCR_FI_START_MASK                 (0x200U)
#define CMU_FC_GCR_FI_START_SHIFT                (9U)
#define CMU_FC_GCR_FI_START_WIDTH                (1U)
#define CMU_FC_GCR_FI_START(x)                   (((uint32_t)(((uint32_t)(x)) << CMU_FC_GCR_FI_START_SHIFT)) & CMU_FC_GCR_FI_START_MASK)

#define CMU_FC_GCR_FI_AUTO_EN_MASK               (0x400U)
#define CMU_FC_GCR_FI_AUTO_EN_SHIFT              (10U)
#define CMU_FC_GCR_FI_AUTO_EN_WIDTH              (1U)
#define CMU_FC_GCR_FI_AUTO_EN(x)                 (((uint32_t)(((uint32_t)(x)) << CMU_FC_GCR_FI_AUTO_EN_SHIFT)) & CMU_FC_GCR_FI_AUTO_EN_MASK)

#define CMU_FC_GCR_FI_INT_MASK_MASK              (0x800U)
#define CMU_FC_GCR_FI_INT_MASK_SHIFT             (11U)
#define CMU_FC_GCR_FI_INT_MASK_WIDTH             (1U)
#define CMU_FC_GCR_FI_INT_MASK(x)                (((uint32_t)(((uint32_t)(x)) << CMU_FC_GCR_FI_INT_MASK_SHIFT)) & CMU_FC_GCR_FI_INT_MASK_MASK)
...
#define CMU_FC_GCR_FI_AUTO_RCOUNT(x)             (((uint32_t)(((uint32_t)(x)) << CMU_FC_GCR_FI_AUTO_RCOUNT_SHIFT)) & CMU_FC_GCR_FI_AUTO_RCOUNT_MASK)
/*! @} */
...
#define CMU_FC_SR_AFI_FAIL(x)                    (((uint32_t)(((uint32_t)(x)) << CMU_FC_SR_AFI_FAIL_SHIFT)) & CMU_FC_SR_AFI_FAIL_MASK)

#define CMU_FC_SR_FI_PASS_MASK                   (0x100000U)
#define CMU_FC_SR_FI_PASS_SHIFT                  (20U)
#define CMU_FC_SR_FI_PASS_WIDTH                  (1U)
#define CMU_FC_SR_FI_PASS(x)                     (((uint32_t)(((uint32_t)(x)) << CMU_FC_SR_FI_PASS_SHIFT)) & CMU_FC_SR_FI_PASS_MASK)

#define CMU_FC_SR_FI_COMP_MASK                   (0x800000U)
#define CMU_FC_SR_FI_COMP_SHIFT                  (23U)
#define CMU_FC_SR_FI_COMP_WIDTH                  (1U)
#define CMU_FC_SR_FI_COMP(x)                     (((uint32_t)(((uint32_t)(x)) << CMU_FC_SR_FI_COMP_SHIFT)) & CMU_FC_SR_FI_COMP_MASK)
/*! @} */
...
#define CMU_FC_IER_AFIFIE(x)                     (((uint32_t)(((uint32_t)(x)) << CMU_FC_IER_AFIFIE_SHIFT)) & CMU_FC_IER_AFIFIE_MASK)

#define CMU_FC_IER_AFIAFIE_MASK                  (0x20000U)
#define CMU_FC_IER_AFIAFIE_SHIFT                 (17U)
#define CMU_FC_IER_AFIAFIE_WIDTH                 (1U)
#define CMU_FC_IER_AFIAFIE(x)                    (((uint32_t)(((uint32_t)(x)) << CMU_FC_IER_AFIAFIE_SHIFT)) & CMU_FC_IER_AFIAFIE_MASK)

#define CMU_FC_IER_FIPIE_MASK                    (0x100000U)
#define CMU_FC_IER_FIPIE_SHIFT                   (20U)
#define CMU_FC_IER_FIPIE_WIDTH                   (1U)
#define CMU_FC_IER_FIPIE(x)                      (((uint32_t)(((uint32_t)(x)) << CMU_FC_IER_FIPIE_SHIFT)) & CMU_FC_IER_FIPIE_MASK)

#define CMU_FC_IER_FIAPIE_MASK                   (0x200000U)
#define CMU_FC_IER_FIAPIE_SHIFT                  (21U)
#define CMU_FC_IER_FIAPIE_WIDTH                  (1U)
#define CMU_FC_IER_FIAPIE(x)                     (((uint32_t)(((uint32_t)(x)) << CMU_FC_IER_FIAPIE_SHIFT)) & CMU_FC_IER_FIAPIE_MASK)

#define CMU_FC_IER_FICIE_MASK                    (0x800000U)
#define CMU_FC_IER_FICIE_SHIFT                   (23U)
#define CMU_FC_IER_FICIE_WIDTH                   (1U)
#define CMU_FC_IER_FICIE(x)                      (((uint32_t)(((uint32_t)(x)) << CMU_FC_IER_FICIE_SHIFT)) & CMU_FC_IER_FICIE_MASK)
/*! @} */
