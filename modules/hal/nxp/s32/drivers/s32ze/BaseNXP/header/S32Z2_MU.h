 ...
 * @version 2.1
 * @date 2023-07-20
 * @brief Peripheral Access Layer for S32Z2_MU
 *
...
#if !defined(S32Z2_MU_H_)  /* Check if memory map has not been already included */
#define S32Z2_MU_H_
...
#define IP_MU0__MUB_BASE                         (0x42200000u)
...
#define IP_MU1__MUB_BASE                         (0x42210000u)
...
#define IP_MU2__MUB_BASE                         (0x42220000u)
...
#define IP_MU3__MUB_BASE                         (0x42230000u)
/** Peripheral MU3__MUB base pointer */
#define IP_MU3__MUB                              ((MU_Type *)IP_MU3__MUB_BASE)
/** Peripheral MU4__MUA base address */
#define IP_MU4__MUA_BASE                         (0x2325C000u)
/** Peripheral MU4__MUA base pointer */
#define IP_MU4__MUA                              ((MU_Type *)IP_MU4__MUA_BASE)
/** Peripheral MU4__MUB base address */
#define IP_MU4__MUB_BASE                         (0x42240000u)
/** Peripheral MU4__MUB base pointer */
#define IP_MU4__MUB                              ((MU_Type *)IP_MU4__MUB_BASE)
/** Peripheral MU5__MUA base address */
#define IP_MU5__MUA_BASE                         (0x2325D000u)
/** Peripheral MU5__MUA base pointer */
#define IP_MU5__MUA                              ((MU_Type *)IP_MU5__MUA_BASE)
/** Peripheral MU5__MUB base address */
#define IP_MU5__MUB_BASE                         (0x42250000u)
/** Peripheral MU5__MUB base pointer */
#define IP_MU5__MUB                              ((MU_Type *)IP_MU5__MUB_BASE)
/** Peripheral MU6__MUA base address */
#define IP_MU6__MUA_BASE                         (0x2325E000u)
/** Peripheral MU6__MUA base pointer */
#define IP_MU6__MUA                              ((MU_Type *)IP_MU6__MUA_BASE)
/** Peripheral MU6__MUB base address */
#define IP_MU6__MUB_BASE                         (0x42260000u)
/** Peripheral MU6__MUB base pointer */
#define IP_MU6__MUB                              ((MU_Type *)IP_MU6__MUB_BASE)
/** Peripheral MU7__MUA base address */
#define IP_MU7__MUA_BASE                         (0x2325F000u)
/** Peripheral MU7__MUA base pointer */
#define IP_MU7__MUA                              ((MU_Type *)IP_MU7__MUA_BASE)
/** Peripheral MU7__MUB base address */
#define IP_MU7__MUB_BASE                         (0x42270000u)
/** Peripheral MU7__MUB base pointer */
#define IP_MU7__MUB                              ((MU_Type *)IP_MU7__MUB_BASE)
/** Array initializer of MU peripheral base addresses */
#define IP_MU_BASE_ADDRS                         { IP_MU0__MUA_BASE, IP_MU0__MUB_BASE, IP_MU1__MUA_BASE, IP_MU1__MUB_BASE, IP_MU2__MUA_BASE, IP_MU2__MUB_BASE, IP_MU3__MUA_BASE, IP_MU3__MUB_BASE, IP_MU4__MUA_BASE, IP_MU4__MUB_BASE, IP_MU5__MUA_BASE, IP_MU5__MUB_BASE, IP_MU6__MUA_BASE, IP_MU6__MUB_BASE, IP_MU7__MUA_BASE, IP_MU7__MUB_BASE }
/** Array initializer of MU peripheral base pointers */
#define IP_MU_BASE_PTRS                          { IP_MU0__MUA, IP_MU0__MUB, IP_MU1__MUA, IP_MU1__MUB, IP_MU2__MUA, IP_MU2__MUB, IP_MU3__MUA, IP_MU3__MUB, IP_MU4__MUA, IP_MU4__MUB, IP_MU5__MUA, IP_MU5__MUB, IP_MU6__MUA, IP_MU6__MUB, IP_MU7__MUA, IP_MU7__MUB }
