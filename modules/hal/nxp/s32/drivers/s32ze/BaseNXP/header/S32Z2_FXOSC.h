 ...
 * @version 2.1
 * @date 2023-07-20
 * @brief Peripheral Access Layer for S32Z2_FXOSC
 *
...
#if !defined(S32Z2_FXOSC_H_)  /* Check if memory map has not been already included */
#define S32Z2_FXOSC_H_
...
#define IP_FXOSC_BASE                            (0x40200000u)
...
#endif  /* #if !defined(S32Z2_FXOSC_H_) */
