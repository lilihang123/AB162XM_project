...
#define SW_ETH_MAC_PORT0_PM0_COMMAND_CONFIG_TX_LOWP_ENA_MASK (0x800000U)
#define SW_ETH_MAC_PORT0_PM0_COMMAND_CONFIG_TX_LOWP_ENA_SHIFT (23U)
#define SW_ETH_MAC_PORT0_PM0_COMMAND_CONFIG_TX_LOWP_ENA_WIDTH (1U)
#define SW_ETH_MAC_PORT0_PM0_COMMAND_CONFIG_TX_LOWP_ENA(x) (((uint32_t)(((uint32_t)(x)) << SW_ETH_MAC_PORT0_PM0_COMMAND_CONFIG_TX_LOWP_ENA_SHIFT)) & SW_ETH_MAC_PORT0_PM0_COMMAND_CONFIG_TX_LOWP_ENA_MASK)
...
#define SW_ETH_MAC_PORT0_PM0_LPWAKE_TIMER_TW_SYS_TX_MASK (0xFFFFFFU)
#define SW_ETH_MAC_PORT0_PM0_LPWAKE_TIMER_TW_SYS_TX_SHIFT (0U)
#define SW_ETH_MAC_PORT0_PM0_LPWAKE_TIMER_TW_SYS_TX_WIDTH (24U)
#define SW_ETH_MAC_PORT0_PM0_LPWAKE_TIMER_TW_SYS_TX(x) (((uint32_t)(((uint32_t)(x)) << SW_ETH_MAC_PORT0_PM0_LPWAKE_TIMER_TW_SYS_TX_SHIFT)) & SW_ETH_MAC_PORT0_PM0_LPWAKE_TIMER_TW_SYS_TX_MASK)
/*! @} */

/*! @name PM0_SLEEP_TIMER - Port MAC 0 Transmit EEE Low Power Timer Register */
/*! @{ */

#define SW_ETH_MAC_PORT0_PM0_SLEEP_TIMER_SLEEPT_MASK (0xFFFFFFU)
#define SW_ETH_MAC_PORT0_PM0_SLEEP_TIMER_SLEEPT_SHIFT (0U)
#define SW_ETH_MAC_PORT0_PM0_SLEEP_TIMER_SLEEPT_WIDTH (24U)
#define SW_ETH_MAC_PORT0_PM0_SLEEP_TIMER_SLEEPT(x) (((uint32_t)(((uint32_t)(x)) << SW_ETH_MAC_PORT0_PM0_SLEEP_TIMER_SLEEPT_SHIFT)) & SW_ETH_MAC_PORT0_PM0_SLEEP_TIMER_SLEEPT_MASK)
/*! @} */

/*! @name PM0_SINGLE_STEP - Port MAC 0 IEEE1588 Single-Step Control Register */
/*! @{ */

#define SW_ETH_MAC_PORT0_PM0_SINGLE_STEP_OFFSET_MASK (0xFF80U)
#define SW_ETH_MAC_PORT0_PM0_SINGLE_STEP_OFFSET_SHIFT (7U)
#define SW_ETH_MAC_PORT0_PM0_SINGLE_STEP_OFFSET_WIDTH (9U)
...
#define SW_ETH_MAC_PORT0_PM1_COMMAND_CONFIG_TX_LOWP_ENA_MASK (0x800000U)
#define SW_ETH_MAC_PORT0_PM1_COMMAND_CONFIG_TX_LOWP_ENA_SHIFT (23U)
#define SW_ETH_MAC_PORT0_PM1_COMMAND_CONFIG_TX_LOWP_ENA_WIDTH (1U)
#define SW_ETH_MAC_PORT0_PM1_COMMAND_CONFIG_TX_LOWP_ENA(x) (((uint32_t)(((uint32_t)(x)) << SW_ETH_MAC_PORT0_PM1_COMMAND_CONFIG_TX_LOWP_ENA_SHIFT)) & SW_ETH_MAC_PORT0_PM1_COMMAND_CONFIG_TX_LOWP_ENA_MASK)
...
#define SW_ETH_MAC_PORT0_PM1_LPWAKE_TIMER_TW_SYS_TX_MASK (0xFFFFFFU)
#define SW_ETH_MAC_PORT0_PM1_LPWAKE_TIMER_TW_SYS_TX_SHIFT (0U)
#define SW_ETH_MAC_PORT0_PM1_LPWAKE_TIMER_TW_SYS_TX_WIDTH (24U)
#define SW_ETH_MAC_PORT0_PM1_LPWAKE_TIMER_TW_SYS_TX(x) (((uint32_t)(((uint32_t)(x)) << SW_ETH_MAC_PORT0_PM1_LPWAKE_TIMER_TW_SYS_TX_SHIFT)) & SW_ETH_MAC_PORT0_PM1_LPWAKE_TIMER_TW_SYS_TX_MASK)
/*! @} */

/*! @name PM1_SLEEP_TIMER - Port MAC 1 Transmit EEE Low Power Timer Register */
/*! @{ */

#define SW_ETH_MAC_PORT0_PM1_SLEEP_TIMER_SLEEPT_MASK (0xFFFFFFU)
#define SW_ETH_MAC_PORT0_PM1_SLEEP_TIMER_SLEEPT_SHIFT (0U)
#define SW_ETH_MAC_PORT0_PM1_SLEEP_TIMER_SLEEPT_WIDTH (24U)
#define SW_ETH_MAC_PORT0_PM1_SLEEP_TIMER_SLEEPT(x) (((uint32_t)(((uint32_t)(x)) << SW_ETH_MAC_PORT0_PM1_SLEEP_TIMER_SLEEPT_SHIFT)) & SW_ETH_MAC_PORT0_PM1_SLEEP_TIMER_SLEEPT_MASK)
/*! @} */

/*! @name PM1_SINGLE_STEP - Port MAC 1 IEEE1588 Single-Step Control Register */
/*! @{ */

#define SW_ETH_MAC_PORT0_PM1_SINGLE_STEP_OFFSET_MASK (0xFF80U)
#define SW_ETH_MAC_PORT0_PM1_SINGLE_STEP_OFFSET_SHIFT (7U)
#define SW_ETH_MAC_PORT0_PM1_SINGLE_STEP_OFFSET_WIDTH (9U)
