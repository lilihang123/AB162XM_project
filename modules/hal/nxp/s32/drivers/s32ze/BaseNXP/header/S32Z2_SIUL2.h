...
#define IP_SIUL2_BASE_ADDRS                      { IP_SIUL2_0_BASE, IP_SIUL2_1_BASE, IP_SIUL2_3_BASE, IP_SIUL2_4_BASE, IP_SIUL2_5_BASE }
...
#define SIUL2_MIDR3_SYSTEM_RAM_SIZE(x)           (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR3_SYSTEM_RAM_SIZE_SHIFT)) & SIUL2_MIDR3_SYSTEM_RAM_SIZE_MASK)
...
#define SIUL2_MIDR3_PART_NO_LETTER(x)            (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR3_PART_NO_LETTER_SHIFT)) & SIUL2_MIDR3_PART_NO_LETTER_MASK)
...
#define SIUL2_MIDR3_PRODUCT_FAMILY_NO(x)         (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR3_PRODUCT_FAMILY_NO_SHIFT)) & SIUL2_MIDR3_PRODUCT_FAMILY_NO_MASK)
...
#define SIUL2_MIDR4_AE0(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_AE0_SHIFT)) & SIUL2_MIDR4_AE0_MASK)

#define SIUL2_MIDR4_AE_RC_MASK                   (0x2U)
#define SIUL2_MIDR4_AE_RC_SHIFT                  (1U)
#define SIUL2_MIDR4_AE_RC_WIDTH                  (1U)
#define SIUL2_MIDR4_AE_RC(x)                     (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_AE_RC_SHIFT)) & SIUL2_MIDR4_AE_RC_MASK)

#define SIUL2_MIDR4_DIP_MASK                     (0x4U)
#define SIUL2_MIDR4_DIP_SHIFT                    (2U)
#define SIUL2_MIDR4_DIP_WIDTH                    (1U)
#define SIUL2_MIDR4_DIP(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_DIP_SHIFT)) & SIUL2_MIDR4_DIP_MASK)

#define SIUL2_MIDR4_GTM_MASK                     (0x200U)
#define SIUL2_MIDR4_GTM_SHIFT                    (9U)
#define SIUL2_MIDR4_GTM_WIDTH                    (1U)
#define SIUL2_MIDR4_GTM(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_GTM_SHIFT)) & SIUL2_MIDR4_GTM_MASK)

#define SIUL2_MIDR4_CANXL_FUNC_MASK              (0x400U)
#define SIUL2_MIDR4_CANXL_FUNC_SHIFT             (10U)
#define SIUL2_MIDR4_CANXL_FUNC_WIDTH             (1U)
#define SIUL2_MIDR4_CANXL_FUNC(x)                (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_CANXL_FUNC_SHIFT)) & SIUL2_MIDR4_CANXL_FUNC_MASK)

#define SIUL2_MIDR4_CANXL_INST_MASK              (0x800U)
#define SIUL2_MIDR4_CANXL_INST_SHIFT             (11U)
#define SIUL2_MIDR4_CANXL_INST_WIDTH             (1U)
#define SIUL2_MIDR4_CANXL_INST(x)                (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_CANXL_INST_SHIFT)) & SIUL2_MIDR4_CANXL_INST_MASK)

#define SIUL2_MIDR4_MCP_MASK                     (0x1000U)
#define SIUL2_MIDR4_MCP_SHIFT                    (12U)
#define SIUL2_MIDR4_MCP_WIDTH                    (1U)
#define SIUL2_MIDR4_MCP(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_MCP_SHIFT)) & SIUL2_MIDR4_MCP_MASK)

#define SIUL2_MIDR4_HPBF_MASK                    (0x2000U)
#define SIUL2_MIDR4_HPBF_SHIFT                   (13U)
#define SIUL2_MIDR4_HPBF_WIDTH                   (1U)
#define SIUL2_MIDR4_HPBF(x)                      (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_HPBF_SHIFT)) & SIUL2_MIDR4_HPBF_MASK)

#define SIUL2_MIDR4_OTA_MASK                     (0x4000U)
#define SIUL2_MIDR4_OTA_SHIFT                    (14U)
#define SIUL2_MIDR4_OTA_WIDTH                    (1U)
#define SIUL2_MIDR4_OTA(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_OTA_SHIFT)) & SIUL2_MIDR4_OTA_MASK)

#define SIUL2_MIDR4_SERDES_MASK                  (0x8000U)
#define SIUL2_MIDR4_SERDES_SHIFT                 (15U)
#define SIUL2_MIDR4_SERDES_WIDTH                 (1U)
#define SIUL2_MIDR4_SERDES(x)                    (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_SERDES_SHIFT)) & SIUL2_MIDR4_SERDES_MASK)
...
#define SIUL2_MIDR4_COMPUTE_DIE_PART_NUMBER(x)   (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_COMPUTE_DIE_PART_NUMBER_SHIFT)) & SIUL2_MIDR4_COMPUTE_DIE_PART_NUMBER_MASK)
...
#define SIUL2_MIDR4_FLASH_CONFIG(x)              (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_FLASH_CONFIG_SHIFT)) & SIUL2_MIDR4_FLASH_CONFIG_MASK)
...
#define SIUL2_MIDR4_FLASH_VENDOR(x)              (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR4_FLASH_VENDOR_SHIFT)) & SIUL2_MIDR4_FLASH_VENDOR_MASK)
/*! @} */
...
#define SIUL2_MSCR_TRC(x)                        (((uint32_t)(((uint32_t)(x)) << SIUL2_MSCR_TRC_SHIFT)) & SIUL2_MSCR_TRC_MASK)
...
#define SIUL2_MSCR_CREF(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MSCR_CREF_SHIFT)) & SIUL2_MSCR_CREF_MASK)
...
#define SIUL2_MSCR_RXCB(x)                       (((uint32_t)(((uint32_t)(x)) << SIUL2_MSCR_RXCB_SHIFT)) & SIUL2_MSCR_RXCB_MASK)
