...
#else
#define FLEXSPI_AMBA_BASE FlexSPI_AMBA_PC_CACHE_BASE
#endif
...
static const uint32_t customLUT[CUSTOM_LUT_LENGTH] = {
    ...
    [4 * NOR_CMD_LUT_SEQ_IDX_PAGEPROGRAM_QUAD] =
        FLEXSPI_LUT_SEQ(kFLEXSPI_Command_SDR, kFLEXSPI_1PAD, 0x3E, kFLEXSPI_Command_RADDR_SDR, kFLEXSPI_4PAD, 0x20),
