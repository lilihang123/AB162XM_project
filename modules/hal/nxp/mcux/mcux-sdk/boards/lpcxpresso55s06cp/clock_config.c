...
!!GlobalInfo
product: Clocks v7.0
processor: LPC5506CPXXXX
package_id: LPC55S06JHI48CPXXXX
mcu_data: ksdk2_0
...
- {id: SYSCON.PLL0M_MULT.scale, value: '96', locked: true}
...
void BOARD_BootClockPLL96M(void)
{
    ...
    const pll_setup_t pll0Setup = {
        .pllctrl = SYSCON_PLL0CTRL_CLKEN_MASK | SYSCON_PLL0CTRL_SELI(51U) | SYSCON_PLL0CTRL_SELP(25U),
        .pllndec = SYSCON_PLL0NDEC_NDIV(4U),
        .pllpdec = SYSCON_PLL0PDEC_PDIV(2U),
        .pllsscg = {0x0U,(SYSCON_PLL0SSCG1_MDIV_EXT(96U) | SYSCON_PLL0SSCG1_SEL_EXT_MASK)},
        .pllRate = 96000000U,
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll0Setup = {
        ...
        .pllndec = SYSCON_PLL0NDEC_NDIV(6U),
