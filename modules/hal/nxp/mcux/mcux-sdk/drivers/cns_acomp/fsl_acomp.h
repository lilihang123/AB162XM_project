...
#define FSL_ACOMP_DRIVER_VERSION (MAKE_VERSION(2, 0, 1)) /*!< Version 2.0.1. */

/*!
 * @brief The macro to get the address based on start address and acomp id.
 */
#define ACOMP_REG_ADDR(startAddr, id) ((volatile uint32_t *)((volatile uint32_t *)(startAddr) + (uint32_t)(id)))
#define ACOMP_REG_CONST_ADDR(startAddr, id) \
    ((volatile const uint32_t *)((volatile const uint32_t *)(startAddr) + (uint32_t)(id)))
...
#define ACOMP_GET_REG_CONST_VAL(startAddr, id) (*ACOMP_REG_CONST_ADDR((startAddr), (id)))
/*!
...
{
    kACOMP_PosCh0,    /*!< ACOMP Channel0 selection */
    kACOMP_PosCh1,    /*!< ACOMP Channel1 selection */
    kACOMP_PosCh2,    /*!< ACOMP Channel2 selection */
    kACOMP_PosCh3,    /*!< ACOMP Channel3 selection */
    kACOMP_PosCh4,    /*!< ACOMP Channel4 selection */
    kACOMP_PosCh5,    /*!< ACOMP Channel5 selection */
    kACOMP_PosCh6,    /*!< ACOMP Channel6 selection */
    kACOMP_PosCh7,    /*!< ACOMP Channel7 selection */
...
{
    kACOMP_NegCh0,        /*!< ACOMP Channel0 selection */
    kACOMP_NegCh1,        /*!< ACOMP Channel1 selection */
    kACOMP_NegCh2,        /*!< ACOMP Channel2 selection */
    kACOMP_NegCh3,        /*!< ACOMP Channel3 selection */
    kACOMP_NegCh4,        /*!< ACOMP Channel4 selection */
    kACOMP_NegCh5,        /*!< ACOMP Channel5 selection */
    kACOMP_NegCh6,        /*!< ACOMP Channel6 selection */
    kACOMP_NegCh7,        /*!< ACOMP Channel7 selection */
...
static inline acomp_result_logic_status_t ACOMP_GetResult(ACOMP_Type *base, acomp_comparator_id_t id)
{
    ...
    val = ((ACOMP_GET_REG_CONST_VAL(&(base->STATUS0), id) & ACOMP_STATUS0_OUT_MASK) >> ACOMP_STATUS0_OUT_SHIFT);
    return (acomp_result_logic_status_t)val;
}
...
{
    assert((statusFlagMask &
            ((uint32_t)kACOMP_Acomp0ActiveFlag | (uint32_t)kACOMP_Acomp1ActiveFlag |
             (uint32_t)kACOMP_Acomp0RawOutInterruptFlag | (uint32_t)kACOMP_Acomp1RawOutInterruptFlag |
             (uint32_t)kACOMP_Acomp0RawOutAInterruptFlag | (uint32_t)kACOMP_Acomp1RawOutAInterruptFlag)) == 0UL);

    base->ICR0 =
        (statusFlagMask & ((uint32_t)kACOMP_Acomp0OutInterruptFlag | (uint32_t)kACOMP_Acomp0OutAInterruptFlag)) >> 1UL;
    base->ICR1 =
