 ...
 * @version 1.0
 * @date 270923
 * @brief Device specific configuration file for MIMX8US3_cm33 (header file)
 *
 * Provides a system configuration function and a global variable that contains
 * the system frequency. It configures the device and initializes the oscillator
 * (PLL) that is part of the microcontroller device.
 */
#ifndef _SYSTEM_MIMX8US3_cm33_H_
#define _SYSTEM_MIMX8US3_cm33_H_                    /**< Symbol preventing repeated inclusion */
...
#endif  /* _SYSTEM_MIMX8US3_cm33_H_ */
