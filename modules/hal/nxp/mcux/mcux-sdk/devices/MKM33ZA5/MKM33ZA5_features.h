...
#ifndef _MKM33ZA5_FEATURES_H_
#define _MKM33ZA5_FEATURES_H_
...
#define FSL_FEATURE_SOC_DMAMUX_COUNT (4)
...
#define FSL_FEATURE_SOC_PORT_COUNT (9)
...
#define FSL_FEATURE_AFE_CHANNEL_NUMBER_WITH_PGA (2)
...
#define FSL_FEATURE_DMA_DMAMUX_CHANNELS (16)

/* DMAMUX module features */

/* @brief Number of DMA channels (related to number of register CHCFGn). */
#define FSL_FEATURE_DMAMUX_MODULE_CHANNEL (1)
/* @brief Total number of DMA channels on all modules. */
...
/* FLASH module features */
...
#if defined(CPU_MKM33Z128ACLH5) || defined(CPU_MKM33Z128ACLL5)
...
#elif defined(CPU_MKM33Z64ACLH5) || defined(CPU_MKM33Z64ACLL5)
    /* @brief Is of type FTFA. */
    #define FSL_FEATURE_FLASH_IS_FTFA (1)
    /* @brief Is of type FTFE. */
    #define FSL_FEATURE_FLASH_IS_FTFE (0)
    ...
    /* @brief Emulated eeprom size code 1111 mapping to emulated eeprom size in bytes (0xFFFF = reserved). */
    #define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1111 (0xFFFF)
#endif /* defined(CPU_MKM33Z128ACLH5) || defined(CPU_MKM33Z128ACLL5) */
...
/* @brief Has no independent GPIO output control registers(register PSOR, PCOR and PTOR). */
#define FSL_FEATURE_GPIO_HAS_NO_INDEP_OUTPUT_CONTROL (1)
...
/* LLWU module features */
...
#if defined(CPU_MKM33Z128ACLH5) || defined(CPU_MKM33Z64ACLH5)
    ...
    #define FSL_FEATURE_LLWU_HAS_INTERNAL_MODULE (5)
...
#elif defined(CPU_MKM33Z128ACLL5) || defined(CPU_MKM33Z64ACLL5)
    /* @brief Maximum number of pins (maximal index plus one) connected to LLWU device. */
    #define FSL_FEATURE_LLWU_HAS_EXTERNAL_PIN (16)
    /* @brief Has pins 8-15 connected to LLWU device. */
    #define FSL_FEATURE_LLWU_EXTERNAL_PIN_GROUP2 (1)
    ...
    /* @brief Has DMA Enable register (LLWU_DE). */
    #define FSL_FEATURE_LLWU_HAS_DMA_ENABLE_REG (0)
#endif /* defined(CPU_MKM33Z128ACLH5) || defined(CPU_MKM33Z64ACLH5) */
...
#if defined(CPU_MKM33Z128ACLL5) || defined(CPU_MKM33Z64ACLL5)
...
#endif /* defined(CPU_MKM33Z128ACLL5) || defined(CPU_MKM33Z64ACLL5) */
...
/* @brief Has SRAM size specification (register bit field SOPT1[SRAMSIZE]). */
#define FSL_FEATURE_SIM_OPT_HAS_SRAMSIZE (1)
...
/* @brief UART0 and UART1 have shared interrupt vector. */
#define FSL_FEATURE_UART_HAS_SHARED_IRQ0_IRQ1 (1)
/* @brief UART2 and UART3 have shared interrupt vector. */
#define FSL_FEATURE_UART_HAS_SHARED_IRQ2_IRQ3 (1)
...
#define FSL_FEATURE_XBAR_INTERRUPT_COUNT (1)

#endif /* _MKM33ZA5_FEATURES_H_ */
