...
#ifndef _LPC5504_FEATURES_H_
#define _LPC5504_FEATURES_H_

/* SOC module features */

#if defined(CPU_LPC5504JBD64)
...
/* FLEXCOMM module features */
    ...
    #define FSL_FEATURE_FLEXCOMM_INSTANCE_I2S_SUPPORT_SECONDARY_CHANNELn(x) \
        ...
        (((x) == FLEXCOMM6) ? (1) : \
        (((x) == FLEXCOMM8) ? (0) : (-1)))))))))
#endif /* defined(CPU_LPC5504JBD64) */
