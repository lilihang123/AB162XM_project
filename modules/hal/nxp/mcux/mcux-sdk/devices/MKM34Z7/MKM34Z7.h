...
typedef enum IRQn
{
    ...
    PTx_IRQn            = 17,          /**< Single interrupt vector for
...
typedef enum _xbar_input_signal
{
    ...
    kXBAR_InputPit0Tif0 =
        16 | 0x100U, /**< PIT 0 Timer Interrupt Flag 0 (Timeout 0) output assigned to XBAR_IN16 input. */
    ...
    kXBAR_InputAdcCocoFlag =
        26 | 0x100U, /**< ORed conversion complete flag for all SAR ADC channels output assigned to XBAR_IN26 input. */
    kXBAR_InputAfeAllCocFlag =
        27 | 0x100U, /**< ORed conversion complete flag for all AFE channels output assigned to XBAR_IN27 input. */
    kXBAR_InputAfeCh0CocFlag =
        28 | 0x100U, /**< AFE Channel 0 conversion complete output assigned to XBAR_IN28 input. */
    kXBAR_InputAfeCh1CocFlag =
        29 | 0x100U, /**< AFE Channel 1 conversion complete output assigned to XBAR_IN29 input. */
    kXBAR_InputAfeCh2CocFlag =
        30 | 0x100U, /**< AFE Channel 2 conversion complete output assigned to XBAR_IN30 input. */
    kXBAR_InputAfeCh3CocFlag =
        31 | 0x100U, /**< AFE Channel 3 conversion complete output assigned to XBAR_IN31 input. */
    ...
    kXBAR_InputPit0Tif1 =
        36 | 0x100U, /**< PIT 0 Timer Interrupt Flag 1 (Timeout 1) output assigned to XBAR_IN36 input. */
    kXBAR_InputPit1Tif0 =
        37 | 0x100U, /**< PIT 1 Timer Interrupt Flag 0 (Timeout 0) output assigned to XBAR_IN37 input. */
    kXBAR_InputPit1Tif1 =
        38 | 0x100U, /**< PIT 1 Timer Interrupt Flag 1 (Timeout 1) output assigned to XBAR_IN38 input. */
...
typedef enum _xbar_output_signal
{
    ...
    kXBAR_OutputUartTxModCarrier =
        14 | 0x100U, /**< XBAR_OUT14 output assigned to SIM UART Tx IrDA Modulator Carrier Input */
    ...
    kXBAR_OutputAfeCh0ExmodData =
        40 | 0x100U, /**< XBAR_OUT40 output assigned to External modulator data input for AFE Channel 0 */
    kXBAR_OutputAfeCh1ExmodData =
        41 | 0x100U, /**< XBAR_OUT41 output assigned to External modulator data input for AFE Channel 1 */
    kXBAR_OutputAfeCh2ExmodData =
        42 | 0x100U, /**< XBAR_OUT42 output assigned to External modulator data input for AFE Channel 2 */
    kXBAR_OutputAfeCh3ExmodData =
        43 | 0x100U, /**< XBAR_OUT43 output assigned to External modulator data input for AFE Channel 3 */
...
typedef struct
{
    __IO uint32_t CFR[4]; /**< Channel0 Configuration Register..Channel3 Configuration Register, array offset: 0x0,
                             array step: 0x4 */
 ...
 */
#define AFE_CFR_DEC_CLK_INP_SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << AFE_CFR_DEC_CLK_INP_SEL_SHIFT)) & AFE_CFR_DEC_CLK_INP_SEL_MASK)
 ...
 */
#define AFE_CFR_DEC_CLK_EDGE_SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << AFE_CFR_DEC_CLK_EDGE_SEL_SHIFT)) & AFE_CFR_DEC_CLK_EDGE_SEL_MASK)
 ...
 *  0b111..reserved
 */
#define AFE_CFR_PGA_GAIN_SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << AFE_CFR_PGA_GAIN_SEL_SHIFT)) & AFE_CFR_PGA_GAIN_SEL_MASK)
 ...
 *  0b0..Left justified 2's complement 32-bit : SVVVVVVVVVVVVVVVVVVVVVVV00000000 where (S= sign bit , V=valid result
 * value, 0=zero) 0b1..Right justified 2's complement 32-bit : SSSSSSSSSVVVVVVVVVVVVVVVVVVVVVVV where (S= sign bit , V=
 * valid result value, 0= zero)
 */
#define AFE_CR_RESULT_FORMAT(x) \
    (((uint32_t)(((uint32_t)(x)) << AFE_CR_RESULT_FORMAT_SHIFT)) & AFE_CR_RESULT_FORMAT_MASK)
...
#define AFE_IRQS                                                   \
    {                                                              \
        {                                                          \
            AFE_CH0_IRQn, AFE_CH1_IRQn, AFE_CH2_IRQn, AFE_CH3_IRQn \
        }                                                          \
    }
...
#define CMP_IRQS                                                      \
    {                                                                 \
        CMP0_CMP1_CMP2_IRQn, CMP0_CMP1_CMP2_IRQn, CMP0_CMP1_CMP2_IRQn \
    }
 ...
 *  0b11..If the current mode is privileged and secure, user and secure, or user and nonsecure, then attributes are set
 * to {user, nonsecure}.
 */
...
#define FGPIO_BASE_ADDRS                                                                                        \
    {                                                                                                           \
        FGPIOA_BASE, FGPIOB_BASE, FGPIOC_BASE, FGPIOD_BASE, FGPIOE_BASE, FGPIOF_BASE, FGPIOG_BASE, FGPIOH_BASE, \
            FGPIOI_BASE, FGPIOJ_BASE, FGPIOK_BASE, FGPIOL_BASE, FGPIOM_BASE                                     \
    }
/** Array initializer of FGPIO peripheral base pointers */
#define FGPIO_BASE_PTRS                                                                                        \
    {                                                                                                          \
        FGPIOA, FGPIOB, FGPIOC, FGPIOD, FGPIOE, FGPIOF, FGPIOG, FGPIOH, FGPIOI, FGPIOJ, FGPIOK, FGPIOL, FGPIOM \
    }
...
#define GPIO_BASE_ADDRS                                                                                             \
    {                                                                                                               \
        GPIOA_BASE, GPIOB_BASE, GPIOC_BASE, GPIOD_BASE, GPIOE_BASE, GPIOF_BASE, GPIOG_BASE, GPIOH_BASE, GPIOI_BASE, \
 ...
 *  0b1..Internal reference clock is enabled in Stop mode if IRCLKEN is set or if MCG is in FEI, FBI, or BLPI modes
 ...
 */
#define MMAU_CSR_IF_CLR_DZIF(x) \
    (((uint32_t)(((uint32_t)(x)) << MMAU_CSR_IF_CLR_DZIF_SHIFT)) & MMAU_CSR_IF_CLR_DZIF_MASK)
/*! @} */
...
typedef struct
{
    ...
    {                         /* offset: 0x10, array step: 0x18 */
        ...
        __IO uint32_t DLY[4]; /**< Channel n Delay 0 register..Channel n Delay 3 register, array offset: 0x18, array
                                 step: index*0x18, index2*0x4 */
    } CH[1];
 ...
 *  0b10..The internal registers are loaded with the values from their buffers when a trigger input event is detected,
 * after 1 is written to LDOK. 0b11..The internal registers are loaded with the values from their buffers when either
 * the PDB counter (CNT) = MOD + 1 CNT delay elapsed, or a trigger input event is detected, after 1 is written to LDOK.
 */
 ...
 *              peripheral clock cycle after a rising edge is detected on selected trigger input source or software
 * trigger is selected and SWTRIG is written with 1. 0b00000001..PDB channel's corresponding pre-trigger asserts when
 * the counter reaches the channel delay register plus one peripheral clock cycle after a rising edge is detected on
 ...
 *  0b00000000000000000000000000000000..Digital filter is disabled on the corresponding pin and output of the digital
 * filter is reset to zero. 0b00000000000000000000000000000001..Digital filter is enabled on the corresponding pin, if
...
#define PORT_BASE_ADDRS                                                                                             \
    {                                                                                                               \
        PORTA_BASE, PORTB_BASE, PORTC_BASE, PORTD_BASE, PORTE_BASE, PORTF_BASE, PORTG_BASE, PORTH_BASE, PORTI_BASE, \
            PORTJ_BASE, PORTK_BASE, PORTL_BASE, PORTM_BASE                                                          \
    }
/** Array initializer of PORT peripheral base pointers */
#define PORT_BASE_PTRS                                                                            \
    {                                                                                             \
        PORTA, PORTB, PORTC, PORTD, PORTE, PORTF, PORTG, PORTH, PORTI, PORTJ, PORTK, PORTL, PORTM \
    }
/** Interrupt vectors for the PORT peripheral type */
#define PORT_IRQS                                                                                                     \
    {                                                                                                                 \
        PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, PTx_IRQn, \
            PTx_IRQn, PTx_IRQn                                                                                        \
    }
 ...
 *  0b1..Clear the interrupt. When you write 1 to this field, RNGA then resets the error-interrupt indicator (SR[ERRI]).
 ...
 */
#define RTC_HOURMIN_HOUR_CNT(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_HOURMIN_HOUR_CNT_SHIFT)) & RTC_HOURMIN_HOUR_CNT_MASK)
/*! @} */
 ...
 */
#define RTC_ALM_YEARMON_ALM_MON(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_YEARMON_ALM_MON_SHIFT)) & RTC_ALM_YEARMON_ALM_MON_MASK)
#define RTC_ALM_YEARMON_ALM_YEAR_MASK  (0xFF00U)
#define RTC_ALM_YEARMON_ALM_YEAR_SHIFT (8U)
/*! ALM_YEAR - Year Value for Alarm.
 */
#define RTC_ALM_YEARMON_ALM_YEAR(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_YEARMON_ALM_YEAR_SHIFT)) & RTC_ALM_YEARMON_ALM_YEAR_MASK)
/*! @} */
 ...
 */
#define RTC_ALM_DAYS_ALM_DAY(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_DAYS_ALM_DAY_SHIFT)) & RTC_ALM_DAYS_ALM_DAY_MASK)
/*! @} */
 ...
 */
#define RTC_ALM_HOURMIN_ALM_MIN(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_HOURMIN_ALM_MIN_SHIFT)) & RTC_ALM_HOURMIN_ALM_MIN_MASK)
#define RTC_ALM_HOURMIN_ALM_HOUR_MASK  (0x1F00U)
#define RTC_ALM_HOURMIN_ALM_HOUR_SHIFT (8U)
/*! ALM_HOUR - Hours Value for Alarm.
 */
#define RTC_ALM_HOURMIN_ALM_HOUR(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_HOURMIN_ALM_HOUR_SHIFT)) & RTC_ALM_HOURMIN_ALM_HOUR_MASK)
/*! @} */
...
#define RTC_ALM_SECONDS_ALM_SEC(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_SECONDS_ALM_SEC_SHIFT)) & RTC_ALM_SECONDS_ALM_SEC_MASK)
#define RTC_ALM_SECONDS_DEC_SEC_MASK  (0x100U)
#define RTC_ALM_SECONDS_DEC_SEC_SHIFT (8U)
/*! DEC_SEC - Decrement Seconds Counter by 1.
 */
#define RTC_ALM_SECONDS_DEC_SEC(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_SECONDS_DEC_SEC_SHIFT)) & RTC_ALM_SECONDS_DEC_SEC_MASK)
#define RTC_ALM_SECONDS_INC_SEC_MASK  (0x200U)
#define RTC_ALM_SECONDS_INC_SEC_SHIFT (9U)
/*! INC_SEC - Increment Seconds Counter by 1.
 */
#define RTC_ALM_SECONDS_INC_SEC(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_ALM_SECONDS_INC_SEC_SHIFT)) & RTC_ALM_SECONDS_INC_SEC_MASK)
/*! @} */
 ...
 */
#define RTC_CTRL_TIMER_STB_MASK(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_CTRL_TIMER_STB_MASK_SHIFT)) & RTC_CTRL_TIMER_STB_MASK_MASK)
 ...
 */
#define RTC_STATUS_INVAL_BIT(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_STATUS_INVAL_BIT_SHIFT)) & RTC_STATUS_INVAL_BIT_MASK)
 ...
 */
#define RTC_STATUS_WRITE_PROT_EN(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_STATUS_WRITE_PROT_EN_SHIFT)) & RTC_STATUS_WRITE_PROT_EN_MASK)
 ...
 */
#define RTC_STATUS_CPU_LOW_VOLT(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_STATUS_CPU_LOW_VOLT_SHIFT)) & RTC_STATUS_CPU_LOW_VOLT_MASK)
 ...
 */
#define RTC_GP_DATA_REG_CFG0(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_GP_DATA_REG_CFG0_SHIFT)) & RTC_GP_DATA_REG_CFG0_MASK)
 ...
 */
#define RTC_GP_DATA_REG_CFG1(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_GP_DATA_REG_CFG1_SHIFT)) & RTC_GP_DATA_REG_CFG1_MASK)
 ...
 *  0b1..Enables capacitor
 */
#define RTC_GP_DATA_REG_CFG2(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_GP_DATA_REG_CFG2_SHIFT)) & RTC_GP_DATA_REG_CFG2_MASK)
 ...
 *  0b1..Enables capacitor
 */
#define RTC_GP_DATA_REG_CFG3(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_GP_DATA_REG_CFG3_SHIFT)) & RTC_GP_DATA_REG_CFG3_MASK)
 ...
 *  0b1..Enables capacitor
 */
#define RTC_GP_DATA_REG_CFG4(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_GP_DATA_REG_CFG4_SHIFT)) & RTC_GP_DATA_REG_CFG4_MASK)
 ...
 *  0b1..Boot in VLPR
 */
#define RTC_GP_DATA_REG_CFG7(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_GP_DATA_REG_CFG7_SHIFT)) & RTC_GP_DATA_REG_CFG7_MASK)
/*! @} */
 ...
 */
#define RTC_DST_HOUR_DST_END_HOUR(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_DST_HOUR_DST_END_HOUR_SHIFT)) & RTC_DST_HOUR_DST_END_HOUR_MASK)
 ...
 */
#define RTC_DST_HOUR_DST_START_HOUR(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_DST_HOUR_DST_START_HOUR_SHIFT)) & RTC_DST_HOUR_DST_START_HOUR_MASK)
/*! @} */
 ...
 */
#define RTC_DST_MONTH_DST_END_MONTH(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_DST_MONTH_DST_END_MONTH_SHIFT)) & RTC_DST_MONTH_DST_END_MONTH_MASK)
 ...
 */
#define RTC_DST_MONTH_DST_START_MONTH(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_DST_MONTH_DST_START_MONTH_SHIFT)) & RTC_DST_MONTH_DST_START_MONTH_MASK)
/*! @} */
 ...
 */
#define RTC_DST_DAY_DST_END_DAY(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_DST_DAY_DST_END_DAY_SHIFT)) & RTC_DST_DAY_DST_END_DAY_MASK)
 ...
 */
#define RTC_DST_DAY_DST_START_DAY(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_DST_DAY_DST_START_DAY_SHIFT)) & RTC_DST_DAY_DST_START_DAY_MASK)
/*! @} */
 ...
 */
#define RTC_COMPEN_COMPEN_VAL(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_COMPEN_COMPEN_VAL_SHIFT)) & RTC_COMPEN_COMPEN_VAL_MASK)
/*! @} */
 ...
 */
#define RTC_TAMPER_SCR_TMPR_EN(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_TAMPER_SCR_TMPR_EN_SHIFT)) & RTC_TAMPER_SCR_TMPR_EN_MASK)
#define RTC_TAMPER_SCR_TMPR_STS_MASK  (0xF00U)
#define RTC_TAMPER_SCR_TMPR_STS_SHIFT (8U)
/*! TMPR_STS - Tamper Status Bit
 */
#define RTC_TAMPER_SCR_TMPR_STS(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_TAMPER_SCR_TMPR_STS_SHIFT)) & RTC_TAMPER_SCR_TMPR_STS_MASK)
/*! @} */
 ...
 */
#define RTC_FILTER01_CFG_FIL_DUR1(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER01_CFG_FIL_DUR1_SHIFT)) & RTC_FILTER01_CFG_FIL_DUR1_MASK)
 ...
 *  0b111..2 Hz clock
 */
#define RTC_FILTER01_CFG_CLK_SEL1(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER01_CFG_CLK_SEL1_SHIFT)) & RTC_FILTER01_CFG_CLK_SEL1_MASK)
 ...
 */
#define RTC_FILTER01_CFG_POL1(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER01_CFG_POL1_SHIFT)) & RTC_FILTER01_CFG_POL1_MASK)
 ...
 *  0b0000..Filtering operation disabled.
 */
#define RTC_FILTER01_CFG_FIL_DUR0(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER01_CFG_FIL_DUR0_SHIFT)) & RTC_FILTER01_CFG_FIL_DUR0_MASK)
 ...
 *  0b111..2 Hz clock
 */
#define RTC_FILTER01_CFG_CLK_SEL0(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER01_CFG_CLK_SEL0_SHIFT)) & RTC_FILTER01_CFG_CLK_SEL0_MASK)
 ...
 */
#define RTC_FILTER01_CFG_POL0(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER01_CFG_POL0_SHIFT)) & RTC_FILTER01_CFG_POL0_MASK)
/*! @} */
 ...
 *  0b0000..Filtering operation disabled.
 */
#define RTC_FILTER2_CFG_FIL_DUR2(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER2_CFG_FIL_DUR2_SHIFT)) & RTC_FILTER2_CFG_FIL_DUR2_MASK)
 ...
 *  0b111..2 Hz clock
 */
#define RTC_FILTER2_CFG_CLK_SEL2(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER2_CFG_CLK_SEL2_SHIFT)) & RTC_FILTER2_CFG_CLK_SEL2_MASK)
 ...
 */
#define RTC_FILTER2_CFG_POL2(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_FILTER2_CFG_POL2_SHIFT)) & RTC_FILTER2_CFG_POL2_MASK)
/*! @} */
 ...
 */
#define RTC_CTRL2_TAMP_CFG_OVER(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_CTRL2_TAMP_CFG_OVER_SHIFT)) & RTC_CTRL2_TAMP_CFG_OVER_MASK)
 ...
 *  0b11..Reserved
 */
#define RTC_CTRL2_WAKEUP_STATUS(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_CTRL2_WAKEUP_STATUS_SHIFT)) & RTC_CTRL2_WAKEUP_STATUS_MASK)
 ...
 */
#define RTC_CTRL2_WAKEUP_MODE(x) \
    (((uint16_t)(((uint16_t)(x)) << RTC_CTRL2_WAKEUP_MODE_SHIFT)) & RTC_CTRL2_WAKEUP_MODE_MASK)
/*! @} */
 ...
 *  0b11..Reserved
 */
#define SIM_SOPT1_CFG_LPTMR0SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_SOPT1_CFG_LPTMR0SEL_SHIFT)) & SIM_SOPT1_CFG_LPTMR0SEL_MASK)
 ...
 *  0b11..Reserved
 */
#define SIM_SOPT1_CFG_LPTMR1SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_SOPT1_CFG_LPTMR1SEL_SHIFT)) & SIM_SOPT1_CFG_LPTMR1SEL_MASK)
 ...
 *  0b11..Reserved
 */
#define SIM_SOPT1_CFG_LPTMR2SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_SOPT1_CFG_LPTMR2SEL_SHIFT)) & SIM_SOPT1_CFG_LPTMR2SEL_MASK)
 ...
 *  0b11..Reserved
 */
#define SIM_SOPT1_CFG_LPTMR3SEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_SOPT1_CFG_LPTMR3SEL_SHIFT)) & SIM_SOPT1_CFG_LPTMR3SEL_MASK)
 ...
 */
#define SIM_SOPT1_CFG_RAMSBDIS(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_SOPT1_CFG_RAMSBDIS_SHIFT)) & SIM_SOPT1_CFG_RAMSBDIS_MASK)
 ...
 */
#define SIM_SOPT1_CFG_RAMBPEN(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_SOPT1_CFG_RAMBPEN_SHIFT)) & SIM_SOPT1_CFG_RAMBPEN_MASK)
/*! @} */
 ...
 */
#define SIM_CTRL_REG_PLLVLPEN(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_PLLVLPEN_SHIFT)) & SIM_CTRL_REG_PLLVLPEN_MASK)
 ...
 *  0b11..OSCCLK
 */
#define SIM_CTRL_REG_ADCTRGSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_ADCTRGSEL_SHIFT)) & SIM_CTRL_REG_ADCTRGSEL_MASK)
 ...
 *  0b1..inverts SS
 */
#define SIM_CTRL_REG_SPI0_INV0(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI0_INV0_SHIFT)) & SIM_CTRL_REG_SPI0_INV0_MASK)
 ...
 *  0b1..inverts SCK
 */
#define SIM_CTRL_REG_SPI0_INV1(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI0_INV1_SHIFT)) & SIM_CTRL_REG_SPI0_INV1_MASK)
 ...
 *  0b1..inverts MOSI
 */
#define SIM_CTRL_REG_SPI0_INV2(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI0_INV2_SHIFT)) & SIM_CTRL_REG_SPI0_INV2_MASK)
 ...
 *  0b1..inverts MISO
 */
#define SIM_CTRL_REG_SPI0_INV3(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI0_INV3_SHIFT)) & SIM_CTRL_REG_SPI0_INV3_MASK)
 ...
 *  0b1..inverts SS
 */
#define SIM_CTRL_REG_SPI1_INV0(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI1_INV0_SHIFT)) & SIM_CTRL_REG_SPI1_INV0_MASK)
 ...
 *  0b1..inverts SCK
 */
#define SIM_CTRL_REG_SPI1_INV1(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI1_INV1_SHIFT)) & SIM_CTRL_REG_SPI1_INV1_MASK)
 ...
 *  0b1..inverts MOSI
 */
#define SIM_CTRL_REG_SPI1_INV2(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI1_INV2_SHIFT)) & SIM_CTRL_REG_SPI1_INV2_MASK)
 ...
 *  0b1..inverts MISO
 */
#define SIM_CTRL_REG_SPI1_INV3(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_SPI1_INV3_SHIFT)) & SIM_CTRL_REG_SPI1_INV3_MASK)
 ...
 */
#define SIM_CTRL_REG_PLLFLLSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_PLLFLLSEL_SHIFT)) & SIM_CTRL_REG_PLLFLLSEL_MASK)
 ...
 *  0b111..PLL clock output from MCG
 */
#define SIM_CTRL_REG_XBARCLKOUT(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_XBARCLKOUT_SHIFT)) & SIM_CTRL_REG_XBARCLKOUT_MASK)
 ...
 */
#define SIM_CTRL_REG_AFEOUTCLKSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_AFEOUTCLKSEL_SHIFT)) & SIM_CTRL_REG_AFEOUTCLKSEL_MASK)
 ...
 *  0b11..MCGIRCLK
 */
#define SIM_CTRL_REG_LPUARTSRC(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_LPUARTSRC_SHIFT)) & SIM_CTRL_REG_LPUARTSRC_MASK)
 ...
 */
#define SIM_CTRL_REG_TMRFREEZE(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CTRL_REG_TMRFREEZE_SHIFT)) & SIM_CTRL_REG_TMRFREEZE_MASK)
/*! @} */
 ...
 */
#define SIM_CLKDIV1_FLASHCLKMODE(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CLKDIV1_FLASHCLKMODE_SHIFT)) & SIM_CLKDIV1_FLASHCLKMODE_MASK)
 ...
 */
#define SIM_CLKDIV1_CLKDIVBUS(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CLKDIV1_CLKDIVBUS_SHIFT)) & SIM_CLKDIV1_CLKDIVBUS_MASK)
 ...
 */
#define SIM_CLKDIV1_CLKDIVSYS(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_CLKDIV1_CLKDIVSYS_SHIFT)) & SIM_CLKDIV1_CLKDIVSYS_MASK)
/*! @} */
 ...
 */
#define SIM_MISC_CTL_PDBADCTRG(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_PDBADCTRG_SHIFT)) & SIM_MISC_CTL_PDBADCTRG_MASK)
 ...
 *  0b11..DMA3
 */
#define SIM_MISC_CTL_DMADONESEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_DMADONESEL_SHIFT)) & SIM_MISC_CTL_DMADONESEL_MASK)
 ...
 *  0b11..Disabled
 */
#define SIM_MISC_CTL_AFECLKSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_AFECLKSEL_SHIFT)) & SIM_MISC_CTL_AFECLKSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_AFECLKPADDIR(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_AFECLKPADDIR_SHIFT)) & SIM_MISC_CTL_AFECLKPADDIR_MASK)
 ...
 */
#define SIM_MISC_CTL_UARTMODTYPE(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_UARTMODTYPE_SHIFT)) & SIM_MISC_CTL_UARTMODTYPE_MASK)
 ...
 */
#define SIM_MISC_CTL_UART0IRSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_UART0IRSEL_SHIFT)) & SIM_MISC_CTL_UART0IRSEL_MASK)
 ...
 *       configuration in XBAR. User should configure XBAR[14:13] accordingly.
 */
#define SIM_MISC_CTL_UART1IRSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_UART1IRSEL_SHIFT)) & SIM_MISC_CTL_UART1IRSEL_MASK)
 ...
 *       configuration in XBAR. User should configure XBAR[14:13] accordingly.
 */
#define SIM_MISC_CTL_UART2IRSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_UART2IRSEL_SHIFT)) & SIM_MISC_CTL_UART2IRSEL_MASK)
#define SIM_MISC_CTL_UART3IRSEL_MASK  (0x800U)
#define SIM_MISC_CTL_UART3IRSEL_SHIFT (11U)
/*! UART3IRSEL - UART3 IrDA Select
 *  0b0..Pad RX input (PTC[3] or PTD[7], as selected in Pinmux control) selected for RX input of UART3 and UART3 TX
 * signal is not used for modulation 0b1..UART3 selected for IrDA modulation. UART3 TX modulated by XBAR_OUT[14] and
 * UART3 RX input connected to XBAR_OUT[13]. UARTxIRSEL cannot configure XBAR_OUT[14] and XBAR_OUT[13] automatically,
 * and they need extra configuration in XBAR. User should configure XBAR[14:13] accordingly.
 */
#define SIM_MISC_CTL_UART3IRSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_UART3IRSEL_SHIFT)) & SIM_MISC_CTL_UART3IRSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_EWMINSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_EWMINSEL_SHIFT)) & SIM_MISC_CTL_EWMINSEL_MASK)
 ...
 *  0b1..Selects the PLL_AFE clock as the source for Timer CH0. The PLL_AFE clock source is itself selected using the
 * MISC_CTL[5:4]
 */
#define SIM_MISC_CTL_TMR0PLLSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR0PLLSEL_SHIFT)) & SIM_MISC_CTL_TMR0PLLSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_TMR0SCSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR0SCSEL_SHIFT)) & SIM_MISC_CTL_TMR0SCSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_TMR1SCSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR1SCSEL_SHIFT)) & SIM_MISC_CTL_TMR1SCSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_TMR2SCSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR2SCSEL_SHIFT)) & SIM_MISC_CTL_TMR2SCSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_TMR3SCSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR3SCSEL_SHIFT)) & SIM_MISC_CTL_TMR3SCSEL_MASK)
 ...
 *  0b11..Disabled
 */
#define SIM_MISC_CTL_TMR0PCSSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR0PCSSEL_SHIFT)) & SIM_MISC_CTL_TMR0PCSSEL_MASK)
 ...
 *  0b11..Disabled
 */
#define SIM_MISC_CTL_TMR1PCSSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR1PCSSEL_SHIFT)) & SIM_MISC_CTL_TMR1PCSSEL_MASK)
 ...
 *  0b11..Disabled
 */
#define SIM_MISC_CTL_TMR2PCSSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR2PCSSEL_SHIFT)) & SIM_MISC_CTL_TMR2PCSSEL_MASK)
 ...
 *  0b11..Disabled
 */
#define SIM_MISC_CTL_TMR3PCSSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_TMR3PCSSEL_SHIFT)) & SIM_MISC_CTL_TMR3PCSSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_RTCCLKSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_RTCCLKSEL_SHIFT)) & SIM_MISC_CTL_RTCCLKSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_VREFBUFOUTEN(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_VREFBUFOUTEN_SHIFT)) & SIM_MISC_CTL_VREFBUFOUTEN_MASK)
 ...
 */
#define SIM_MISC_CTL_VREFBUFINSEL(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_VREFBUFINSEL_SHIFT)) & SIM_MISC_CTL_VREFBUFINSEL_MASK)
 ...
 */
#define SIM_MISC_CTL_VREFBUFPD(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_MISC_CTL_VREFBUFPD_SHIFT)) & SIM_MISC_CTL_VREFBUFPD_MASK)
/*! @} */
 ...
 */
#define SIM_ADC_COMP0_ADCCOMPVAL0(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_ADC_COMP0_ADCCOMPVAL0_SHIFT)) & SIM_ADC_COMP0_ADCCOMPVAL0_MASK)
 ...
 */
#define SIM_ADC_COMP0_ADCCOMPVAL1(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_ADC_COMP0_ADCCOMPVAL1_SHIFT)) & SIM_ADC_COMP0_ADCCOMPVAL1_MASK)
/*! @} */
 ...
 */
#define SIM_ADC_COMP1_ADCCOMPVAL2(x) \
    (((uint32_t)(((uint32_t)(x)) << SIM_ADC_COMP1_ADCCOMPVAL2_SHIFT)) & SIM_ADC_COMP1_ADCCOMPVAL2_MASK)
/*! @} */
...
typedef struct
{
    ...
    __IO uint32_t WORD[8][4]; /**< Region Descriptor n, Word 0..Region Descriptor n, Word 3, array offset: 0x400, array
                                 step: index*0x10, index2*0x4 */
 ...
 *  0b000..An attempted access of that mode may be terminated with an access error (if not allowed by another
 * descriptor) and the access not performed. 0b001..Allows the given access type to occur
 */
...
#define TMR_BASE_ADDRS                             \
    {                                              \
        TMR0_BASE, TMR1_BASE, TMR2_BASE, TMR3_BASE \
    }
 ...
 *  0b0..If C2[ILIE] and S1[IDLE] are set, the IDLE interrupt request signal is asserted to request an interrupt
 * service. 0b1..If C2[ILIE] and S1[IDLE] are set, the IDLE DMA request signal is asserted to request a DMA transfer.
 */
 ...
 *  0b111..Reserved.
 */
#define UART_PFIFO_RXFIFOSIZE(x) \
 ...
 *  0b111..Reserved.
 */
#define UART_PFIFO_TXFIFOSIZE(x) \
...
#define UART_RX_TX_IRQS                                                                           \
    {                                                                                             \
        UART0_UART1_UART2_UART3_IRQn, UART0_UART1_UART2_UART3_IRQn, UART0_UART1_UART2_UART3_IRQn, \
 ...
 */
#define VREF_VREFH_TRM_CHOPEN(x) \
    (((uint8_t)(((uint8_t)(x)) << VREF_VREFH_TRM_CHOPEN_SHIFT)) & VREF_VREFH_TRM_CHOPEN_MASK)
/*! @} */
 ...
 *  0b11..Reserved
 */
#define VREF_VREFH_SC_MODE_LV(x) \
    (((uint8_t)(((uint8_t)(x)) << VREF_VREFH_SC_MODE_LV_SHIFT)) & VREF_VREFH_SC_MODE_LV_MASK)
 ...
 *  0b1..Enabled
 */
#define VREF_VREFH_SC_ICOMPEN(x) \
    (((uint8_t)(((uint8_t)(x)) << VREF_VREFH_SC_ICOMPEN_SHIFT)) & VREF_VREFH_SC_ICOMPEN_MASK)
...
#define VREF_VREFL_TRM_VREFL_TRIM(x) \
    (((uint8_t)(((uint8_t)(x)) << VREF_VREFL_TRM_VREFL_TRIM_SHIFT)) & VREF_VREFL_TRM_VREFL_TRIM_MASK)
 ...
 *  0b1..Enable
 */
#define VREF_VREFL_TRM_VREFL_EN(x) \
    (((uint8_t)(((uint8_t)(x)) << VREF_VREFL_TRM_VREFL_EN_SHIFT)) & VREF_VREFL_TRM_VREFL_EN_MASK)
 ...
 */
#define VREF_VREFL_TRM_VREFL_SEL(x) \
    (((uint8_t)(((uint8_t)(x)) << VREF_VREFL_TRM_VREFL_SEL_SHIFT)) & VREF_VREFL_TRM_VREFL_SEL_MASK)
/*! @} */
 ...
 */
#define WDOG_STCTRLH_IRQRSTEN(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_STCTRLH_IRQRSTEN_SHIFT)) & WDOG_STCTRLH_IRQRSTEN_MASK)
 ...
 */
#define WDOG_STCTRLH_ALLOWUPDATE(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_STCTRLH_ALLOWUPDATE_SHIFT)) & WDOG_STCTRLH_ALLOWUPDATE_MASK)
...
#define WDOG_STCTRLH_TESTWDOG(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_STCTRLH_TESTWDOG_SHIFT)) & WDOG_STCTRLH_TESTWDOG_MASK)
 ...
 */
#define WDOG_STCTRLH_TESTSEL(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_STCTRLH_TESTSEL_SHIFT)) & WDOG_STCTRLH_TESTSEL_MASK)
 ...
 */
#define WDOG_STCTRLH_BYTESEL(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_STCTRLH_BYTESEL_SHIFT)) & WDOG_STCTRLH_BYTESEL_MASK)
 ...
 */
#define WDOG_STCTRLH_DISTESTWDOG(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_STCTRLH_DISTESTWDOG_SHIFT)) & WDOG_STCTRLH_DISTESTWDOG_MASK)
/*! @} */
...
#define WDOG_TOVALH_TOVALHIGH(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_TOVALH_TOVALHIGH_SHIFT)) & WDOG_TOVALH_TOVALHIGH_MASK)
/*! @} */
...
#define WDOG_TOVALL_TOVALLOW(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_TOVALL_TOVALLOW_SHIFT)) & WDOG_TOVALL_TOVALLOW_MASK)
/*! @} */
...
#define WDOG_REFRESH_WDOGREFRESH(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_REFRESH_WDOGREFRESH_SHIFT)) & WDOG_REFRESH_WDOGREFRESH_MASK)
/*! @} */
...
#define WDOG_UNLOCK_WDOGUNLOCK(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_UNLOCK_WDOGUNLOCK_SHIFT)) & WDOG_UNLOCK_WDOGUNLOCK_MASK)
/*! @} */
...
#define WDOG_TMROUTH_TIMEROUTHIGH(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_TMROUTH_TIMEROUTHIGH_SHIFT)) & WDOG_TMROUTH_TIMEROUTHIGH_MASK)
/*! @} */
...
#define WDOG_TMROUTL_TIMEROUTLOW(x) \
    (((uint16_t)(((uint16_t)(x)) << WDOG_TMROUTL_TIMEROUTLOW_SHIFT)) & WDOG_TMROUTL_TIMEROUTLOW_MASK)
/*! @} */
