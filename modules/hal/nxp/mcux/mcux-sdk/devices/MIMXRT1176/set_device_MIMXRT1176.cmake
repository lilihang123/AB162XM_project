...
if (CONFIG_USE_DEVICES_Project_Template_MIMXRT1176)
# Add set(CONFIG_USE_DEVICES_Project_Template_MIMXRT1176 true) in config.cmake to use this component

message("DEVICES_Project_Template_MIMXRT1176 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
...
if (CONFIG_USE_device_MIMXRT1176_startup)
# Add set(CONFIG_USE_device_MIMXRT1176_startup true) in config.cmake to use this component

message("device_MIMXRT1176_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message("device_MIMXRT1176_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message("device_MIMXRT1176_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.MIMXRT1176)
...
if (CONFIG_USE_component_power_manager_MIMXRT1176)
# Add set(CONFIG_USE_component_power_manager_MIMXRT1176 true) in config.cmake to use this component

message("component_power_manager_MIMXRT1176 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/power_manager/devices/MIMXRT1176/fsl_pm_device.c
)
...
message("component_flexspi_nor_flash_adapter_rt1170evkb component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_BOARD STREQUAL evkbmimxrt1170) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_flexspi)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/internal_flash/evkbmimxrt1170/fsl_adapter_flexspi_nor_flash.c
)
...
message("component_mflash_mimxrt1170evkb component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/flash/mflash/mimxrt1170evkb/mflash_drv.c
)
