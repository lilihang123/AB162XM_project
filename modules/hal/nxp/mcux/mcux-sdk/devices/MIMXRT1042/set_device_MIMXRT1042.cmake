...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template/SEGGER_RTT_Conf.h ${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template driver_rtt_template.MIMXRT1042)
...
if (CONFIG_USE_DEVICES_Project_Template_MIMXRT1042)
# Add set(CONFIG_USE_DEVICES_Project_Template_MIMXRT1042 true) in config.cmake to use this component

message("DEVICES_Project_Template_MIMXRT1042 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MIMXRT1042.MIMXRT1042)
...
message("device_MIMXRT1042_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message("device_MIMXRT1042_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.MIMXRT1042)
...
message("device_MIMXRT1042_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_component_flexspi_nor_flash_adapter_rt1040evk)
# Add set(CONFIG_USE_component_flexspi_nor_flash_adapter_rt1040evk true) in config.cmake to use this component

message("component_flexspi_nor_flash_adapter_rt1040evk component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_BOARD STREQUAL evkmimxrt1040) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_flexspi)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/internal_flash/evkmimxrt1040/fsl_adapter_flexspi_nor_flash.c
)
...
message("component_mflash_rt1040 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/flash/mflash/mimxrt1042/mflash_drv.c
)
