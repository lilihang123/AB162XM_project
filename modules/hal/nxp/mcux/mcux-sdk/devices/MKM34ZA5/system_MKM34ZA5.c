 ...
 * @version 1.0
 * @date 2014-07-22
 * @brief Device specific configuration file for MKM34ZA5 (implementation file)
 *
...
void SystemCoreClockUpdate (void) {
  ...
  if ((MCG->C1 & MCG_C1_CLKS_MASK) == 0x00U) {
    ...
    if ((MCG->C6 & MCG_C6_PLLS_MASK) == 0x00U) {
      ...
      if ((MCG->C7 & MCG_C7_PLL32KREFSEL_MASK) == 0x00U) {
        ...
        MCGOUTClock = (MCGOUTClock / Divider); /* Calculate the divided FLL reference clock */
      } else { /* (MCG->C7 & MCG_C7_PLL32KREFSEL_MASK) == 0xB0U */
        /* Reserved value */
        return;
      }
  ...
  SystemCoreClock = (MCGOUTClock / (0x01U + ((SIM->CLKDIV1 & SIM_CLKDIV1_SYSDIV_MASK) >> SIM_CLKDIV1_SYSDIV_SHIFT)));
}
