...
#  set(CONFIG_USE_BOARD_Project_Template_lpcxpresso55s69 true)
...
#  set(CONFIG_USE_DEVICES_Project_Template_LPC55S69 true)
...
#  # description: FRO calibration driver with calibration Lib
...
#  # description: mflash lpc55xxx
#  set(CONFIG_USE_component_mflash_lpc55xxx true)
...
#  # description: RPMsg-Lite for lpcxpresso55s69 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_lpcxpresso55s69_bm true)

#  # description: RPMsg-Lite for lpcxpresso55s69 FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_lpcxpresso55s69_freertos true)

#  # description: RPMsg-Lite baremetal for lpcxpresso55s69 board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_lpcxpresso55s69 true)
...
#  # description: Middleware sdmmc host sdif azurertos
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/lpcxpresso55s69
)

include(set_board_lpcxpresso55s69 OPTIONAL)
include(set_CMSIS_DSP_Lib OPTIONAL)
include(set_CMSIS OPTIONAL)
include(set_device_LPC55S69 OPTIONAL)
