...
#ifndef _LPC812_FEATURES_H_
#define _LPC812_FEATURES_H_

/* SOC module features */

#if defined(CPU_LPC812M101JD20)
...
#elif defined(CPU_LPC812M101JDH16) || defined(CPU_LPC812M101JDH20) || defined(CPU_LPC812M101JTB16)
    /* @brief CRC availability on the SoC. */
    #define FSL_FEATURE_SOC_CRC_COUNT (1)
    /* @brief GPIO availability on the SoC. */
    #define FSL_FEATURE_SOC_GPIO_COUNT (1)
