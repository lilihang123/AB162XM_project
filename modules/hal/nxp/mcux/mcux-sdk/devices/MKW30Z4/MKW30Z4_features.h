...
**     - rev. 1.5 (2016-03-15)
**         Enabled FSL_FEATURE_I2C_HAS_DOUBLE_BUFFER_ENABLE
**         Enabled FSL_FEATURE_TPM_HAS_PAUSE_COUNTER_ON_TRIGGER
**         Enabled FSL_FEATURE_TPM_HAS_EXTERNAL_TRIGGER_SELECTION
**         Enabled FSL_FEATURE_TPM_HAS_POL
**
** ###################################################################
*/

#ifndef _MKW30Z4_FEATURES_H_
#define _MKW30Z4_FEATURES_H_
...
#define FSL_FEATURE_DCDC_REG3_HAS_VDD1P5_BITS (0)
/* @brief Has VDD1P45 bits in DCDC REG3. */
#define FSL_FEATURE_DCDC_REG3_HAS_VDD1P45_BITS (1)
...
#define FSL_FEATURE_DCDC_HAS_BOOST_MODE (1)
...
#define FSL_FEATURE_FLASH_PFLASH_PROTECTION_REGION_COUNT (20)
/* @brief P-Flash start address. */
#define FSL_FEATURE_FLASH_PFLASH_1_START_ADDRESS (0x00020000)
/* @brief P-Flash block count. */
#define FSL_FEATURE_FLASH_PFLASH_1_BLOCK_COUNT (2)
/* @brief P-Flash block size. */
#define FSL_FEATURE_FLASH_PFLASH_1_BLOCK_SIZE (16384)
/* @brief P-Flash sector size. */
#define FSL_FEATURE_FLASH_PFLASH_1_BLOCK_SECTOR_SIZE (1024)
/* @brief P-Flash write unit size. */
#define FSL_FEATURE_FLASH_PFLASH_1_BLOCK_WRITE_UNIT_SIZE (4)
/* @brief P-Flash data path width. */
#define FSL_FEATURE_FLASH_PFLASH_1_BLOCK_DATA_PATH_WIDTH (4)
/* @brief P-Flash block swap feature. */
...
#define FSL_FEATURE_LLWU_HAS_EXTERNAL_PIN (12)
