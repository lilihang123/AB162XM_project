...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MKE16F16
**
 ...
 * @version 4.0
 * @date 2016-09-20
 * @brief CMSIS Peripheral Access Layer for MKE16F16
 *
 * CMSIS Peripheral Access Layer for MKE16F16
 */

#ifndef _MKE16F16_H_
#define _MKE16F16_H_                             /**< Symbol preventing repeated inclusion */
...
#include "system_MKE16F16.h"           /* Device specific configuration file */
...
typedef enum _dma_request_source
{
    ...
    kDmaRequestMux0FTM1Channel4     = 57|0x100U,   /**< FTM1 Channel4 */
    kDmaRequestMux0FTM1Channel5     = 57|0x100U,   /**< FTM1 Channel5 */
    kDmaRequestMux0FTM1Channel6     = 57|0x100U,   /**< FTM1 Channel6 */
    kDmaRequestMux0FTM1Channel7     = 57|0x100U,   /**< FTM1 Channel7 */
    kDmaRequestMux0FTM2Channel2     = 58|0x100U,   /**< FTM2 Channel2 */
    kDmaRequestMux0FTM2Channel3     = 58|0x100U,   /**< FTM2 Channel3 */
    kDmaRequestMux0FTM2Channel4     = 58|0x100U,   /**< FTM2 Channel4 */
    kDmaRequestMux0FTM2Channel5     = 58|0x100U,   /**< FTM2 Channel5 */
    kDmaRequestMux0FTM2Channel6     = 58|0x100U,   /**< FTM2 Channel6 */
    kDmaRequestMux0FTM2Channel7     = 58|0x100U,   /**< FTM2 Channel7 */
 ...
 *  0b11..In normal mode, 4 words . In FIFO mode, Max-2 or less than Max-2 data remaining in FIFO will set
 *        watermark status bit. Max is equal to the FIFO depth.
 */
 ...
 *  0b0..PDB0 channel 0 back-to-back operation with ADC0 COCO[7:0]; PDB1 channel 0 back-to-back operation with
 *       ADC1 COCO[7:0] ; PDB2 channel 0 back-to-back operation with ADC2 COCO[7:0].
...
/*! TRACEFRAC - Trace clock divider fraction To configure TRACEDIV and TRACEFRAC, the user must
 *    clear TRACEDIVEN at first to disable the trace clock divide function.
 */
...
/*! TRACEDIV - Trace clock divider divisor To configure TRACEDIV, the user must disable TRACEDIVEN
 *    at first, and then enable it after setting TRACEDIV.
 */
