...
#ifndef _MK22F12_FEATURES_H_
#define _MK22F12_FEATURES_H_

/* SOC module features */

#if defined(CPU_MK22FN1M0VLH12) || defined(CPU_MK22FX512VLH12)
...
#elif defined(CPU_MK22FN1M0VLK12) || defined(CPU_MK22FX512VLK12)
    /* @brief ADC16 availability on the SoC. */
    #define FSL_FEATURE_SOC_ADC16_COUNT (2)
    /* @brief AIPS availability on the SoC. */
    #define FSL_FEATURE_SOC_AIPS_COUNT (1)
    ...
    /* @brief WDOG availability on the SoC. */
    #define FSL_FEATURE_SOC_WDOG_COUNT (1)
#elif defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FX512VLL12)
    /* @brief ADC16 availability on the SoC. */
    #define FSL_FEATURE_SOC_ADC16_COUNT (2)
    /* @brief AIPS availability on the SoC. */
    #define FSL_FEATURE_SOC_AIPS_COUNT (1)
    ...
    /* @brief WDOG availability on the SoC. */
    #define FSL_FEATURE_SOC_WDOG_COUNT (1)
#elif defined(CPU_MK22FN1M0VLQ12) || defined(CPU_MK22FN1M0VMC12) || defined(CPU_MK22FN1M0VMD12) || defined(CPU_MK22FX512VLQ12) || \
    defined(CPU_MK22FX512VMC12) || defined(CPU_MK22FX512VMD12)
    /* @brief ADC16 availability on the SoC. */
    #define FSL_FEATURE_SOC_ADC16_COUNT (2)
    /* @brief AIPS availability on the SoC. */
    #define FSL_FEATURE_SOC_AIPS_COUNT (1)
...
/* FLASH module features */
...
#if defined(CPU_MK22FN1M0VLH12) || defined(CPU_MK22FN1M0VLK12) || defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FN1M0VLQ12) || \
    defined(CPU_MK22FN1M0VMC12) || defined(CPU_MK22FN1M0VMD12)
...
#elif defined(CPU_MK22FX512VLH12) || defined(CPU_MK22FX512VLK12) || defined(CPU_MK22FX512VLL12) || defined(CPU_MK22FX512VLQ12) || \
    defined(CPU_MK22FX512VMC12) || defined(CPU_MK22FX512VMD12)
    /* @brief Is of type FTFA. */
    #define FSL_FEATURE_FLASH_IS_FTFA (0)
    /* @brief Is of type FTFE. */
    ...
    /* @brief Emulated eeprom size code 1111 mapping to emulated eeprom size in bytes (0xFFFF = reserved). */
    #define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1111 (0x0000)
#endif /* defined(CPU_MK22FN1M0VLH12) || defined(CPU_MK22FN1M0VLK12) || defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FN1M0VLQ12) || \
    defined(CPU_MK22FN1M0VMC12) || defined(CPU_MK22FN1M0VMD12) */
...
/* LLWU module features */
...
#elif defined(CPU_MK22FN1M0VLK12) || defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FN1M0VLQ12) || defined(CPU_MK22FN1M0VMC12) || \
    defined(CPU_MK22FN1M0VMD12) || defined(CPU_MK22FX512VLK12) || defined(CPU_MK22FX512VLL12) || defined(CPU_MK22FX512VLQ12) || \
    defined(CPU_MK22FX512VMC12) || defined(CPU_MK22FX512VMD12)
    /* @brief Maximum number of pins (maximal index plus one) connected to LLWU device. */
    #define FSL_FEATURE_LLWU_HAS_EXTERNAL_PIN (16)
    /* @brief Has pins 8-15 connected to LLWU device. */
    ...
    /* @brief Has DMA Enable register (LLWU_DE). */
    #define FSL_FEATURE_LLWU_HAS_DMA_ENABLE_REG (0)
#endif /* defined(CPU_MK22FN1M0VLH12) || defined(CPU_MK22FX512VLH12) */
...
#if defined(CPU_MK22FN1M0VLK12) || defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FN1M0VLQ12) || defined(CPU_MK22FN1M0VMC12) || \
    defined(CPU_MK22FN1M0VMD12) || defined(CPU_MK22FX512VLK12) || defined(CPU_MK22FX512VLL12) || defined(CPU_MK22FX512VLQ12) || \
    defined(CPU_MK22FX512VMC12) || defined(CPU_MK22FX512VMD12)
...
#endif /* defined(CPU_MK22FN1M0VLK12) || defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FN1M0VLQ12) || defined(CPU_MK22FN1M0VMC12) || \
    defined(CPU_MK22FN1M0VMD12) || defined(CPU_MK22FX512VLK12) || defined(CPU_MK22FX512VLL12) || defined(CPU_MK22FX512VLQ12) || \
    defined(CPU_MK22FX512VMC12) || defined(CPU_MK22FX512VMD12) */
...
/* DSPI module features */
    ...
    #define FSL_FEATURE_DSPI_HAS_SEPARATE_DMA_RX_TX_REQn(x) \
        (((x) == SPI0) ? (1) : \
        (((x) == SPI1) ? (0) : (-1)))
#elif defined(CPU_MK22FN1M0VLL12) || defined(CPU_MK22FN1M0VLQ12) || defined(CPU_MK22FN1M0VMC12) || defined(CPU_MK22FN1M0VMD12) || \
    defined(CPU_MK22FX512VLL12) || defined(CPU_MK22FX512VLQ12) || defined(CPU_MK22FX512VMC12) || defined(CPU_MK22FX512VMD12)
    /* @brief Receive/transmit FIFO size in number of items. */
    #define FSL_FEATURE_DSPI_FIFO_SIZEn(x) \
        (((x) == SPI0) ? (4) : \
        (((x) == SPI1) ? (1) : \
