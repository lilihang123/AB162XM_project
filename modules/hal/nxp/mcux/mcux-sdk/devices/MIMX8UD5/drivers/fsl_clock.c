...
uint32_t CLOCK_GetHifiDspSysClkFreq(cgc_sys_clk_t type)
{
    ...
    (void)memcpy((void *)&sysClkConfig, (void *)&CGC_LPAV->HIFICLK, sizeof(sysClkConfig));
...
uint32_t CLOCK_GetLpavSysClkFreq(cgc_sys_clk_t type)
{
    ...
    (void)memcpy((void *)&sysClkConfig, (void *)&CGC_LPAV->NICLPAVCLK, sizeof(sysClkConfig));
...
uint32_t CLOCK_GetDdrClkFreq(void)
{
    ...
    (void)memcpy((void *)&sysClkConfig, (void *)&CGC_LPAV->DDRCLK, sizeof(sysClkConfig));
