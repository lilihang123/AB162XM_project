...
if (CONFIG_USE_device_MIMX8UD5_startup)
# Add set(CONFIG_USE_device_MIMX8UD5_startup true) in config.cmake to use this component

message("device_MIMX8UD5_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_TOOLCHAIN STREQUAL armgcc AND CONFIG_CORE STREQUAL cm33 AND CONFIG_CORE_ID STREQUAL cm33)
  target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
      ${CMAKE_CURRENT_LIST_DIR}/./gcc/startup_MIMX8UD5_cm33.S
  )
endif()
...
if (CONFIG_USE_DEVICES_Project_Template_MIMX8UD5)
# Add set(CONFIG_USE_DEVICES_Project_Template_MIMX8UD5 true) in config.cmake to use this component

message("DEVICES_Project_Template_MIMX8UD5 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_lpuart_adapter AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_device_MIMX8UD5_startup AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_common AND CONFIG_USE_driver_fusion AND CONFIG_USE_driver_iomuxc AND CONFIG_USE_driver_lpuart AND CONFIG_USE_driver_reset AND CONFIG_USE_driver_rgpio AND CONFIG_USE_driver_upower AND ((CONFIG_USE_component_serial_manager AND CONFIG_USE_utility_assert AND CONFIG_USE_utility_debug_console) OR (CONFIG_USE_utility_assert_lite AND CONFIG_USE_utility_debug_console_lite)))

add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MIMX8UD5.MIMX8UD5)
...
message(SEND_ERROR "DEVICES_Project_Template_MIMX8UD5.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MIMX8UD5_CMSIS)
# Add set(CONFIG_USE_device_MIMX8UD5_CMSIS true) in config.cmake to use this component

message("device_MIMX8UD5_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_CMSIS_Include_core_cm AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))

if(CONFIG_CORE STREQUAL cm33 AND CONFIG_CORE_ID STREQUAL cm33)
  target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
      ${CMAKE_CURRENT_LIST_DIR}/./system_MIMX8UD5_cm33.c
  )
endif()
...
message(SEND_ERROR "device_MIMX8UD5_CMSIS.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MIMX8UD5_DSP)
# Add set(CONFIG_USE_device_MIMX8UD5_DSP true) in config.cmake to use this component

message("device_MIMX8UD5_DSP component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_dma3 AND CONFIG_USE_driver_sai AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_sai_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_dma3 AND CONFIG_USE_driver_lpi2c AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_lpi2c_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_dma3 AND CONFIG_USE_driver_lpspi AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_lpspi_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_dma3 AND CONFIG_USE_driver_lpuart AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_lpuart_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexspi_dma3.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_clock.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_reset.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_fusion.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_uart.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_lpuart_adapter AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "utility_debug_console_lite.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_notifier.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_iomuxc.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_memory.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sentinel.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_upower.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert_lite.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_str.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_debug_console.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_driver_lpi2c AND CONFIG_USE_CMSIS_Driver_Include_I2C AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_lpi2c.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_driver_lpspi AND CONFIG_USE_CMSIS_Driver_Include_SPI AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_lpspi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_driver_lpuart AND CONFIG_USE_CMSIS_Driver_Include_USART AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_lpuart.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_audio_sai_edma_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_button.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_codec.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_codec_adapters.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_wm8960_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_sgtl_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_da7212_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_codec_i2c.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_software_crc_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dialog7212.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_nand_flash-controller-flexspi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_nor_flash-controller-flexspi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_nor_flash-controller-lpspi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_fxos8700cq.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_rgpio_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpi2c_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_i3c_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_i3c_bus.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_i3c_bus_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lists.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager_light.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_panic.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_pwm_tpm_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_reset_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_software_rng_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_rtc_bbnsm_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_spi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_virtual.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_swo.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sgtl5000.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_shell.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpspi_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_srtm_freertos.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpit_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lptmr_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mrt_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_tpm_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_timer_manager.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpuart_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpuart_dma_adapter.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_video-common.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wm8960.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_clock AND CONFIG_USE_device_MIMX8UD5_CMSIS)
...
message(SEND_ERROR "driver_common.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_acmp.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_bbnsm.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dac12.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dma3.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ewm.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcan.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexcan AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexcan_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexio_camera.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio_camera AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexio_camera_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_i2c_master.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_i2s.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio_i2s AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexio_i2s_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_mculcd.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio_mculcd AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexio_mculcd_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_spi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio_spi AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexio_spi_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexio_uart.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexio_uart AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_flexio_uart_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexspi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpadc.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpi2c.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpi2c_freertos.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpit.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpspi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpspi_freertos.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lptmr.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart_freertos.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_soc_mipi_dsi)
...
message(SEND_ERROR "driver_mipi_dsi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mu1.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pdm.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_pdm AND (CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08))
...
message(SEND_ERROR "driver_pdm_edma.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pxp.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rgpio.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rtd_cmc.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sai.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sema42.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_trdc.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_trgmux.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_tstmr.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wdog32.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wuu.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cache_cache64.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_casper.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_i3c.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lcdif.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mrt.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_powerquad.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8UD5xxx08) AND CONFIG_USE_driver_powerquad AND CONFIG_USE_CMSIS_DSP_Include)
...
message(SEND_ERROR "driver_powerquad_cmsis.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_soc_mipi_dsi.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_display-rm68200.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_video-i2c.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_display-it6161.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_display-mipi-dsi-cmd.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_display-hx8394.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_display-common.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dc-fb-common.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dc-fb-lcdif.MIMX8UD5 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
