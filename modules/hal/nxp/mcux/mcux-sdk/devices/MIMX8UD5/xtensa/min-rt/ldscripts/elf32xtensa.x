/* This linker script generated from xt-genldscripts.tpp for LSP C:\nxp\devices\MIMX8UD5\xtensa\min-rt */
/* Linker Script for default link */
MEMORY
{
  iram0_0_seg :                       	org = 0x00000000, len = 0x400
  iram1_0_seg :                       	org = 0x00008400, len = 0x17C
  iram1_1_seg :                       	org = 0x0000857C, len = 0x20
  iram1_2_seg :                       	org = 0x0000859C, len = 0x20
  iram1_3_seg :                       	org = 0x000085BC, len = 0x20
  iram1_4_seg :                       	org = 0x000085DC, len = 0x20
  iram1_5_seg :                       	org = 0x000085FC, len = 0x20
  iram1_6_seg :                       	org = 0x0000861C, len = 0x20
  iram1_7_seg :                       	org = 0x0000863C, len = 0x400
  iram1_8_seg :                       	org = 0x00008A3C, len = 0x175C4
  dram1_0_seg :                       	org = 0x00820000, len = 0x10000
  dram0_0_seg :                       	org = 0x00880000, len = 0x10000
}
...
_memmap_mem_iram1_start = 0x8400;
_memmap_mem_iram1_end   = 0x20000;
_memmap_mem_dram0_start = 0x880000;
_memmap_mem_dram0_end   = 0x890000;
_memmap_mem_dram1_start = 0x820000;
_memmap_mem_dram1_end   = 0x830000;

/*  Memory segment boundary addresses:  */
_memmap_seg_iram0_0_start = 0x0;
_memmap_seg_iram0_0_max   = 0x400;
_memmap_seg_iram1_0_start = 0x8400;
_memmap_seg_iram1_0_max   = 0x857c;
_memmap_seg_iram1_1_start = 0x857c;
_memmap_seg_iram1_1_max   = 0x859c;
_memmap_seg_iram1_2_start = 0x859c;
_memmap_seg_iram1_2_max   = 0x85bc;
_memmap_seg_iram1_3_start = 0x85bc;
_memmap_seg_iram1_3_max   = 0x85dc;
_memmap_seg_iram1_4_start = 0x85dc;
_memmap_seg_iram1_4_max   = 0x85fc;
_memmap_seg_iram1_5_start = 0x85fc;
_memmap_seg_iram1_5_max   = 0x861c;
_memmap_seg_iram1_6_start = 0x861c;
_memmap_seg_iram1_6_max   = 0x863c;
_memmap_seg_iram1_7_start = 0x863c;
_memmap_seg_iram1_7_max   = 0x8a3c;
_memmap_seg_iram1_8_start = 0x8a3c;
_memmap_seg_iram1_8_max   = 0x20000;
_memmap_seg_dram1_0_start = 0x820000;
_memmap_seg_dram1_0_max   = 0x830000;
_memmap_seg_dram0_0_start = 0x880000;
_memmap_seg_dram0_0_max   = 0x890000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x0);
PROVIDE(_memmap_vecbase_reset = 0x8400);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x830000);
  _heap_sentry = 0x830000;
