...
if (CONFIG_USE_DEVICES_Project_Template_MIMX8MM6)
# Add set(CONFIG_USE_DEVICES_Project_Template_MIMX8MM6 true) in config.cmake to use this component

message("DEVICES_Project_Template_MIMX8MM6 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_device_MIMX8MM6_CMSIS AND CONFIG_USE_device_MIMX8MM6_startup AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_common AND CONFIG_USE_driver_iuart AND CONFIG_USE_driver_rdc AND ((CONFIG_USE_utility_assert AND CONFIG_USE_utility_debug_console) OR (CONFIG_USE_utility_assert_lite AND CONFIG_USE_utility_debug_console_lite)))

add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MIMX8MM6.MIMX8MM6)
...
message(SEND_ERROR "DEVICES_Project_Template_MIMX8MM6.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message("device_MIMX8MM6_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.MIMX8MM6)
...
message(SEND_ERROR "driver_clock.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_memory AND (CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_enet.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sdma.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_uart.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_iuart_adapter AND (CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_ecspi_sdma.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_iuart_sdma.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sai_sdma.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ))
...
message(SEND_ERROR "driver_iomuxc.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_memory.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message("device_MIMX8MM6_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MIMX8MM6_startup)
# Add set(CONFIG_USE_device_MIMX8MM6_startup true) in config.cmake to use this component

message("device_MIMX8MM6_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_str.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_driver_ecspi AND CONFIG_USE_CMSIS_Driver_Include_SPI AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_ecspi.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_enet.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_driver_ii2c AND CONFIG_USE_CMSIS_Driver_Include_I2C AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_ii2c.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_driver_iuart AND CONFIG_USE_CMSIS_Driver_Include_USART AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_iuart.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_driver_ak4497)
# Add set(CONFIG_USE_driver_ak4497 true) in config.cmake to use this component

message("driver_ak4497 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_driver_common AND CONFIG_USE_component_codec_i2c)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/codec/ak4497/fsl_ak4497.c
)
...
if(CONFIG_USE_driver_common AND (CONFIG_USE_component_wm8524_adapter OR CONFIG_USE_component_ak4497_adapter OR CONFIG_USE_component_codec_adapters))
...
message(SEND_ERROR "driver_codec.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_USE_driver_codec AND CONFIG_USE_component_wm8524_adapter) OR (CONFIG_USE_driver_codec AND CONFIG_USE_component_ak4497_adapter))
...
message(SEND_ERROR "component_codec_adapters.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message("component_ak4497_adapter component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_driver_ak4497 AND CONFIG_USE_driver_codec)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/codec/port/ak4497/fsl_codec_ak4497_adapter.c
)

target_include_directories(${MCUX_SDK_PROJECT_NAME} PUBLIC
  ${CMAKE_CURRENT_LIST_DIR}/../../components/codec/port/ak4497
  ${CMAKE_CURRENT_LIST_DIR}/../../components/codec/port
)
...
message(SEND_ERROR "component_codec_i2c.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lists.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_phy-device-rtl8211f.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_virtual.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_swo.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxLZ OR CONFIG_DEVICE_ID STREQUAL MIMX8MM6xxxKZ) AND CONFIG_USE_component_silicon_id)
...
message(SEND_ERROR "component_silicon_id_imx8.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_silicon_id.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_srtm_freertos.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_iuart_adapter.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wm8524.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_clock AND CONFIG_USE_device_MIMX8MM6_CMSIS)
...
message(SEND_ERROR "driver_common.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cache_lmem.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ecspi.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gpc_2.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gpt.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_igpio.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ii2c_freertos.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ipwm.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_iuart.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_iuart_freertos.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mu.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rdc.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rdc_sema42.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sai.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sema4.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_tmu_1.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wdog01.MIMX8MM6 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
