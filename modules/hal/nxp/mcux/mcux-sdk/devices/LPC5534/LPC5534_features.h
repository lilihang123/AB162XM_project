...
#ifndef _LPC5534_FEATURES_H_
#define _LPC5534_FEATURES_H_

/* SOC module features */

#if defined(CPU_LPC5534JBD100)
...
#elif defined(CPU_LPC5534JBD64) || defined(CPU_LPC5534JHI48)
    /* @brief AOI availability on the SoC. */
    #define FSL_FEATURE_SOC_AOI_COUNT (2)
    /* @brief CACHE64_CTRL availability on the SoC. */
    #define FSL_FEATURE_SOC_CACHE64_CTRL_COUNT (1)
...
#endif /* defined(CPU_LPC5534JBD100) */
