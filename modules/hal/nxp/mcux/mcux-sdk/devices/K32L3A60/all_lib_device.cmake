...
#set.board.frdmk32l3a6
#  # description: Board_project_template frdmk32l3a6
#  set(CONFIG_USE_BOARD_Project_Template_frdmk32l3a6 true)
...
#  # description: Devices_project_template K32L3A60
#  set(CONFIG_USE_DEVICES_Project_Template_K32L3A60 true)

#  # description: Device K32L3A60_startup
#  set(CONFIG_USE_device_K32L3A60_startup true)

#  # description: Device K32L3A60_system
#  set(CONFIG_USE_device_K32L3A60_system true)

#  # description: Device K32L3A60_cmsis
...
#  # description: CAU3 Driver
#  set(CONFIG_USE_driver_cau3 true)
...
#  # description: FLEXBUS Driver
#  set(CONFIG_USE_driver_flexbus true)
...
#  set(CONFIG_USE_driver_spm true)
...
#  # description: Multicore Manager for frdmk32l3a6 board
#  set(CONFIG_USE_middleware_multicore_mcmgr_k32l3a6 true)

#  # description: RPMsg-Lite for frdmk32l3a6 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_k32l3a6_bm true)

#  # description: RPMsg-Lite for frdmk32l3a6 FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_k32l3a6_freertos true)

#  # description: RPMsg-Lite baremetal for frdmk32l3a6 board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_k32l3a6 true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/frdmk32l3a6
)

include(set_board_frdmk32l3a6 OPTIONAL)
include(set_CMSIS_DSP_Lib OPTIONAL)
include(set_CMSIS OPTIONAL)
include(set_device_K32L3A60 OPTIONAL)
