//*****************************************************************************
// MKM14ZA5 startup code for use with MCUXpresso IDE
//
// Version : 090321
//*****************************************************************************
//
...
WEAK void CMP0_CMP1_IRQHandler(void);
...
WEAK void UART0_UART1_IRQHandler(void);
WEAK void UART2_UART3_IRQHandler(void);
...
WEAK void LPTMR_IRQHandler(void);
...
void CMP0_CMP1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void UART0_UART1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void UART2_UART3_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void LPTMR_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    SPI0_IRQHandler,         // 20: SPI0 ORed interrupt
    SPI1_IRQHandler,         // 21: SPI1 ORed interrupt
    ...
    CMP0_CMP1_IRQHandler,    // 30: CMP0/CMP1 ORed interrupt
    Reserved31_IRQHandler,   // 31: Reserved interrupt
    ADC_IRQHandler,          // 32: ADC interrupt
    PTx_IRQHandler,          // 33: Single interrupt vector for GPIOA,GPIOB,GPIOC,GPIOD,GPIOE,GPIOF,GPIOG,GPIOH,GPIOI
    RNGA_IRQHandler,         // 34: RNGA interrupt
    UART0_UART1_IRQHandler,  // 35: UART0/UART1 ORed interrupt
    UART2_UART3_IRQHandler,  // 36: UART2/UART3 ORed interrupt
    ...
    EWM_IRQHandler,          // 43: External Watchdog Monitor
    MCG_IRQHandler,          // 44: MCG interrupt
    WDOG_IRQHandler,         // 45: WDOG ORed interrupt
    LPTMR_IRQHandler,        // 46: LPTMR interrupt
...
WEAK_AV void CMP0_CMP1_IRQHandler(void)
{   CMP0_CMP1_DriverIRQHandler();
}

WEAK_AV void Reserved31_IRQHandler(void)
...
WEAK_AV void UART0_UART1_IRQHandler(void)
{   UART0_UART1_DriverIRQHandler();
}

WEAK_AV void UART2_UART3_IRQHandler(void)
...
WEAK_AV void LPTMR_IRQHandler(void)
{   LPTMR_DriverIRQHandler();
}
