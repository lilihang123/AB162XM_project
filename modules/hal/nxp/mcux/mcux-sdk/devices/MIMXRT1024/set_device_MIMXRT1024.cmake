...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template/SEGGER_RTT_Conf.h ${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template driver_rtt_template.MIMXRT1024)
...
if (CONFIG_USE_DEVICES_Project_Template_MIMXRT1024)
# Add set(CONFIG_USE_DEVICES_Project_Template_MIMXRT1024 true) in config.cmake to use this component

message("DEVICES_Project_Template_MIMXRT1024 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MIMXRT1024.MIMXRT1024)
...
if (CONFIG_USE_device_MIMXRT1024_startup)
# Add set(CONFIG_USE_device_MIMXRT1024_startup true) in config.cmake to use this component

message("device_MIMXRT1024_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message("device_MIMXRT1024_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.MIMXRT1024)
...
if (CONFIG_USE_component_cmsis_pack_flash_algo_MIMXRT1024)
# Add set(CONFIG_USE_component_cmsis_pack_flash_algo_MIMXRT1024 true) in config.cmake to use this component

message("component_cmsis_pack_flash_algo_MIMXRT1024 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_DEVICE_ID STREQUAL MIMXRT1024xxxxx))

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmimxrt1024/cmsis_pack_flash_algo/Sources/fsl_romapi.c
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmimxrt1024/cmsis_pack_flash_algo/FlashDev.c
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmimxrt1024/cmsis_pack_flash_algo/FlashPrg.c
)

target_include_directories(${MCUX_SDK_PROJECT_NAME} PUBLIC
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmimxrt1024/cmsis_pack_flash_algo/Sources
...
message("device_MIMXRT1024_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message("component_mflash_rt1024 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/flash/mflash/mimxrt1024/mflash_drv.c
)
