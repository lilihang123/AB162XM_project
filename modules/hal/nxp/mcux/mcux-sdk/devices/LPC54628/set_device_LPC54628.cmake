...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template/SEGGER_RTT_Conf.h ${CMAKE_CURRENT_LIST_DIR}/../../components/rtt/template driver_rtt_template.LPC54628)
...
if (CONFIG_USE_DEVICES_Project_Template_LPC54628)
# Add set(CONFIG_USE_DEVICES_Project_Template_LPC54628 true) in config.cmake to use this component

message("DEVICES_Project_Template_LPC54628 component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_LPC54628.LPC54628)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_LPC54628.LPC54628)
...
message(SEND_ERROR "DEVICES_Project_Template_LPC54628.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_LPC54628_startup)
# Add set(CONFIG_USE_device_LPC54628_startup true) in config.cmake to use this component

message("device_LPC54628_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_device_LPC54628_system)

if(CONFIG_TOOLCHAIN STREQUAL armgcc)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./gcc/startup_LPC54628.S "" device_LPC54628_startup.LPC54628)
endif()
...
if (CONFIG_USE_device_LPC54628_CMSIS)
# Add set(CONFIG_USE_device_LPC54628_CMSIS true) in config.cmake to use this component

message("device_LPC54628_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL LPC54628J512) AND CONFIG_USE_driver_lpc_dma)

add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.LPC54628)
...
message(SEND_ERROR "RTE_Device.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_clock.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_uart.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_usart_adapter AND (CONFIG_DEVICE_ID STREQUAL LPC54628J512) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "utility_debug_console_lite.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmic_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2c_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2s_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spifi_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_spi_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_usart_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_notifier.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_inputmux_connections.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL LPC54628J512) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_fro_calib.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_reset AND CONFIG_USE_driver_clock AND CONFIG_USE_device_LPC54628_CMSIS)
...
message(SEND_ERROR "driver_common.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_LPC54628_system)
# Add set(CONFIG_USE_device_LPC54628_system true) in config.cmake to use this component

message("device_LPC54628_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "device_LPC54628_system.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert_lite.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_str.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_debug_console.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rtt.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_flexcomm_i2c.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_flexcomm_spi.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_flexcomm_usart.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_audio_flexcomm_i2s_dma_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_button.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_codec.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_codec_adapters.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_wm8904_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_wm8960_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_cs42888_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_sgtl_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_da7212_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_codec_i2c.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpc_crc_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_software_crc_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cs42888.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dialog7212.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ft5406.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ft6x06.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_fxos8700cq.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpc_gpio_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_gint_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gt911.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_flexcomm_i2c_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ili9341.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_led.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lists.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_debugconsole.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_debugconsole_lite.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_ringbuffer.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager_light.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mflash_file.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mflash_dummy.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_mflash_common AND (CONFIG_BOARD STREQUAL lpcxpresso54628) AND CONFIG_USE_driver_spifi)
...
message(SEND_ERROR "component_mflash_lpc54xxx.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mma8451q.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mma8652fc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_panic.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_phy-device-lan8720a.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_pwm_ctimer_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_reset_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_rng_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_software_rng_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND CONFIG_USE_driver_lpc_rtc AND (CONFIG_DEVICE_ID STREQUAL LPC54628J512))
...
message(SEND_ERROR "component_lpcrtc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_spi.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_usb_cdc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_virtual.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_swo.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sgtl5000.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_shell.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_USE_driver_iap AND (CONFIG_DEVICE_ID STREQUAL LPC54628J512)))
...
message(SEND_ERROR "component_silicon_id.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_flexcomm_spi_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_ctimer_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mrt_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_timer_manager.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_usart_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_usart_dma_adapter.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_video-common.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wm8904.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wm8960.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_crc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ctimer.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmic.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmic_hwvad.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_driver_eeprom)
# Add set(CONFIG_USE_driver_eeprom true) in config.cmake to use this component

message("driver_eeprom component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_DEVICE_ID STREQUAL LPC54628J512) AND CONFIG_USE_driver_common)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../drivers/eeprom/fsl_eeprom.c
)
...
message(SEND_ERROR "driver_eeprom.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_emc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_enet.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flashiap.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_driver_fmc)
# Add set(CONFIG_USE_driver_fmc true) in config.cmake to use this component

message("driver_fmc component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_DEVICE_ID STREQUAL LPC54628J512) AND CONFIG_USE_driver_common)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../drivers/fmc/fsl_fmc.c
)
...
message(SEND_ERROR "driver_fmc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_fmeas.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gint.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexcomm AND CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL LPC54628J512))
...
message(SEND_ERROR "driver_flexcomm_i2c.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2c_freertos.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2s.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_iap.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL LPC54628J512) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_inputmux_connections)
...
message(SEND_ERROR "driver_inputmux.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_adc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_dma.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_gpio.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_iocon.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_lcdc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mcan.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mrt.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_otp.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pint.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_reset.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rit.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rng.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_rtc.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sctimer.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sdif.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sha.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_spi.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_spi_freertos.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spifi.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexcomm AND (CONFIG_DEVICE_ID STREQUAL LPC54628J512))
...
message(SEND_ERROR "driver_flexcomm_usart.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_usart_freertos.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_utick.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wwdt.LPC54628 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
