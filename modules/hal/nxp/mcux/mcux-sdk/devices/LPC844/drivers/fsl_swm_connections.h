...
typedef enum _swm_select_fixed_pin_t
{
    ...
    kSWM_CAPT_X0 = SWM_PINENABLE0_CAPT_X0_MASK, /*!< Fixed-pin function as CAPT_X0, an X capacitor(a mutual capacitance
                                                   touch sensor) . */
    ...
    kSWM_CAPT_X3 = SWM_PINENABLE0_CAPT_X3_MASK, /*!< Fixed-pin function as CAPT_X3. */

    kSWM_CAPT_X4 = SWM_PINENABLE1_CAPT_X4_MASK | 0x80000000U, /*!< Fixed-pin function as CAPT_X4. */
    kSWM_CAPT_X5 = SWM_PINENABLE1_CAPT_X5_MASK | 0x80000000U, /*!< Fixed-pin function as CAPT_X5. */
    kSWM_CAPT_X6 = SWM_PINENABLE1_CAPT_X6_MASK | 0x80000000U, /*!< Fixed-pin function as CAPT_X6. */
    kSWM_CAPT_X7 = SWM_PINENABLE1_CAPT_X7_MASK | 0x80000000U, /*!< Fixed-pin function as CAPT_X7. */
    kSWM_CAPT_X8 = SWM_PINENABLE1_CAPT_X8_MASK | 0x80000000U, /*!< Fixed-pin function as CAPT_X8. */
    kSWM_CAPT_YL = SWM_PINENABLE1_CAPT_YL_MASK |
                   0x80000000U, /*!< Fixed-pin function as CAPT_YL, an Y capacitor(the measurement capacitor) . */
    kSWM_CAPT_YH = SWM_PINENABLE1_CAPT_YH_MASK | 0x80000000U, /*!< Fixed-pin function as CAPT_YH. */

    kSWM_FIXEDPIN_NUM_FUNCS = 0x80000041U, /*!< Fixed-pin function number. */
