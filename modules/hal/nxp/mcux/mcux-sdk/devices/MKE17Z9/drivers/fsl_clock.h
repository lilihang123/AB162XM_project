...
/*! @brief Clock ip name array for SCI/UART clock. */
#define UART_CLOCKS              \
    {                            \
        kCLOCK_Sci0, kCLOCK_Sci1 \
    }
/*!
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_Flash0 = 0x40065080U, /*!< Note, the flash clock is always enabled, that is PCC_FLASH[CGC] bit is always 1 in
                                    this device and writing 0 takes no effect! */
    ...
    kCLOCK_FlexioTrig0 = 0x40065188U,
    kCLOCK_FlexioTrig1 = 0x4006518CU,
    ...
    kCLOCK_Sci0        = 0x400651B4U,
    kCLOCK_Sci1        = 0x400651B8U,
