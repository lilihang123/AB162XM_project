...
if (CONFIG_USE_DEVICES_Project_Template_MKM35Z7)
# Add set(CONFIG_USE_DEVICES_Project_Template_MKM35Z7 true) in config.cmake to use this component

message("DEVICES_Project_Template_MKM35Z7 component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_uart_adapter AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_device_MKM35Z7_startup AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_common AND CONFIG_USE_driver_gpio AND CONFIG_USE_driver_irtc AND CONFIG_USE_driver_port AND CONFIG_USE_driver_smc AND CONFIG_USE_driver_uart AND ((CONFIG_USE_component_serial_manager AND CONFIG_USE_utility_assert AND CONFIG_USE_utility_debug_console) OR (CONFIG_USE_utility_assert_lite AND CONFIG_USE_utility_debug_console_lite)))

add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_MKM35Z7.MKM35Z7)
...
message(SEND_ERROR "DEVICES_Project_Template_MKM35Z7.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MKM35Z7_startup)
# Add set(CONFIG_USE_device_MKM35Z7_startup true) in config.cmake to use this component

message("device_MKM35Z7_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_device_MKM35Z7_system)

if(CONFIG_TOOLCHAIN STREQUAL armgcc)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./gcc/startup_MKM35Z7.S "" device_MKM35Z7_startup.MKM35Z7)
endif()

if(CONFIG_TOOLCHAIN STREQUAL mcux)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./mcuxpresso/startup_mkm35z7.c "" device_MKM35Z7_startup.MKM35Z7)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./mcuxpresso/startup_mkm35z7.cpp "" device_MKM35Z7_startup.MKM35Z7)
endif()

else()

message(SEND_ERROR "device_MKM35Z7_startup.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MKM35Z7_CMSIS)
# Add set(CONFIG_USE_device_MKM35Z7_CMSIS true) in config.cmake to use this component

message("device_MKM35Z7_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_CMSIS_Include_core_cm AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7))
...
message(SEND_ERROR "device_MKM35Z7_CMSIS.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_dma AND CONFIG_USE_driver_dmamux)
...
message(SEND_ERROR "RTE_Device.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_clock.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_uart.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_uart_adapter AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "utility_debug_console_lite.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_spi_dma AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_spi AND CONFIG_USE_CMSIS_Driver_Include_SPI AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_spi.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_i2c_dma AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_i2c AND CONFIG_USE_CMSIS_Driver_Include_I2C AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_i2c.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_uart_dma AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_uart AND CONFIG_USE_CMSIS_Driver_Include_USART AND CONFIG_USE_RTE_Device)
...
message(SEND_ERROR "driver_cmsis_uart.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_i2c_dma.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart_dma.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spi_dma.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_uart_dma.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_notifier.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_MKM35Z7_system)
# Add set(CONFIG_USE_device_MKM35Z7_system true) in config.cmake to use this component

message("device_MKM35Z7_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "device_MKM35Z7_system.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert_lite.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_str.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_debug_console.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_flash_adapter.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lists.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_debugconsole.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_debugconsole_lite.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_ringbuffer.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_virtual.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_shell.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_slcd_engine.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_BOARD STREQUAL twrkm35z75m))
...
message(SEND_ERROR "driver_slcd_gdh_1247wp.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lptmr_adapter.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_pit_adapter.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpuart_adapter.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_uart_adapter.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_clock AND CONFIG_USE_device_MKM35Z7_CMSIS)
...
message(SEND_ERROR "driver_common.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_adc16.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_afe.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmp.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_crc.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_dmamux AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_dma.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmamux.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ewm.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flash.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gpio.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_i2c.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_i2c_freertos.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_irtc.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_llwu.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lptmr.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpuart_freertos.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_driver_mmau)
# Add set(CONFIG_USE_driver_mmau true) in config.cmake to use this component

message("driver_mmau component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if((CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7) AND CONFIG_USE_driver_common)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../drivers/mmau/fsl_mmau.c
)
...
message(SEND_ERROR "driver_mmau.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pdb.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pit.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pmc.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_port.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_qtmr_2.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rcm.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rnga.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sim.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_slcd.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_smc.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spi.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spi_freertos.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sysmpu.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL MKM35Z512xxx7 OR CONFIG_DEVICE_ID STREQUAL MKM35Z256xxx7))
...
message(SEND_ERROR "driver_uart.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_uart_freertos.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_vref.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wdog.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_xbar.MKM35Z7 dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
