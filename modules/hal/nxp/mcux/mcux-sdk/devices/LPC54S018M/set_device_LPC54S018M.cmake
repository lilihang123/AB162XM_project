...
if (CONFIG_USE_DEVICES_Project_Template_LPC54S018M)
# Add set(CONFIG_USE_DEVICES_Project_Template_LPC54S018M true) in config.cmake to use this component

message("DEVICES_Project_Template_LPC54S018M component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_usart_adapter AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M) AND CONFIG_USE_device_LPC54S018M_startup AND CONFIG_USE_driver_clock AND CONFIG_USE_driver_common AND CONFIG_USE_driver_emc AND CONFIG_USE_driver_flexcomm AND CONFIG_USE_driver_flexcomm_usart AND CONFIG_USE_driver_lpc_gpio AND CONFIG_USE_driver_lpc_iocon AND CONFIG_USE_driver_power AND CONFIG_USE_driver_reset AND ((CONFIG_USE_component_serial_manager AND CONFIG_USE_utility_assert AND CONFIG_USE_utility_debug_console) OR (CONFIG_USE_utility_assert_lite AND CONFIG_USE_utility_debug_console_lite)))

add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.h "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/board.c "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.h "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/clock_config.c "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.h "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/pin_mux.c "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.h "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
add_config_file(${CMAKE_CURRENT_LIST_DIR}/project_template/peripherals.c "" DEVICES_Project_Template_LPC54S018M.LPC54S018M)
...
message(SEND_ERROR "DEVICES_Project_Template_LPC54S018M.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_LPC54S018M_startup)
# Add set(CONFIG_USE_device_LPC54S018M_startup true) in config.cmake to use this component

message("device_LPC54S018M_startup component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_device_LPC54S018M_system)

if(CONFIG_TOOLCHAIN STREQUAL armgcc)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./gcc/startup_LPC54S018M.S "" device_LPC54S018M_startup.LPC54S018M)
endif()

if(CONFIG_TOOLCHAIN STREQUAL mcux)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./mcuxpresso/startup_lpc54s018m.c "" device_LPC54S018M_startup.LPC54S018M)
  add_config_file(${CMAKE_CURRENT_LIST_DIR}/./mcuxpresso/startup_lpc54s018m.cpp "" device_LPC54S018M_startup.LPC54S018M)
endif()

else()

message(SEND_ERROR "device_LPC54S018M_startup.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_LPC54S018M_CMSIS)
# Add set(CONFIG_USE_device_LPC54S018M_CMSIS true) in config.cmake to use this component

message("device_LPC54S018M_CMSIS component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_CMSIS_Include_core_cm AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M))
...
message(SEND_ERROR "device_LPC54S018M_CMSIS.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M) AND CONFIG_USE_driver_lpc_dma)

add_config_file(${CMAKE_CURRENT_LIST_DIR}/template/RTE_Device.h "" RTE_Device.LPC54S018M)
...
message(SEND_ERROR "RTE_Device.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_clock.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_uart.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_usart_adapter AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "utility_debug_console_lite.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmic_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2c_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2s_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spifi_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_spi_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_usart_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_notifier.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M))
...
message(SEND_ERROR "driver_inputmux_connections.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_power.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M) AND CONFIG_USE_driver_common)
...
message(SEND_ERROR "driver_fro_calib.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_reset AND CONFIG_USE_driver_clock AND CONFIG_USE_device_LPC54S018M_CMSIS)
...
message(SEND_ERROR "driver_common.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_device_LPC54S018M_system)
# Add set(CONFIG_USE_device_LPC54S018M_system true) in config.cmake to use this component

message("device_LPC54S018M_system component is included from ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "device_LPC54S018M_system.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_assert_lite.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_str.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_debug_console.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_flexcomm_i2c.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_flexcomm_spi.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cmsis_flexcomm_usart.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_audio_flexcomm_i2s_dma_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_button.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_codec.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_codec_adapters.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_wm8904_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_wm8960_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_cs42888_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_sgtl_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_da7212_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_codec_i2c.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpc_crc_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_software_crc_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_cs42888.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dialog7212.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ft5406.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ft6x06.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_fxos8700cq.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lpc_gpio_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_gint_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gt911.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_flexcomm_i2c_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ili9341.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_led.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_lists.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_debugconsole.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_debugconsole_lite.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_log_backend_ringbuffer.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mem_manager_light.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_component_mflash_lpc54s018m)
...
message(SEND_ERROR "component_mflash_file.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mflash_dummy.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if (CONFIG_USE_component_mflash_lpc54s018m)
# Add set(CONFIG_USE_component_mflash_lpc54s018m true) in config.cmake to use this component

message("component_mflash_lpc54s018m component is included from ${CMAKE_CURRENT_LIST_FILE}.")

if(CONFIG_USE_component_mflash_common AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M) AND CONFIG_USE_driver_spifi)

target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
  ${CMAKE_CURRENT_LIST_DIR}/../../components/flash/mflash/lpc54s018m/mflash_drv.c
)
...
message(SEND_ERROR "component_mflash_lpc54s018m.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mma8451q.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mma8652fc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_panic.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_phy-device-lan8720a.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_pwm_ctimer_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_reset_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_rng_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_software_rng_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_common AND CONFIG_USE_driver_lpc_rtc AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M))
...
message(SEND_ERROR "component_lpcrtc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_spi.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_usb_cdc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_virtual.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_serial_manager_swo.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sgtl5000.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "utility_shell.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_USE_driver_iap AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M)))
...
message(SEND_ERROR "component_silicon_id.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_flexcomm_spi_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_ctimer_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_mrt_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_timer_manager.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_usart_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "component_usart_dma_adapter.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_video-common.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wm8904.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wm8960.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_aes.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_crc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_ctimer.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmic.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_dmic_hwvad.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_emc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_enet.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_fmeas.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_gint.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexcomm AND CONFIG_USE_driver_common AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M))
...
message(SEND_ERROR "driver_flexcomm_i2c.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2c_freertos.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_i2s.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_iap.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if((CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M) AND CONFIG_USE_driver_common AND CONFIG_USE_driver_inputmux_connections)
...
message(SEND_ERROR "driver_inputmux.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_adc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_dma.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_gpio.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_iocon.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_lcdc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mcan.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_mrt.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_otp.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_pint.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_puf.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_reset.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rit.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_rng.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_lpc_rtc.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sctimer.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sdif.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_sha.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_spi.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_spi_freertos.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_spifi.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
if(CONFIG_USE_driver_flexcomm AND (CONFIG_DEVICE_ID STREQUAL LPC54S018J2M OR CONFIG_DEVICE_ID STREQUAL LPC54S018J4M))
...
message(SEND_ERROR "driver_flexcomm_usart.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_flexcomm_usart_freertos.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_utick.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
...
message(SEND_ERROR "driver_wwdt.LPC54S018M dependency does not meet, please check ${CMAKE_CURRENT_LIST_FILE}.")
