 ...
 * for S32K148_LQFP176/signal_configuration.xml
 *
 * Copyright 2023, NXP
 * SPDX-License-Identifier: Apache-2.0
 */

#ifndef _ZEPHYR_DTS_BINDING_S32K148_LQFP176_
#define _ZEPHYR_DTS_BINDING_S32K148_LQFP176_
...
#define FTM4_CH0_PTA18 KINETIS_MUX('A',18,2) /* PTA18 */
#define LPUART1_TX_PTA18 KINETIS_MUX('A',18,3) /* PTA18 */
#define LPSPI1_SOUT_PTA18 KINETIS_MUX('A',18,4) /* PTA18 */
#define FTM6_CH0_PTA18 KINETIS_MUX('A',18,5) /* PTA18 */
#define PTA19 KINETIS_MUX('A',19,1) /* PTA19 */
#define FTM4_CH1_PTA19 KINETIS_MUX('A',19,2) /* PTA19 */
#define LPUART1_RX_PTA19 KINETIS_MUX('A',19,3) /* PTA19 */
#define LPSPI1_SCK_PTA19 KINETIS_MUX('A',19,4) /* PTA19 */
#define PTA20 KINETIS_MUX('A',20,1) /* PTA20 */
#define FTM4_CH2_PTA20 KINETIS_MUX('A',20,2) /* PTA20 */
#define LPSPI1_SIN_PTA20 KINETIS_MUX('A',20,4) /* PTA20 */
#define PTA21 KINETIS_MUX('A',21,1) /* PTA21 */
#define FTM4_CH3_PTA21 KINETIS_MUX('A',21,2) /* PTA21 */
#define FXIO_D0_PTA21 KINETIS_MUX('A',21,3) /* PTA21 */
#define LPSPI1_PCS0_PTA21 KINETIS_MUX('A',21,4) /* PTA21 */
#define PTA22 KINETIS_MUX('A',22,1) /* PTA22 */
#define FTM4_CH4_PTA22 KINETIS_MUX('A',22,2) /* PTA22 */
#define FXIO_D1_PTA22 KINETIS_MUX('A',22,3) /* PTA22 */
#define LPSPI1_PCS1_PTA22 KINETIS_MUX('A',22,4) /* PTA22 */
#define PTA23 KINETIS_MUX('A',23,1) /* PTA23 */
#define FTM4_CH6_PTA23 KINETIS_MUX('A',23,2) /* PTA23 */
#define FXIO_D2_PTA23 KINETIS_MUX('A',23,3) /* PTA23 */
#define PTA24 KINETIS_MUX('A',24,1) /* PTA24 */
#define FTM4_CH7_PTA24 KINETIS_MUX('A',24,2) /* PTA24 */
#define FXIO_D3_PTA24 KINETIS_MUX('A',24,3) /* PTA24 */
#define PTA25 KINETIS_MUX('A',25,1) /* PTA25 */
#define FTM5_CH0_PTA25 KINETIS_MUX('A',25,2) /* PTA25 */
#define PTA26 KINETIS_MUX('A',26,1) /* PTA26 */
#define FTM5_CH1_PTA26 KINETIS_MUX('A',26,2) /* PTA26 */
#define LPSPI1_PCS0_PTA26 KINETIS_MUX('A',26,3) /* PTA26 */
#define LPSPI0_PCS0_PTA26 KINETIS_MUX('A',26,4) /* PTA26 */
#define PTA27 KINETIS_MUX('A',27,1) /* PTA27 */
#define FTM5_CH2_PTA27 KINETIS_MUX('A',27,2) /* PTA27 */
#define LPSPI1_SOUT_PTA27 KINETIS_MUX('A',27,3) /* PTA27 */
#define LPUART0_TX_PTA27 KINETIS_MUX('A',27,4) /* PTA27 */
#define CAN0_TX_PTA27 KINETIS_MUX('A',27,5) /* PTA27 */
#define PTA28 KINETIS_MUX('A',28,1) /* PTA28 */
#define FTM5_CH3_PTA28 KINETIS_MUX('A',28,2) /* PTA28 */
#define LPSPI1_SCK_PTA28 KINETIS_MUX('A',28,3) /* PTA28 */
#define LPUART0_RX_PTA28 KINETIS_MUX('A',28,4) /* PTA28 */
#define CAN0_RX_PTA28 KINETIS_MUX('A',28,5) /* PTA28 */
#define PTA29 KINETIS_MUX('A',29,1) /* PTA29 */
#define FTM5_CH4_PTA29 KINETIS_MUX('A',29,2) /* PTA29 */
#define LPUART2_TX_PTA29 KINETIS_MUX('A',29,4) /* PTA29 */
#define LPSPI1_SIN_PTA29 KINETIS_MUX('A',29,5) /* PTA29 */
#define PTA30 KINETIS_MUX('A',30,1) /* PTA30 */
#define FTM5_CH5_PTA30 KINETIS_MUX('A',30,2) /* PTA30 */
#define LPUART2_RX_PTA30 KINETIS_MUX('A',30,3) /* PTA30 */
#define LPSPI0_SOUT_PTA30 KINETIS_MUX('A',30,4) /* PTA30 */
#define PTA31 KINETIS_MUX('A',31,1) /* PTA31 */
#define FTM5_CH6_PTA31 KINETIS_MUX('A',31,2) /* PTA31 */
#define LPSPI0_PCS1_PTA31 KINETIS_MUX('A',31,4) /* PTA31 */
...
#define QSPI_B_IO0_PTB4 KINETIS_MUX('B',4,7) /* PTB4 */
...
#define ADC0_SE16_PTB18 KINETIS_MUX('B',18,0) /* PTB18 */
#define PTB18 KINETIS_MUX('B',18,1) /* PTB18 */
#define FTM5_CH7_PTB18 KINETIS_MUX('B',18,2) /* PTB18 */
#define LPSPI1_PCS1_PTB18 KINETIS_MUX('B',18,4) /* PTB18 */
#define PTB19 KINETIS_MUX('B',19,1) /* PTB19 */
#define FTM5_CH7_PTB19 KINETIS_MUX('B',19,2) /* PTB19 */
#define ADC0_SE17_PTB20 KINETIS_MUX('B',20,0) /* PTB20 */
#define PTB20 KINETIS_MUX('B',20,1) /* PTB20 */
#define FTM6_CH0_PTB20 KINETIS_MUX('B',20,2) /* PTB20 */
#define ADC0_SE18_PTB21 KINETIS_MUX('B',21,0) /* PTB21 */
#define PTB21 KINETIS_MUX('B',21,1) /* PTB21 */
#define FTM6_CH1_PTB21 KINETIS_MUX('B',21,2) /* PTB21 */
#define ADC0_SE19_PTB22 KINETIS_MUX('B',22,0) /* PTB22 */
#define PTB22 KINETIS_MUX('B',22,1) /* PTB22 */
#define FTM6_CH2_PTB22 KINETIS_MUX('B',22,2) /* PTB22 */
#define MII_CRS_PTB22 KINETIS_MUX('B',22,3) /* PTB22 */
#define LPUART1_TX_PTB22 KINETIS_MUX('B',22,5) /* PTB22 */
#define ADC0_SE20_PTB23 KINETIS_MUX('B',23,0) /* PTB23 */
#define PTB23 KINETIS_MUX('B',23,1) /* PTB23 */
#define FTM6_CH3_PTB23 KINETIS_MUX('B',23,2) /* PTB23 */
#define LPUART1_RX_PTB23 KINETIS_MUX('B',23,3) /* PTB23 */
#define MII_COL_PTB23 KINETIS_MUX('B',23,4) /* PTB23 */
#define PTB24 KINETIS_MUX('B',24,1) /* PTB24 */
#define FTM6_CH4_PTB24 KINETIS_MUX('B',24,2) /* PTB24 */
#define ADC0_SE21_PTB25 KINETIS_MUX('B',25,0) /* PTB25 */
#define PTB25 KINETIS_MUX('B',25,1) /* PTB25 */
#define FTM6_CH5_PTB25 KINETIS_MUX('B',25,2) /* PTB25 */
#define LPSPI2_PCS0_PTB25 KINETIS_MUX('B',25,5) /* PTB25 */
#define PTB26 KINETIS_MUX('B',26,1) /* PTB26 */
#define FTM6_CH6_PTB26 KINETIS_MUX('B',26,2) /* PTB26 */
#define ADC0_SE22_PTB27 KINETIS_MUX('B',27,0) /* PTB27 */
#define PTB27 KINETIS_MUX('B',27,1) /* PTB27 */
#define FTM6_CH7_PTB27 KINETIS_MUX('B',27,2) /* PTB27 */
#define LPSPI2_SOUT_PTB27 KINETIS_MUX('B',27,5) /* PTB27 */
#define ADC0_SE23_PTB28 KINETIS_MUX('B',28,0) /* PTB28 */
#define PTB28 KINETIS_MUX('B',28,1) /* PTB28 */
#define FTM7_CH0_PTB28 KINETIS_MUX('B',28,2) /* PTB28 */
#define LPSPI2_SIN_PTB28 KINETIS_MUX('B',28,5) /* PTB28 */
#define ADC0_SE24_PTB29 KINETIS_MUX('B',29,0) /* PTB29 */
#define PTB29 KINETIS_MUX('B',29,1) /* PTB29 */
#define FTM7_CH1_PTB29 KINETIS_MUX('B',29,2) /* PTB29 */
#define LPSPI2_SCK_PTB29 KINETIS_MUX('B',29,5) /* PTB29 */
#define PTB30 KINETIS_MUX('B',30,1) /* PTB30 */
#define FTM7_CH2_PTB30 KINETIS_MUX('B',30,2) /* PTB30 */
#define PTB31 KINETIS_MUX('B',31,1) /* PTB31 */
#define FTM7_CH3_PTB31 KINETIS_MUX('B',31,2) /* PTB31 */
...
#define QSPI_B_RWDS_PTC0 KINETIS_MUX('C',0,7) /* PTC0 */
...
#define QSPI_B_SCK_PTC1 KINETIS_MUX('C',1,7) /* PTC1 */
...
#define QSPI_A_IO3_PTC2 KINETIS_MUX('C',2,7) /* PTC2 */
...
#define QSPI_A_CS_PTC3 KINETIS_MUX('C',3,6) /* PTC3 */
#define QSPI_B_IO3_PTC3 KINETIS_MUX('C',3,7) /* PTC3 */
...
#define QSPI_B_CS_PTC15 KINETIS_MUX('C',15,7) /* PTC15 */
...
#define QSPI_B_IO7_PTC16 KINETIS_MUX('C',16,7) /* PTC16 */
...
#define QSPI_B_IO6_PTC17 KINETIS_MUX('C',17,7) /* PTC17 */
#define PTC18 KINETIS_MUX('C',18,1) /* PTC18 */
#define FTM7_CH4_PTC18 KINETIS_MUX('C',18,2) /* PTC18 */
#define ADC0_SE25_PTC19 KINETIS_MUX('C',19,0) /* PTC19 */
#define PTC19 KINETIS_MUX('C',19,1) /* PTC19 */
#define FTM7_CH5_PTC19 KINETIS_MUX('C',19,2) /* PTC19 */
#define LPSPI2_PCS1_PTC19 KINETIS_MUX('C',19,5) /* PTC19 */
#define PTC20 KINETIS_MUX('C',20,1) /* PTC20 */
#define FTM7_CH6_PTC20 KINETIS_MUX('C',20,2) /* PTC20 */
#define PTC21 KINETIS_MUX('C',21,1) /* PTC21 */
#define FTM7_CH7_PTC21 KINETIS_MUX('C',21,2) /* PTC21 */
#define FTM7_FLT0_PTC21 KINETIS_MUX('C',21,4) /* PTC21 */
#define PTC22 KINETIS_MUX('C',22,1) /* PTC22 */
#define FTM7_FLT1_PTC22 KINETIS_MUX('C',22,2) /* PTC22 */
#define ADC0_SE26_PTC23 KINETIS_MUX('C',23,0) /* PTC23 */
#define PTC23 KINETIS_MUX('C',23,1) /* PTC23 */
#define LPSPI0_SCK_PTC23 KINETIS_MUX('C',23,2) /* PTC23 */
#define PTC24 KINETIS_MUX('C',24,1) /* PTC24 */
#define FTM4_CH0_PTC24 KINETIS_MUX('C',24,2) /* PTC24 */
#define PTC25 KINETIS_MUX('C',25,1) /* PTC25 */
#define FTM4_CH1_PTC25 KINETIS_MUX('C',25,2) /* PTC25 */
#define PTC26 KINETIS_MUX('C',26,1) /* PTC26 */
#define FTM4_CH3_PTC26 KINETIS_MUX('C',26,2) /* PTC26 */
#define ADC0_SE27_PTC27 KINETIS_MUX('C',27,0) /* PTC27 */
#define PTC27 KINETIS_MUX('C',27,1) /* PTC27 */
#define FTM4_CH4_PTC27 KINETIS_MUX('C',27,2) /* PTC27 */
#define ADC0_SE28_PTC28 KINETIS_MUX('C',28,0) /* PTC28 */
#define PTC28 KINETIS_MUX('C',28,1) /* PTC28 */
#define FTM4_CH7_PTC28 KINETIS_MUX('C',28,2) /* PTC28 */
#define ADC0_SE29_PTC29 KINETIS_MUX('C',29,0) /* PTC29 */
#define PTC29 KINETIS_MUX('C',29,1) /* PTC29 */
#define FTM5_CH2_PTC29 KINETIS_MUX('C',29,2) /* PTC29 */
#define ADC0_SE30_PTC30 KINETIS_MUX('C',30,0) /* PTC30 */
#define PTC30 KINETIS_MUX('C',30,1) /* PTC30 */
#define FTM5_CH4_PTC30 KINETIS_MUX('C',30,2) /* PTC30 */
#define FXIO_D0_PTC30 KINETIS_MUX('C',30,3) /* PTC30 */
#define LPI2C1_SDAS_PTC30 KINETIS_MUX('C',30,4) /* PTC30 */
#define ADC0_SE31_PTC31 KINETIS_MUX('C',31,0) /* PTC31 */
#define PTC31 KINETIS_MUX('C',31,1) /* PTC31 */
#define FTM5_CH6_PTC31 KINETIS_MUX('C',31,2) /* PTC31 */
#define FXIO_D1_PTC31 KINETIS_MUX('C',31,3) /* PTC31 */
#define LPI2C1_SDA_PTC31 KINETIS_MUX('C',31,4) /* PTC31 */
...
#define QSPI_B_IO2_PTD5 KINETIS_MUX('D',5,7) /* PTD5 */
...
#define QSPI_B_IO1_PTD6 KINETIS_MUX('D',6,7) /* PTD6 */
...
#define QSPI_A_IO1_PTD7 KINETIS_MUX('D',7,7) /* PTD7 */
...
#define QSPI_B_IO5_PTD8 KINETIS_MUX('D',8,7) /* PTD8 */
...
#define QSPI_B_IO4_PTD9 KINETIS_MUX('D',9,7) /* PTD9 */
...
#define QSPI_A_SCK_PTD10 KINETIS_MUX('D',10,7) /* PTD10 */
...
#define QSPI_A_IO0_PTD11 KINETIS_MUX('D',11,7) /* PTD11 */
...
#define QSPI_A_IO2_PTD12 KINETIS_MUX('D',12,7) /* PTD12 */
...
#define ADC1_SE16_PTD18 KINETIS_MUX('D',18,0) /* PTD18 */
#define PTD18 KINETIS_MUX('D',18,1) /* PTD18 */
#define FTM5_CH7_PTD18 KINETIS_MUX('D',18,2) /* PTD18 */
#define FXIO_D2_PTD18 KINETIS_MUX('D',18,3) /* PTD18 */
#define LPI2C1_SCLS_PTD18 KINETIS_MUX('D',18,4) /* PTD18 */
#define ADC1_SE17_PTD19 KINETIS_MUX('D',19,0) /* PTD19 */
#define PTD19 KINETIS_MUX('D',19,1) /* PTD19 */
#define FTM6_CH0_PTD19 KINETIS_MUX('D',19,2) /* PTD19 */
#define FXIO_D3_PTD19 KINETIS_MUX('D',19,3) /* PTD19 */
#define LPI2C1_SCL_PTD19 KINETIS_MUX('D',19,4) /* PTD19 */
#define PTD20 KINETIS_MUX('D',20,1) /* PTD20 */
#define FTM6_CH1_PTD20 KINETIS_MUX('D',20,2) /* PTD20 */
#define PTD21 KINETIS_MUX('D',21,1) /* PTD21 */
#define FTM6_CH2_PTD21 KINETIS_MUX('D',21,2) /* PTD21 */
#define ADC1_SE18_PTD22 KINETIS_MUX('D',22,0) /* PTD22 */
#define PTD22 KINETIS_MUX('D',22,1) /* PTD22 */
#define FTM6_CH3_PTD22 KINETIS_MUX('D',22,2) /* PTD22 */
#define ADC1_SE19_PTD23 KINETIS_MUX('D',23,0) /* PTD23 */
#define PTD23 KINETIS_MUX('D',23,1) /* PTD23 */
#define FTM6_CH4_PTD23 KINETIS_MUX('D',23,2) /* PTD23 */
#define ADC1_SE20_PTD24 KINETIS_MUX('D',24,0) /* PTD24 */
#define PTD24 KINETIS_MUX('D',24,1) /* PTD24 */
#define FTM6_CH5_PTD24 KINETIS_MUX('D',24,2) /* PTD24 */
#define PTD25 KINETIS_MUX('D',25,1) /* PTD25 */
#define FTM6_CH6_PTD25 KINETIS_MUX('D',25,2) /* PTD25 */
#define PTD26 KINETIS_MUX('D',26,1) /* PTD26 */
#define FTM6_CH7_PTD26 KINETIS_MUX('D',26,2) /* PTD26 */
#define FXIO_D7_PTD26 KINETIS_MUX('D',26,3) /* PTD26 */
#define ADC1_SE21_PTD27 KINETIS_MUX('D',27,0) /* PTD27 */
#define PTD27 KINETIS_MUX('D',27,1) /* PTD27 */
#define FTM7_CH0_PTD27 KINETIS_MUX('D',27,2) /* PTD27 */
#define ADC1_SE22_PTD28 KINETIS_MUX('D',28,0) /* PTD28 */
#define PTD28 KINETIS_MUX('D',28,1) /* PTD28 */
#define FTM7_CH1_PTD28 KINETIS_MUX('D',28,2) /* PTD28 */
#define ADC1_SE23_PTD29 KINETIS_MUX('D',29,0) /* PTD29 */
#define PTD29 KINETIS_MUX('D',29,1) /* PTD29 */
#define FTM7_CH2_PTD29 KINETIS_MUX('D',29,2) /* PTD29 */
#define ADC1_SE24_PTD30 KINETIS_MUX('D',30,0) /* PTD30 */
#define PTD30 KINETIS_MUX('D',30,1) /* PTD30 */
#define FTM7_CH3_PTD30 KINETIS_MUX('D',30,2) /* PTD30 */
#define FTM6_FLT1_PTD30 KINETIS_MUX('D',30,3) /* PTD30 */
#define PTD31 KINETIS_MUX('D',31,1) /* PTD31 */
#define FTM7_CH4_PTD31 KINETIS_MUX('D',31,2) /* PTD31 */
#define FXIO_D6_PTD31 KINETIS_MUX('D',31,3) /* PTD31 */
#define FTM6_FLT0_PTD31 KINETIS_MUX('D',31,5) /* PTD31 */
...
#define FTM7_CH5_PTE17 KINETIS_MUX('E',17,2) /* PTE17 */
#define FXIO_D5_PTE17 KINETIS_MUX('E',17,3) /* PTE17 */
#define PTE18 KINETIS_MUX('E',18,1) /* PTE18 */
#define FTM7_CH6_PTE18 KINETIS_MUX('E',18,2) /* PTE18 */
#define FXIO_D4_PTE18 KINETIS_MUX('E',18,3) /* PTE18 */
#define ADC1_SE25_PTE19 KINETIS_MUX('E',19,0) /* PTE19 */
#define PTE19 KINETIS_MUX('E',19,1) /* PTE19 */
#define FTM7_CH7_PTE19 KINETIS_MUX('E',19,2) /* PTE19 */
#define ADC1_SE26_PTE20 KINETIS_MUX('E',20,0) /* PTE20 */
#define PTE20 KINETIS_MUX('E',20,1) /* PTE20 */
#define FTM4_CH0_PTE20 KINETIS_MUX('E',20,2) /* PTE20 */
#define ADC1_SE27_PTE21 KINETIS_MUX('E',21,0) /* PTE21 */
#define PTE21 KINETIS_MUX('E',21,1) /* PTE21 */
#define FTM4_CH1_PTE21 KINETIS_MUX('E',21,2) /* PTE21 */
#define ADC1_SE28_PTE22 KINETIS_MUX('E',22,0) /* PTE22 */
#define PTE22 KINETIS_MUX('E',22,1) /* PTE22 */
#define FTM4_CH2_PTE22 KINETIS_MUX('E',22,2) /* PTE22 */
#define ADC1_SE29_PTE23 KINETIS_MUX('E',23,0) /* PTE23 */
#define PTE23 KINETIS_MUX('E',23,1) /* PTE23 */
#define FTM4_CH3_PTE23 KINETIS_MUX('E',23,2) /* PTE23 */
#define ADC1_SE30_PTE24 KINETIS_MUX('E',24,0) /* PTE24 */
#define PTE24 KINETIS_MUX('E',24,1) /* PTE24 */
#define FTM4_CH4_PTE24 KINETIS_MUX('E',24,2) /* PTE24 */
#define CAN2_TX_PTE24 KINETIS_MUX('E',24,3) /* PTE24 */
#define ADC1_SE31_PTE25 KINETIS_MUX('E',25,0) /* PTE25 */
#define PTE25 KINETIS_MUX('E',25,1) /* PTE25 */
#define FTM4_CH5_PTE25 KINETIS_MUX('E',25,2) /* PTE25 */
#define CAN2_RX_PTE25 KINETIS_MUX('E',25,3) /* PTE25 */
#define PTE26 KINETIS_MUX('E',26,1) /* PTE26 */
#define FTM4_CH6_PTE26 KINETIS_MUX('E',26,2) /* PTE26 */
#define PTE27 KINETIS_MUX('E',27,1) /* PTE27 */
#define FTM4_CH7_PTE27 KINETIS_MUX('E',27,2) /* PTE27 */
#endif
