...
#define MCHP_EMI_BASE_ADDR	0x400f4000u

#define MCHP_EMI_NUM_INSTANCES	2u
#define MCHP_EMI_SPACING	0x0400u
#define MCHP_EMI_SPACING_PWROF2	10u

#define MCHP_EMI0_ADDR		0x400f4000u
#define MCHP_EMI1_ADDR		0x400f4400u
...
#define MCHP_EMI0_GIRQ		(1u << 2)
#define MCHP_EMI1_GIRQ		(1u << 3)

/*
 * OS_INT_SRC_LSB
 */
#define MCHP_EMI_OSIS_LSB_EC_WR_POS	0u
#define MCHP_EMI_OSIS_LSB_EC_WR		(1u << 0)
/* the following bits are also apply to OS_INT_MASK_LSB */
#define MCHP_EMI_OSIS_LSB_SWI_POS	1u
#define MCHP_EMI_OSIS_LSB_SWI_MASK0	0x7fu
#define MCHP_EMI_OSIS_LSB_SWI_MASK	0xfeu
...
#define MCHP_EMI_OSIS_MSB_SWI_MASK0	0xffu
#define MCHP_EMI_OSIS_MSB_SWI_MASK	0xffu
 ...
 * OS_APP_ID
 */
#define MCHP_EMI_OS_APP_ID_MASK		0xffu
 ...
 * be aligned >= 4 bytes.
 */
#define MCHP_EMI_MEM_BASE_MASK		0xfffffffcu
 ...
 */
#define MEM_EMI_MEM_LIMIT_MASK		0xfffcfffcu
#define MEM_EMI_MEM_LIMIT_RD_POS	0u
#define MEM_EMI_MEM_LIMIT_RD_MASK0	0xfffcu
#define MEM_EMI_MEM_LIMIT_RD_MASK	0xfffcu
#define MEM_EMI_MEM_LIMIT_WR_POS	16u
#define MEM_EMI_MEM_LIMIT_WR_MASK0	0xfffcu
#define MEM_EMI_MEM_LIMIT_WR_MASK	(0xfffcu << 16)

/*
 * EC_SET_OS_INT and EC_OS_INT_CLR_EN
 */
#define MCHP_EMI_EC_OS_SWI_MASK	0xfffeu
#define MCHP_EMI_EC_OS_SWI1	(1u << 1)
#define MCHP_EMI_EC_OS_SWI2	(1u << 2)
#define MCHP_EMI_EC_OS_SWI3	(1u << 3)
#define MCHP_EMI_EC_OS_SWI4	(1u << 4)
#define MCHP_EMI_EC_OS_SWI5	(1u << 5)
#define MCHP_EMI_EC_OS_SWI6	(1u << 6)
#define MCHP_EMI_EC_OS_SWI7	(1u << 7)
#define MCHP_EMI_EC_OS_SWI8	(1u << 8)
#define MCHP_EMI_EC_OS_SWI9	(1u << 9)
#define MCHP_EMI_EC_OS_SWI10	(1u << 10)
#define MCHP_EMI_EC_OS_SWI11	(1u << 11)
#define MCHP_EMI_EC_OS_SWI12	(1u << 12)
#define MCHP_EMI_EC_OS_SWI13	(1u << 13)
#define MCHP_EMI_EC_OS_SWI14	(1u << 14)
#define MCHP_EMI_EC_OS_SWI15	(1u << 15)
