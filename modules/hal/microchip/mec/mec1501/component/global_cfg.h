...
#define MCHP_GCFG_BASE_ADDR	0x400fff00u
...
#define MCHP_GCFG_DEV_ID_REG_MASK	0xffffffffu
#define MCHP_GCFG_REV_ID_POS		0
#define MCHP_GCFG_DID_REV_MASK0		0xffu
#define MCHP_GCFG_DID_REV_MASK		0xffu
#define MCHP_GCFG_DID_SUB_ID_POS	8
#define MCHP_GCFG_DID_SUB_ID_MASK0	0xffu
#define MCHP_GCFG_DID_SUB_ID_MASK	(0xffu << 8)
#define MCHP_GCFG_DID_DEV_ID_POS	16
#define MCHP_GCFG_DID_DEV_ID_MASK0	0xffffu
#define MCHP_GCFG_DID_DEV_ID_MASK	(0xffffu << 16)
