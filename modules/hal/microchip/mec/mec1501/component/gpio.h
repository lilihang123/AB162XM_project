...
#define MCHP_GPIO_BASE_ADDR	0x40081000u
#define MCHP_GPIO_CTRL_BASE	0x40081000u
 ...
 * Control
 */
#define MCHP_GPIO_CTRL_MASK		0x0101bfffu
/* bits[15:0] of Control register */
#define MCHP_GPIO_CTRL_CFG_MASK		0xbfffu
...
#define GPIO163_CTRL_DFLT	0x1040u
#define GPIO172_CTRL_DFLT	0x1040u
#define GPIO062_CTRL_DFLT	0x8240u
#define GPIO170_CTRL_DFLT	0x0041u	/* Boot-ROM JTAG_STRAP_BS */
#define GPIO116_CTRL_DFLT	0x0041u
#define GPIO250_CTRL_DFLT	0x1240u
...
#define MCHP_GPIO_CTRL_PUD_MASK		(0x03u << (MCHP_GPIO_CTRL_PUD_POS))
...
#define MCHP_GPIO_CTRL_PWRG_MASK	(0x03u << (MCHP_GPIO_CTRL_PWRG_POS))
#define MCHP_GPIO_CTRL_PWRG_VTR_IO	(0x00u << (MCHP_GPIO_CTRL_PWRG_POS))
#define MCHP_GPIO_CTRL_PWRG_VCC_IO	(0x01u << (MCHP_GPIO_CTRL_PWRG_POS))
#define MCHP_GPIO_CTRL_PWRG_OFF		(0x02u << (MCHP_GPIO_CTRL_PWRG_POS))
#define MCHP_GPIO_CTRL_PWRG_RSVD	(0x03u << (MCHP_GPIO_CTRL_PWRG_POS))
...
#define MCHP_GPIO_CTRL_IDET_MASK	(0x0fu << (MCHP_GPIO_CTRL_IDET_POS))
#define MCHP_GPIO_CTRL_IDET_LVL_LO	(0x00u << (MCHP_GPIO_CTRL_IDET_POS))
#define MCHP_GPIO_CTRL_IDET_LVL_HI	(0x01u << (MCHP_GPIO_CTRL_IDET_POS))
#define MCHP_GPIO_CTRL_IDET_DISABLE	(0x04u << (MCHP_GPIO_CTRL_IDET_POS))
#define MCHP_GPIO_CTRL_IDET_REDGE	(0x0du << (MCHP_GPIO_CTRL_IDET_POS))
#define MCHP_GPIO_CTRL_IDET_FEDGE	(0x0eu << (MCHP_GPIO_CTRL_IDET_POS))
#define MCHP_GPIO_CTRL_IDET_BEDGE	(0x0fu << (MCHP_GPIO_CTRL_IDET_POS))
...
#define MCHP_GPIO_CTRL_BUFT_MASK0	0x01u
#define MCHP_GPIO_CTRL_BUFT_MASK	(1u << (MCHP_GPIO_CTRL_BUFT_POS))
#define MCHP_GPIO_CTRL_BUFT_PUSHPULL	(0x00u << (MCHP_GPIO_CTRL_BUFT_POS))
#define MCHP_GPIO_CTRL_BUFT_OPENDRAIN	(0x01u << (MCHP_GPIO_CTRL_BUFT_POS))
...
#define MCHP_GPIO_CTRL_DIR_MASK0	0x01u
#define MCHP_GPIO_CTRL_DIR_MASK		(0x01u << (MCHP_GPIO_CTRL_DIR_POS))
#define MCHP_GPIO_CTRL_DIR_INPUT	(0x00u << (MCHP_GPIO_CTRL_DIR_POS))
#define MCHP_GPIO_CTRL_DIR_OUTPUT	(0x01u << (MCHP_GPIO_CTRL_DIR_POS))
...
#define MCHP_GPIO_CTRL_AOD_MASK0	0x01u
#define MCHP_GPIO_CTRL_AOD_MASK		(1u << (MCHP_GPIO_CTRL_AOD_POS))
#define MCHP_GPIO_CTRL_AOD_DIS		(0x01u << (MCHP_GPIO_CTRL_AOD_POS))
#define MCHP_GPIO_CTRL_AOD_EN		(0x00u << (MCHP_GPIO_CTRL_AOD_POS))
...
#define MCHP_GPIO_CTRL_POL_MASK0	0x01u
#define MCHP_GPIO_CTRL_POL_MASK		(1u << (MCHP_GPIO_CTRL_POL_POS))
#define MCHP_GPIO_CTRL_POL_NON_INVERT	(0x00u << (MCHP_GPIO_CTRL_POL_POS))
#define MCHP_GPIO_CTRL_POL_INVERT	(0x01u << (MCHP_GPIO_CTRL_POL_POS))
...
#define MCHP_GPIO_CTRL_MUX_MASK0	0x03u
#define MCHP_GPIO_CTRL_MUX_MASK		\
	(MCHP_GPIO_CTRL_MUX_MASK0 << (MCHP_GPIO_CTRL_MUX_POS))
#define MCHP_GPIO_CTRL_MUX_F0		(0x00u << (MCHP_GPIO_CTRL_MUX_POS))
#define MCHP_GPIO_CTRL_MUX_F1		(0x01u << (MCHP_GPIO_CTRL_MUX_POS))
#define MCHP_GPIO_CTRL_MUX_F2		(0x02u << (MCHP_GPIO_CTRL_MUX_POS))
#define MCHP_GPIO_CTRL_MUX_F3		(0x03u << (MCHP_GPIO_CTRL_MUX_POS))
...
#define MCHP_GPIO_CTRL_INPAD_DIS_MASK0	0x01u
#define MCHP_GPIO_CTRL_INPAD_DIS_MASK	(0x01u << (MCHP_GPIO_CTRL_INPAD_DIS_POS))
#define MCHP_GPIO_CTRL_INPAD_DIS	(0x01u << (MCHP_GPIO_CTRL_INPAD_DIS_POS))
#define MCHP_GPIO_CTRL_INPAD_EN		(0u << (MCHP_GPIO_CTRL_INPAD_DIS_POS))
...
#define MCHP_GPIO_CTRL_OUTVAL_MASK0	0x01u
#define MCHP_GPIO_CTRL_OUTVAL_MASK	(1u << (MCHP_GPIO_CTRL_OUTVAL_POS))
#define MCHP_GPIO_CTRL_OUTV_LO		(0x00u << (MCHP_GPIO_CTRL_OUTVAL_POS))
#define MCHP_GPIO_CTRL_OUTV_HI		(0x01u << (MCHP_GPIO_CTRL_OUTVAL_POS))
...
#define MCHP_GPIO_CTRL_INPAD_VAL_MASK0	0x01u
#define MCHP_GPIO_CTRL_INPAD_VAL_MASK	(0x01u << (MCHP_GPIO_CTRL_INPAD_VAL_POS))
#define MCHP_GPIO_CTRL_INPAD_VAL_LO	(0x00u << (MCHP_GPIO_CTRL_INPAD_VAL_POS))
#define MCHP_GPIO_CTRL_INPAD_VAL_HI	(0x01u << (MCHP_GPIO_CTRL_INPAD_VAL_POS))
...
#define MCHP_GPIO_CTRL2_SLEW_POS	0u
#define MCHP_GPIO_CTRL2_SLEW_MASK	(1u << MCHP_GPIO_CTRL2_SLEW_POS)
#define MCHP_GPIO_CTRL2_SLEW_SLOW	(0u << MCHP_GPIO_CTRL2_SLEW_POS)
#define MCHP_GPIO_CTRL2_SLEW_FAST	(1u << MCHP_GPIO_CTRL2_SLEW_POS)
#define MCHP_GPIO_CTRL2_DRV_STR_POS	4u
#define MCHP_GPIO_CTRL2_DRV_STR_MASK	(0x03u << MCHP_GPIO_CTRL2_DRV_STR_POS)
#define MCHP_GPIO_CTRL2_DRV_STR_2MA	(0u << MCHP_GPIO_CTRL2_DRV_STR_POS)
#define MCHP_GPIO_CTRL2_DRV_STR_4MA	(1u << MCHP_GPIO_CTRL2_DRV_STR_POS)
#define MCHP_GPIO_CTRL2_DRV_STR_8MA	(2u << MCHP_GPIO_CTRL2_DRV_STR_POS)
#define MCHP_GPIO_CTRL2_DRV_STR_12MA	(3u << MCHP_GPIO_CTRL2_DRV_STR_POS)
...
/**
  ...
  */
#define MCHP_GPIO_CTRL_BEGIN	0u
#define MCHP_GPIO_CTRL_END	0x2c4u
#define MCHP_GPIO_PARIN_BEGIN	0x300u
#define MCHP_GPIO_PARIN_END	0x318u
#define MCHP_GPIO_PAROUT_BEGIN	0x380u
#define MCHP_GPIO_PAROUT_END	0x398u
#define MCHP_GPIO_LOCK_BEGIN	0x3e8u
#define MCHP_GPIO_LOCK_END	0x400u
#define MCHP_GPIO_CTRL2_BEGIN	0x500u
#define MCHP_GPIO_CTRL2_END	0x7b4u

#define MAX_MCHP_GPIO_PIN	((MCHP_GPIO_CTRL_END) / 4u)
...
enum mchp_gpio_pwrgate {
	MCHP_GPIO_PWRGT_VTR = 0u,
	MCHP_GPIO_PWRGT_VCC = 1u,
	MCHP_GPIO_PWRGD_OFF = 2u,
};

enum mchp_gpio_idet {
	MCHP_GPIO_IDET_LO_LVL = 0x00u,
...
enum mchp_gpio_outbuf {
	MCHP_GPIO_PUSH_PULL = 0u,
	MCHP_GPIO_OPEN_DRAIN = 1u,
};

enum mchp_gpio_dir {
	MCHP_GPIO_DIR_IN = 0u,
	MCHP_GPIO_DIR_OUT = 1u,
};

enum mchp_gpio_parout_en {
	MCHP_GPIO_PAROUT_DIS = 0u,
	MCHP_GPIO_PAROUT_EN = 1u,
};

enum mchp_gpio_pol {
	MCHP_GPIO_POL_NORM = 0u,
	MCHP_GPIO_POL_INV = 1u,
};
...
enum mchp_gpio_inpad_ctrl {
	MCHP_GPIO_INPAD_CTRL_EN = 0u,
	MCHP_GPIO_INPAD_CTRL_DIS = 1u,
};

enum mchp_gpio_alt_out {
	MCHP_GPIO_ALT_OUT_LO = 0u,
	MCHP_GPIO_ALT_OUT_HI = 1u,
};

enum mchp_gpio_slew {
	MCHP_GPIO_SLEW_SLOW = 0u,
	MCHP_GPIO_SLEW_FAST = 1u,
};

enum mchp_gpio_drv_str {
	MCHP_GPIO_DRV_STR_2MA = 0u,
	MCHP_GPIO_DRV_STR_4MA = 1u,
	MCHP_GPIO_DRV_STR_8MA = 2u,
	MCHP_GPIO_DRV_STR_12MA = 3u,
};
...
{
	return REG8(gp_ctrl_addr + 3u) & MCHP_GPIO_CTRL_INPAD_VAL_MASK0;
}
