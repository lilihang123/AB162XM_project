...
#define MCHP_KBC_BASE_ADDR	0x400f0400u
...
#define MCHP_KBC_OBE_GIRQ	(1u << 18)
#define MCHP_KBC_IBF_GIRQ	(1u << 19)

/*
 * EC_KBC_STS and KBC_STS_RD bit definitions
 */
#define MCHP_KBC_STS_OBF_POS	0u
#define MCHP_KBC_STS_OBF	(1u << (MCHP_KBC_STS_OBF_POS))
#define MCHP_KBC_STS_IBF_POS	1u
#define MCHP_KBC_STS_IBF	(1u << (MCHP_KBC_STS_IBF_POS))
#define MCHP_KBC_STS_UD0_POS	2u
#define MCHP_KBC_STS_UD0	(1u << (MCHP_KBC_STS_UD0_POS))
#define MCHP_KBC_STS_CD_POS	3u
#define MCHP_KBC_STS_CD		(1u << (MCHP_KBC_STS_CD_POS))
#define MCHP_KBC_STS_UD1_POS	4u
#define MCHP_KBC_STS_UD1	(1u << (MCHP_KBC_STS_UD1_POS))
#define MCHP_KBC_STS_AUXOBF_POS	5u
#define MCHP_KBC_STS_AUXOBF	(1u << (MCHP_KBC_STS_AUXOBF_POS))
#define MCHP_KBC_STS_UD2_POS	6u
#define MCHP_KBC_STS_UD2_MASK0	0x03u
#define MCHP_KBC_STS_UD2_MASK	(0x03u << 6)
#define MCHP_KBC_STS_UD2_0_POS	6u
#define MCHP_KBC_STS_UD2_0	(1u << 6)
#define MCHP_KBC_STS_UD2_1	(1u << 7)

/*
 * KBC_CTRL bit definitions
 */
#define MCHP_KBC_CTRL_UD3_POS	0u
#define MCHP_KBC_CTRL_UD3	(1u << (MCHP_KBC_CTRL_UD3_POS))
#define MCHP_KBC_CTRL_SAEN_POS	1u
#define MCHP_KBC_CTRL_SAEN	(1u << (MCHP_KBC_CTRL_SAEN_POS))
#define MCHP_KBC_CTRL_PCOBFEN_POS	2u
#define MCHP_KBC_CTRL_PCOBFEN	(1u << (MCHP_KBC_CTRL_PCOBFEN_POS))
#define MCHP_KBC_CTRL_UD4_POS	3u
#define MCHP_KBC_CTRL_UD4_MASK0	0x03u
#define MCHP_KBC_CTRL_UD4_MASK	(0x03u << (MCHP_KBC_CTRL_UD4_POS))
#define MCHP_KBC_CTRL_OBFEN_POS	5u
#define MCHP_KBC_CTRL_OBFEN	(1u << (MCHP_KBC_CTRL_OBFEN_POS))
#define MCHP_KBC_CTRL_UD5_POS	6u
#define MCHP_KBC_CTRL_UD5	(1u << (MCHP_KBC_CTRL_UD5_POS))
#define MCHP_KBC_CTRL_AUXH_POS	7u
#define MCHP_KBC_CTRL_AUXH	(1u << (MCHP_KBC_CTRL_AUXH_POS))

/*
 * PCOBF register bit definitions
 */
#define MCHP_KBC_PCOBF_EN_POS	0u
#define MCHP_KBC_PCOBF_EN	(1u << (MCHP_KBC_PCOBF_EN_POS))

/*
 * KBC_PORT92_EN register bit definitions
 */
#define MCHP_KBC_PORT92_EN_POS	0u
#define MCHP_KBC_PORT92_EN	(1u << (MCHP_KBC_PORT92_EN_POS))
