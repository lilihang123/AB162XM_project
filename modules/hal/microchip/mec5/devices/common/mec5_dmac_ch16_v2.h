 ...
 */
#ifndef _MEC5_DMAC_V2_CH16_H
#define _MEC5_DMAC_V2_CH16_H
...
typedef struct mec_dmac_regs {                  /*!< (@ 0x40002400) MEC_DMAC Structure                                         */
  ...
  __IOM MEC_DMA_CHAN_Type CHAN[16];             /*!< (@ 0x00000040) DMA Channel                                                */
} MEC_DMAC_Type;                                /*!< Size = 1088 (0x440)                                                       */
...
typedef enum {                                  /*!< MEC_DMAC_CHAN_CTRL_HFC_DEV                                                */
