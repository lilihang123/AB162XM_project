 ...
 */
#ifndef _MEC5_UART_V1_5_H
#define _MEC5_UART_V1_5_H
...
typedef struct mec_uart_regs {                  /*!< (@ 0x400F2400) MEC_UART Structure                                        */
  ...
  __IOM uint8_t   LSRB;                         /*!< (@ 0x00000008) Line Status Register B                                     */
  __IM  uint8_t   RESERVED[807];
...
/* =========================================================  LSRB  ========================================================== */
#define MEC_UART_LSRB_TXF_FULL_STS_Pos    (0UL)                     /*!< TXF_FULL_STS (Bit 0)                                  */
#define MEC_UART_LSRB_TXF_FULL_STS_Msk    (0x1UL)                   /*!< TXF_FULL_STS (Bitfield-Mask: 0x01)                    */
#define MEC_UART_LSRB_TX_FIFO_CNT_Pos     (4UL)                     /*!< TX_FIFO_CNT (Bit 4)                                   */
#define MEC_UART_LSRB_TX_FIFO_CNT_Msk     (0xf0UL)                  /*!< TX_FIFO_CNT (Bitfield-Mask: 0x0f)                     */
/* =========================================================  ACTV  ========================================================== */
...
/* ==========================================================  SCR  ========================================================== */
/* =========================================================  LSRB  ========================================================== */
/* ==========================================  MEC_UART LSRB TXF_FULL_STS [0..0]  =========================================== */
typedef enum {                                  /*!< MEC_UART_LSRB_TXF_FULL_STS                                               */
  MEC_UART_LSRB_TXF_FULL_STS_FULL     = 1,     /*!< FULL : TX FIFO is full                                                    */
} MEC_UART_LSRB_TXF_FULL_STS_Enum;

/* ===========================================  MEC_UART LSRB TX_FIFO_CNT [4..7]  =========================================== */
typedef enum {                                  /*!< MEC_UART_LSRB_TX_FIFO_CNT                                                */
  MEC_UART_LSRB_TX_FIFO_CNT_0B        = 0,     /*!< 0B : Zero bytes in TX FIFO (empty)                                        */
  MEC_UART_LSRB_TX_FIFO_CNT_15B       = 15,    /*!< 15B : 15 bytes in TX FIFO                                                 */
} MEC_UART_LSRB_TX_FIFO_CNT_Enum;
