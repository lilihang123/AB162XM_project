...
/* ========================================================  PP_LOCK  ======================================================== */
#define MEC_PCR_PP_LOCK_VAL_Pos           (0UL)                     /*!< VAL (Bit 0)                                           */
#define MEC_PCR_PP_LOCK_VAL_Msk           (0xffffffffUL)            /*!< VAL (Bitfield-Mask: 0xffffffff)                       */
/* ========================================================  VBSRST  ========================================================= */
...
/* ========================================================  PP_LOCK  ======================================================== */
/* ==============================================  MEC_PCR PP_LOCK VAL [0..31]  ============================================== */
typedef enum {                                  /*!< MEC_PCR_PP_LOCK_VAL                                                       */
  MEC_PCR_PP_LOCK_VAL_UNLOCK           = -1506267828,/*!< UNLOCK : Write value for unlocking all PCR privilege registers       */
  MEC_PCR_PP_LOCK_VAL_LOCK             = -1506267827,/*!< LOCK : Write value for locking all PCR privilege registers           */
} MEC_PCR_PP_LOCK_VAL_Enum;
