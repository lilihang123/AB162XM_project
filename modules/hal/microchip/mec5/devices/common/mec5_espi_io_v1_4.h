 ...
 */
#ifndef _MEC5_ESPI_IO_V1_4_H
#define _MEC5_ESPI_IO_V1_4_H
...
/* =====================================================  RPMC_OP1_CFG  ====================================================== */
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS0_048_Pos (0UL)                  /*!< CS0_048 (Bit 0)                                       */
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS0_048_Msk (0x1UL)                /*!< CS0_048 (Bitfield-Mask: 0x01)                         */
...
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS1_048_Pos (2UL)                  /*!< CS1_048 (Bit 2)                                       */
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS1_048_Msk (0x4UL)                /*!< CS1_048 (Bitfield-Mask: 0x01)                         */
...
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS0_NCNTR_EN_Pos (4UL)             /*!< CS0_NCNTR_EN (Bit 4)                                  */
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS0_NCNTR_EN_Msk (0x10UL)          /*!< CS0_NCNTR_EN (Bitfield-Mask: 0x01)                    */
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS1_NCNTR_EN_Pos (5UL)             /*!< CS1_NCNTR_EN (Bit 5)                                  */
#define MEC_ESPI_IO_RPMC_OP1_CFG_CS1_NCNTR_EN_Msk (0x20UL)          /*!< CS1_NCNTR_EN (Bitfield-Mask: 0x01)                    */
...
typedef enum {                                  /*!< MEC_ESPI_IO_EC_LDN_MSK                                                    */
  ...
  MEC_ESPI_IO_EC_LDN_MSK_RSVD21        = 21,    /*!< RSVD21 : eSPI Reserved LDN and I/O mask                                   */
  MEC_ESPI_IO_EC_LDN_MSK_GLUE          = 22,    /*!< GLUE : eSPI Glue Logic LDN and I/O mask                                   */
  MEC_ESPI_IO_EC_LDN_MSK_RSVD23        = 23,    /*!< RSVD23 : eSPI Reserved LDN and I/O mask                                   */
...
typedef enum {                                  /*!< MEC_ESPI_IO_HOST_BAR                                                      */
  ...
  MEC_ESPI_IO_HOST_BAR_RSVD21          = 21,    /*!< RSVD21 : eSPI Reserved Host I/O address and valid                         */
  MEC_ESPI_IO_HOST_BAR_GLUE            = 22,    /*!< GLUE : eSPI Glue Logic Host I/O address and valid                         */
  MEC_ESPI_IO_HOST_BAR_RSVD23          = 23,    /*!< RSVD23 : eSPI Reserved Host I/O address and valid                         */
...
typedef enum {                                  /*!< MEC_ESPI_IO_SERIRQ                                                        */
  ...
  MEC_ESPI_IO_SERIRQ_RSVD19            = 19,    /*!< RSVD19 : Reserved Serial IRQ index 19                                     */
  MEC_ESPI_IO_SERIRQ_RSVD20            = 20,    /*!< RSVD20 : Reserved Serial IRQ index 20                                     */
  MEC_ESPI_IO_SERIRQ_RSVD21            = 21,    /*!< RSVD21 : Reserved Serial IRQ index 21                                     */
