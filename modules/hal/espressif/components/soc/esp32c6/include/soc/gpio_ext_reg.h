...
/** GPIO_ETM_TASK_P7_CFG_REG register
 *  Etm Configure Register to decide which GPIO been chosen
 */
#define GPIO_ETM_TASK_P7_CFG_REG (DR_REG_GPIO_EXT_BASE + 0xbc)
/** GPIO_ETM_TASK_GPIO28_EN : R/W; bitpos: [0]; default: 0;
 *  Enable bit of GPIO response etm task.
 */
#define GPIO_ETM_TASK_GPIO28_EN    (BIT(0))
#define GPIO_ETM_TASK_GPIO28_EN_M  (GPIO_ETM_TASK_GPIO28_EN_V << GPIO_ETM_TASK_GPIO28_EN_S)
#define GPIO_ETM_TASK_GPIO28_EN_V  0x00000001U
#define GPIO_ETM_TASK_GPIO28_EN_S  0
/** GPIO_ETM_TASK_GPIO28_SEL : R/W; bitpos: [3:1]; default: 0;
 *  GPIO choose a etm task channel.
 */
#define GPIO_ETM_TASK_GPIO28_SEL    0x00000007U
#define GPIO_ETM_TASK_GPIO28_SEL_M  (GPIO_ETM_TASK_GPIO28_SEL_V << GPIO_ETM_TASK_GPIO28_SEL_S)
#define GPIO_ETM_TASK_GPIO28_SEL_V  0x00000007U
#define GPIO_ETM_TASK_GPIO28_SEL_S  1
/** GPIO_ETM_TASK_GPIO29_EN : R/W; bitpos: [8]; default: 0;
 *  Enable bit of GPIO response etm task.
 */
#define GPIO_ETM_TASK_GPIO29_EN    (BIT(8))
#define GPIO_ETM_TASK_GPIO29_EN_M  (GPIO_ETM_TASK_GPIO29_EN_V << GPIO_ETM_TASK_GPIO29_EN_S)
#define GPIO_ETM_TASK_GPIO29_EN_V  0x00000001U
#define GPIO_ETM_TASK_GPIO29_EN_S  8
/** GPIO_ETM_TASK_GPIO29_SEL : R/W; bitpos: [11:9]; default: 0;
 *  GPIO choose a etm task channel.
 */
#define GPIO_ETM_TASK_GPIO29_SEL    0x00000007U
#define GPIO_ETM_TASK_GPIO29_SEL_M  (GPIO_ETM_TASK_GPIO29_SEL_V << GPIO_ETM_TASK_GPIO29_SEL_S)
#define GPIO_ETM_TASK_GPIO29_SEL_V  0x00000007U
#define GPIO_ETM_TASK_GPIO29_SEL_S  9
/** GPIO_ETM_TASK_GPIO30_EN : R/W; bitpos: [16]; default: 0;
 *  Enable bit of GPIO response etm task.
 */
#define GPIO_ETM_TASK_GPIO30_EN    (BIT(16))
#define GPIO_ETM_TASK_GPIO30_EN_M  (GPIO_ETM_TASK_GPIO30_EN_V << GPIO_ETM_TASK_GPIO30_EN_S)
#define GPIO_ETM_TASK_GPIO30_EN_V  0x00000001U
#define GPIO_ETM_TASK_GPIO30_EN_S  16
/** GPIO_ETM_TASK_GPIO30_SEL : R/W; bitpos: [19:17]; default: 0;
 *  GPIO choose a etm task channel.
 */
#define GPIO_ETM_TASK_GPIO30_SEL    0x00000007U
#define GPIO_ETM_TASK_GPIO30_SEL_M  (GPIO_ETM_TASK_GPIO30_SEL_V << GPIO_ETM_TASK_GPIO30_SEL_S)
#define GPIO_ETM_TASK_GPIO30_SEL_V  0x00000007U
#define GPIO_ETM_TASK_GPIO30_SEL_S  17
