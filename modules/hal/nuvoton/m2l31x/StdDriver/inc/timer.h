 ...
 * @file     timer.h
 * @version  V1.00
 * @brief    Timer Controller driver header file
 *
...
#define TIMER_CAPSRC_INTERNAL                   (1UL << TIMER_CTL_CAPSRC_Pos)      /*!< Capture source from Internal event such as HXT/LXT/HIRC/LIRC/MIRC or ACMP0/1/2  \hideinitializer */
...
#define TIMER_INTERCAPSEL_MIRC                  (6UL << TIMER_EXTCTL_INTERCAPSEL_Pos)   /*!< Capture source from Internal event MIRC \hideinitializer */
#define TIMER_INTERCAPSEL_ACMP2                 (7UL << TIMER_EXTCTL_INTERCAPSEL_Pos)   /*!< Capture source from Internal event ACMP2 \hideinitializer */
...
#define TIMER_CAPTURE_FROM_HXT                  (TIMER_INTERCAPSEL_HXT)             /*!< Capture source from Internal event HXT    \hideinitializer */
#define TIMER_CAPTURE_FROM_LXT                  (TIMER_INTERCAPSEL_LXT)             /*!< Capture source from Internal event LXT    \hideinitializer */
#define TIMER_CAPTURE_FROM_HIRC                 (TIMER_INTERCAPSEL_HIRC)            /*!< Capture source from Internal event HIRC    \hideinitializer */
#define TIMER_CAPTURE_FROM_LIRC                 (TIMER_INTERCAPSEL_LIRC)            /*!< Capture source from Internal event LIRC    \hideinitializer */
#define TIMER_CAPTURE_FROM_MIRC                 (TIMER_INTERCAPSEL_MIRC)            /*!< Capture source from Internal event MIRC    \hideinitializer */
#define TIMER_CAPTURE_FROM_ACMP2                (TIMER_INTERCAPSEL_ACMP2)           /*!< Capture source from Internal event ACMP2   \hideinitializer */
...
#define TIMER_TRG_TO_PWM                        (TIMER_TRGCTL_TRGPWM_Msk)       /*!< Each timer event as PWM counter clock source \hideinitializer */
...
#define TIMER_TRG_TO_LPADC                      (TIMER_TRGCTL_TRGLPADC_Msk)     /*!< Each timer event to trigger LPADC transfer \hideinitializer */
#define TIMER_TRG_TO_TK                         (TIMER_TRGCTL_TRGTK_Msk)        /*!< Each timer event to trigger TK transfer \hideinitializer */
