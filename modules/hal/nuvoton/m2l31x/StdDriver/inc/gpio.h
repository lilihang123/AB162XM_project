 ...
 * @file     gpio.h
 * @version  V1.00
 * @brief    M2L31 series GPIO driver header file
 *
 ...
 *                          - It could be \ref BIT0 ~ \ref BIT15 for PA, PB, PD and PE GPIO port.
 *                          - It could be \ref BIT0 ~ \ref BIT14 for PC GPIO port.
 *                          - It could be \ref BIT0 ~ \ref BIT11 for PF GPIO port.
 *                          - It could be \ref BIT2 ~ \ref BIT4, \ref BIT9 ~ \ref BIT15 for PG GPIO port.
 *                          - It could be \ref BIT4 ~ \ref BIT11 for PH GPIO port.
 *
 * @return      None
 *
