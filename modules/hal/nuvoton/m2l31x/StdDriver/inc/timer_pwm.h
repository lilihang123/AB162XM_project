 ...
 * @file     timer_pwm.h
 * @version  V1.01
 * @brief    M2L31 series Timer PWM Controller(Timer PWM) driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
/*  TPWM Trigger EADC/DAC/PDMA/LPADC Source Select Constant Definitions                                          */
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_TRIGGER_AT_PERIOD_POINT            (0UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger EADC/DAC/PDMA/LPADC while counter period point event occurred \hideinitializer */
#define TPWM_TRIGGER_AT_COMPARE_POINT           (1UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger EADC/DAC/PDMA/LPADC while counter compare point event occurred \hideinitializer */
#define TPWM_TRIGGER_AT_PERIOD_OR_COMPARE_POINT (2UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger EADC/DAC/PDMA/LPADC while counter period or compare point event occurred \hideinitializer */
...
/**
  * @brief      Get Trigger LPADC Status
  *
  * @param[in]  timer   The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
  *
  * @retval     0       Trigger LPADC start conversion is not occur
  * @retval     1       Specified counter event has trigger LPADC start conversion
  *
...
/**
  ...
  * @return     None
  *
  * @details    This macro is used to clear TPWM counter event trigger LPADC status.
  * \hideinitializer
  */
#define TPWM_CLEAR_TRG_LPADC_STATUS(timer)            ((timer)->PWMSTATUS = TIMER_PWMSTATUS_LPADCTRGF_Msk)
