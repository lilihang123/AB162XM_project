 ...
 * @file     lpadc.h
 * @version  V1.0
 * @brief    M2L31 series LPADC driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
/* LPADC Interrupt Constant Definitions                                                                      */
/*---------------------------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------------------------*/
#define LPADC_AUTOCTL_TRIGSEL_SOFTWARE  (0xFFUL)                            /*!< LPADC Automatic Operation Trigger Source Select is Software  \hideinitializer */
...
/**
  ...
  * @param[in] u32ChNum LPADC Channel, valid value are from 0 to 26, 28 ~ 31.
  * @return  16-bit data.
  * @details Read RSLT bit field to get conversion data.
  * \hideinitializer
  */
#define LPADC_GET_CONVERSION_DATA(lpadc, u32ChNum) ((lpadc)->ADDR[(u32ChNum)] & LPADC_ADDR0_RSLT_Msk)
...
/**
  ...
  * @return None
  * @details For example, LPADC_ENABLE_CMP0(LPADC, 5, LPADC_ADCMPR_CMPCOND_GREATER_OR_EQUAL, 0x800, 10);
...
/**
  ...
  * @param[in] u32MatchCount Specifies the match count setting, valid values are between 1~16.
  * @return None
  * @details For example, LPADC_ENABLE_CMP1(LPADC, 5, LPADC_ADCMPR_CMPCOND_GREATER_OR_EQUAL, 0x800, 10);
 ...
 * @return      None
 */
#define LPADC_CONVERSION_END_WAKEUP_DISABLE(lpadc)  ((lpadc)->AUTOCTL &= ~LPADC_AUTOCTL_ADWKEN_Msk)
 ...
 */
#define LPADC_CLEAR_CONVERSION_END_WAKEUP_FLAG(lpadc)   ((lpadc)->AUTOSTS = LPADC_AUTOSTS_ADWKF_Msk)
