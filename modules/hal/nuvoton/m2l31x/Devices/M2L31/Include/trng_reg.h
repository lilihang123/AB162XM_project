...
typedef struct
{
     ...
     * @var TRNG_T::DATA0
     * Offset: 0x0C  TRNG Data Output Word 0 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var TRNG_T::DATA1
     * Offset: 0x10  TRNG Data Output Word 1 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |DATA      |True Random Number Generator Data (Read Only)
     ...
     * |        |          |TRNG_DATA3 stores NRBG word 3 / DRBG word 3.
     * @var TRNG_T::DATA2
     * Offset: 0x14  TRNG Data Output Word 2 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |DATA      |True Random Number Generator Data (Read Only)
     ...
     * |        |          |TRNG_DATA3 stores NRBG word 3 / DRBG word 3.
     * @var TRNG_T::DATA3
     * Offset: 0x18  TRNG Data Output Word 3 Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |DATA      |True Random Number Generator Data (Read Only)
