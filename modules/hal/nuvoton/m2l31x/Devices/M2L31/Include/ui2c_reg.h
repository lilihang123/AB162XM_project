...
typedef struct
{
     ...
     * |        |          |Note 2: When software set 10'h000, the address cannot be used.
     * @var UI2C_T::DEVADDR1
     ...
     * |        |          |Note: This bit cannot be released when WKUPIF is set.
...
#define UI2C_BRGEN_NFCNT_Pos          (28)                                              /*!< UI2C_T::BRGEN: NFCNT Position       */
#define UI2C_BRGEN_NFCNT_Msk          (0xful << UI2C_BRGEN_NFCNT_Pos)                   /*!< UI2C_T::BRGEN: NFCNT Mask           */
