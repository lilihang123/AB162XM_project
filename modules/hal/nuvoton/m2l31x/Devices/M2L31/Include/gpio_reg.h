 ...
 * |        |          |Note 2: For more information about Px.n, please refer to the "PIN CONFIGURATION" chapter.
 * @var GPIO_T::DBCTL
 * Offset: 0x34/0x74/0xB4/0xF4/0x134/0x174/0x1B4/0x1F4  Port A-H Interrupt De-bounce Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
...
#define GPIO_INT_INNF_NFEN_Pos           (0)                                               /*!< GPIO_INT_T::INT_INNF: NFEN Position        */
#define GPIO_INT_INNF_NFEN_Msk           (0x1ul << GPIO_INT_INNF_NFEN_Pos)                 /*!< GPIO_INT_T::INT_INNF: NFEN Mask            */

#define GPIO_INT_INNF_NFSEL_Pos          (4)                                               /*!< GPIO_INT_T::INT_INNF: NFSEL Position       */
#define GPIO_INT_INNF_NFSEL_Msk          (0x7ul << GPIO_INT_INNF_NFSEL_Pos)                /*!< GPIO_INT_T::INT_INNF: NFSEL Mask           */

#define GPIO_INT_INNF_NFCNT_Pos          (8)                                               /*!< GPIO_INT_T::INT_INNF: NFCNT Position       */
#define GPIO_INT_INNF_NFCNT_Msk          (0x7ul << GPIO_INT_INNF_NFCNT_Pos)                /*!< GPIO_INT_T::INT_INNF: NFCNT Mask           */
