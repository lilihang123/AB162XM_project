...
/**
    @addtogroup Universal Asynchronous Receiver/Transmitter Controller(UART)
 ...
 * |        |          |Note 1: Refer to Figure 6.28-13 and Figure 6.28-14 for UART function mode.
 ...
 * |        |          |Note 3: The control and interactions of this field are explained in 6.27.5.10 (Slave mode with automatic resynchronization).
 ...
 * |        |          |Note: The exit from mute mode condition and each control and interactions of this field are explained in 6.27.5.10 (LIN slave mode).
