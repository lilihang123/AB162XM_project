 ...
 * |        |          |001 = Event Counter input source is from internal USB internal SOF output signal.
 ...
 * |        |          |0 = Time-out interrupt signal is used to internal trigger PWM, EPWM, PDMA, DAC, LPADC and EADC.
 * |        |          |1 = Capture interrupt signal is used to internal trigger PWM, EPWM, PDMA, DAC, LPADC and EADC.
 * |[1]     |TRGPWM    |Trigger PWM/EPWM Enable Bit
 * |        |          |If this bit is set to 1, each timer time-out event or capture event can be as PWM/EPWM counter clock source.
 * |        |          |0 = Timer interrupt trigger PWM/EPWM Disabled.
 * |        |          |1 = Timer interrupt trigger PWM/EPWM Enabled.
 * |        |          |Note: If TRGSSEL (TIMERx_TRGCTL[0]) = 0, time-out interrupt signal as PWM/EPWM counter clock source.
 * |        |          |If TRGSSEL (TIMERx_TRGCTL[0]) = 1, capture interrupt signal as PWM/EPWM counter clock source.
 ...
 * |[5]     |TRGLPADC  |Trigger LPADC Enable Bit
 * |        |          |If this bit is set to 1, each timer time-out event or capture event can be triggered LPADC transfer.
 * |        |          |0 = Timer interrupt trigger LPADC Disabled.
 * |        |          |1 = Timer interrupt trigger LPADC Enabled.
 * |        |          |Note: If TRGSSEL (TIMERx_TRGCTL[0]) = 0, time-out interrupt signal will trigger LPADC.
 * |        |          |If TRGSSEL (TIMERx_TRGCTL[0]) = 1, capture interrupt signal will trigger LPADC.
 * |[8]     |TRGTK     |Trigger Touch-key Scan Enable Bit
 * |        |          |If this bit is set to 1, timer time-out interrupt can trigger Touck-Key start scan.
 * |        |          |0 = Timer time-out interrupt signal trigger Touch-Key scan Disabled.
 * |        |          |1 = Timer time-out interrupt signal trigger Touch-Key scan Enabled.
 * @var TIMER_T::CAPNF
 ...
 * |        |          |Note: Set TRGSEL (TIMERx_PWMTRGCTL[1:0]) to select PWM trigger conversion source.
 * |[10]    |PWMTRGLPADC|PWM Counter Event Trigger LPADC Conversion Enable Bit
 * |        |          |If this bit is set to 1, PWM can trigger LPADC conversion.
 * |        |          |0 = PWM trigger LPADC Disabled.
 * |        |          |1 = PWM trigger LPADC Enabled.
 * |        |          |Note: Set TRGSEL (TIMERx_PWMTRGCTL[1:0]) to select PWM trigger conversion source.
 ...
 * |        |          |Note: This bit is cleared by writing 1 to it.
 * |[19]    |LPADCTRGF |Trigger LPADC Start Conversion Flag
 * |        |          |0 = PWM counter event trigger LPADC start conversion has not occurred.
 * |        |          |1 = PWM counter event trigger LPADC start conversion has occurred.
 * |        |          |Note: This bit is cleared by writing 1 to it.
 * @var TIMER_T::PWMPBUF
...
#define TIMER_TRGCTL_TRGLPADC_Pos        (5)                                               /*!< TIMER_T::TRGCTL: TRGLPADC Position     */
#define TIMER_TRGCTL_TRGLPADC_Msk        (0x1ul << TIMER_TRGCTL_TRGLPADC_Pos)              /*!< TIMER_T::TRGCTL: TRGLPADC Mask         */

#define TIMER_TRGCTL_TGTKEN_Pos          (8)                                               /*!< TIMER_T::TRGCTL: TGTKEN Position       */
#define TIMER_TRGCTL_TGTKEN_Msk          (0x1ul << TIMER_TRGCTL_TGTKEN_Pos)                /*!< TIMER_T::TRGCTL: TGTKEN Mask           */
...
#define TIMER_PWMTRGCTL_PWMTRGLPADC_Pos  (10)                                              /*!< TIMER_T::PWMTRGCTL: PWMTRGLPADC Position*/
#define TIMER_PWMTRGCTL_PWMTRGLPADC_Msk  (0x1ul << TIMER_PWMTRGCTL_PWMTRGLPADC_Pos)        /*!< TIMER_T::PWMTRGCTL: PWMTRGLPADC Mask   */
...
#define TIMER_PWMSTATUS_LPADCTRGF_Pos    (19)                                              /*!< TIMER_T::PWMSTATUS: LPADCTRGF Position */
#define TIMER_PWMSTATUS_LPADCTRGF_Msk    (0x1ul << TIMER_PWMSTATUS_LPADCTRGF_Pos)          /*!< TIMER_T::PWMSTATUS: LPADCTRGF Mask     */
