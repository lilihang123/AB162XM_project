...
/**
    @addtogroup CANFD Controller Area Network with Flexible DataRate(CANFD)
...
typedef struct
{
     ...
     * |        |          |1 = Loop Back Mode is enabled (refer to 6.36.5.1 TEST Mode).
     ...
     * |        |          |Note: For use of timeout function with CAN FD refer to 6.36.5.3.
     ...
     * |        |          |Start address of standard Message ID filter list (32-bit word address, refer to Figure 1.1-11Figure 0-11).
     ...
     * |        |          |Start address of extended Message ID filter list (32-bit word address, refer to Figure 1.1-11Figure 0-11)
     ...
     * |        |          |Start address of Rx FIFO 1 in Message RAM (32-bit word address, refer to Figure 6.36 11).
     ...
     * |        |          |After a CANFD_TXBRP bit has been set, a Tx scan (refer to 6.36.5.5, Tx Handling) is started to check for the pending Tx request with the highest priority (Tx Buffer with lowest Message ID).
     ...
     * |        |          |Start address of Tx Event FIFO in Message RAM (32-bit word address, refer to Figure 6.36 11).
