 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |CSSBRKEN  |Clock Security System Detection Trigger EPWM Brake Function Enable Bit
 * |        |          |0 = Brake Function triggered by CSS detection Disabled.
 * |        |          |1 = Brake Function triggered by CSS detection Enabled.
 * |[1]     |BODBRKEN  |Brown-out Detection Trigger EPWM Brake Function Enable Bit
 * |        |          |0 = Brake Function triggered by BOD Disabled.
 * |        |          |1 = Brake Function triggered by BOD Enabled.
 * |[2]     |RAMBRKEN  |SRAM Parity Error Detection Trigger EPWM Brake Function Enable Bit
 ...
 * |[3]     |CORBRKEN  |Core Lockup Detection Trigger EPWM Brake Function Enable Bit
 ...
 * Offset: 0x100  EPWM Free Trigger Compare Register 0~2
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |FTCMP     |EPWM Free Trigger Compare Register
 * |        |          |FTCMP use to compare with even CNT (EPWM_CNTm[15:0], m=0,2,4) to trigger EADC
 * |        |          |EPWM_FTCMPDAT0_1, EPWM_FTCMPDAT2_3, EPWM_FTCMPDAT4_5 corresponding complementary pairs EPWM_CH0 and EPWM_CH1, EPWM_CH2 and EPWM_CH3, EPWM_CH4 and EPWM_CH5.
 * @var EPWM_T::SSCTL
 ...
 * |        |          |Blanking window size = LEBCNT+1, and LEB counter clock base is EPWM_CLK.
 * @var EPWM_T::STATUS
 ...
 * |        |          |1 = An EADC start of conversion trigger event has occurred.
 * |        |          |Note: This bit can be cleared by software writing 1.
 * |[23]    |LPADCTRGF |LPADC Start of Conversion Flag
 * |        |          |0 = No LPADC start of conversion trigger event has occurred.
 * |        |          |1 = A LPADC start of conversion trigger event has occurred.
 * |        |          |Note: This bit can be cleared by software writing 1.
 ...
 * |        |          |1 = EPWMx_CLK divide by prescaler, x denotes 0 or 1.
 * @var EPWM_T::FDCTL[6]
 * Offset: 0x164  EPWM Fault Detect Control Register 0~5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |0 = Fault detect mask function Disable.
 * |        |          |1 = Fault detect mask function Enable.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |FDIEN0    |EPWM Channel n Fault Detect Interrupt Enable Bit
 * |        |          |0 = EPWM Channel n Fault Detect Interrupt Disable.
 * |        |          |1 = EPWM Channel n Fault Detect Interrupt Enable.
 * |[1]     |FDIEN1    |EPWM Channel n Fault Detect Interrupt Enable Bit
 * |        |          |0 = EPWM Channel n Fault Detect Interrupt Disable.
 * |        |          |1 = EPWM Channel n Fault Detect Interrupt Enable.
 * |[2]     |FDIEN2    |EPWM Channel n Fault Detect Interrupt Enable Bit
 * |        |          |0 = EPWM Channel n Fault Detect Interrupt Disable.
 * |        |          |1 = EPWM Channel n Fault Detect Interrupt Enable.
 * |[3]     |FDIEN3    |EPWM Channel n Fault Detect Interrupt Enable Bit
 * |        |          |0 = EPWM Channel n Fault Detect Interrupt Disable.
 * |        |          |1 = EPWM Channel n Fault Detect Interrupt Enable.
 * |[4]     |FDIEN4    |EPWM Channel n Fault Detect Interrupt Enable Bit
 * |        |          |0 = EPWM Channel n Fault Detect Interrupt Disable.
 * |        |          |1 = EPWM Channel n Fault Detect Interrupt Enable.
 * |[5]     |FDIEN5    |EPWM Channel n Fault Detect Interrupt Enable Bit
 * |        |          |0 = EPWM Channel n Fault Detect Interrupt Disable.
 * |        |          |1 = EPWM Channel n Fault Detect Interrupt Enable.
 * @var EPWM_T::FDSTS
 ...
 * |        |          |0 = EPWM Trigger EADC Pre-scale Function Disable.
 * |        |          |1 = EPWM Trigger EADC Pre-scale Function Enable.
 ...
 * |        |          |Indicator is set by hardware when EPWM counter down count and reaches EPWM_FTCMPDATn, software can clear this bit by writing 1 to it.
 * @var EPWM_T::CPSCBUF[6]
 * Offset: 0x350  EPWM CLKPSC Buffer 0~5
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 */
    ...
    __O  uint32_t SWSYNC;                /*!< [0x000c] EPWM Software Control Synchronization Register                   */
    ...
    __IO uint32_t FDCTL[6];              /*!< [0x0164] EPWM Fault Detect Control Register 0                             */
    ...
    __IO uint32_t RDTCNT0_1;             /*!< [0x02a8] EPWM Rising Dead-time Counter Register 0/1                       */
    __IO uint32_t RDTCNT2_3;             /*!< [0x02ac] EPWM Rising Dead-time Counter Register 2/3                       */
    __IO uint32_t RDTCNT4_5;             /*!< [0x02b0] EPWM Rising Dead-time Counter Register 4/5                       */
    __IO uint32_t FDTCNT0_1;             /*!< [0x02b4] EPWM Falling Dead-time Counter Register 0/1                      */
    __IO uint32_t FDTCNT2_3;             /*!< [0x02b8] EPWM Falling Dead-time Counter Register 2/3                      */
    __IO uint32_t FDTCNT4_5;             /*!< [0x02bc] EPWM Falling Dead-time Counter Register 4/5                      */
    __IO uint32_t DTCTL0;                /*!< [0x02c0] EPWM Dead-time Control Register                                  */
...
#define EPWM_BRKCTL0_1_VBSNBKEN_Pos      (6)                                               /*!< EPWM_T::BRKCTL0_1: VBSNBKEN Position   */
#define EPWM_BRKCTL0_1_VBSNBKEN_Msk      (0x1ul << EPWM_BRKCTL0_1_VBSNBKEN_Pos)            /*!< EPWM_T::BRKCTL0_1: VBSNBKEN Mask       */
...
#define EPWM_BRKCTL2_3_VBSNBKEN_Pos      (6)                                               /*!< EPWM_T::BRKCTL2_3: VBSNBKEN Position   */
#define EPWM_BRKCTL2_3_VBSNBKEN_Msk      (0x1ul << EPWM_BRKCTL2_3_VBSNBKEN_Pos)            /*!< EPWM_T::BRKCTL2_3: VBSNBKEN Mask       */
...
#define EPWM_BRKCTL4_5_VBSNBKEN_Pos      (6)                                               /*!< EPWM_T::BRKCTL4_5: VBSNBKEN Position   */
#define EPWM_BRKCTL4_5_VBSNBKEN_Msk      (0x1ul << EPWM_BRKCTL4_5_VBSNBKEN_Pos)            /*!< EPWM_T::BRKCTL4_5: VBSNBKEN Mask       */
...
#define EPWM_EXTETCTL0_EXTETEN_Pos       (0)                                               /*!< EPWM_T::EXTETCTL0: EXTETEN Position    */
#define EPWM_EXTETCTL0_EXTETEN_Msk       (0x1ul << EPWM_EXTETCTL0_EXTETEN_Pos)             /*!< EPWM_T::EXTETCTL0: EXTETEN Mask        */
...
#define EPWM_EXTETCTL1_EXTETEN_Pos       (0)                                               /*!< EPWM_T::EXTETCTL1: EXTETEN Position    */
#define EPWM_EXTETCTL1_EXTETEN_Msk       (0x1ul << EPWM_EXTETCTL1_EXTETEN_Pos)             /*!< EPWM_T::EXTETCTL1: EXTETEN Mask        */
...
#define EPWM_EXTETCTL2_EXTETEN_Pos       (0)                                               /*!< EPWM_T::EXTETCTL2: EXTETEN Position    */
#define EPWM_EXTETCTL2_EXTETEN_Msk       (0x1ul << EPWM_EXTETCTL2_EXTETEN_Pos)             /*!< EPWM_T::EXTETCTL2: EXTETEN Mask        */
...
#define EPWM_EXTETCTL3_EXTETEN_Pos       (0)                                               /*!< EPWM_T::EXTETCTL3: EXTETEN Position    */
#define EPWM_EXTETCTL3_EXTETEN_Msk       (0x1ul << EPWM_EXTETCTL3_EXTETEN_Pos)             /*!< EPWM_T::EXTETCTL3: EXTETEN Mask        */
...
#define EPWM_EXTETCTL4_EXTETEN_Pos       (0)                                               /*!< EPWM_T::EXTETCTL4: EXTETEN Position    */
#define EPWM_EXTETCTL4_EXTETEN_Msk       (0x1ul << EPWM_EXTETCTL4_EXTETEN_Pos)             /*!< EPWM_T::EXTETCTL4: EXTETEN Mask        */
...
#define EPWM_EXTETCTL5_EXTETEN_Pos       (0)                                               /*!< EPWM_T::EXTETCTL5: EXTETEN Position    */
#define EPWM_EXTETCTL5_EXTETEN_Msk       (0x1ul << EPWM_EXTETCTL5_EXTETEN_Pos)             /*!< EPWM_T::EXTETCTL5: EXTETEN Mask        */
