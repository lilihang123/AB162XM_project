...
/**
    @addtogroup LPADC Low Power Analog to Digital Converter (LPADC)
 ...
 * |        |          |Enable or disable triggering of A/D conversion by external LPADC0_ST pin, EPWM trigger, PWM trigger, ACMP interrupt event and Timer trigger
 ...
 * |        |          |When A/D conversion is completed, the converted data is loaded into ADDR0~26 and ADDR28~ADDR31
 * |        |          |Software can enable this bit to generate a LPPDMA data transfer request.
 * |        |          |0 = LPPDMA data transfer Disabled.
 * |        |          |1 = LPPDMA data transfer in ADDR0~26 and ADDR28~ADDR31 Enabled.
 ...
 * |        |          |ADST bit can be set to 1 from four sources: software, external pin LPADC0_ST, PWM trigger and Timer trigger
 ...
 * |        |          |Calibration data in macro will be deleted, but registers LPADC will keep.
 ...
 * |        |          |00 = ACMP0/1/2 both edge event as trigger source.
 * |        |          |01 = ACMP0/1/2 rising edge event as trigger source.
 * |        |          |10 = ACMP0/1/2 falling edge event as trigger source.
 * |        |          |11 = Reserved.
 ...
 * |        |          |Set this bit to 1 to enable LPADC to compare CMPD (ADCMPRx[27:16]) with specified channel conversion result when converted data is loaded into ADDR register.
 ...
 * |        |          |11000 = OPA0 internal output voltage conversion result is selected to be compared.
 * |        |          |11001 = OPA1 internal output voltage conversion result is selected to be compared.
 * |        |          |11010 = OPA2 internal output voltage conversion result is selected to be compared.
 ...
 * |        |          |After set ADEN (LPADC_ADCR[0]) to 1, the ADPRDY will set to 1 within one PCLK2 clock period.
 * |        |          |Then ADC macro can start convet.
 * |        |          |The chip also support ALDO when chip want to do A/D conversion under chip power level is PL2 and PL3.
 * |        |          |When ALDOEN (LPADC_ALDOCTL[8]) set to 1 to enable ALDO, the ALDO need a power stable time.
 * |        |          |The ADPRDY will keep low until ALDO power stable.
 * |        |          |The ALDO power ready time depends on STBSEL (LPADC_ALDOCTL[18:16]).
 * |        |          |Note: LPADC can start converting after ADPRDY is 1.
 ...
 * |        |          |VALID[31, 30, 29, 28, 26, 25, 24, 23:0] are the mirror of the VALID bits in ADDR31[17], ADDR30[17], ADDR29[17], ADDR28[17], ADDR26[17], ADDR25[17], ADDR24[17], ADDR23[17]~ ADDR0[17]
 * |        |          |The other bits are reserved.
 * |        |          |Note: When ADC is in burst mode and any conversion result is valid, VALID[31, 30, 29, 28, 26, 25, 24, 23:0] will be set to 1.
 * @var LPADC_T::ADSR2
 ...
 * |        |          |OVERRUN[31, 30, 29, 28, 26, 25, 24, 23:0] are the mirror of the OVERRUN bit in ADDR31[16], ADDR30[16], ADDR29[16], ADDR28[16], ADDR26[16], ADDR25[16], ADDR24[16], ADDR23[16] ~ ADDR0[16]
 * |        |          |The other bits are reserved.
 * |        |          |Note: When ADC is in burst mode and the FIFO is overrun, OVERRUN[31, 30, 29, 28, 26, 25, 24, 23:0] will be set to 1.
 * @var LPADC_T::ESMPCTL
 ...
 * |        |          |Current LPPDMA transfer data could be the content of ADDR0 ~ ADDR23, ADDR24, ADDR25, ADDR26, ADDR28, ADDR29, ADDC30 and ADDR31 registers.
 * @var LPADC_T::ADCAL
 ...
 * |        |          |Note 2: ALDO can be enabled only when the chip runs at power level 3 (PL3) or NPD2/4 or NPD0/1/3 with power level 3
 * |        |          |When the chip runs at power level 1 (PL1) or power level 2 (PL2), ALDO should be disabled.
 * |[18:16] |STBSEL    |ALDO Stable Count Select Bits
 * |        |          |If IGENEN (ALDOCTL[23]) is 0, the ALDO stable count is as follows.
 * |        |          |010 = ALDO stable count is 408 PCLK2 (When PCLK is 12 MHz).
 * |        |          |011 = ALDO stable count is 272 PCLK2 (When PCLK is 8 MHz).
 * |        |          |100 = ALDO stable count is 136 PCLK2 (When PCLK is 4 MHz).
 * |        |          |Others = Reserved.
 * |        |          |If IGENEN (ALDOCTL[23]) is 1, the ALDO stable count is as follows.
 * |        |          |010 = ALDO stable count is 48 PCLK2 (When PCLK is 12 MHz).
 * |        |          |011 = ALDO stable count is 32 PCLK2 (When PCLK is 8 MHz).
 * |        |          |100 = ALDO stable count is 16 PCLK2 (When PCLK is 4 MHz).
 * |        |          |Others = Reserved.
 * |[23]    |IGENEN    |ALDO Enable under IGEN Enable Bit
 * |        |          |0 = ALDO enable under IGEN Disabled.
 * |        |          |1 = ALDO enable under IGEN Enabled.
 * |        |          |Note: When ALDO enable under IGEN enable, the ALDO stable time is shorter.
 */
...
#define LPADC_ADDR24_RSLT_Pos            (0)                                               /*!< LPADC_T::ADDR24: RSLT Position         */
#define LPADC_ADDR24_RSLT_Msk            (0xfffful << LPADC_ADDR24_RSLT_Pos)               /*!< LPADC_T::ADDR24: RSLT Mask             */

#define LPADC_ADDR24_OVERRUN_Pos         (16)                                              /*!< LPADC_T::ADDR24: OVERRUN Position      */
#define LPADC_ADDR24_OVERRUN_Msk         (0x1ul << LPADC_ADDR24_OVERRUN_Pos)               /*!< LPADC_T::ADDR24: OVERRUN Mask          */

#define LPADC_ADDR24_VALID_Pos           (17)                                              /*!< LPADC_T::ADDR24: VALID Position        */
#define LPADC_ADDR24_VALID_Msk           (0x1ul << LPADC_ADDR24_VALID_Pos)                 /*!< LPADC_T::ADDR24: VALID Mask            */

#define LPADC_ADDR25_RSLT_Pos            (0)                                               /*!< LPADC_T::ADDR25: RSLT Position         */
#define LPADC_ADDR25_RSLT_Msk            (0xfffful << LPADC_ADDR25_RSLT_Pos)               /*!< LPADC_T::ADDR25: RSLT Mask             */

#define LPADC_ADDR25_OVERRUN_Pos         (16)                                              /*!< LPADC_T::ADDR25: OVERRUN Position      */
#define LPADC_ADDR25_OVERRUN_Msk         (0x1ul << LPADC_ADDR25_OVERRUN_Pos)               /*!< LPADC_T::ADDR25: OVERRUN Mask          */

#define LPADC_ADDR25_VALID_Pos           (17)                                              /*!< LPADC_T::ADDR25: VALID Position        */
#define LPADC_ADDR25_VALID_Msk           (0x1ul << LPADC_ADDR25_VALID_Pos)                 /*!< LPADC_T::ADDR25: VALID Mask            */

#define LPADC_ADDR26_RSLT_Pos            (0)                                               /*!< LPADC_T::ADDR26: RSLT Position         */
#define LPADC_ADDR26_RSLT_Msk            (0xfffful << LPADC_ADDR26_RSLT_Pos)               /*!< LPADC_T::ADDR26: RSLT Mask             */

#define LPADC_ADDR26_OVERRUN_Pos         (16)                                              /*!< LPADC_T::ADDR26: OVERRUN Position      */
#define LPADC_ADDR26_OVERRUN_Msk         (0x1ul << LPADC_ADDR26_OVERRUN_Pos)               /*!< LPADC_T::ADDR26: OVERRUN Mask          */

#define LPADC_ADDR26_VALID_Pos           (17)                                              /*!< LPADC_T::ADDR26: VALID Position        */
#define LPADC_ADDR26_VALID_Msk           (0x1ul << LPADC_ADDR26_VALID_Pos)                 /*!< LPADC_T::ADDR26: VALID Mask            */
...
#define LPADC_ADCR_ACMPTES_Pos           (20)                                              /*!< LPADC_T::ADCR: ACMPTES Position        */
#define LPADC_ADCR_ACMPTES_Msk           (0x3ul << LPADC_ADCR_ACMPTES_Pos)                 /*!< LPADC_T::ADCR: ACMPTES Mask            */
...
#define LPADC_ADCMPR_CMPMCNT_Pos         (8)                                               /*!< LPADC_T::ADCMPR: CMPMCNT Position      */
#define LPADC_ADCMPR_CMPMCNT_Msk         (0xful << LPADC_ADCMPR_CMPMCNT_Pos)               /*!< LPADC_T::ADCMPR: CMPMCNT Mask          */
...
#define LPADC_ALDOCTL_STBSEL_Msk         (0x7ul << LPADC_ALDOCTL_STBSEL_Pos)               /*!< LPADC_T::ALDOCTL: STBSEL Mask          */
