 ...
 * |        |          |Note: It is cleared by software writing 1 into this bit.
 * |[5]     |TXDCUDIS  |Transmit SOP* Message Discarded
 ...
 * |        |          |0 = Disabled.
 * |        |          |1 = Enabled.
 * |[5]     |TXDCUDIE  |Transmit SOP* Message Discarded Interrupt Enable
 * |        |          |0 = Disabled.
 * |        |          |1 = Enabled. 
 ...
 * |        |          |0 = Low active.
 * |        |          |1 = High active.
 * |[4]     |FOFFVBPL  |Force Off VBUS event Polarity
 * |        |          |0 = Low active.
 * |        |          |1 = High active.
 ...
 * |        |          |0 = Low active.
 * |        |          |1 = High active.
 * |[10]    |VCOCPL    |VCONN Overcurrent event Polarity
 * |        |          |0 = Low active.
 * |        |          |1 = High active.
 * @var UTCPD_T::ROLCTL
 ...
 * |[4]     |CPSDBG    |SOP'_DBG/SOP''_DBG Support
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[2:0]   |VBOCS     |VBUS Overcurrent Source Select
 * |        |          |000 = EINT0.
 * |        |          |001 = EINT1.
 * |        |          |010 = EINT2.
 * |        |          |011 = EINT3.
 * |        |          |100 = ADC Comparator out.
 * |        |          |101 = ACMP0.
 * |        |          |110 = ACMP1.
 * |        |          |111 = ACMP2.
 * |[6:4]   |VCOCS     |VCONN Overcurrent Source Select
 * |        |          |000 = EINT0.
 * |        |          |001 = EINT1.
 * |        |          |010 = EINT2.
 * |        |          |011 = EINT3.
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |VCUVDTEN  |VCONN Under Voltage Detect Enable
 * |        |          |0 = Disabled.
 * |        |          |1 = Enabled. 
 ...
 * |[22:20] |TRIMVB10  |Trim VBUS divided 10
 * |[26:24] |TRIMVB20  |Trim VBUS divided 20
 * |[31:28] |VTRIM     |VTRIM
 * @var UTCPD_T::PHYCTL
 ...
 */
    ...
    __IO uint32_t TCREV;                 /*!< [0x000c] UTCPD USB Type C Revision Register                               */
    ...
    __I  uint32_t FUTSTS;                /*!< [0x0040] UTCPD Fault Status Register                                      */
	...
	__IO uint32_t TEST2;                 /*!< [0x0300] UTCPD Test2 Register                                             */				
...
#define UTCPD_IS_TXDCUDIS_Pos            (5)                                               /*!< UTCPD_T::IS: TXDCUDIS Position         */
#define UTCPD_IS_TXDCUDIS_Msk            (0x1ul << UTCPD_IS_TXDCUDIS_Pos)                  /*!< UTCPD_T::IS: TXDCUDIS Mask             */
...
#define UTCPD_IE_TXDCUDIE_Pos            (5)                                               /*!< UTCPD_T::IE: TXDCUDIE Position         */
#define UTCPD_IE_TXDCUDIE_Msk            (0x1ul << UTCPD_IE_TXDCUDIE_Pos)                  /*!< UTCPD_T::IE: TXDCUDIE Mask             */

#define UTCPD_IE_TXOKIE_Pos              (6)                                               /*!< UTCPD_T::IE: TXOKIE Position           */
#define UTCPD_IE_TXOKIE_Msk              (0x1ul << UTCPD_IE_TXOKIE_Pos)                    /*!< UTCPD_T::IE: TXOKIE Mask               */
...
#define UTCPD_PINPL_FOFFVBPL_Pos         (4)                                               /*!< UTCPD_T::PINPL: FOFFVBPL Position      */
...
#define UTCPD_PINPL_VCOCPL_Pos           (10)                                              /*!< UTCPD_T::PINPL: VCOCPL Position        */
...
#define UTCPD_MUXSEL_VBOCS_Msk           (0x7ul << UTCPD_MUXSEL_VBOCS_Pos)                 /*!< UTCPD_T::MUXSEL: VBOCS Mask            */

#define UTCPD_MUXSEL_VCOCS_Pos           (4)                                               /*!< UTCPD_T::MUXSEL: VCOCS Position        */
#define UTCPD_MUXSEL_VCOCS_Msk           (0x7ul << UTCPD_MUXSEL_VCOCS_Pos)                 /*!< UTCPD_T::MUXSEL: VCOCS Mask            */
...
#define UTCPD_VCDGCTL_VCUVDTEN_Pos       (0)                                               /*!< UTCPD_T::VCDGCTL: VCUVDTEN Position    */
#define UTCPD_VCDGCTL_VCUVDTEN_Msk       (0x1ul << UTCPD_VCDGCTL_VCUVDTEN_Pos)             /*!< UTCPD_T::VCDGCTL: VCUVDTEN Mask        */
...
#define UTCPD_BMCSLICE_TRIMVB10_Pos      (20)                                              /*!< UTCPD_T::BMCSLICE: TRIMVB10 Position   */
#define UTCPD_BMCSLICE_TRIMVB10_Msk      (0x7ul << UTCPD_BMCSLICE_TRIMVB10_Pos)            /*!< UTCPD_T::BMCSLICE: TRIMVB10 Mask       */

#define UTCPD_BMCSLICE_TRIMVB20_Pos      (24)                                              /*!< UTCPD_T::BMCSLICE: TRIMVB20 Position   */
#define UTCPD_BMCSLICE_TRIMVB20_Msk      (0x7ul << UTCPD_BMCSLICE_TRIMVB20_Pos)            /*!< UTCPD_T::BMCSLICE: TRIMVB20 Mask       */
