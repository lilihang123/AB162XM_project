...
#define PORT_PC16F_GCLK_IO1    (_UL_(1) << 16)
...
#define PORT_PA28F_SERCOM3_PAD1  (_UL_(1) << 28)
...
#define PORT_PA12F_RFCTRL_FECTRL2  (_UL_(1) << 12)
...
#define PORT_PA13F_RFCTRL_FECTRL3  (_UL_(1) << 13)
