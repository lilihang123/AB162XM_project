...
#ifndef STM32WBAxx_HAL_ADC_H
#define STM32WBAxx_HAL_ADC_H
...
/** @defgroup ADC_HAL_EC_AUTONOMOUS_DEEP_POWER_DOWN_MODE ADC autonomous deep power down mode
  * @{
  */
#define ADC_LP_AUTONOMOUS_DPD_DISABLE     (LL_ADC_LP_AUTONOMOUS_DPD_DISABLE)  /*!< ADC deep power down in autonomous
                                          mode disabled */
#define ADC_LP_AUTONOMOUS_DPD_ENABLE      (LL_ADC_LP_AUTONOMOUS_DPD_ENABLE)   /*!< ADC deep power down in autonomous
                                          mode enabled */
/**
  * @}
  */
...
#define ADC_EXTERNALTRIG_LPTIM1_CC1   (LL_ADC_REG_TRIG_EXT_LPTIM1_CH1)          /*!< ADC group regular conversion
...
#define ADC_SAMPLETIME_79CYCLES_5        (LL_ADC_SAMPLINGTIME_79CYCLES_5)   /*!< Sampling time  79.5 ADC clock cycle  */
#define ADC_SAMPLETIME_814CYCLES_5       (LL_ADC_SAMPLINGTIME_814CYCLES_5)  /*!< Sampling time 814.5 ADC clock cycles */
/**
  * @}
  */
...
#define ADC_CHANNEL_VCORE                  (LL_ADC_CHANNEL_VCORE)          /*!< ADC internal channel to Vcore. */
/**
  * @}
  */
...
#define ADC_FLAG_LDORDY        ADC_ISR_LDORDY   /*!< ADC internal voltage regulator ready flag */
...
#define ADC_AWD1THRESHOLD_SHIFT_RESOLUTION(__HANDLE__, _Threshold_)            \
  ((_Threshold_) << ((((__HANDLE__)->Instance->CFGR1 & ADC_CFGR1_RES) >> 2U)*2U))
...
#define IS_ADC_AUTONOMOUS_DPD(AUTONOMOUS_DPD) (((AUTONOMOUS_DPD) == ADC_LP_AUTONOMOUS_DPD_DISABLE) || \
                                               ((AUTONOMOUS_DPD) == ADC_LP_AUTONOMOUS_DPD_ENABLE)    )
...
#define IS_ADC_EXTTRIG(REGTRIG) (((REGTRIG) == ADC_EXTERNALTRIG_T1_TRGO2)   || \
                                 ...
                                 ((REGTRIG) == ADC_EXTERNALTRIG_LPTIM1_CC1) || \
                                 ((REGTRIG) == ADC_EXTERNALTRIG_EXT_IT15)   || \
...
#define IS_ADC_SAMPLE_TIME(TIME) (((TIME) == ADC_SAMPLETIME_1CYCLE_5)    || \
                                  ...
                                  ((TIME) == ADC_SAMPLETIME_814CYCLES_5)   )
...
/**
  ...
  *            @arg @ref ADC_IT_LDORDY ADC channel internal voltage regulator ready interrupt source
...
/**
  ...
  *            @arg @ref ADC_FLAG_LDORDY  ADC channel internal voltage regulator ready flag
...
#include "stm32wbaxx_hal_adc_ex.h"
