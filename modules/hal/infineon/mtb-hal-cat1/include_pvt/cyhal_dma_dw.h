...
/** Initialize the Datawire peripheral using data provided by the configurator.
 *
...
/** Enable the DataWire transfer so that it can start transfering data when triggered.
 *
 * @param[in] obj    The DMA object
...
/** Disable the DataWire transfer so that it does not continue to trigger.
 *
 * @param[in] obj    The DMA object
 * @return The status of the enable request
 */
