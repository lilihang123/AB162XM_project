...
typedef enum
{
    ...
    CYBT_ERR_GENERIC,
    CYBT_ERR_HCI_IPC_INIT_FAILED,
    CYBT_ERR_HCI_IPC_DEINIT_FAILED,
    CYBT_ERR_HCI_IPC_GET_PTI_FAILED,
    CYBT_ERR_HCI_IPC_REL_BUFFER_FAILED,
    CYBT_ERR_HCI_IPC_REL_CHNL_FAILED,
    CYBT_ERR_HCI_IPC_GET_FIFO_FAILED,
    CYBT_ERR_INIT_EVENT_FAILED
} cybt_result_t;
