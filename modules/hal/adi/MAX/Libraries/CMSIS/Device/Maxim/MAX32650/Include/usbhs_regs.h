...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32650_INCLUDE_USBHS_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32650_INCLUDE_USBHS_REGS_H_
...
#define MXC_V_USBHS_INCSRL_SENDSTALL_TERMINATE         ((uint8_t)0x0UL) /**< INCSRL_SENDSTALL_TERMINATE Value */
#define MXC_S_USBHS_INCSRL_SENDSTALL_TERMINATE         (MXC_V_USBHS_INCSRL_SENDSTALL_TERMINATE << MXC_F_USBHS_INCSRL_SENDSTALL_POS) /**< INCSRL_SENDSTALL_TERMINATE Setting */
#define MXC_V_USBHS_INCSRL_SENDSTALL_RESPOND           ((uint8_t)0x1UL) /**< INCSRL_SENDSTALL_RESPOND Value */
#define MXC_S_USBHS_INCSRL_SENDSTALL_RESPOND           (MXC_V_USBHS_INCSRL_SENDSTALL_RESPOND << MXC_F_USBHS_INCSRL_SENDSTALL_POS) /**< INCSRL_SENDSTALL_RESPOND Setting */
...
#define MXC_V_USBHS_INCSRU_AUTOSET_SET                 ((uint8_t)0x0UL) /**< INCSRU_AUTOSET_SET Value */
#define MXC_S_USBHS_INCSRU_AUTOSET_SET                 (MXC_V_USBHS_INCSRU_AUTOSET_SET << MXC_F_USBHS_INCSRU_AUTOSET_POS) /**< INCSRU_AUTOSET_SET Setting */
#define MXC_V_USBHS_INCSRU_AUTOSET_AUTO                ((uint8_t)0x1UL) /**< INCSRU_AUTOSET_AUTO Value */
#define MXC_S_USBHS_INCSRU_AUTOSET_AUTO                (MXC_V_USBHS_INCSRU_AUTOSET_AUTO << MXC_F_USBHS_INCSRU_AUTOSET_POS) /**< INCSRU_AUTOSET_AUTO Setting */
...
#define MXC_V_USBHS_INCSRU_ISO_INTERRUPT               ((uint8_t)0x0UL) /**< INCSRU_ISO_INTERRUPT Value */
#define MXC_S_USBHS_INCSRU_ISO_INTERRUPT               (MXC_V_USBHS_INCSRU_ISO_INTERRUPT << MXC_F_USBHS_INCSRU_ISO_POS) /**< INCSRU_ISO_INTERRUPT Setting */
#define MXC_V_USBHS_INCSRU_ISO_ISOCHRONOUS             ((uint8_t)0x1UL) /**< INCSRU_ISO_ISOCHRONOUS Value */
#define MXC_S_USBHS_INCSRU_ISO_ISOCHRONOUS             (MXC_V_USBHS_INCSRU_ISO_ISOCHRONOUS << MXC_F_USBHS_INCSRU_ISO_POS) /**< INCSRU_ISO_ISOCHRONOUS Setting */
...
#define MXC_V_USBHS_INCSRU_MODE_OUT                    ((uint8_t)0x0UL) /**< INCSRU_MODE_OUT Value */
#define MXC_S_USBHS_INCSRU_MODE_OUT                    (MXC_V_USBHS_INCSRU_MODE_OUT << MXC_F_USBHS_INCSRU_MODE_POS) /**< INCSRU_MODE_OUT Setting */
#define MXC_V_USBHS_INCSRU_MODE_IN                     ((uint8_t)0x1UL) /**< INCSRU_MODE_IN Value */
#define MXC_S_USBHS_INCSRU_MODE_IN                     (MXC_V_USBHS_INCSRU_MODE_IN << MXC_F_USBHS_INCSRU_MODE_POS) /**< INCSRU_MODE_IN Setting */
...
#define MXC_V_USBHS_INCSRU_FRCDATATOG_RECEIVED         ((uint8_t)0x0UL) /**< INCSRU_FRCDATATOG_RECEIVED Value */
#define MXC_S_USBHS_INCSRU_FRCDATATOG_RECEIVED         (MXC_V_USBHS_INCSRU_FRCDATATOG_RECEIVED << MXC_F_USBHS_INCSRU_FRCDATATOG_POS) /**< INCSRU_FRCDATATOG_RECEIVED Setting */
#define MXC_V_USBHS_INCSRU_FRCDATATOG_DONTCARE         ((uint8_t)0x1UL) /**< INCSRU_FRCDATATOG_DONTCARE Value */
#define MXC_S_USBHS_INCSRU_FRCDATATOG_DONTCARE         (MXC_V_USBHS_INCSRU_FRCDATATOG_DONTCARE << MXC_F_USBHS_INCSRU_FRCDATATOG_POS) /**< INCSRU_FRCDATATOG_DONTCARE Setting */
...
#define MXC_V_USBHS_INCSRU_DPKTBUFDIS_EN               ((uint8_t)0x0UL) /**< INCSRU_DPKTBUFDIS_EN Value */
#define MXC_S_USBHS_INCSRU_DPKTBUFDIS_EN               (MXC_V_USBHS_INCSRU_DPKTBUFDIS_EN << MXC_F_USBHS_INCSRU_DPKTBUFDIS_POS) /**< INCSRU_DPKTBUFDIS_EN Setting */
#define MXC_V_USBHS_INCSRU_DPKTBUFDIS_DIS              ((uint8_t)0x1UL) /**< INCSRU_DPKTBUFDIS_DIS Value */
#define MXC_S_USBHS_INCSRU_DPKTBUFDIS_DIS              (MXC_V_USBHS_INCSRU_DPKTBUFDIS_DIS << MXC_F_USBHS_INCSRU_DPKTBUFDIS_POS) /**< INCSRU_DPKTBUFDIS_DIS Setting */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32650_INCLUDE_USBHS_REGS_H_
