...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32672_INCLUDE_GCR_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32672_INCLUDE_GCR_REGS_H_
...
#define MXC_F_GCR_PCLKDIV_AON_CLKDIV                   ((uint32_t)(0x7UL << MXC_F_GCR_PCLKDIV_AON_CLKDIV_POS)) /**< PCLKDIV_AON_CLKDIV Mask */
...
#define MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_OFF         ((uint32_t)0x0UL) /**< PCLKDIV_DIV_CLK_OUT_CTRL_OFF Value */
#define MXC_S_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_OFF         (MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_OFF << MXC_F_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_POS) /**< PCLKDIV_DIV_CLK_OUT_CTRL_OFF Setting */
#define MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV2        ((uint32_t)0x1UL) /**< PCLKDIV_DIV_CLK_OUT_CTRL_DIV2 Value */
#define MXC_S_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV2        (MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV2 << MXC_F_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_POS) /**< PCLKDIV_DIV_CLK_OUT_CTRL_DIV2 Setting */
#define MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV4        ((uint32_t)0x2UL) /**< PCLKDIV_DIV_CLK_OUT_CTRL_DIV4 Value */
#define MXC_S_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV4        (MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV4 << MXC_F_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_POS) /**< PCLKDIV_DIV_CLK_OUT_CTRL_DIV4 Setting */
#define MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV8        ((uint32_t)0x3UL) /**< PCLKDIV_DIV_CLK_OUT_CTRL_DIV8 Value */
#define MXC_S_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV8        (MXC_V_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_DIV8 << MXC_F_GCR_PCLKDIV_DIV_CLK_OUT_CTRL_POS) /**< PCLKDIV_DIV_CLK_OUT_CTRL_DIV8 Setting */
...
#define MXC_F_GCR_PCLKDIS0_CTB_POS                     14 /**< PCLKDIS0_CTB Position */
#define MXC_F_GCR_PCLKDIS0_CTB                         ((uint32_t)(0x1UL << MXC_F_GCR_PCLKDIS0_CTB_POS)) /**< PCLKDIS0_CTB Mask */
...
#define MXC_F_GCR_RST1_QDEC_POS                        25 /**< RST1_QDEC Position */
#define MXC_F_GCR_RST1_QDEC                            ((uint32_t)(0x1UL << MXC_F_GCR_RST1_QDEC_POS)) /**< RST1_QDEC Mask */
...
#define MXC_F_GCR_PCLKDIS1_QDEC_POS                    25 /**< PCLKDIS1_QDEC Position */
#define MXC_F_GCR_PCLKDIS1_QDEC                        ((uint32_t)(0x1UL << MXC_F_GCR_PCLKDIS1_QDEC_POS)) /**< PCLKDIS1_QDEC Mask */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32672_INCLUDE_GCR_REGS_H_
