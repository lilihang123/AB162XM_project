...
typedef enum {
    ...
    CM4_IRQn = 4,           /* 0x04, 4 Cortex-M4 (CPU0) */
    RSV5_IRQn,              /* 0x05, 5 Reserved */
    RSV6_IRQn,              /* 0x06, 6 Reserved */
    WDT0_IRQn,              /* 0x07, 7 Watchdog 0 */
    WDT1_IRQn,              /* 0x08, 8 Watchdog 1 */
    RTC_IRQn,               /* 0x09, 9 RTC */
    MSRADC_IRQn,            /* 0x0A, 10 Magstripe DSP */
    ...
    CRYPTO_IRQn,            /* 0x27, 39 CTB */
    SCA_IRQn,               /* 0x28, 40 SCA Accelerator */
    SC0_IRQn,               /* 0x29, 41 SC0 */
    SC1_IRQn,               /* 0x2A, 42 SC1 */
    SKBD_IRQn,              /* 0x2B, 43 SKBD */
...
#define MXC_SPI_GET_IDX(p) ((p) == MXC_SPI0 ? 0 : (p) == MXC_SPI1 ? 1 : (p) == MXC_SPI3 ? 3 : -1)
