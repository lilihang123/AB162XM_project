...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_I2S_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_I2S_REGS_H_
...
/**
 * @ingroup  i2s_registers
 * @defgroup I2S_FILTCH0 I2S_FILTCH0
 * @brief    Filter.
 * @{
 */
#define MXC_F_I2S_FILTCH0_FILTER_POS                   0 /**< FILTCH0_FILTER Position */
#define MXC_F_I2S_FILTCH0_FILTER                       ((uint32_t)(0xFFFFFFFFUL << MXC_F_I2S_FILTCH0_FILTER_POS)) /**< FILTCH0_FILTER Mask */

/**@} end of group I2S_FILTCH0_Register */
...
/**
 * @ingroup  i2s_registers
 * @defgroup I2S_WKEN I2S_WKEN
 * @brief    Wakeup Enable.
 * @{
 */
#define MXC_F_I2S_WKEN_CH_POS                          0 /**< WKEN_CH Position */
#define MXC_F_I2S_WKEN_CH                              ((uint32_t)(0x1UL << MXC_F_I2S_WKEN_CH_POS)) /**< WKEN_CH Mask */

/**@} end of group I2S_WKEN_Register */

/**
 * @ingroup  i2s_registers
 * @defgroup I2S_WKFL I2S_WKFL
 * @brief    Wakeup Flags.
 * @{
 */
#define MXC_F_I2S_WKFL_CH_POS                          0 /**< WKFL_CH Position */
#define MXC_F_I2S_WKFL_CH                              ((uint32_t)(0x1UL << MXC_F_I2S_WKFL_CH_POS)) /**< WKFL_CH Mask */

/**@} end of group I2S_WKFL_Register */

#ifdef __cplusplus
}
#endif

#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_I2S_REGS_H_
