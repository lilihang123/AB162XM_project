...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32650_INCLUDE_SMON_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32650_INCLUDE_SMON_REGS_H_
...
typedef struct {
    ...
    __R  uint32_t rsv_0x14_0x37[9];
    __IO uint32_t secst;                /**< <tt>\b 0x38:</tt> SMON SECST Register */
} mxc_smon_regs_t;
...
#define MXC_R_SMON_SECST                   ((uint32_t)0x00000038UL) /**< Offset from SMON Base Address: <tt> 0x0038</tt> */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32650_INCLUDE_SMON_REGS_H_
