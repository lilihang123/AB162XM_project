...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32665_INCLUDE_TPU_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32665_INCLUDE_TPU_REGS_H_
...
typedef struct {
    ...
    __IO uint32_t dma_dst;              /**< <tt>\b 0x14:</tt> TPU DMA_DST Register */
    __IO uint32_t dma_cnt;              /**< <tt>\b 0x18:</tt> TPU DMA_CNT Register */
    __IO uint32_t maa_ctrl;             /**< <tt>\b 0x1C:</tt> TPU MAA_CTRL Register */
    __O  uint32_t data_in[4];           /**< <tt>\b 0x20:</tt> TPU DATA_IN Register */
    __I  uint32_t data_out[4];          /**< <tt>\b 0x30:</tt> TPU DATA_OUT Register */
...
#define MXC_R_TPU_DMA_DST                  ((uint32_t)0x00000014UL) /**< Offset from TPU Base Address: <tt> 0x0014</tt> */
...
#define MXC_R_TPU_DATA_IN                  ((uint32_t)0x00000020UL) /**< Offset from TPU Base Address: <tt> 0x0020</tt> */
#define MXC_R_TPU_DATA_OUT                 ((uint32_t)0x00000030UL) /**< Offset from TPU Base Address: <tt> 0x0030</tt> */
...
#define MXC_F_TPU_CTRL_INT_POS                         1 /**< CTRL_INT Position */
#define MXC_F_TPU_CTRL_INT                             ((uint32_t)(0x1UL << MXC_F_TPU_CTRL_INT_POS)) /**< CTRL_INT Mask */
...
#define MXC_F_TPU_CTRL_DMADNE_MSK_POS                  15 /**< CTRL_DMADNE_MSK Position */
#define MXC_F_TPU_CTRL_DMADNE_MSK                      ((uint32_t)(0x1UL << MXC_F_TPU_CTRL_DMADNE_MSK_POS)) /**< CTRL_DMADNE_MSK Mask */
 ...
 * @{
 */
#define MXC_F_TPU_DMA_SRC_SRC_ADDR_POS                 0 /**< DMA_SRC_SRC_ADDR Position */
#define MXC_F_TPU_DMA_SRC_SRC_ADDR                     ((uint32_t)(0xFFFFFFFFUL << MXC_F_TPU_DMA_SRC_SRC_ADDR_POS)) /**< DMA_SRC_SRC_ADDR Mask */

/**@} end of group TPU_DMA_SRC_Register */

/**
 * @ingroup  tpu_registers
 * @defgroup TPU_DMA_DST TPU_DMA_DST
 * @brief    Crypto DMA Destination Address.
 * @{
 */
#define MXC_F_TPU_DMA_DST_DST_ADDR_POS                 0 /**< DMA_DST_DST_ADDR Position */
#define MXC_F_TPU_DMA_DST_DST_ADDR                     ((uint32_t)(0xFFFFFFFFUL << MXC_F_TPU_DMA_DST_DST_ADDR_POS)) /**< DMA_DST_DST_ADDR Mask */

/**@} end of group TPU_DMA_DST_Register */
...
/**
 * @ingroup  tpu_registers
 * @defgroup TPU_DATA_IN TPU_DATA_IN
 ...
 * @{
 */
#define MXC_F_TPU_DATA_IN_DATA_POS                     0 /**< DATA_IN_DATA Position */
#define MXC_F_TPU_DATA_IN_DATA                         ((uint32_t)(0xFFFFFFFFUL << MXC_F_TPU_DATA_IN_DATA_POS)) /**< DATA_IN_DATA Mask */

/**@} end of group TPU_DATA_IN_Register */

/**
 * @ingroup  tpu_registers
 * @defgroup TPU_DATA_OUT TPU_DATA_OUT
 ...
 * @{
 */
#define MXC_F_TPU_DATA_OUT_DATA_POS                    0 /**< DATA_OUT_DATA Position */
#define MXC_F_TPU_DATA_OUT_DATA                        ((uint32_t)(0xFFFFFFFFUL << MXC_F_TPU_DATA_OUT_DATA_POS)) /**< DATA_OUT_DATA Mask */

/**@} end of group TPU_DATA_OUT_Register */
 ...
 * @{
 */
#define MXC_F_TPU_CRC_POLY_SRC_ADDR_POS                0 /**< CRC_POLY_SRC_ADDR Position */
#define MXC_F_TPU_CRC_POLY_SRC_ADDR                    ((uint32_t)(0xFFFFFFFFUL << MXC_F_TPU_CRC_POLY_SRC_ADDR_POS)) /**< CRC_POLY_SRC_ADDR Mask */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32665_INCLUDE_TPU_REGS_H_
