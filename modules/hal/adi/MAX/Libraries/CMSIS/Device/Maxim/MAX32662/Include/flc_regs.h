...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_FLC_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_FLC_REGS_H_
...
#define MXC_F_FLC_INTR_PROG_PROT_ERR_IF_POS            2 /**< INTR_PROG_PROT_ERR_IF Position */
#define MXC_F_FLC_INTR_PROG_PROT_ERR_IF                ((uint32_t)(0x1UL << MXC_F_FLC_INTR_PROG_PROT_ERR_IF_POS)) /**< INTR_PROG_PROT_ERR_IF Mask */

#define MXC_F_FLC_INTR_MASS_ER_PROT_ERR_IF_POS         3 /**< INTR_MASS_ER_PROT_ERR_IF Position */
#define MXC_F_FLC_INTR_MASS_ER_PROT_ERR_IF             ((uint32_t)(0x1UL << MXC_F_FLC_INTR_MASS_ER_PROT_ERR_IF_POS)) /**< INTR_MASS_ER_PROT_ERR_IF Mask */

#define MXC_F_FLC_INTR_PAGE_ER_PROT_ERR_IF_POS         4 /**< INTR_PAGE_ER_PROT_ERR_IF Position */
#define MXC_F_FLC_INTR_PAGE_ER_PROT_ERR_IF             ((uint32_t)(0x1UL << MXC_F_FLC_INTR_PAGE_ER_PROT_ERR_IF_POS)) /**< INTR_PAGE_ER_PROT_ERR_IF Mask */

#define MXC_F_FLC_INTR_PROT_AREA_PROT_ERR_IF_POS       5 /**< INTR_PROT_AREA_PROT_ERR_IF Position */
#define MXC_F_FLC_INTR_PROT_AREA_PROT_ERR_IF           ((uint32_t)(0x1UL << MXC_F_FLC_INTR_PROT_AREA_PROT_ERR_IF_POS)) /**< INTR_PROT_AREA_PROT_ERR_IF Mask */
...
#define MXC_F_FLC_INTR_PROT_IE_POS                     10 /**< INTR_PROT_IE Position */
#define MXC_F_FLC_INTR_PROT_IE                         ((uint32_t)(0x1UL << MXC_F_FLC_INTR_PROT_IE_POS)) /**< INTR_PROT_IE Mask */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_FLC_REGS_H_
