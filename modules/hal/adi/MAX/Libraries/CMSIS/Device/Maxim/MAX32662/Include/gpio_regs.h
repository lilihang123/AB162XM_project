...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_GPIO_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_GPIO_REGS_H_
...
typedef struct {
    ...
    __IO uint32_t en3;                  /**< <tt>\b 0x80:</tt> GPIO EN3 Register */
    __IO uint32_t en3_set;              /**< <tt>\b 0x84:</tt> GPIO EN3_SET Register */
    __IO uint32_t en3_clr;              /**< <tt>\b 0x88:</tt> GPIO EN3_CLR Register */
...
#define MXC_R_GPIO_EN3                     ((uint32_t)0x00000080UL) /**< Offset from GPIO Base Address: <tt> 0x0080</tt> */
#define MXC_R_GPIO_EN3_SET                 ((uint32_t)0x00000084UL) /**< Offset from GPIO Base Address: <tt> 0x0084</tt> */
#define MXC_R_GPIO_EN3_CLR                 ((uint32_t)0x00000088UL) /**< Offset from GPIO Base Address: <tt> 0x0088</tt> */
...
/**
 * @ingroup  gpio_registers
 * @defgroup GPIO_EN3 GPIO_EN3
 * @brief    GPIO Alternate Function Enable Register. Each bit in this register selects
 *           between primary/secondary functions for the associated GPIO pin in this port.
 * @{
 */
#define MXC_F_GPIO_EN3_GPIO_EN3_POS                    0 /**< EN3_GPIO_EN3 Position */
#define MXC_F_GPIO_EN3_GPIO_EN3                        ((uint32_t)(0xFFFFFFFFUL << MXC_F_GPIO_EN3_GPIO_EN3_POS)) /**< EN3_GPIO_EN3 Mask */
#define MXC_V_GPIO_EN3_GPIO_EN3_PRIMARY                ((uint32_t)0x0UL) /**< EN3_GPIO_EN3_PRIMARY Value */
#define MXC_S_GPIO_EN3_GPIO_EN3_PRIMARY                (MXC_V_GPIO_EN3_GPIO_EN3_PRIMARY << MXC_F_GPIO_EN3_GPIO_EN3_POS) /**< EN3_GPIO_EN3_PRIMARY Setting */
#define MXC_V_GPIO_EN3_GPIO_EN3_SECONDARY              ((uint32_t)0x1UL) /**< EN3_GPIO_EN3_SECONDARY Value */
#define MXC_S_GPIO_EN3_GPIO_EN3_SECONDARY              (MXC_V_GPIO_EN3_GPIO_EN3_SECONDARY << MXC_F_GPIO_EN3_GPIO_EN3_POS) /**< EN3_GPIO_EN3_SECONDARY Setting */

/**@} end of group GPIO_EN3_Register */

/**
 * @ingroup  gpio_registers
 * @defgroup GPIO_EN3_SET GPIO_EN3_SET
 ...
 * @{
 */
#define MXC_F_GPIO_EN3_SET_ALL_POS                     0 /**< EN3_SET_ALL Position */
#define MXC_F_GPIO_EN3_SET_ALL                         ((uint32_t)(0xFFFFFFFFUL << MXC_F_GPIO_EN3_SET_ALL_POS)) /**< EN3_SET_ALL Mask */

/**@} end of group GPIO_EN3_SET_Register */

/**
 * @ingroup  gpio_registers
 * @defgroup GPIO_EN3_CLR GPIO_EN3_CLR
 * @brief    GPIO Wake Alternate Function Clear. Writing a 1 to one or more bits in this
 *           register clears the bits in the same positions in GPIO_EN3 to 0, without
 *           affecting other bits in that register.
 * @{
 */
#define MXC_F_GPIO_EN3_CLR_ALL_POS                     0 /**< EN3_CLR_ALL Position */
#define MXC_F_GPIO_EN3_CLR_ALL                         ((uint32_t)(0xFFFFFFFFUL << MXC_F_GPIO_EN3_CLR_ALL_POS)) /**< EN3_CLR_ALL Mask */

/**@} end of group GPIO_EN3_CLR_Register */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32662_INCLUDE_GPIO_REGS_H_
