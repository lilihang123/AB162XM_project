...
#ifndef LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32672_INCLUDE_PWRSEQ_REGS_H_
#define LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32672_INCLUDE_PWRSEQ_REGS_H_
...
typedef struct {
    ...
    __IO uint32_t gpr0;                 /**< <tt>\b 0x48:</tt> PWRSEQ GPR0 Register */
    __IO uint32_t gpr1;                 /**< <tt>\b 0x4C:</tt> PWRSEQ GPR1 Register */
} mxc_pwrseq_regs_t;
...
#define MXC_R_PWRSEQ_GPR0                  ((uint32_t)0x00000048UL) /**< Offset from PWRSEQ Base Address: <tt> 0x0048</tt> */
#define MXC_R_PWRSEQ_GPR1                  ((uint32_t)0x0000004CUL) /**< Offset from PWRSEQ Base Address: <tt> 0x004C</tt> */
...
#define MXC_F_PWRSEQ_LPCN_VBBMON_DIS_POS               27 /**< LPCN_VBBMON_DIS Position */
#define MXC_F_PWRSEQ_LPCN_VBBMON_DIS                   ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPCN_VBBMON_DIS_POS)) /**< LPCN_VBBMON_DIS Mask */
...
#define MXC_F_PWRSEQ_LPWKST0_ST                        ((uint32_t)(0x7FFFFFFFUL << MXC_F_PWRSEQ_LPWKST0_ST_POS)) /**< LPWKST0_ST Mask */
...
#define MXC_F_PWRSEQ_LPPWKST_AINCOMP0_POS              3 /**< LPPWKST_AINCOMP0 Position */
#define MXC_F_PWRSEQ_LPPWKST_AINCOMP0                  ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPPWKST_AINCOMP0_POS)) /**< LPPWKST_AINCOMP0 Mask */

#define MXC_F_PWRSEQ_LPPWKST_AINCOMP1_POS              4 /**< LPPWKST_AINCOMP1 Position */
#define MXC_F_PWRSEQ_LPPWKST_AINCOMP1                  ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPPWKST_AINCOMP1_POS)) /**< LPPWKST_AINCOMP1 Mask */

#define MXC_F_PWRSEQ_LPPWKST_AINCOMP0_OUT_POS          5 /**< LPPWKST_AINCOMP0_OUT Position */
#define MXC_F_PWRSEQ_LPPWKST_AINCOMP0_OUT              ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPPWKST_AINCOMP0_OUT_POS)) /**< LPPWKST_AINCOMP0_OUT Mask */

#define MXC_F_PWRSEQ_LPPWKST_AINCOMP1_OUT_POS          6 /**< LPPWKST_AINCOMP1_OUT Position */
#define MXC_F_PWRSEQ_LPPWKST_AINCOMP1_OUT              ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPPWKST_AINCOMP1_OUT_POS)) /**< LPPWKST_AINCOMP1_OUT Mask */

#define MXC_F_PWRSEQ_LPPWKST_BACKUP_POS                16 /**< LPPWKST_BACKUP Position */
#define MXC_F_PWRSEQ_LPPWKST_BACKUP                    ((uint32_t)(0x1UL << MXC_F_PWRSEQ_LPPWKST_BACKUP_POS)) /**< LPPWKST_BACKUP Mask */
...
#endif // LIBRARIES_CMSIS_DEVICE_MAXIM_MAX32672_INCLUDE_PWRSEQ_REGS_H_
