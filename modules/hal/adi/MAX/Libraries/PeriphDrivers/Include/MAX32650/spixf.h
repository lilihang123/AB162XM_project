...
#ifndef LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32650_SPIXF_H_
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32650_SPIXF_H_
 ...
 */
typedef enum {
    MXC_SPIXF_TRISTATE = MXC_S_SPIXF_IO_CTRL_PUPDCTRL_TRI_STATE,
    MXC_SPIXF_PULL_UP = MXC_S_SPIXF_IO_CTRL_PUPDCTRL_PULL_UP,
    MXC_SPIXF_PULL_DOWN = MXC_S_SPIXF_IO_CTRL_PUPDCTRL_PULL_DOWN,
} mxc_spixf_pup_t;
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32650_SPIXF_H_
