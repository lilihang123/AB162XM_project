...
#ifndef LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32680_WUT_H_
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32680_WUT_H_
 ...
 * @param   wut     Pointer to Wakeup Timer instance to set count valeu for.
 * @param   cnt     New count.
 */
 ...
 * @param   wut     Pointer to Wakeup Timer instance to get tick count from.
 ...
 * @param   wut     Pointer to Wakeup Timer instance to get time from.
 ...
 * @param   wut      Pointer to Wakeup Timer instance to restore count and snapshot values for.
 ...
 * @param   wut        Pointer to Wakeup Timer instance to get current sleep ticks from.
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32680_WUT_H_
