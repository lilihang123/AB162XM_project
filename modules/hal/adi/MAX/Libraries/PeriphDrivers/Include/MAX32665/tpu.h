...
#ifndef LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32665_TPU_H_
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32665_TPU_H_
...
/**
 * @defgroup tpu Trust Protection Unit (TPU)
 * @ingroup tpu
 * @{
 */
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32665_TPU_H_
