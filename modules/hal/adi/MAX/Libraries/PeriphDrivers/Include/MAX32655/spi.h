...
#ifndef LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32655_SPI_H_
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32655_SPI_H_
...
/**
 * @brief   Sets Multi-Transaction (MT) mode on or off
 *
 * This function allows Multi-Transaction Mode to be enabled or disabled. MT Mode
 * provides a performance improvement on back-to-back DMA operations.
 *
 * @param   spi         Pointer to SPI registers (selects the SPI block used.)
 * @param   mtMode      1 to enable, 0 to disable (default)
 *
 * @return  Success/Fail, see \ref MXC_Error_Codes for a list of return codes.
 */
...
/**
 * @brief   Gets the current setting for Multi-Transaction (MT) mode
 *
 * @param   spi         Pointer to SPI registers (selects the SPI block used.)
 *
 * @return  The current value of MT mode, either 1 (enabled) or 0 (disabled)
 */
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32655_SPI_H_
