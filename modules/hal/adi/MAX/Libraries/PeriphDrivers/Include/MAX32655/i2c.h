...
#ifndef LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32655_I2C_H_
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32655_I2C_H_
 ...
 *
 * @param   i2c         Pointer to I2C registers (selects the I2C block used.)
 * @param   flags0      Pointer to variable to store interrupt status for interrupt register intfl0.
 * @param   flags1      Pointer to variable to store interrupt status for interrupt register intfl1.
 */
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32655_I2C_H_
