 ...
 */
typedef enum {
    MXC_HPB_LAT_5 = MXC_V_HPB_MEMTIM_LAT_5CLK, /**< 5 clock latency for RAM */
    MXC_HPB_LAT_6 = MXC_V_HPB_MEMTIM_LAT_6CLK, /**< 6 clock latency for RAM */
    MXC_HPB_LAT_3 = MXC_V_HPB_MEMTIM_LAT_3CLK, /**< 3 clock latency for RAM */
    MXC_HPB_LAT_4 = MXC_V_HPB_MEMTIM_LAT_4CLK, /**< 4 clock latency for RAM */
} mxc_hpb_latency_t;
 ...
 */
typedef enum {
    MXC_HPB_DEV_HYPER_FLASH = MXC_V_HPB_MEMCTRL_DEVTYPE_HYPERFLASH,
    MXC_HPB_DEV_XCCELA_PSRAM = MXC_V_HPB_MEMCTRL_DEVTYPE_XCCELA_PSRAM,
    MXC_HPB_DEV_HYPER_RAM = MXC_V_HPB_MEMCTRL_DEVTYPE_HYPERRAM,
} mxc_hpb_device_t;
