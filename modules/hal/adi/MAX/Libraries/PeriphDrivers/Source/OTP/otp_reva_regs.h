 ...
 * @{
 */
 #define MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS              0 /**< CLKDIV_PCLKDIV Position */
 #define MXC_F_OTP_REVA_CLKDIV_PCLKDIV                  ((uint32_t)(0x3FUL << MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS)) /**< CLKDIV_PCLKDIV Mask */
 #define MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV2             ((uint32_t)0x1UL) /**< CLKDIV_PCLKDIV_DIV2 Value */
 #define MXC_S_OTP_REVA_CLKDIV_PCLKDIV_DIV2             (MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV2 << MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS) /**< CLKDIV_PCLKDIV_DIV2 Setting */
 #define MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV4             ((uint32_t)0x3UL) /**< CLKDIV_PCLKDIV_DIV4 Value */
 #define MXC_S_OTP_REVA_CLKDIV_PCLKDIV_DIV4             (MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV4 << MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS) /**< CLKDIV_PCLKDIV_DIV4 Setting */
 #define MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV8             ((uint32_t)0x7UL) /**< CLKDIV_PCLKDIV_DIV8 Value */
 #define MXC_S_OTP_REVA_CLKDIV_PCLKDIV_DIV8             (MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV8 << MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS) /**< CLKDIV_PCLKDIV_DIV8 Setting */
 #define MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV16            ((uint32_t)0xFUL) /**< CLKDIV_PCLKDIV_DIV16 Value */
 #define MXC_S_OTP_REVA_CLKDIV_PCLKDIV_DIV16            (MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV16 << MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS) /**< CLKDIV_PCLKDIV_DIV16 Setting */
 #define MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV32            ((uint32_t)0x1FUL) /**< CLKDIV_PCLKDIV_DIV32 Value */
 #define MXC_S_OTP_REVA_CLKDIV_PCLKDIV_DIV32            (MXC_V_OTP_REVA_CLKDIV_PCLKDIV_DIV32 << MXC_F_OTP_REVA_CLKDIV_PCLKDIV_POS) /**< CLKDIV_PCLKDIV_DIV32 Setting */
